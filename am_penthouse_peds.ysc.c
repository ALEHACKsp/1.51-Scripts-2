...
void __EntryFunction__()
{
	...
	{
		func_47();
		if ((!unk_0x8CD06866876216F2() || func_35()) || Global_1417D7 == 0)
		{
			func_32();
		}
		func_3();
	...
	if (iVar3 != 0 && iVar3 != 1)
	{
		if (unk_0xB4AE0788C1587752(sVar0))
		{
			...
			if (!func_7(uParam0))
			{
				if (func_6(uParam0))
				{
					unk_0x3E8E48829F3C7624(0, sVar0, sVar1, uParam0->f_6, 0f, 0f, uParam0->f_9, 1090519040, 3238002688, 4294967295, 790529, fVar2, 2, 3);
				}
				else
				{
			...
			else
			{
				...
				while (iVar8 < 4)
				{
					...
					{
						case 0:
							unk_0xC6EB89C59F2AF6B8(0, sVar0, "IDLE_A", 8f, -8f, 4294967295, 0, 0f, 0, 0, 0);
							break;
						
						case 1:
							unk_0xC6EB89C59F2AF6B8(0, sVar0, "IDLE_B", 8f, -8f, 4294967295, 0, 0f, 0, 0, 0);
							break;
						
						case 2:
							unk_0xC6EB89C59F2AF6B8(0, sVar0, "IDLE_C", 8f, -8f, 4294967295, 0, 0f, 0, 0, 0);
							break;
						
						case 3:
							unk_0xC6EB89C59F2AF6B8(0, sVar0, "IDLE_D", 8f, -8f, 4294967295, 0, 0f, 0, 0, 0);
							break;
					}
					iVar8++;
				}
			...
			*uParam0 = unk_0x36F2404464202779(26, func_26(uParam0), uParam0->f_6, uParam0->f_9, 0, false);
			if (unk_0xC844350D5D58C99A(*uParam0))
			{
				...
				if (func_16(uParam0))
				{
					...
					{
						uParam0->f_1 = unk_0x7707E48765093646(func_15(uParam0), unk_0x64430C979F516F7A(*uParam0, func_14(uParam0), 0f, 0f, 0f), false, false, false);
...
void func_54()
{
	while (!unk_0x5F4FB6573A5696A1(32, 0, Global_1417E6))
	{
		SYSTEM::WAIT(0);
	}
	Global_1417E6++;
	func_55(0, 4294967295, 0);

...
void func_1()
{
	if (func_18(&Local_42, &Local_48) || func_17(110) == 1)
	{
		...
		if (!func_17(110))
		{
			if (!bLocal_62)
			{
				bLocal_62 = func_3(1303349750, 1, 1, 16, 3, 1000, 10000, 1256519626, 4294967295, 163, 4294967295, 0);
			}
		}
		func_2(2);
	}
...
int func_18(var uParam0, int iParam1)
{
	...
	while (iVar0 < 1)
	{
		...
		if (!(iParam1[uParam0->f_A /*11*/])->f_A)
		{
			if (!bVar1)
			{
				if (!func_53((iParam1[uParam0->f_A /*11*/])->f_6, 0f, 0f, 0f, 0))
				{
	...
	if (uParam0->f_B)
	{
		if (!Global_12C52)
		{
			func_26(&(uParam0->f_B), &(uParam0->f_C), &(uParam0->f_9), 5, &iLocal_52, &iLocal_50, "DIVING_TITLE", "DIVING_COLLECT");
		}
		if (!func_25(44))
		{
			...
			{
				if (unk_0x0EB28750412C3A5A(func_23(iVar4), vVar3, false) > 200f)
				{
					func_20("DIVING_HELP4", 1, 7500, 4294967295, 10000, 7, 0, 0, 0);
					func_19(44);
				}
			}
		}
...
int func_28(int iParam0)
{
	...
	else
	{
		...
		while (iVar1 < func_34(iParam0))
		{
			...
			if (func_29(iVar2, 4294967295, 4294967295))
			{
				iVar0++;
			}
			iVar1++;
...
int func_36(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		if ((SYSTEM::VDIST2(vParam2, unk_0xE925E52ACABA4CE7((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_38(13)) || func_38(14))
		{
...
void func_41()
{
	...
	iVar3 = 0;
	unk_0x6FB46C25CCB7E6D5(func_42(0), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(18, iVar0);
	}
	unk_0x6FB46C25CCB7E6D5(func_42(1), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(19, iVar0);
	}
	unk_0x6FB46C25CCB7E6D5(func_42(3), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_12(20, iVar0);
...
void func_43(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			iVar1++;
			func_13((uParam0->f_2 + iVar0), 1, 4294967295, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_45(var uParam0, int iParam1)
{
	...
	{
		uParam0->f_4++;
		func_13((uParam0->f_2 + iParam1), 1, 4294967295, 1);
		if (bLocal_40)
		{
		}
	}
	...
	switch (iLocal_66)
	{
		case 0:
			if (func_62())
			{
				...
				{
					func_61();
					unk_0xB078AFA7242F1F7B(iLocal_64, false);
					iLocal_66 = 1;
					if (iLocal_49 == 2)
					{
						func_2(3);
...
int func_62()
{
	if (func_50(unk_0x16F2683693E537C9()))
	{
		...
		else if (func_63())
		{
			...
			{
				unk_0x73270B3C9CC833FD(iLocal_64, true, 1);
...
void func_64()
{
	...
	if (func_24(&Local_42, &Local_48, vVar0, &iLocal_51))
	{
		...
		fVar2 = unk_0x0EB28750412C3A5A(vVar1, vVar0, false);
		if (fVar2 > 200f)
		{
			func_66();
			if (!iLocal_61)
			...
			if (func_63())
			{
				if (!func_25(41))
				{
					func_20("DIVING_HELP1", 1, 0, 4294967295, 10000, 7, 0, 0, 0);
					func_19(41);
				}
		...
		else
		{
			if (func_63())
			{
				if (!func_25(42))
				{
					func_20("DIVING_HELP2", 1, 0, 4294967295, 10000, 7, 0, 0, 0);
					func_19(42);
				}
			}
			if (func_25(42))
			{
				if (!func_25(43))
				{
					...
					{
						func_20("DIVING_HELP3", 1, 2000, 4294967295, 10000, 7, 0, 0, 0);
						func_19(43);
					}
				}
			}
			...
			if (Local_42.f_1.f_4 < Local_42.f_1.f_3)
			{
				if (iLocal_61)
				{
					...
					if (func_63())
					{
						unk_0xEB819BD1E585E9CB(iLocal_63, "SINGLE_BLIP_FROM_BOAT", vVar1, "ABIGAIL_SONAR_SOUNDSET", false, 0, 0);
					}
					else
					{
						unk_0xEB819BD1E585E9CB(iLocal_63, "SCRIPT_TRIGGERED_FROM_PROP", vVar0, "ABIGAIL_SONAR_SOUNDSET", false, 0, 0);
					}
				}
				else
				{
					...
					if (!unk_0xE4EDC4B0E92C078B(iLocal_55))
					{
						...
						unk_0x6ABCCE651368DB93(iLocal_55, true);
						unk_0xBF72CE7FA6B07FFC(iLocal_55, 1);
						unk_0xF2D30B8ACAF12A39(iLocal_55, false);
					}
					else
					{
					...
					if (func_63())
					{
						...
						while (iVar3 <= 3)
						{
							if (!unk_0xE4EDC4B0E92C078B(iLocal_56[iVar3]))
							{
								...
								unk_0x6ABCCE651368DB93(iLocal_56[iVar3], true);
								unk_0xBF72CE7FA6B07FFC(iLocal_56[iVar3], 1);
								unk_0xF2D30B8ACAF12A39(iLocal_56[iVar3], false);
							}
							else
							{
...
void func_69(int iParam0, var uParam1, var uParam2)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_29((iParam0->f_2 + iVar0), 4294967295, 4294967295))
		{
			iVar1++;

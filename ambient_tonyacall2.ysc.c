...
void __EntryFunction__()
{
	...
	if (unk_0x8A22C4C08282BF26(joaat("ambient_tonyacall2")) > 1)
	{
...
int func_1()
{
	...
	if ((SYSTEM::VDIST2(vVar0, vVar1) > 10000f || unk_0x437347B10A200C4B(iLocal_38, 0)) || func_27())
	{
		return 1;
	}
	switch (iLocal_40)
		...
		case 0:
			if (unk_0xC844350D5D58C99A(iLocal_38) && !unk_0x437347B10A200C4B(iLocal_38, 0))
			{
				if (unk_0x5A91F08DF773C39D(iLocal_38, vLocal_49, 1f, 1f, 1f, false, true, 0))
				{
					...
					unk_0x78ADC381772E3D54(iLocal_38, iVar3);
					unk_0xF82EA857DA10E0CD(&iVar3);
					iLocal_40 = 1;
				}
			}

...
int func_10()
{
	...
	{
		if ((unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()) && unk_0x93B62D155C014521(unk_0xD803B885F5E47A62())) && !unk_0x991B1F0980C62628())
		{
			if (func_26(0))
			{
				func_11(48, 4, 0);
		...
		if (bParam2)
		{
			if (!Global_12B4E)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_1F4F[iParam1 /*4*/] = { func_13(iParam0) };
					...
					{
						Global_1F1E[1 /*6*/] = { func_13(iParam0) };

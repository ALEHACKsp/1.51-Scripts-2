	...
	while (true)
	{
		...
		if (iLocal_24 == 0)
		{
			if (Global_4C1E.f_1 != 9)
			{
				...
				{
					case 7:
						if ((iLocal_31 == 0 && iLocal_32 == 0) && Global_5550 == 0)
						{
							func_22();
							func_16();
						}
					...
					case 8:
						if ((func_15(2, Global_4BFE, 0) && iLocal_31 == 0) && iLocal_32 == 0)
						{
							func_14();
							Global_4C08 = 1;
							if (Global_4C1E.f_1 > 3)
							{
								if (unk_0xEAE0D21A50E6C7F4(Global_1CBD, 15))
								{
								}
								func_13();
							}
...
void func_3()
{
	...
	func_7(Global_4C0B, "SET_DATA_SLOT_EMPTY", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
	...
	while (iLocal_22 < iLocal_21)
	{
		...
		{
			func_6(Global_4C0B, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_27[iLocal_22 /*6*/]), 0, 0, 0, 0);
			iLocal_26[iVar0] = iLocal_22;
			iVar0++;
		}
		iLocal_22++;
	}
	func_7(Global_4C0B, "DISPLAY_VIEW", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
	func_4(Global_4C0B, "SET_HEADER", "CELL_MSMENU_1", 0, 0, 0, 0);
	if (Global_4C12)
	{
		func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
		func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
	}
...
void func_9()
{
	if ((iLocal_31 == 1 && iLocal_32 == 0) && Global_5550 == 6)
	{
		if (iLocal_33)
		{
			vLocal_30.x = (vLocal_30.x - 1f);
	...
	if (unk_0xEAE0D21A50E6C7F4(Global_1CBD, 15))
	{
		...
		iLocal_32 = 0;
		func_7(Global_4C0B, "SET_DATA_SLOT_EMPTY", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
		func_6(Global_4C0B, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_3", 0, 0, 0, 0);
		if (Global_4C12)
		{
			func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
			func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
		}
		else
		{
			func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
			func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
		}
		func_6(Global_4C0B, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
		unk_0x0674E58A79778E99(&Global_1CBC, 17);
		func_7(Global_4C0B, "DISPLAY_VIEW", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
		func_4(Global_4C0B, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
	}
}
...
void func_16()
{
	...
	if (iLocal_28 == 0)
	{
		if (func_15(2, Global_4C06, 0))
		{
			func_20();
			iLocal_28 = 1;
			SYSTEM::SETTIMERA(0);
		}
		if (func_15(2, Global_4C07, 0))
		{
			func_17();
			iLocal_28 = 1;
			SYSTEM::SETTIMERA(0);
...
void func_17()
{
	func_7(Global_4C0B, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), 3212836864, 3212836864, 3212836864, 3212836864);
...
void func_20()
{
	func_7(Global_4C0B, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), 3212836864, 3212836864, 3212836864, 3212836864);
	unk_0x4D7F4CC43D4D0DE3(4294967295, "Menu_Navigate", &Global_4C13, true);
	func_21();
}
...
void func_22()
{
	...
	if (Global_4C08 == 0)
	{
		if (func_15(2, Global_4BFF, 0))
		{
			unk_0x0674E58A79778E99(&Global_1CBD, 15);
			func_24();
			Global_4C08 = 1;
			...
			if (iVar0 > 4294967295)
			{
				...
				if (Global_4C1E.f_1 > 3)
				{
					...
					{
						func_7(Global_4C0B, "SET_DATA_SLOT_EMPTY", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
						func_6(Global_4C0B, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_2", 0, 0, 0, 0);
						func_7(Global_4C0B, "DISPLAY_VIEW", 18f, 3212836864, 3212836864, 3212836864, 3212836864);
						func_4(Global_4C0B, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
						if (Global_4C12)
						{
							func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
							func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 0f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
						}
						else
						{
							func_6(Global_4C0B, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
							func_6(Global_4C0B, "SET_SOFT_KEYS", 3f, 0f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
						}
						func_6(Global_4C0B, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
						unk_0x0674E58A79778E99(&Global_1CBC, 17);

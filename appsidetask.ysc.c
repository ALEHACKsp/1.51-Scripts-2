...
void __EntryFunction__()
{
	...
	func_18();
	Global_4C1E.f_1 = 7;
	func_17(Global_4C0B, "DISPLAY_VIEW", 14f, 3212836864, 3212836864, 3212836864, 3212836864);
	func_16(Global_4C0B, "SET_HEADER", "CELL_4", 0, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (Global_4C1E.f_1 != 9)
		{
			...
			else if (func_2(2, Global_4BFE, 0))
			{
				Global_4C08 = 1;
				Global_556F = 0;
				Global_4C1E.f_1 = 7;
...
void func_6()
{
	...
	func_9();
	func_8(fLocal_25, fLocal_26, &(Global_706[Global_564D[iLocal_21 /*9*/] /*29*/].f_3), 0);
	fLocal_25 = (fLocal_25 + 0.07f);
	func_10(255, 255, 255, 205);
	if (Global_564D[iLocal_21 /*9*/].f_2.f_1 < 10)
	{
	...
	if (Global_55A4[Global_564D[iLocal_21 /*9*/].f_1 /*42*/].f_8 == 0)
	{
		func_9();
	}
	unk_0xF1F881BAAAFB43B1(0f, 0.93f);
	func_8(fLocal_25, fLocal_26, &(Global_55A4[Global_564D[iLocal_21 /*9*/].f_1 /*42*/].f_4), 0);
	...
	while (iVar0 <= Global_55A4[Global_564D[iLocal_21 /*9*/].f_1 /*42*/].f_9)
	{
		...
		if (Global_55A4[Global_564D[iLocal_21 /*9*/].f_1 /*42*/].f_20[iVar0] == 4294967295)
		{
			func_8(fLocal_25, fLocal_26, &(Global_55A4[Global_564D[iLocal_21 /*9*/].f_1 /*42*/].f_A[iVar0 /*4*/]), 0);
		}
		else
		{
...
void func_11()
{
	if (func_2(2, Global_4BFF, 0))
	{
		...
		Global_556F = 1;
		func_12(Global_4C0B, "SET_DATA_SLOT", 15f, 0f, -1f, -1f, -1f, "CELL_287", "CELL_280", "CELL_285", "CELL_284", 0);
		func_17(Global_4C0B, "DISPLAY_VIEW", 15f, 3212836864, 3212836864, 3212836864, 3212836864);
		func_16(Global_4C0B, "SET_HEADER", "CELL_4", 0, 0, 0, 0);
		Global_4C1E.f_1 = 8;
		Global_556F = 1;
	}
...
void func_15()
{
	...
	while (iVar0 < iLocal_22)
	{
		...
		func_8(fLocal_25, fLocal_26, &(Global_706[Global_564D[iLocal_18[iVar0] /*9*/] /*29*/].f_3), 0);
		fLocal_25 = (fLocal_25 + 0.07f);
		func_10(255, 255, 255, 205);
		if (Global_564D[iLocal_18[iVar0] /*9*/].f_2.f_1 < 10)
		{
		...
		fLocal_26 = (fLocal_26 + 0.02f);
		unk_0xF1F881BAAAFB43B1(0f, 0.93f);
		func_8(fLocal_25, fLocal_26, &(Global_55A4[Global_564D[iLocal_18[iVar0] /*9*/].f_1 /*42*/]), 0);
...
void func_18()
{
	...
	while (iVar1 < 4)
	{
		iVar2 = 0;
		iVar3 = 3;
		Global_564D[iVar3 /*9*/].f_2 = 4294967295;
		Global_564D[iVar3 /*9*/].f_2.f_1 = 0;
		Global_564D[iVar3 /*9*/].f_2.f_2 = 0;
		Global_564D[iVar3 /*9*/].f_2.f_3 = 0;
		Global_564D[iVar3 /*9*/].f_2.f_5 = 0;
		while (iVar2 < 4)
		{
			if (iVar0[iVar2] == 0)
			{
				if (Global_564D[iVar2 /*9*/].f_8 != 0)
				{
		...
		iVar0[iVar3] = 1;
		if (Global_564D[iVar1 /*9*/].f_8 != 0)
		{
			iLocal_19++;
		}
		iVar1++;
	}
	func_12(Global_4C0B, "SET_DATA_SLOT", 14f, 0f, 25f, -1f, -1f, "CELL_287", "CELL_280", 0, 0, 0);
}

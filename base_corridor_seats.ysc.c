...
{
	return unk_0x3D1053F9EB43B7AD(iParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, true, 0);
}
...
int func_73()
{
	if (Global_18446C != func_60())
	{
		if (unk_0xADC2AA9A68E522A1("base_corridor_seats", Global_18446C, 1, 0))
		{
			return 0;
		}

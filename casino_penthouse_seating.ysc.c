		...
		if (unk_0x40B8C182D63932FC(iParam0) && (unk_0xE1DBBD6CE209517C(iParam0) || iParam3 == 1))
		{
			...
			else
			{
				if (!func_94(iVar27) && !unk_0x20906E1D6BDC7044(iVar27))
				{
					...
					if (func_91(Global_440000.f_38DB3))
					{
...
void func_105(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	uParam1->f_10[iParam2 /*14*/].f_6.f_1 = { func_107(func_109(), func_108(iParam3, fVar1)) + vVar0 };
	uParam1->f_10[iParam2 /*14*/].f_6.f_4 = { func_107(func_106(), func_108(iParam3, fVar1)) + vVar0 };

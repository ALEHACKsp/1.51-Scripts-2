...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_A56F)
		{
			if (Global_A571 > 4294967295)
			{
				if (!Global_A4A7[Global_A571 /*32*/].f_6)
				{
					if (!func_23(Global_A571, 1))
					{
		...
		switch (iVar0)
		{
			case 0:
				...
				if (!func_19())
				{
					if (iVar2 > 4294967295 && iVar6)
					{
						if (unk_0xBFC0798A6E3417F9(2, 51))
						{
							Global_A4A7[iVar2 /*32*/].f_4 = 1;
							Global_A4A7[iVar2 /*32*/].f_1D = 0;
			...
			case 1:
				...
				else
				{
					...
					if (Global_A4A7[iVar2 /*32*/].f_7 || Global_A4A7[iVar2 /*32*/] == 0)
					{
						iVar0 = 0;
					}
				}
...
void func_10(int iParam0)
{
	...
	while (iVar0 < 6)
	{
		...
		{
			if (Global_A4A7[iVar0 /*32*/].f_1F != 0)
			{
				if (!unk_0x1727A44C562FBED2(Global_A4A7[iVar0 /*32*/].f_1F))
				{
					...
					Global_A4A7[iVar0 /*32*/] = 0;
					Global_A4A7[iVar0 /*32*/].f_1F = 0;
					Global_A4A7[iVar0 /*32*/] = 0;
					Global_A4A7[iVar0 /*32*/].f_4 = 0;
					Global_A4A7[iVar0 /*32*/].f_5 = 0;
					Global_A4A7[iVar0 /*32*/].f_2 = 0;
					Global_A4A7[iVar0 /*32*/].f_7 = 0;
					Global_A4A7[iVar0 /*32*/].f_6 = 0;
					Global_A4A7[iVar0 /*32*/].f_3 = 0;
					*iParam0 = 4294967295;
				}
			}
		}
...
void func_11()
{
	if (Global_A571 != 4294967295 || bLocal_80)
	{
		bLocal_80 = false;
		Global_A571 = 4294967295;
	}
...
void func_12()
{
	...
	while (iVar0 < 6)
	{
		if (Global_A4A7[iVar0 /*32*/].f_7)
		{
			...
			Global_A4A7[iVar0 /*32*/].f_7 = 0;
			Global_A4A7[iVar0 /*32*/].f_6 = 0;
			Global_A4A7[iVar0 /*32*/].f_1 = 4294967295;
			Global_A4A7[iVar0 /*32*/].f_3 = 0;
		}
		iVar0++;
	}
...
int func_14()
{
	...
	while (iVar0 < 6)
	{
		if (Global_A4A7[iVar0 /*32*/] == 1)
		{
			if (Global_A4A7[iVar0 /*32*/].f_4 == 0)
			{
				iVar1++;
			}
		}
...
void func_35()
{
	...
	if (Global_1801BA != 4294967295)
	{
		Var0[0 /*13*/] = Global_1801BB[0];
		Var0[0 /*13*/].f_1 = Global_1801BB[1];
		Var0[0 /*13*/].f_2 = Global_1801BB[2];
		Var0[0 /*13*/].f_3 = Global_1801BB[3];
		Var0[0 /*13*/].f_4 = Global_1801BB[4];
		Var0[0 /*13*/].f_5 = Global_1801BB[5];
		Var0[0 /*13*/].f_6 = Global_1801BB[6];
		Var0[0 /*13*/].f_7 = Global_1801BB[7];
		Var0[0 /*13*/].f_8 = Global_1801BB[8];
		Var0[0 /*13*/].f_9 = Global_1801BB[9];
		Var0[0 /*13*/].f_A = Global_1801BB[10];
		Var0[0 /*13*/].f_B = Global_1801BB[11];
		Var0[0 /*13*/].f_C = Global_1801BB[12];
		if (unk_0xA3F916BCE430ED26() || unk_0xDC30EF462887322E())
		{
			...
			if (iLocal_86)
			{
				...
				else
				{
					...
					{
						StringCopy(&(Global_200000[func_38() /*10930*/].f_2A01.f_12[Global_1801BA /*6*/]), unk_0xD7926DA4168DF7E1(&(Var0[0 /*13*/])), 24);
					}
					func_37();
				}
			}
				...
				switch (iLocal_87)
				{
					...
					case 1:
						...
						switch (iVar2)
						{
							...
							case 0:
								MemCopy(&(Global_200000[func_38() /*10930*/].f_2A01.f_12[Global_1801BA /*6*/]), {Var1[0 /*16*/]}, 6);
								func_37();
								break;
		...
		else
		{
			if (func_36(Var0[0 /*13*/]))
			{
				StringCopy(&(Global_200000[func_38() /*10930*/].f_2A01.f_12[Global_1801BA /*6*/]), unk_0x8F1B0D2ECDA568E2(&(Var0[0 /*13*/])), 24);
			}
			func_37();
		}
	}

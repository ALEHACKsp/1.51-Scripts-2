...
void func_7()
{
	switch (iLocal_44)
	{
		...
		case 1:
			if (unk_0x8A22C4C08282BF26(joaat("emergencycall")) == 0)
			{
				if (!func_35(130))
				{
					iLocal_43 = 1;
...
bool func_8(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	...
	StringCopy(&Global_51AF, sParam6, 24);
	StringCopy(&Global_51B5, sParam7, 24);
	StringCopy(&Global_51BB, sParam8, 24);
...
{
	Global_7910 = 1;
	StringCopy(&Global_7911, unk_0xBB0808A181D4745C(), 32);
}

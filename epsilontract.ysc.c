...
int func_4(int iParam0)
{
	...
	else
	{
		...
		while (iVar1 < func_11(iParam0))
		{
			...
			if (func_5(iVar2, 4294967295, 4294967295))
			{
				iVar0++;
			}
			iVar1++;
...
int func_15(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar1 < Global_CACB[iVar0 /*203*/].f_3)
	{
		...
		if (iVar3 < 3)
		{
			func_16(Global_CACB[iVar0 /*203*/].f_4[iVar1], Global_CACB[iVar0 /*203*/].f_1, 1, bParam2, 0);
		}
		iVar1++;
	}
	return 1;
...
void func_22()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_25(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_23(iVar0) && (!func_46(14) || Global_1AFFD))
			{
...
int func_33(int iParam0, int iParam1)
{
	...
	iVar0 = (iVar1 + iParam1);
	return func_5(iVar0, 4294967295, 4294967295);
}
...
void func_34(var uParam0, var uParam1)
{
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0xE925E52ACABA4CE7(*uParam0), true) >= 60f)
		{
			func_41(uParam0);
			*uParam0 = 0;
			*uParam1 = 0;
...
void func_48()
{
	...
	{
		iVar1 = (805 + iVar0);
		if (func_5(iVar1, 4294967295, 4294967295))
		{
			iLocal_41++;
		}
		iVar0++;

...
void __EntryFunction__()
{
	...
	fLocal_82 = 328.7801f;
	iLocal_289 = unk_0xD68EA767274B7444();
	...
	if (unk_0xC844350D5D58C99A(iLocal_103))
	{
	}
	func_318();
	if (!func_335())
	{
		if ((func_317(Local_80.f_1C[0]) && func_317(unk_0x16F2683693E537C9())) && !func_316(unk_0x16F2683693E537C9(), Local_80.f_1C[0], 4f, 1))
		{
			iLocal_305 = 1;
		}
	}
	...
	{
		SYSTEM::WAIT(0);
		unk_0x1A6DFFFEEC27BF4F("SF_UR", 0);
		...
		{
			if (func_317(unk_0x16F2683693E537C9()) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1668.882f, -19.65248f, 172.6748f, 1653.855f, 8.008027f, 175.0248f, 7f, 0, true, 0))
			{
				if (func_317(Local_91))
				{
					if (func_316(unk_0x16F2683693E537C9(), Local_91, 10f, 1))
					{
						func_297();
					}
				}
...
void func_1()
{
	switch (iLocal_83)
	{
		case 0:
			...
			if (unk_0xEA6BC48857E0AC4C(sLocal_92))
			{
				func_351(1);
			}
			else
...
void func_8()
{
	switch (iLocal_85)
	{
		...
		case 1:
			...
			{
				if (!unk_0x437347B10A200C4B(iLocal_102, 0))
				{
					if (func_316(unk_0x16F2683693E537C9(), iLocal_102, 1f, 1))
					{
			...
			if (func_317(unk_0x16F2683693E537C9()))
			{
				if (iLocal_297 == 0)
				{
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1624.015f, -5.45107f, 102.0677f, 1639.007f, -52.9875f, 181.3352f, 58.75f, 0, true, 0) && unk_0x75B806D0A76CB67D(unk_0x16F2683693E537C9()) == 2)
					{
						iLocal_297 = 1;
					}
				}
				if (func_228(Local_91))
				{
					...
					{
						if ((unk_0x1C0640BA9A7327B3() > iLocal_292 + 25000 || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
						{
							iLocal_85 = 2;
						}
					}
				}
				else if ((unk_0x1C0640BA9A7327B3() > iLocal_292 + 25000 || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1665.729f, -26.27869f, 172.5815f, 1672.652f, -24.58394f, 177.2547f, 4f, 0, true, 0)) || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1650.519f, 5.134407f, 172.6743f, 1656.571f, 9.669823f, 176.7743f, 15.25f, 0, true, 0))
				{
					iLocal_85 = 2;
				}
			}
			if (unk_0x1C0640BA9A7327B3() < iLocal_292 + 5000)
			{
				if (unk_0x192DA571D9133D23())
				{
		...
		case 2:
			if (((!unk_0x92444005288A72ED(unk_0x16F2683693E537C9()) && !unk_0x6438374572DE9B51(unk_0x16F2683693E537C9())) && unk_0xEE9925602B29903C(unk_0x16F2683693E537C9()) < 2f) && !unk_0x869EFD0BC0868856(unk_0x16F2683693E537C9()))
			{
...
void func_9()
{
	if (iLocal_297 == 1)
	{
		unk_0x8B4C4CA774181102(10f, 4f, 0);
		func_210(762);
	}
	func_2(1);
	func_10(84, 1);
...
void func_229()
{
	...
	if (!unk_0x9F4FE516EAACCFC5(iLocal_274))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_275))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_276))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_277))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_278))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_279))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_280))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_281))
	{
	}
	if (!unk_0x9F4FE516EAACCFC5(iLocal_282))
	{
	}
	...
	iLocal_299 = 0;
	iLocal_304 = 0;
	unk_0x62956E22F3B365FF("SLOWMO_EXTREME_04");
	unk_0x420FE818E70BB523(0);
	while (unk_0x1C0640BA9A7327B3() < iLocal_296 + 11000 && !unk_0x757EF87A33649210())
	{
		if (!unk_0x69DF961355195C3C(iLocal_293) && !unk_0x69DF961355195C3C(iLocal_294))
		{
			if (func_242(400))
			{
				bLocal_303 = true;
		...
		if (!iLocal_301)
		{
			...
			{
				if (unk_0xA45992A6CE82FB43(iLocal_293) == 1f)
				{
					if (func_317(Local_91))
					{
						iLocal_294 = unk_0xE9744DB7B8CA6965(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
						iLocal_286 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", true);
						unk_0x915804B434753CBD(Local_91, iLocal_294, "rcmextreme4", "Base_Jump_Spot_02", 1000f, -1000f, 0, 0, 1148846080, 0);
						unk_0xEFC3DF9D33E248D8(iLocal_294, false);
						unk_0xE3BB8E05FCEB3FBE(iLocal_286, true);
						unk_0x93E9ED66DAB9FBE3(iLocal_286, iLocal_294, "Base_Jump_Spot_02_CAM", "rcmextreme4");
						unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
						unk_0xF895E10BF4C72645(Local_91, 0, 0);
						unk_0x9A8DDC7C522F5BF5(iLocal_285, 0);
						iLocal_301 = 1;
					}
				}
			}
		...
		{
			if (unk_0x69DF961355195C3C(iLocal_294) && unk_0xA45992A6CE82FB43(iLocal_294) >= 0.2f)
			{
				if (!unk_0x69DF961355195C3C(iLocal_295))
				{
					unk_0x4AD41BCE9202A92E("RCM_Extreme4_Fall_and_impact", 0);
				}
			}
			if (unk_0x69DF961355195C3C(iLocal_294) && unk_0xA45992A6CE82FB43(iLocal_294) == 1f)
			{
				if (func_317(Local_91))
				{
					iLocal_295 = unk_0xE9744DB7B8CA6965(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
					iLocal_287 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", true);
					unk_0x915804B434753CBD(Local_91, iLocal_295, "rcmextreme4", "Fall_and_impact", 1000f, -1000f, 0, 0, 1148846080, 0);
					unk_0xEFC3DF9D33E248D8(iLocal_295, true);
					unk_0xE3BB8E05FCEB3FBE(iLocal_287, true);
					unk_0x93E9ED66DAB9FBE3(iLocal_287, iLocal_295, "Fall_and_impact_CAM", "rcmextreme4");
					unk_0x451E64C9E789DAF6(iLocal_295);
					unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
					unk_0xF895E10BF4C72645(Local_91, 0, 0);
					unk_0x9A8DDC7C522F5BF5(iLocal_286, 0);
					iLocal_302 = 1;
				}
			}
		}
		else if (unk_0x69DF961355195C3C(iLocal_295) && unk_0xA45992A6CE82FB43(iLocal_295) >= 0.323f)
		{
			if (!iLocal_298)
			{
				unk_0xBA3209FB359D3EA4("scr_extrm4_water_splash", 1655.27f, -20.8134f, 133.841f, 0f, 0f, 0f, 1f, 0, 0, 0);
				unk_0xB266E4CCF2051DAE(1f);
				func_240();
				iLocal_298 = 1;
			}
			else if (!iLocal_304)
			{
				if (unk_0x69DF961355195C3C(iLocal_295) && unk_0xA45992A6CE82FB43(iLocal_295) >= 0.44f)
				{
					iLocal_104 = unk_0xB055A4268B938F30("scr_extrm4_water_blood", 1655.27f, -20.8134f, 133.842f, 0f, 0f, 0f, 1f, 0, 0, 0, false);
					unk_0xB89D9C4FC0F45AF9(iLocal_104, 1f);
					iLocal_304 = 1;
				}
			}
		}
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 600 && fVar1 == 1f)
		{
			if (!iLocal_299)
			{
				iLocal_299 = 1;
		...
		fVar2 = (1f / 30f);
		fVar3 = (unk_0x6117725E0134737F() / fVar2);
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 630)
		{
		...
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 563)
		{
			if (iVar0 == 1)
			{
				func_3(&iLocal_99);
		...
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 871)
		{
			if (iVar0 == 2)
			{
				if (func_317(Local_91))
		...
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 2000)
		{
			if (iVar0 == 3)
			{
				if (func_317(Local_91))
		...
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 3500)
		{
			if (iVar0 == 4)
			{
				iVar0 = 5;
		...
		if (unk_0x1C0640BA9A7327B3() > iLocal_296 + 10000)
		{
			if (iVar0 != 7)
			{
				unk_0x9A8DDC7C522F5BF5(iLocal_287, 0);
				iLocal_284 = unk_0x0D032838710EE57D("DEFAULT_SCRIPTED_CAMERA", true);
				unk_0x86F44313DFA8F00C(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
				unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
				unk_0xE3BB8E05FCEB3FBE(iLocal_284, true);
				iVar0 = 7;
			}
		}
	}
	if (bLocal_303)
	{
		if (unk_0x69DF961355195C3C(iLocal_295))
		{
			unk_0x0C381ABE35BC2C84(iLocal_295);
		}
		unk_0x38DC636F3D2D2FA8("EXT4_JUMPED_OS");
		func_240();
		iLocal_284 = unk_0x0D032838710EE57D("DEFAULT_SCRIPTED_CAMERA", true);
		unk_0x86F44313DFA8F00C(iLocal_284, 1659.893f, -6.552459f, 174.871f, -29.25931f, 1E-06f, 122.4502f, 50f, 0, 1, 1, 2);
		unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
	...
	unk_0xBA4AFD9D5C7A6F8D("SLOWMO_EXTREME_04");
	func_3(&iLocal_99);
	if (func_317(Local_91))
	{
		if (iVar0 < 3)
		{
			unk_0xD458AC1C1D29C3B4(Local_91, 101, 0);
			vVar4 = { unk_0x68F4C0EC296D3901(Local_91, true) };
			if (vVar4.z > 155f)
			{
				fVar5 = 155f;
			}
			...
			unk_0xA47B46945FF6DE74(Local_91, 1657.046f, -17.4571f, fVar5, 1, false, 0, 1);
		}
	}
	...
	unk_0x8BCB70EB440DED83(true);
	unk_0xBFE31971E49FA500(true);
	unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), true, 128);
	unk_0x9A82EEAF6CA12AEE(1f);
	if (func_228(Local_91))
	{
		if (unk_0x69DF961355195C3C(iLocal_295))
		{
			unk_0x57E0CF9BF653D99A(iLocal_295, 1f);
		}
		unk_0x327AAEE25F323797(Local_91);
		unk_0xF895E10BF4C72645(Local_91, 0, 0);
		unk_0xA47B46945FF6DE74(Local_91, 1655.77f, -20.04f, 135.8f, 1, false, 0, 1);
		unk_0xD458AC1C1D29C3B4(Local_91, 0, 0);
	}
	func_230(&uLocal_106, 1, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
...
void func_232(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_236(unk_0xD803B885F5E47A62())) && !func_234(unk_0xD803B885F5E47A62(), 0)) && !func_233()) && !bParam4) && !bParam5)
			{
				unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
			}
		}
		else if (((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_236(unk_0xD803B885F5E47A62())) && !bParam4) && !bParam5)
		{
			unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
		}
		Global_12B4C = 0;
...
void func_245()
{
	if (iLocal_85 < 2)
	{
		unk_0x13896FDECC859926("EXT4_JUMPED_OS");
	}
	switch (iLocal_85)
	{
		case 0:
			iLocal_87 = 0;
			if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1655.139f, 5.342447f, 172.6748f, 1662.085f, -6.198325f, 175.0248f, 8.25f, 0, true, 0))
			{
				unk_0x8E590B419F1E5182("es_4_rcm_p2_concat", 6, 8);
			}
			else
			{
				unk_0x8E590B419F1E5182("es_4_rcm_p2_concat", 5, 8);
			}
			unk_0x55D0A2DB35045A35(iLocal_289);
			if (unk_0x75EECC9B0572F772())
			{
				unk_0x7656EB524FEAB9B3("Dom", 8, 2, 0, 0);
			}
			if (!func_266())
			{
				if (func_260(1, 20f, 1))
				{
					if ((!iLocal_305 || unk_0x1C0640BA9A7327B3() > iLocal_306 + 3000) || unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), 1658.95f, -5.45f, 173.78f, 0.2f, 0.2f, 0.2f, false, true, 0))
					{
						unk_0x420FE818E70BB523(1);
						unk_0x4C902758BEA97C68(2048);
						if (func_317(Local_91))
						{
							unk_0x29E8331978B73E7F(Local_91, "Dom", 0, joaat("cs_dom"), 0);
						}
						SYSTEM::WAIT(0);
						iLocal_305 = 0;
						unk_0x29D5132FBDCF2B1E(0);
						unk_0x8BC9595FD2792B5D("EXTREME_04_CUSTOM_QUIET_SCENE");
						if (func_317(Local_91))
						{
							unk_0x1E9649458B15960F(Local_91, false);
						}
						if (unk_0xC844350D5D58C99A(iLocal_103) && !unk_0x437347B10A200C4B(iLocal_103, 0))
						{
							unk_0x4A4806F9D471E491(iLocal_103, false, 0);
						}
						if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
						{
							iLocal_96 = unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0);
							iLocal_105 = unk_0x134B62B726CEC8E6(iLocal_96);
							if (unk_0x8E39AC3C76C8AA58(iLocal_105) == 1 || unk_0x7D8B2A8F9EA82DB7(iLocal_105) == 1)
							{
						...
						unk_0x745CE398A4B0A3C6(1660.186f, -7.492f, 172.774f, 200f, 0);
						iLocal_288 = unk_0x7D6CA5F52B3748BF(1636.691f, -89.8127f, 150f, 1706.146f, 58.721f, 190f, 0, 1, 1, 1);
						iLocal_85 = 1;
					}
				}
			}
		...
		case 1:
			if (unk_0x22A8E52414415B76())
			{
				if (unk_0xEABED1927EFB48CA(0))
				{
					if (!iLocal_90)
					{
						if (!unk_0x69DF961355195C3C(iLocal_293))
						{
							if (func_317(Local_91))
							{
								if (!unk_0x9F4FE516EAACCFC5(iLocal_285))
								{
									iLocal_285 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", true);
								}
								unk_0xE3BB8E05FCEB3FBE(iLocal_285, true);
								unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
								iLocal_293 = unk_0xE9744DB7B8CA6965(1656.378f, -12.057f, 169.038f, 0f, 0f, 115.85f, 2);
								unk_0x915804B434753CBD(Local_91, iLocal_293, "rcmextreme4", "Base_Jump_Spot", 1000f, -1000f, 0, 0, 1148846080, 0);
								unk_0xEFC3DF9D33E248D8(iLocal_293, true);
								unk_0xE3BB8E05FCEB3FBE(iLocal_285, true);
								unk_0x93E9ED66DAB9FBE3(iLocal_285, iLocal_293, "Base_Jump_Spot_CAM", "rcmextreme4");
								unk_0xB3A1B75CB59FEB56(true, false, 3000, 1, 0, 0);
								unk_0xF895E10BF4C72645(Local_91, 0, 0);
								iLocal_90 = 1;
							}
				...
				if (func_317(Local_91))
				{
					if (unk_0x3148AE92ED70DC30("Dom", 0))
					{
						iLocal_85 = 2;
					}
				}
		...
		case 2:
			...
			if (unk_0xC844350D5D58C99A(iLocal_103) && !unk_0x437347B10A200C4B(iLocal_103, 0))
			{
				unk_0x4A4806F9D471E491(iLocal_103, true, 0);
			}
			if (iLocal_87 == 0)
			{
				unk_0xC92DB9682A650680("EXT4_JUMPED_OS");
				func_246(3);
			}
			break;
	}
...
void func_247(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (unk_0xE1DBBD6CE209517C(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			unk_0x745CE398A4B0A3C6(func_248(unk_0xA30EC016B12C03E4()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_250(vector3 vParam0, float fParam1)
{
	...
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		...
		if (unk_0xC844350D5D58C99A(iVar0))
		{
			...
			{
				unk_0xA47B46945FF6DE74(iVar0, vParam0, 1, false, 0, 1);
...
int func_260(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_264(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_263(unk_0x16F2683693E537C9(), 3466132403))
				{
...
void func_267()
{
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		...
		{
			if (((((((unk_0x06F8112AA79C53D9(0, 30) || unk_0x06F8112AA79C53D9(0, 31)) || unk_0x06F8112AA79C53D9(0, 23)) || unk_0x06F8112AA79C53D9(0, 21)) || unk_0x06F8112AA79C53D9(0, 22)) || (func_279() && unk_0x06F8112AA79C53D9(0, 1))) || (func_279() && unk_0x06F8112AA79C53D9(0, 2))) || (func_279() && unk_0x06F8112AA79C53D9(0, 32)))
			{
	...
	{
		case 0:
			if (func_317(Local_80.f_1C[0]))
			{
				unk_0xAFF39FB306F8E232(Local_80.f_1C[0], 17, true);
			}
			iLocal_290 = 0;
			iLocal_305 = 1;
		...
		case 1:
			...
			if (func_317(unk_0x16F2683693E537C9()))
			{
				if (func_317(Local_91))
				{
					if (func_316(unk_0x16F2683693E537C9(), Local_91, 100f, 1))
					{
						unk_0x8E590B419F1E5182("es_4_rcm_p2_concat", 6, 8);
						if (unk_0x75EECC9B0572F772())
						{
					...
					if (unk_0x869EFD0BC0868856(Local_91))
					{
						unk_0xD458AC1C1D29C3B4(Local_91, 0, 0);
					}
					if (func_316(unk_0x16F2683693E537C9(), Local_91, 32f, 1))
					{
						...
						else
						{
							if (!iLocal_300)
							{
								if (func_316(unk_0x16F2683693E537C9(), Local_91, 30f, 1) && !func_266())
								{
							...
							func_269();
							if (!unk_0xC7E2E6167C09468B(unk_0x16F2683693E537C9(), Local_91))
							{
								unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_91, 4294967295, 0, 2);
							}
						}
					}
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1663.587f, -11.71415f, 172.6748f, 1658.387f, -1.735749f, 175.7748f, 5.5f, 0, true, 0))
					{
						if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
						{
							iLocal_85 = 2;
		...
		case 2:
			...
			if (func_317(unk_0x16F2683693E537C9()))
			{
				if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
				{
					unk_0xE0C0351D5B931E37(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 5f, 1, 0);
					SYSTEM::WAIT(600);
					unk_0x75CDA8644CD3B5F5(unk_0x16F2683693E537C9(), 0, 0);
				}
			}
...
void func_268()
{
	if (func_317(Local_91))
	{
		if (unk_0xD1960163A3042274(Local_91, 242628503) != 1)
		{
			unk_0x78ADC381772E3D54(Local_91, iLocal_95);
		}
	}
}
...
void func_269()
{
	if (!func_266())
	{
		if (iLocal_290 < 5)
		{
			if (unk_0x1C0640BA9A7327B3() > (iLocal_291 + (8000 + unk_0x09AC81E49EA267F7(0, 2000))))
			{
				if (unk_0x8AA6DC470ABA63A2(iLocal_289))
				{
	...
	if (!func_266())
	{
		if ((unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_A", false, 4294967295) && unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_B", false, 4294967295)) && unk_0xAE317D00A5A55DF6("EXTREME_04_DOM_C", false, 4294967295))
		{
			if (unk_0x8AA6DC470ABA63A2(iLocal_289))
			{
				unk_0xCEAA091B490F8407(iLocal_289, "DOM", Local_91, "EXTREME_04_SOUNDSET", false, 0);
			}
		}
	}
}
...
int func_271(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(unk_0x16F2683693E537C9()) && func_228(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_276(iParam0, bParam1, iVar0, fVar1))
			{
				return 1;
			}
...
int func_274(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_258(vParam1 - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	{
		vVar1 = { func_258(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_276(int iParam0, bool bParam1, int iParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
...
void func_280()
{
	...
	else
	{
		...
		unk_0x96167B03C5A77156(unk_0x16F2683693E537C9(), 1723.452f, 80.729f, 169.6701f, 1f, 4294967295, 1f, 2113, 1193033728);
		func_244(800, 0);
		iLocal_88 = 1;
		func_287(1, 1, 1);
	}
...
void func_281()
{
	if (func_228(Local_80.f_1C[0]))
	{
		func_285(Local_80.f_1C[0], 1737.453f, 101.7498f, 170.0243f, 288.5211f, 0, 1);
	}
	else
	{
		func_282(&(Local_80.f_1C[0]), 1737.453f, 101.7498f, 170.0243f, 288.5211f);
	}
	unk_0x96167B03C5A77156(Local_80.f_1C[0], 1826.662f, 146.9161f, 170.4472f, 1f, 4294967295, 0.25f, 0, 1193033728);
	unk_0xCD7D80FD792F9954("WORLD_VEHICLE_BICYCLE_MOUNTAIN", false);
	unk_0x28F5E4DA506AC0CA(Local_91.f_1, 20f, 0, 0, 0, 0, false, 0);
	if (!unk_0xC844350D5D58C99A(iLocal_97))
	{
		iLocal_97 = unk_0x122AAB0B1D6F55AD(joaat("sanchez"), 1662.88f, -14.255f, 172.7742f, 205.3516f, true, true, false);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_98))
	{
		iLocal_98 = unk_0x122AAB0B1D6F55AD(joaat("bmx"), 1633.766f, -23.6768f, 127.0535f, 55.7565f, true, true, false);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_100))
	{
		iLocal_100 = unk_0x7707E48765093646(1165008631, 1666.282f, -11.20408f, 172.7773f, true, true, false);
		unk_0xC023D1C4BF532815(iLocal_100, 0.000637f, -0.000136f, 10.66059f, 2, 1);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_101))
	{
		iLocal_101 = unk_0x7707E48765093646(1165008631, 1667.076f, -12.07778f, 173.2611f, true, true, false);
		unk_0xC023D1C4BF532815(iLocal_101, 90.03932f, -0.257438f, -13.86142f, 2, 1);
	}
	if (func_317(Local_91))
	{
		if (unk_0xD1960163A3042274(Local_91, 242628503) != 1)
		{
			...
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "fidget_01", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "idle", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "rcmextreme4", "fidget_02", 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
			unk_0x25644C31B4B6E9F3(iLocal_95, 1);
	...
	if (func_317(Local_91))
	{
		unk_0xF4CB0B98F8F79D8D(Local_91, 0);
		func_230(&uLocal_106, 4, Local_91, "DOM", 0, 1);
		unk_0x6DF7BF67E86AAE86(Local_91, unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9()));
	}
	if (!unk_0xC844350D5D58C99A(iLocal_103))
	{
		iLocal_103 = unk_0xB8D1BBEFD1257857(joaat("pickup_parachute"), 1665.264f, -11.4427f, 172.7747f, 7, 4294967295, joaat("p_parachute_s"), 1, 1);
	}
	unk_0xC023D1C4BF532815(iLocal_103, -111.8225f, -0.454914f, -162.2231f, 2, 1);
	unk_0xD65E6E13E145467B(iLocal_103, "Chute_Off_Bag", "skydive@parachute@", 4f, false, true, 0, 0.99f, 0);
	func_246(1);
}
...
void func_282(int iParam0, vector3 vParam1, float fParam2)
{
	...
	unk_0x5F2AA9E2843E9403(*iParam0, "EXTREME LAUNCHER RC");
}
...
void func_286(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_228(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_228(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_228(uParam0->f_29[iVar0]))
		{
...
void func_291()
{
	switch (iLocal_86)
	{
		case 0:
			...
			{
				if (!iLocal_305 || unk_0x1C0640BA9A7327B3() > iLocal_306 + 3500)
				{
					func_292();
					unk_0x420FE818E70BB523(1);
					...
					if (func_228(Local_80.f_1C[0]))
					{
						unk_0x29E8331978B73E7F(Local_80.f_1C[0], "Hudson", 0, joaat("a_c_retriever"), 0);
					}
					SYSTEM::WAIT(0);
					unk_0x29D5132FBDCF2B1E(0);
		...
		case 2:
			func_285(unk_0x16F2683693E537C9(), 1732.222f, 92.0087f, 169.7867f, 138.1854f, 0, 1);
			unk_0xBD453909DC26A85D(unk_0x16F2683693E537C9(), 3626484699, false, 1, 0);
			unk_0xDEAC6BC509D10068(unk_0x16F2683693E537C9(), 1f);
			unk_0x96167B03C5A77156(unk_0x16F2683693E537C9(), 1723.452f, 80.729f, 169.6701f, 1f, 4294967295, 1f, 2113, 1193033728);
			unk_0xEF6276132B396452(0f, 1065353216);
...
void func_296()
{
	...
	fVar3 = -0.85f;
	fVar4 = 0f;
	if (((!func_335() && func_317(Local_80.f_1C[0])) && func_317(unk_0x16F2683693E537C9())) && iLocal_305 == 1)
	{
		if (!unk_0x8C74DE122769E1BF())
		{
			unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), false, 0);
			unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_80.f_1C[0], 4294967295, 0, 2);
			unk_0xA8CC11FF8D2962D4(unk_0x16F2683693E537C9(), Local_80.f_1C[0], 0f, 0f, 0f, 1f, 4294967295, 0.5f, 1);
			unk_0x4F4B34F617B087DF(1);
			unk_0xC0B0B9E466C0ED17(Local_80.f_1C[0], -0.5f, 0f, -0.2f, 1, 30000, 2000, 2000, 0);
			unk_0xF0B0E93CF50F0322(fVar0);
			unk_0x908430F113C0DC6D(fVar1);
			unk_0xDA9C58A3CC25952B(fVar2);
			unk_0x4BF9B75F44D4B6CE(fVar3);
			unk_0x910A71FBA7D16B6B(fVar4);
			iLocal_306 = unk_0x1C0640BA9A7327B3();
		}
		else
		{
			if (func_316(unk_0x16F2683693E537C9(), Local_80.f_1C[0], 4f, 1))
			{
...
void func_297()
{
	...
	if (iLocal_305)
	{
		if (!unk_0x8C74DE122769E1BF())
		{
			unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), false, 0);
			unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_91, 4294967295, 0, 2);
			unk_0x96167B03C5A77156(unk_0x16F2683693E537C9(), 1658.95f, -5.45f, 173.78f, 1f, 4294967295, 0.25f, 0, -161.08f);
			unk_0x4F4B34F617B087DF(1);
			unk_0xC0B0B9E466C0ED17(Local_91, 0f, 0f, 0f, 1, 30000, 2000, 2000, 0);
			unk_0xF0B0E93CF50F0322(fVar0);
			unk_0x908430F113C0DC6D(fVar1);
			unk_0xDA9C58A3CC25952B(fVar2);
			unk_0x4BF9B75F44D4B6CE(fVar3);
...
void func_298()
{
	...
	if (iLocal_84 == 1)
	{
		...
		{
			fVar0 = unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(Local_91, true), true);
			if (iLocal_89 == 0)
			{
				if (fVar0 > 160f)
				{
			...
			if (fVar0 > 150f)
			{
				...
				{
					unk_0xF412DD40DE84CE72(iLocal_94, true);
				}
			}
			else if (unk_0xE4EDC4B0E92C078B(iLocal_94))
			{
				unk_0xF412DD40DE84CE72(iLocal_94, false);
			}
		}
		if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1660.332f, -20.45607f, 136.7029f, 1584.419f, -30.29117f, 120.6038f, 32f, 0, true, 0))
		{
			sLocal_92 = "EXT4_F2";
			iLocal_84 = 4;
		}
	...
	if (Global_12C4C != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x757EF87A33649210())
			{
				...
				Var4 = { func_301(Global_12C4D, Global_12C4F, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_313(0) || Global_12C5B) || Global_12C50 == 1) || !unk_0x0F1CCD77290EE12F())
	{
		return 0;
	}
	switch (Global_12C4C)
	{
		...
		case 5:
			if ((unk_0x22A8E52414415B76() || func_312(0)) || func_311(1))
			{
			}
			else
			{
...
{
	return func_315(iParam0, Global_A1D7);
}
...
void func_318()
{
	...
	Local_91.f_C = 119.6007f;
	unk_0xD7992BEF7A9D109E("EXT4", 0);
	while (!unk_0x67C1D9E5B91B2E37(0))
	{
		SYSTEM::WAIT(0);
	}
	unk_0x523BCC9DC80CD82F(joaat("prop_box_guncase_03a"));
	unk_0x523BCC9DC80CD82F(1165008631);
	unk_0x523BCC9DC80CD82F(joaat("p_parachute_s"));
	unk_0x523BCC9DC80CD82F(joaat("bmx"));
	while (((!unk_0xB87F6CF6E5628C67(joaat("prop_box_guncase_03a")) || !unk_0xB87F6CF6E5628C67(1165008631)) || !unk_0xB87F6CF6E5628C67(joaat("p_parachute_s"))) || !unk_0xB87F6CF6E5628C67(joaat("bmx")))
	{
		SYSTEM::WAIT(0);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_99))
	{
		iLocal_99 = unk_0xB0BE3DFBBB59A620(joaat("prop_box_guncase_03a"), 1658.299f, -7.930665f, 173.71f, true, true, false);
		unk_0xC023D1C4BF532815(iLocal_99, 90f, 0f, -63f, 2, 1);
		unk_0x1E9649458B15960F(iLocal_99, true);
		unk_0x4A4806F9D471E491(iLocal_99, false, 0);
	}
	func_322(1);
	if (!unk_0xC844350D5D58C99A(Local_91))
	{
		func_319(&Local_91, 52, Local_91.f_1, Local_91.f_4, "Ext4-Dom", 1);
		unk_0x1E9649458B15960F(Local_91, true);
		unk_0x11AD11297DC58CC7(Local_91, true);
		unk_0xE3A2D2E900FEFBE7(Local_91, 1);
		unk_0x64F9F278AB9DCA2C(Local_91, 8, 2, 0, 0);
		unk_0xCAC78D14D05349E7(Local_91, true);
		unk_0x4E885A246A9D983A(Local_91, 137, true);
		unk_0x4E885A246A9D983A(Local_91, 118, false);
		unk_0x4E885A246A9D983A(Local_91, 208, true);
		unk_0x6D80F1AEBA734886(Local_91, 5000);
	}
	if (func_228(unk_0x16F2683693E537C9()))
	{
		func_230(&uLocal_106, 1, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
...
{
	unk_0x523BCC9DC80CD82F(Local_91.f_5);
	unk_0x3F423BF5B8125A50("rcmextreme4");
	unk_0x3F423BF5B8125A50("skydive@parachute@");
	unk_0x523BCC9DC80CD82F(joaat("sanchez"));
	unk_0x9E5E60D8C63FD9D1();
	if (iParam0 == 1)
	{
		while ((((!unk_0xB87F6CF6E5628C67(Local_91.f_5) || !unk_0xB87F6CF6E5628C67(joaat("sanchez"))) || !unk_0xB4AE0788C1587752("rcmextreme4")) || !unk_0xB4AE0788C1587752("skydive@parachute@")) || !unk_0x25F7A4D42AF2AB93())
		{
			SYSTEM::WAIT(0);
		}
	}
		...
		if (bParam2)
		{
			if (!Global_12B4E)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_1F4F[iParam1 /*4*/] = { func_325(iParam0) };
					...
					{
						Global_1F1E[1 /*6*/] = { func_325(iParam0) };
...
int func_330(var uParam0)
{
	...
	switch (iLocal_77)
	{
		case 0:
			...
			func_334(&(uParam0->f_30), "rcmextreme4", "idle_a", "idle_c");
			iLocal_77 = 1;
			break;
		
		case 1:
			if (!func_333(&iVar0) || !func_331(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_77 = 2;
		...
		case 2:
			func_282(&(uParam0->f_1C[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
			unk_0x8D6AA03C7E479C0D(uParam0->f_1C[0], 1);
			unk_0x76C102AEA12B3523(uParam0->f_1C[0], 2);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_336(int iParam0)
{
	...
	unk_0x2952D66A502EA873(iLocal_288, 0);
	unk_0x8C26F31DFF77D124();
	func_348(&iLocal_100, 0);
	func_348(&iLocal_101, 0);
	func_348(&iLocal_102, 0);
	unk_0xCD7D80FD792F9954("WORLD_VEHICLE_BICYCLE_MOUNTAIN", true);
...
{
	func_337(&Local_80, 1, 0, 0);
	func_347(&(Local_80.f_1C[0]), 1, 0, 1);
	unk_0x8D17794CE3273D70("rcmextreme4");
}
...
void func_351(bool bParam0)
{
	...
	if (!func_372())
	{
		...
		{
			func_167(iVar0, 1, 0);
			func_352(unk_0xBB0808A181D4745C(), iVar0);
		}
		else
		{
			if (Global_1B085[iVar0 /*10*/].f_9 == 4294967295)
...
int func_353(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_359())
	{
		...
		{
			iVar2 = func_354(unk_0xBB0808A181D4745C());
			if (iVar2 > 4294967295)
			{
...
int func_355()
{
	...
	iVar0 = func_356(&(Global_181B8.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_359()
{
	...
	{
		if (func_354(&(Global_181B8.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
{
	func_376(&(uParam0->f_1C));
	func_376(&(uParam0->f_23));

...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0x437347B10A200C4B(iLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()
{
	...
	func_21();
	if (iLocal_29 != 4294967295 && func_20(iLocal_29))
	{
		vVar0 = { unk_0x68F4C0EC296D3901(iLocal_31, false) };
		...
		if (SYSTEM::VDIST2(vVar1, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x3D1053F9EB43B7AD(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, true, 0))
					{
						bVar2 = true;
					}
				}
	...
	if (unk_0x8CD06866876216F2())
	{
		if (func_2())
		{
			if (unk_0xEAE0D21A50E6C7F4(iLocal_32, 1))
			{
				unk_0x0674E58A79778E99(&iLocal_32, 1);
			}
			if (unk_0x798A3F1296751F46())
			{
				if (!unk_0xEAE0D21A50E6C7F4(iLocal_32, 0))
				{
					unk_0x4A847DA194A5532B(15, 1, 4294967295);
					unk_0x5D96D8530B3D0904(&iLocal_32, 0);
				}
			}
			else if (unk_0xEAE0D21A50E6C7F4(iLocal_32, 0))
			{
				unk_0x4A847DA194A5532B(15, 0, 4294967295);
				unk_0x0674E58A79778E99(&iLocal_32, 0);
			}
		}
		else if (!unk_0xEAE0D21A50E6C7F4(iLocal_32, 1))
		{
			unk_0x4A847DA194A5532B(15, 0, 4294967295);
			unk_0x0674E58A79778E99(&iLocal_32, 0);
			unk_0x5D96D8530B3D0904(&iLocal_32, 1);
		}
	}
}
...
int func_2()
{
	...
	if (func_5(unk_0xD803B885F5E47A62(), 1))
	{
		iVar0 = func_4();
		if (iVar0 != func_3())
		{

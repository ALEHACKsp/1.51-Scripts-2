...
void func_8(int iParam0)
{
	...
	if (Global_1B416.f_2378 || func_23(0))
	{
		iVar0 = func_22();
		if (!func_9(iVar0))
		{
...
void func_16()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_20(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_18(iVar0) && (!func_17(14) || Global_1AFFD))
			{
...
void func_28()
{
	...
	switch (iLocal_53)
	{
		...
		case 2:
			...
			{
				func_47(46, 1);
				func_42(func_46(iVar0), 3673067633, 3673067633, 5, 0, iVar0, func_45(iVar0), 0, 6000, 6000, 4294967295, 0, 0);
				func_53();
				func_48();
			}
			break;
...
void func_49(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_23(0) && Global_12C44.f_1 == 1) && func_50(Global_12C44))
		{
		}
		else
		{
...
void func_63()
{
	...
	func_64(func_65(), 0, func_15(), func_86(), 9, 6000, 6000, 4294967295, 0, 4294967295, 0);
}
...
void func_88(bool bParam0)
{
	if (bParam0)
	{
		func_64(1527885205, 0, func_15(), 23, 3, 6000, 6000, 4294967295, 0, 4294967295, 0);
	}
	else if (!func_90(3))
	{
		func_64(4070275669, 0, func_15(), 23, 3, 6000, 6000, 4294967295, 50, 4294967295, 0);
	}
	else
	{
		func_64(4070275669, 0, func_15(), 23, 3, 6000, 6000, 4294967295, 0, 4294967295, 0);
	}
}
...
void func_96()
{
	...
	switch (iLocal_53)
	{
		case 0:
			if (func_110(iLocal_52, bLocal_40))
			{
				if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0)
				{
					...
					{
						if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_198, 0))
						{
		...
		case 3:
			if (func_6(Local_202))
			{
				if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_202, 0))
				{
					unk_0xF821F915BC24D246(unk_0x16F2683693E537C9(), Local_202, 4294967295);
				}
				else
				{
...
int func_101(int iParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4, var uParam5, int iParam6, var uParam7, var uParam8, int iParam9, float fParam10)
{
	...
	else if (unk_0x5A91F08DF773C39D(iParam0, vParam1, fParam10, fParam10, 2f, false, true, 2))
	{
		...
		else if ((unk_0x1C0640BA9A7327B3() - *uParam7) > 3000)
		{
			return 1;
		}
	}
...
int func_110(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_124(1, vLocal_175, 0))
			{
				if (!func_459())
				{
					...
					{
						iLocal_206 = unk_0x7D6CA5F52B3748BF(-417.198f, -2155.886f, 8.36266f, -383.4908f, -2188.511f, 12.9213f, 0, 1, 1, 1);
						func_122(34);
						unk_0xAB8E2DDC7AF955E0(joaat("trash"), true);
						unk_0xAB8E2DDC7AF955E0(joaat("towtruck"), true);
						if (func_446(Local_197))
						{
							if (!func_121(Local_197, 2277090178))
							{
								unk_0x3E8E48829F3C7624(Local_197, "mini@repair", "fixing_a_ped", unk_0x68E4ADDDDCD7BDDE(Local_200, vLocal_196), 0f, 0f, -unk_0xD9522BA9E27E1349(Local_200), 1000f, -1.5f, 4294967295, 1, 0f, 2, 0);
								unk_0xF895E10BF4C72645(Local_197, 0, 0);
							}
							func_120();
							func_118();
							unk_0x4E885A246A9D983A(Local_197, 154, false);
							unk_0x6DF7BF67E86AAE86(Local_197, iLocal_203);
						}
						if (unk_0xC0E5DA578D275A41(Local_202) != 0)
						{
						...
						unk_0xCEAA091B490F8407(4294967295, "Tow_truck_damage", Local_200, "FBI_04_HEAT_SOUNDS", false, 0);
						return 1;
					}
				}
				else
		...
		case 1:
			if (bParam1)
			{
				if ((((func_124(2, Local_202.f_1, Local_202.f_4) && func_124(5, Local_200.f_1, Local_200.f_4)) && func_124(4, vLocal_175, 0)) && func_124(6, Local_201.f_1, Local_201.f_4)) && func_124(3, unk_0x68E4ADDDDCD7BDDE(Local_200, vLocal_196), -unk_0xD9522BA9E27E1349(Local_200)))
				{
					unk_0x536F1BE96C726C4B(Local_197.f_1, 100f, 1, 0, 0, false);
					func_115();
					if (func_446(Local_197))
					{
		...
		case 2:
			if (bParam1)
			{
				if (func_124(2, Local_202.f_1, Local_202.f_4))
				{
					...
					{
						func_111(Local_202, 4294967295, 1);
					}
				}
			}
			else
...
int func_123()
{
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		if (unk_0x4906F8A34E9F4814(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), joaat("towtruck")))
		{
			...
			iLocal_198 = unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0);
			if (func_6(iLocal_198))
			{
				return 1;
			}
...
int func_124(int iParam0, vector3 vParam1, float fParam2)
{
	switch (iParam0)
	{
		...
		case 1:
			unk_0xD7992BEF7A9D109E(sLocal_166, 0);
			unk_0xD7992BEF7A9D109E(cLocal_207, 6);
		...
		case 2:
			if (func_6(Global_17409[0]))
			{
				unk_0x73270B3C9CC833FD(Global_17409[0], true, 1);
				Local_202 = Global_17409[0];
				if (func_6(Local_202))
				{
					func_129(Local_202, 0);
					unk_0x44A200C9B6E1CEA6(Local_202, true);
					return 1;
				}
			}
			...
			if (unk_0xC844350D5D58C99A(Global_17409.f_9[0]))
			{
				if (!unk_0x28072FDD60CE3A6E(Global_17409.f_9[0], 1))
				{
					...
					if (func_446(Local_197))
					{
						...
						unk_0x7EB60BF335619074(Local_197, 0.1f);
						unk_0x33CE5A9E32EA10B2(Local_197, true);
						unk_0x291398BF0ED6A2E2(Local_197, 0);
						return 1;
					}
				}
				else
		...
		case 5:
			if (func_6(Global_17409[1]))
			{
				unk_0x73270B3C9CC833FD(Global_17409[1], true, 1);
				Local_200 = Global_17409[1];
				if (func_6(Local_200))
				{
					unk_0xC6A6B4DDD6DC073A(Local_200, 0);
					return 1;
				}
			}
			...
			{
				unk_0xC6A6B4DDD6DC073A(Local_200, 0);
				unk_0x611DFA9294B339CA(Local_200, 4, 0, false);
				unk_0x611DFA9294B339CA(Local_200, 0, 1, false);
		...
		case 6:
			if (func_6(Global_17409[2]))
			{
				unk_0x73270B3C9CC833FD(Global_17409[2], true, 1);
				Local_201 = Global_17409[2];
				if (func_6(Local_201))
				{
					unk_0x71EDC33E5A423750(Local_201, 3);
					return 1;
				}
			}
...
void func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, vector3 vParam5, int iParam6, bool bParam7, float fParam8)
{
	if (func_6(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), *iParam0, 0) && !func_137(*iParam0)) && !func_136(*iParam0))
				{
					func_27(iParam4);
...
int func_136(int iParam0)
{
	...
	if ((func_446(unk_0x16F2683693E537C9()) && unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0)) && func_6(iParam0))
	{
	...
	switch (iLocal_53)
	{
		...
		case 1:
			...
			else if (!iLocal_192)
			{
				if (!func_142())
				{
					if (func_446(Local_197))
					{
						if (func_137(unk_0x6937EA2286828455(Local_197, 0)))
						{
		...
		case 3:
			if (func_6(iLocal_198))
			{
				if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_198, 0))
				{
					unk_0xF821F915BC24D246(unk_0x16F2683693E537C9(), iLocal_198, 4294967295);
				}
				else
				{
...
int func_146(int iParam0, int iParam1)
{
	switch (iLocal_57[iParam0])
	{
		case 0:
			...
			{
				unk_0x132B85BCE016BCA0(iParam1, unk_0x6937EA2286828455(iParam1, 0), vLocal_176, 4, 20f, 786469, 2f, 10f, 1);
				iLocal_57[iParam0] = 5;
			}
			break;
	...
	if (func_446(Local_197))
	{
		...
		switch (iLocal_57[iParam0])
		{
			case 0:
				...
				if (!unk_0xF65264B66E133BD8(vVar0, 1.5f, 0, 0, 1, 0, 0, Local_197, 0))
				{
					if (!bLocal_195)
					{
						if (iParam0 == 0)
					...
					{
						unk_0x96167B03C5A77156(iParam1, vVar0, 1f, 20000, 0.25f, 0, 82.7989f);
						unk_0x6E8BDA9057564534(iParam1, 1, 0);
						if (iParam0 == 2)
						{
							unk_0x262EF6C6306BEA6C(iParam1, joaat("weapon_knife"), 4294967295, true, true);
							iLocal_57[iParam0] = 2;
						}
						else
						{
							unk_0x262EF6C6306BEA6C(iParam1, joaat("weapon_unarmed"), 4294967295, true, true);
							iLocal_57[iParam0] = 1;
						}
					}
				}
			...
			case 1:
				...
				{
					unk_0x53034259CAA511D1(iParam1, Local_197, unk_0x12AB0310C2281427("AR_stealth_kill_a"), 1f, 0);
			...
			case 2:
				...
				{
					unk_0x53034259CAA511D1(iParam1, Local_197, unk_0x12AB0310C2281427("AR_stealth_kill_knife"), 1f, 0);
					unk_0xA3BF0AA5A2608191(Local_197);
					iLocal_56 = 18;
					iLocal_57[iParam0] = 4;
				}
...
int func_150(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if ((unk_0xC844350D5D58C99A(iLocal_198) && unk_0xDF1306B443CD3D15(iLocal_198, 0)) && !unk_0x5A91F08DF773C39D(iLocal_198, vLocal_176, 2f, 2f, 2f, false, true, 0))
		{
			if ((unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_198, 0) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0) && unk_0xA30B8362589C124A(iLocal_198, 4294967295, 0) != unk_0x16F2683693E537C9())
			{
				if (unk_0xC42A92762C58E1B9(iParam1, iLocal_198, 0) && unk_0xA30B8362589C124A(iLocal_198, 4294967295, 0) == iParam1)
				{
					iLocal_58[iParam0] = 2;
					return 1;
				}
...
int func_152(int iParam0, int iParam1)
{
	if (!func_151())
	{
		if (func_446(Local_197))
		{
			if (((unk_0x3D1053F9EB43B7AD(iParam1, -408.0286f, -2175.476f, 5.31836f, -394.644f, -2175.297f, 15.31835f, 21.52f, 0, true, 0) && !func_153(iParam0)) && !unk_0x65851B2C8786EE74(Local_197)) && !unk_0x405E212DDE472467(iParam1, 0))
			{
				iLocal_58[iParam0] = 1;
				return 1;
			}
...
void func_154(int iParam0, int iParam1)
{
	if (iParam0 != unk_0x16F2683693E537C9())
	{
		...
		else if (!unk_0x405E212DDE472467(iParam0, 0))
		{
			...
			unk_0x7D732AB707BE9152(iParam0, 1);
		}
	}
...
void func_156()
{
	...
	if (func_446(Local_197))
	{
		...
		switch (iLocal_56)
		{
			...
			case 1:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(9000, 10000)
				{
					if (!func_226())
					{
						func_210(iLocal_56);
			...
			case 4:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(1500, 2500)
				{
					if (func_95(Local_200, Local_200.f_1, 2f))
					{
						if (!func_226())
			...
			case 9:
				if (func_209(Local_197, unk_0x16F2683693E537C9(), 20f, 1) && !unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
				{
					func_210(10);
					return;
				}
				...
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(1500, 2500)
				{
					if (!func_121(Local_197, 780511057))
					{
						...
						{
							if (func_209(Local_197, unk_0x16F2683693E537C9(), 10f, 1))
							{
								func_210(10);
							}
			...
			case 10:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(1500, 2500)
				{
					...
					{
						if (!func_209(Local_197, Local_201, 15f, 1) && !unk_0xE3614539F8B5C807(unk_0x16F2683693E537C9()))
						{
							func_210(8);
						}
					}
			...
			case 11:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(1000, 2000)
				{
					if (!func_226())
					{
						func_210(11);
			...
			case 14:
				if (!func_209(Local_197, unk_0x16F2683693E537C9(), 118f, 1))
				{
			...
			case 13:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(3000, 5000)
				{
					if (!func_209(Local_197, unk_0x16F2683693E537C9(), 10f, 1))
					{
						func_210(14);
					}
					else if (unk_0xB87D13D0C064E9D1(Local_197, unk_0x16F2683693E537C9(), 1))
					{
						func_210(14);
					}
					else
			...
			case 15:
				...
				{
					if (func_195(Local_197, unk_0x16F2683693E537C9(), 1126825984, 1, 250, 7))
					{
						func_194();
						return;
					}
				}
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(7000, 10000)
				{
					func_210(15);
				}
				break;
			...
			case 16:
				if (func_6(Local_202))
				{
					if (unk_0xC42A92762C58E1B9(Local_197, Local_202, 0))
					{
						if (func_190(Local_202, &uLocal_180, &uLocal_181, &uLocal_182, &uLocal_183, 3, 2f))
						{
							...
							if (unk_0xC42A92762C58E1B9(Local_197, Local_202, 0))
							{
								unk_0x75CDA8644CD3B5F5(0, 1000, 4096);
							}
							unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 120f, 4294967295, 0, 0);
			...
			case 17:
				if (unk_0x1C0640BA9A7327B3() - Local_197.f_E) > unk_0x09AC81E49EA267F7(10000, 12000)
				{
	...
	else
	{
		...
		if (func_6(Local_200))
		{
			if (!func_95(Local_200, Local_200.f_1, 50f) || !func_209(unk_0x16F2683693E537C9(), Local_200, 250f, 1))
			{
				func_133(&Local_200);
			}
		}
	...
	{
		func_158(Local_197, &(Local_197.f_6), 4294967295, 0, 0, 0, 3212836864, 0, 4294967295, 4294967295, 1);
	}
	else
	{
...
int func_168(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_175() || func_174(Global_440000.f_38DB3)) || func_173())
	{
		...
		{
			iVar0 = unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0);
			iVar1 = func_172(unk_0x16F2683693E537C9(), 0);
			if (((unk_0x137240CA2BADB0D2(iVar0, iVar1) || (unk_0x134B62B726CEC8E6(iVar0) == 562680400 && iVar1 != 4294967295)) || (unk_0x134B62B726CEC8E6(iVar0) == 1181327175 && iVar1 != 4294967295)) || (((unk_0x134B62B726CEC8E6(iVar0) == 2601952180 && iVar1 == 0) && func_171(iVar0, 10)) && unk_0x0ECB5CA5140957AD(iVar0, 10) != 4294967295))
			{
				return 0;
			}
		}
...
int func_169(int iParam0)
{
	if (iParam0 != func_77())
	{
		...
		else if ((Global_14086D && iParam0 == unk_0xD803B885F5E47A62()) && func_170(iParam0, 1, 0))
		{
			return Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295;
		}
	}
...
int func_190(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, float fParam6)
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		vVar1 = { func_192(unk_0x68F4C0EC296D3901(iVar0, true) - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	if (func_6(Local_200))
	{
		if (!func_121(Local_197, 2277090178))
		{
			if (!func_95(Local_197, unk_0x68E4ADDDDCD7BDDE(Local_200, vLocal_196), 0.5f))
			{
				...
				{
					unk_0x96167B03C5A77156(Local_197, unk_0x68E4ADDDDCD7BDDE(Local_200, vLocal_196), 1f, 60000, 0.3f, 512, -unk_0xD9522BA9E27E1349(Local_200));
				}
			}
			else if (!func_121(Local_197, 1920390111))
			{
				unk_0xE655C47E46F9A7E4(Local_197, -unk_0xD9522BA9E27E1349(Local_200), 0);
			}
		}
		unk_0x7EB60BF335619074(Local_197, 0.1f);
	}
...
void func_194()
{
	if (unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
	{
		if (!func_209(unk_0x16F2683693E537C9(), Local_197, 10f, 1))
		{
			func_210(14);
		}
		else
...
int func_208()
{
	if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		if (func_209(Local_197, unk_0x16F2683693E537C9(), 20f, 1))
		{
			return 1;
		}
		else if (unk_0x9C66D99E63E8E24C(unk_0x16F2683693E537C9()) < 10f)
		{
			if (iLocal_185 == 4294967295)
			{
				iLocal_185 = unk_0x1C0640BA9A7327B3();
			}
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_185) > 6000)
			{
				return 1;
			}
		}
	}
	else if (func_209(Local_197, unk_0x16F2683693E537C9(), 10f, 1))
	{
		if (unk_0x9C66D99E63E8E24C(unk_0x16F2683693E537C9()) < 10f)
		{
			...
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_185) > 5500)
			{
				return 1;
			}
		}
	...
	switch (iParam0)
	{
		case 1:
			if (!func_121(Local_197, 2277090178))
			{
				if (func_6(Local_200))
				{
					unk_0xC6EB89C59F2AF6B8(Local_197, "mini@repair", "fixing_a_ped", 1.5f, -1.5f, 4294967295, 1, 0, 0, 0, 0);
				}
			}
			break;
		
		case 3:
			if (!func_121(Local_197, 2500551826))
			{
				if (func_6(Local_202))
				{
					unk_0x5B1D360B9C6F0A09(Local_197, Local_202, 60000, 4294967295, 2f, 524296, 0);
				}
			}
			break;
		...
		case 2:
			if (!func_121(Local_197, 713668775))
			{
				if (func_6(Local_202))
				{
					unk_0x96167B03C5A77156(Local_197, unk_0x68E4ADDDDCD7BDDE(Local_200, -1f, 0.5f, 0f), 1f, 30000, 0.25f, 0, 141.2603f);
				}
			}
			break;
		...
		case 6:
			if (!func_121(Local_197, 2500551826))
			{
				if (func_6(Local_200))
				{
					if (!unk_0x405E212DDE472467(Local_197, 0))
					{
						unk_0x5B1D360B9C6F0A09(Local_197, Local_200, 60000, 4294967295, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 7:
			if (!func_121(Local_197, 2500551826))
			{
				if (func_6(Local_202))
				{
					if (!unk_0x405E212DDE472467(Local_197, 0))
					{
						unk_0x5B1D360B9C6F0A09(Local_197, Local_202, 60000, 4294967295, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 8:
			if (func_121(Local_197, 242628503) || unk_0xD1960163A3042274(Local_197, 242628503) == 2)
			{
				unk_0xA3BF0AA5A2608191(Local_197);
			}
			if (func_6(Local_201))
			{
				if (!func_121(Local_197, 2500551826))
				{
					if (!unk_0x405E212DDE472467(Local_197, 0))
					{
						unk_0x5B1D360B9C6F0A09(Local_197, Local_201, 60000, 4294967295, 2f, 1, 0);
					}
				}
			}
			break;
		...
		case 9:
			if (!func_121(Local_197, 3021937204))
			{
				if (func_6(Local_201))
				{
					if (func_6(Local_200) && func_6(Local_202))
					{
						if (bLocal_177)
						{
							...
							{
								unk_0x60274E99F9B27DEA(Local_197, Local_201, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_213();
						...
						else if (iLocal_55 == 1)
						{
							if (!unk_0x377BE9A1BF38C7CE(Local_201))
							{
								unk_0x60274E99F9B27DEA(Local_197, Local_201, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
							}
							else
							{
								func_213();
				...
				else if (func_6(Local_200) && func_6(Local_202))
				{
					if (bLocal_177)
					{
						...
						{
							unk_0x60274E99F9B27DEA(Local_197, Local_202, Local_200, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_213();
					...
					else if (iLocal_55 == 1)
					{
						...
						{
							unk_0x60274E99F9B27DEA(Local_197, Local_200, Local_202, 11, 30f, 34341156, 1f, -1f, 1);
						}
						else
						{
							func_213();
		...
		case 10:
			if (!func_121(Local_197, 242628503))
			{
				...
				if (unk_0x405E212DDE472467(Local_197, 0))
				{
					unk_0x75CDA8644CD3B5F5(0, 1000, 0);
				}
				unk_0x0E2400AB9174FA81(5, iLocal_203, 1862763509);
		...
		case 11:
			if (!func_121(Local_197, 3419293077))
			{
				unk_0xF96A174EE26D7588(Local_197, unk_0x16F2683693E537C9(), 0);
			}
			break;
		...
		case 13:
			...
			{
				unk_0xA3BF0AA5A2608191(Local_197);
				unk_0x8BE3D040D15AEA1D(Local_197, 4294967295);
			}
			break;
		...
		case 14:
			if (!func_121(Local_197, 1805844857))
			{
				...
				unk_0xF3268524E9BE6D6E(Local_197, unk_0x16F2683693E537C9(), 120f, 4294967295, 0, 0);
			}
			break;
		...
		case 15:
			...
			{
				unk_0x0E2400AB9174FA81(5, iLocal_203, 1862763509);
				unk_0x6C3AE6E278DB3D0E(Local_197, unk_0x16F2683693E537C9(), 0, 16);
			}
			break;
		...
		case 16:
			if (!func_121(Local_197, 242628503))
			{
				if (func_6(Local_202))
				{
					...
					if (!unk_0xC42A92762C58E1B9(Local_197, Local_202, 0))
					{
						unk_0x5B1D360B9C6F0A09(0, Local_202, 60000, 4294967295, 2f, 1, 0);
					}
					unk_0xE072601B4380E9DF(0, Local_202, 30f, 786469);
...
{
	unk_0xEB0A515D699A7E90(Local_197, sParam0, "S_M_M_TRUCKER_01_BLACK_FULL_02", "SPEECH_PARAMS_FORCE", 0);
}
...
void func_219(char* sParam0, int iParam1, int iParam2)
{
	...
	{
		Var0 = { func_221() };
		if ((((!unk_0x7F8A39872A07D2CE(&Var0, sParam0) && !unk_0x46BC6F5F089F3AFF(Local_197)) && !unk_0x869EFD0BC0868856(Local_197)) && !unk_0x15D0A3E61766C539(Local_197, 0)) && !unk_0x9E834FAC6CCB49FB(Local_197))
		{
...
int func_223(int iParam0, float fParam1)
{
	...
	{
		if (func_225(unk_0x16F2683693E537C9(), iParam0, 0) <= fParam1 && func_224(iParam0, unk_0x16F2683693E537C9()))
		{
			return 1;
		}
	}
...
void func_228()
{
	if (iLocal_56 != 14 && iLocal_56 != 13)
	{
		...
		if (!func_235() || unk_0xB87D13D0C064E9D1(Local_197, unk_0x16F2683693E537C9(), 1))
		{
			if (func_209(unk_0x16F2683693E537C9(), Local_197, 30f, 1))
			{
...
void func_229()
{
	if (!unk_0x405E212DDE472467(Local_197, 1))
	{
		func_194();
	}
	else
	{
		if (func_6(Local_202))
		{
			if (unk_0xC42A92762C58E1B9(Local_197, Local_202, 0))
			{
				unk_0x89258193691A7600(Local_197, Local_202, unk_0x16F2683693E537C9(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_200))
		{
			if (unk_0xC42A92762C58E1B9(Local_197, Local_200, 0))
			{
				unk_0x89258193691A7600(Local_197, Local_200, unk_0x16F2683693E537C9(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
				return;
			}
		}
		if (func_6(Local_201))
		{
			if (unk_0xC42A92762C58E1B9(Local_197, Local_201, 0))
			{
				unk_0x89258193691A7600(Local_197, Local_201, unk_0x16F2683693E537C9(), 8, 30f, 786469, 300f, 2f, 1);
				iLocal_56 = 14;
			}
		}
	}
...
{
	return func_195(iParam0, unk_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}
...
int func_235()
{
	if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(Local_197, 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
	{
		return 1;
	}
	return 0;
...
void func_238()
{
	if (func_6(Local_202))
	{
		if (((func_241() && iLocal_56 != 6) && iLocal_56 != 11) && iLocal_56 != 8)
		{
			...
			if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				if (func_209(Local_202, unk_0x16F2683693E537C9(), 6f, 1))
				{
			...
			else if (unk_0xB87D13D0C064E9D1(Local_202, unk_0x16F2683693E537C9(), 1))
			{
		...
		if ((func_241() && iLocal_56 != 7) && iLocal_56 != 8)
		{
			if (iLocal_56 != 2)
			{
				if (iLocal_56 != 4)
				{
					...
					if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
					{
						if (func_209(Local_200, unk_0x16F2683693E537C9(), 6f, 1))
						{
					...
					else if (unk_0xB87D13D0C064E9D1(Local_200, unk_0x16F2683693E537C9(), 1))
					{
						if (!unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 4))
						{
							func_210(15);
...
int func_239()
{
	if (func_240())
	{
		...
		{
			if (iLocal_56 == 11 && func_209(Local_197, unk_0x16F2683693E537C9(), 5f, 1))
			{
				return 0;
			}
			return 1;
...
{
	if (func_209(Local_197, unk_0x16F2683693E537C9(), 2f, 1) || unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
...
void func_246()
{
	if (iLocal_56 != 20)
	{
		if (func_209(unk_0x16F2683693E537C9(), Local_197, 15f, 1))
		{
...
void func_250()
{
	if (func_446(Local_197) && iLocal_56 != 15)
	{
		...
		if (!func_209(Local_197, unk_0x16F2683693E537C9(), 150f, 1) && !unk_0x0A059E0DB9253280(Local_197))
		{
		...
		else if (!func_209(Local_197, unk_0x16F2683693E537C9(), 200f, 1))
		{
			if (unk_0x0A059E0DB9253280(Local_197))
			{
				func_207(&Local_197, 0, 1, 1);
...
void func_252()
{
	if (func_6(Local_200))
	{
		if (!bLocal_177)
		{
			if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_200, 0))
			{
				bLocal_177 = true;
			}
		}
		...
		if (bParam6)
		{
			switch (func_15())
			{
				case 0:
					...
					{
						func_272(unk_0x16F2683693E537C9(), 8, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					if (func_386(unk_0x16F2683693E537C9(), 9, 6))
					{
						func_272(unk_0x16F2683693E537C9(), 9, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				...
				case 1:
					...
					{
						func_272(unk_0x16F2683693E537C9(), 8, 26, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				...
				case 2:
					...
					{
						func_272(unk_0x16F2683693E537C9(), 8, 15, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				}
		}
...
int func_272(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_12A92[1 /*14*/] = { func_322(iVar10, iParam1, iParam2, 4294967295) };
		if (!func_321(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			if (!func_310(iVar10, 14, iVar7, 4294967295))
			{
				iVar7 = 4294967197;
			}
			iVar8 = func_311(iParam0, 0);
			if (!func_309(iVar10, 14, iVar8, 4294967295) && !func_308(iVar10, 14, iVar8, 4294967295))
			{
				iVar8 = 4294967197;
			}
			if (iVar10 == joaat("player_one"))
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_12A92[1 /*14*/] = { func_322(iVar10, iVar0, uVar11[iVar0], 4294967295) };
				if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_12A92[1 /*14*/] = { func_322(iVar10, 14, uVar12[iVar1], 4294967295) };
							func_292(iParam0, Global_12A92[1 /*14*/].f_C, Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4);
							func_314(14);
							if (Global_12A90 == 1)
							{
								iVar2 = 0;
								while (iVar2 < 15)
								{
									...
									if (iVar3 != 4294967197)
									{
										func_272(iParam0, iVar2, iVar3, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
									}
									iVar2++;
								}
							}
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_282(iVar0), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_282(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_282(iVar0), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, iParam4);
						}
						func_314(iVar0);
						if (Global_12A90 == 1)
						{
			...
			{
				Global_12A92[1 /*14*/] = { func_322(iVar10, iVar0, func_281(iParam0, iVar0, 4294967295), 4294967295) };
				if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 3))
				{
					if (iVar0 == 2)
					{
						if (iVar10 == joaat("player_one"))
						{
							...
							{
								func_272(iParam0, 2, iVar4, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
							}
						}
					}
					else
					{
						...
						func_272(iParam0, iVar0, uVar13[iVar0], 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
				}
			}
			iVar0++;
		...
		if (iParam7 == 1)
		{
			Var14 = { func_322(iVar10, 8, iVar5, 4294967295) };
			if (iVar5 != 4294967197)
			{
				if (func_278(iVar10, iParam2, 8, iVar5, &uVar11, &Var14))
				{
					func_272(iParam0, 8, iVar5, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_322(iVar10, 9, iVar6, 4294967295) };
			if (iVar6 != 4294967197)
			{
				if (func_278(iVar10, iParam2, 9, iVar6, &uVar11, &Var14))
				{
					func_272(iParam0, 9, iVar6, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_322(iVar10, 14, iVar7, 4294967295) };
			if (iVar7 != 4294967197)
			{
				if (func_278(iVar10, iParam2, 14, iVar7, &uVar11, &Var14))
				{
					func_272(iParam0, 14, iVar7, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_322(iVar10, 14, iVar8, 4294967295) };
			if (iVar8 != 4294967197)
			{
				if (func_278(iVar10, iParam2, 14, iVar8, &uVar11, &Var14))
				{
					func_272(iParam0, 14, iVar8, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_322(iVar10, 14, iVar9, 4294967295) };
			if (iVar9 != 4294967197)
			{
				if (func_278(iVar10, iParam2, 14, iVar9, &uVar11, &Var14))
				{
					func_272(iParam0, 14, iVar9, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
		}
	}
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_12A92[1 /*14*/] = { func_322(iVar10, 14, uVar15[iVar1], 4294967295) };
			func_292(iParam0, Global_12A92[1 /*14*/].f_C, Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4);
			func_314(14);
			if (Global_12A90 == 1)
			{
	...
	else
	{
		if (iParam4 == 4294967295)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_282(iParam1), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_282(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_282(iParam1), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, iParam4);
		}
		if (Global_12A90 == 1)
		{
			iVar2 = 0;
	...
	if (Global_12A90 == 1)
	{
		...
		{
			func_272(iParam0, 1, iVar4, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
		}
	}
	Global_12A90 = (Global_12A90 - 1);
	return 1;
...
{
	Global_12A92[1 /*14*/] = { func_322(iParam0, iParam1, iParam2, 4294967295) };
...
int func_278(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	...
	if (iParam0 == joaat("player_zero"))
	{
		if (func_310(iParam0, iParam2, iParam3, 4294967295))
		{
		...
		else if (func_309(iParam0, iParam2, iParam3, 4294967295))
		{
		...
		else if (func_308(iParam0, iParam2, iParam3, 4294967295))
		{
			if (((((((((iParam1 == 1 || iParam1 == 2) || iParam1 == 4) || iParam1 == 5) || iParam1 == 10) || iParam1 == 11) || iParam1 == 12) || iParam1 == 14) || iParam1 == 18) || iParam1 == 50)
			{
				return 0;
...
int func_280(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_386(iParam0, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_3D, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
					...
					case 11:
						...
						else if (iParam2 == 8)
						{
							if (((iParam3 >= 27 && iParam3 <= 42) || (iParam3 >= 43 && iParam3 <= 58)) || (iParam3 >= 59 && iParam3 <= 74))
							{
								...
								iVar0 = func_286(iParam1, 4294967197, iVar9, 0);
							}
						}
						break;
				}
...
void func_292(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_293(unk_0x134B62B726CEC8E6(iParam0), 14, iVar0, unk_0xD1BC07002824FE76(iParam0, 0, iParam2, iParam3)))
			{
...
int func_294(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_282(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_297(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != 4294967295 && iVar1 != 0)
	{
		...
		{
			return func_299(unk_0x134B62B726CEC8E6(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_299(unk_0x134B62B726CEC8E6(iParam0), iVar1, 14, 4);
		}
	}
...
int func_299(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_282(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
struct<17> func_304(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_307(&Var1, 4294967197, 4294967197, 1, 1, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					else
					{
						func_307(&Var1, 4294967197, 4294967197, 0, 0, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					break;
				
				case 1:
					func_307(&Var1, 4294967197, 4294967197, 16, 16, 6, 1, 1, 0, 1, 4294967197, 0, 0, 0);
					break;
				
				case 2:
					func_307(&Var1, 4294967197, 4294967197, 36, 21, 6, 1, 5, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 3:
					func_307(&Var1, 4294967197, 4294967197, 65, 36, 6, 0, 2, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 4:
					func_307(&Var1, 4294967197, 4294967197, 61, 32, 6, 0, 0, 7, 3, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_307(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[0], Global_1B416.f_936.f_21B.f_C8[0], 6, 3, 0, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 6:
					func_307(&Var1, 4294967197, 4294967197, 92, 72, 7, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_307(&Var1, 4294967197, 4294967197, 85, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 8:
					func_307(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_307(&Var1, 4294967197, 4294967197, 171, 89, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_307(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 4);
					break;
				
				case 11:
					func_307(&Var1, 4294967197, 4294967197, 33, 18, 17, 10, 4, 8, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_307(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 23, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_307(&Var1, 4294967197, 4294967197, 69, 40, 13, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_307(&Var1, 4294967197, 4294967197, 62, 33, 38, 0, 8, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 15:
					func_307(&Var1, 4294967197, 4294967197, 63, 34, 6, 10, 0, 0, 4, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_307(&Var1, 4294967197, 4294967197, 174, 93, 18, 0, 18, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_307(&Var1, 4294967197, 4294967197, 76, 46, 6, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_307(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 4, 0, 4294967197, 0, 0, 7);
					break;
				
				case 19:
					func_307(&Var1, 4294967197, 4294967197, 64, 35, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_307(&Var1, 4294967197, 4294967197, 66, 37, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_307(&Var1, 4294967197, 4294967197, 67, 38, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_307(&Var1, 4294967197, 4294967197, 68, 39, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_307(&Var1, 4294967197, 4294967197, 177, 94, 19, 9, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_307(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 4, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_307(&Var1, 4294967197, 4294967197, 97, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_307(&Var1, 4294967197, 4294967197, 3, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_307(&Var1, 4294967197, 4294967197, 129, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_307(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_307(&Var1, 4294967197, 4294967197, 2, 2, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_307(&Var1, 4294967197, 4294967197, 161, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_307(&Var1, 4294967197, 4294967197, 3, 3, 0, 12, 0, 0, 0, 4294967197, 0, 1, 31);
					break;
				
				case 32:
					func_307(&Var1, 4294967197, 4294967197, 85, 55, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_307(&Var1, 4294967197, 4294967197, 86, 4, 20, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_307(&Var1, 4294967197, 4294967197, 44, 97, 6, 0, 0, 0, 0, 4294967197, 0, 2, 31);
					break;
				
				case 35:
					func_307(&Var1, 4294967197, 4294967197, 85, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_307(&Var1, 4294967197, 4294967197, 4, 4, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_307(&Var1, 4294967197, 4294967197, 5, 5, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_307(&Var1, 4294967197, 4294967197, 6, 6, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_307(&Var1, 4294967197, 4294967197, 7, 7, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_307(&Var1, 4294967197, 4294967197, 8, 8, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_307(&Var1, 4294967197, 4294967197, 9, 9, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_307(&Var1, 4294967197, 4294967197, 10, 10, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_307(&Var1, 4294967197, 4294967197, 11, 11, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_307(&Var1, 4294967197, 4294967197, 12, 12, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_307(&Var1, 4294967197, 4294967197, 13, 13, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 46:
					func_307(&Var1, 4294967197, 4294967197, 14, 14, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_307(&Var1, 4294967197, 4294967197, 15, 15, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 48:
					func_307(&Var1, 4294967197, 4294967197, 91, 71, 14, 13, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 49:
					func_307(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 50:
					func_307(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 9);
					break;
				
				case 51:
					func_307(&Var1, 4294967197, 4294967197, 169, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 52:
					func_307(&Var1, 4294967197, 4294967197, 169, 72, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_one"):
			...
			{
				case 0:
					func_307(&Var1, 4294967197, 4294967197, 73, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_307(&Var1, 4294967197, 4294967197, 22, 10, 64, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 2:
					func_307(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[1], Global_1B416.f_936.f_21B.f_C8[1], 17, 2, 26, 0, 0, 4294967197, 0, 45, 31);
					break;
				
				case 3:
					func_307(&Var1, 4294967197, 4294967197, 23, 11, 13, 5, 2, 4, 0, 4294967197, 0, 0, 1);
					break;
				
				case 4:
					func_307(&Var1, 4294967197, 4294967197, 23, 11, 34, 5, 26, 0, 0, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_307(&Var1, 4294967197, 20, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 6:
					func_307(&Var1, 4294967197, 4294967197, 40, 13, 14, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_307(&Var1, 4294967197, 4294967197, 90, 32, 17, 1, 8, 0, 1, 4294967197, 0, 0, 3);
					break;
				
				case 8:
					func_307(&Var1, 4294967197, 4294967197, 17, 5, 12, 0, 26, 0, 2, 4294967197, 0, 0, 5);
					break;
				
				case 9:
					func_307(&Var1, 4294967197, 4294967197, 16, 4, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_307(&Var1, 4294967197, 4294967197, 208, 71, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_307(&Var1, 4294967197, 4294967197, 259, 10, 35, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 12:
					func_307(&Var1, 4294967197, 4294967197, 18, 6, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_307(&Var1, 4294967197, 4294967197, 19, 7, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_307(&Var1, 4294967197, 4294967197, 20, 8, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_307(&Var1, 4294967197, 4294967197, 21, 9, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_307(&Var1, 4294967197, 4294967197, 135, 40, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_307(&Var1, 4294967197, 4294967197, 74, 24, 52, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_307(&Var1, 4294967197, 4294967197, 176, 53, 26, 5, 26, 0, 0, 4294967197, 0, 41, 31);
					break;
				
				case 19:
					func_307(&Var1, 4294967197, 4294967197, 125, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_307(&Var1, 4294967197, 4294967197, 162, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_307(&Var1, 4294967197, 4294967197, 75, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 22:
					func_307(&Var1, 4294967197, 4294967197, 227, 53, 25, 0, 27, 0, 0, 4294967197, 0, 25, 31);
					break;
				
				case 23:
					func_307(&Var1, 4294967197, 4294967197, 228, 54, 25, 0, 28, 0, 0, 4294967197, 0, 26, 31);
					break;
				
				case 24:
					func_307(&Var1, 4294967197, 4294967197, 229, 55, 25, 0, 29, 0, 0, 4294967197, 0, 27, 31);
					break;
				
				case 25:
					func_307(&Var1, 4294967197, 4294967197, 230, 56, 25, 0, 30, 0, 0, 4294967197, 0, 28, 31);
					break;
				
				case 26:
					func_307(&Var1, 4294967197, 4294967197, 231, 57, 25, 0, 31, 0, 0, 4294967197, 0, 29, 31);
					break;
				
				case 27:
					func_307(&Var1, 4294967197, 4294967197, 232, 58, 25, 0, 32, 0, 0, 4294967197, 0, 30, 31);
					break;
				
				case 28:
					func_307(&Var1, 4294967197, 4294967197, 233, 59, 25, 0, 33, 0, 0, 4294967197, 0, 31, 31);
					break;
				
				case 29:
					func_307(&Var1, 4294967197, 4294967197, 234, 60, 25, 0, 34, 0, 0, 4294967197, 0, 32, 31);
					break;
				
				case 30:
					func_307(&Var1, 4294967197, 4294967197, 235, 61, 25, 0, 35, 0, 0, 4294967197, 0, 33, 31);
					break;
				
				case 31:
					func_307(&Var1, 4294967197, 4294967197, 236, 62, 25, 0, 36, 0, 0, 4294967197, 0, 34, 31);
					break;
				
				case 32:
					func_307(&Var1, 4294967197, 4294967197, 237, 63, 25, 0, 37, 0, 0, 4294967197, 0, 35, 31);
					break;
				
				case 33:
					func_307(&Var1, 4294967197, 4294967197, 238, 64, 25, 0, 38, 0, 0, 4294967197, 0, 36, 31);
					break;
				
				case 34:
					func_307(&Var1, 4294967197, 4294967197, 239, 65, 25, 0, 39, 0, 0, 4294967197, 0, 37, 31);
					break;
				
				case 35:
					func_307(&Var1, 4294967197, 4294967197, 240, 66, 25, 0, 40, 0, 0, 4294967197, 0, 38, 31);
					break;
				
				case 36:
					func_307(&Var1, 4294967197, 4294967197, 241, 67, 25, 0, 41, 0, 0, 4294967197, 0, 39, 31);
					break;
				
				case 37:
					func_307(&Var1, 4294967197, 4294967197, 242, 68, 25, 0, 42, 0, 0, 4294967197, 0, 40, 31);
					break;
				
				case 38:
					func_307(&Var1, 4294967197, 4294967197, 260, 72, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_307(&Var1, 4294967197, 4294967197, 125, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_307(&Var1, 4294967197, 4294967197, 123, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_307(&Var1, 4294967197, 4294967197, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_307(&Var1, 4294967197, 4294967197, 89, 22, 15, 6, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_307(&Var1, 4294967197, 4294967197, 317, 69, 17, 0, 0, 0, 51, 4294967197, 0, 0, 6);
					break;
				
				case 44:
					func_307(&Var1, 4294967197, 4294967197, 30, 23, 16, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 45:
					func_307(&Var1, 4294967197, 4294967197, 106, 70, 17, 5, 26, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 46:
					func_307(&Var1, 4294967197, 4294967197, 117, 24, 20, 5, 26, 0, 52, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_two"):
			...
			{
				case 0:
					func_307(&Var1, 4294967197, 4294967197, 0, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_307(&Var1, 4294967197, 4294967197, 17, 5, 8, 2, 3, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 2:
					func_307(&Var1, 4294967197, 4294967197, 43, 8, 12, 3, 5, 0, 0, 4294967197, 0, 0, 1);
					break;
				
				case 3:
					func_307(&Var1, 4294967197, 4294967197, 50, 14, 8, 0, 15, 6, 3, 4294967197, 0, 0, 2);
					break;
				
				case 4:
					func_307(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[2], Global_1B416.f_936.f_21B.f_C8[2], 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 5:
					func_307(&Var1, 4294967197, 4294967197, 95, 33, 8, 0, 15, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 6:
					func_307(&Var1, 4294967197, 4294967197, 49, 13, 10, 4, 6, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 7:
					func_307(&Var1, 4294967197, 4294967197, 49, 13, 14, 4, 15, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 8:
					func_307(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 7, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_307(&Var1, 4294967197, 4294967197, 53, 17, 11, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_307(&Var1, 4294967197, 4294967197, 96, 81, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_307(&Var1, 4294967197, 4294967197, 51, 15, 33, 0, 8, 0, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_307(&Var1, 4294967197, 4294967197, 0, 93, 29, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_307(&Var1, 4294967197, 4294967197, 52, 16, 30, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_307(&Var1, 4294967197, 4294967197, 241, 92, 16, 0, 12, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_307(&Var1, 4294967197, 4294967197, 97, 34, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_307(&Var1, 4294967197, 4294967197, 44, 9, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_307(&Var1, 4294967197, 4294967197, 45, 10, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_307(&Var1, 4294967197, 4294967197, 46, 11, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 19:
					func_307(&Var1, 4294967197, 4294967197, 47, 12, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_307(&Var1, 4294967197, 4294967197, 161, 53, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_307(&Var1, 4294967197, 4294967197, 0, 44, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_307(&Var1, 4294967197, 4294967197, 98, 0, 28, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_307(&Var1, 4294967197, 4294967197, 27, 0, 31, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_307(&Var1, 4294967197, 4294967197, 190, 71, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_307(&Var1, 4294967197, 4294967197, 191, 72, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_307(&Var1, 4294967197, 4294967197, 192, 73, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_307(&Var1, 4294967197, 4294967197, 193, 74, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_307(&Var1, 4294967197, 4294967197, 194, 75, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_307(&Var1, 4294967197, 4294967197, 195, 76, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_307(&Var1, 4294967197, 4294967197, 196, 77, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_307(&Var1, 4294967197, 4294967197, 197, 78, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 32:
					func_307(&Var1, 4294967197, 4294967197, 198, 79, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_307(&Var1, 4294967197, 4294967197, 199, 80, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_307(&Var1, 4294967197, 4294967197, 200, 62, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 35:
					func_307(&Var1, 4294967197, 4294967197, 201, 63, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_307(&Var1, 4294967197, 4294967197, 202, 64, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_307(&Var1, 4294967197, 4294967197, 203, 65, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_307(&Var1, 4294967197, 4294967197, 204, 66, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_307(&Var1, 4294967197, 4294967197, 205, 67, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_307(&Var1, 4294967197, 4294967197, 206, 68, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_307(&Var1, 4294967197, 4294967197, 2, 43, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_307(&Var1, 4294967197, 4294967197, 55, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_307(&Var1, 4294967197, 4294967197, 0, 52, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_307(&Var1, 4294967197, 4294967197, 70, 30, 32, 6, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_307(&Var1, 4294967197, 4294967197, 19, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 46:
					func_307(&Var1, 4294967197, 4294967197, 0, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_307(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("mp_m_freemode_01"):
			...
			{
				case 0:
					func_307(&Var1, 4294967197, 4294967197, 0, 0, 10, 4294967197, 0, 4294967197, 4294967197, 0, 0, 0, 31);
					break;
				
				case 1:
					func_307(&Var1, 4294967197, 4294967197, 1, 127, 38, 4294967197, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_307(&Var1, 4294967197, 4294967197, 0, 248, 45, 4294967197, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_307(&Var1, 4294967197, 4294967197, 4, 31, 25, 4294967197, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_307(&Var1, 4294967197, 4294967197, 1, 66, 10, 4294967197, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_307(&Var1, 4294967197, 4294967197, 1, 93, 141, 4294967197, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_307(&Var1, 4294967197, 4294967197, 1, 116, 113, 4294967197, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_307(&Var1, 4294967197, 4294967197, 1, 61, 136, 4294967197, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_307(&Var1, 4294967197, 4294967197, 0, 112, 10, 4294967197, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_307(&Var1, 4294967197, 4294967197, 4, 131, 24, 4294967197, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_307(&Var1, 4294967197, 4294967197, 1, 209, 188, 4294967197, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_307(&Var1, 4294967197, 4294967197, 1, 209, 160, 4294967197, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_307(&Var1, 4294967197, 4294967197, 1, 162, 174, 4294967197, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_307(&Var1, 4294967197, 4294967197, 1, 4, 240, 4294967197, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_307(&Var1, 4294967197, 4294967197, 1, 128, 232, 4294967197, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_307(&Var1, 4294967197, 4294967197, 1, 66, 65, 4294967197, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_307(&Var1, 4294967197, 4294967197, 1, 65, 172, 4294967197, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_307(&Var1, 4294967197, 4294967197, 1, 64, 10, 4294967197, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_307(&Var1, 4294967197, 4294967197, 5, 98, 80, 4294967197, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_307(&Var1, 4294967197, 4294967197, 5, 192, 96, 4294967197, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_307(&Var1, 4294967197, 4294967197, 1, 124, 96, 4294967197, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_307(&Var1, 4294967197, 4294967197, 0, 80, 114, 4294967197, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_307(&Var1, 4294967197, 4294967197, 6, 43, 112, 4294967197, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_307(&Var1, 4294967197, 4294967197, 1, 116, 144, 4294967197, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_307(&Var1, 4294967197, 4294967197, 1, 63, 38, 4294967197, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_307(&Var1, 4294967197, 4294967197, 2, 64, 10, 4294967197, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 0:
					func_307(&Var1, 4294967197, 4294967197, 0, 0, 0, 4294967197, 0, 4294967197, 4294967197, 0, 4294967197, 0, 31);
					break;
				
				case 1:
					func_307(&Var1, 4294967197, 4294967197, 5, 136, 241, 4294967197, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_307(&Var1, 4294967197, 4294967197, 4, 1, 96, 4294967197, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_307(&Var1, 4294967197, 4294967197, 1, 73, 241, 4294967197, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_307(&Var1, 4294967197, 4294967197, 2, 88, 217, 4294967197, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_307(&Var1, 4294967197, 4294967197, 9, 7, 98, 4294967197, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_307(&Var1, 4294967197, 4294967197, 1, 140, 241, 4294967197, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_307(&Var1, 4294967197, 4294967197, 4, 139, 112, 4294967197, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_307(&Var1, 4294967197, 4294967197, 1, 193, 48, 4294967197, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_307(&Var1, 4294967197, 4294967197, 5, 114, 97, 4294967197, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_307(&Var1, 4294967197, 4294967197, 9, 134, 239, 4294967197, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_307(&Var1, 4294967197, 4294967197, 5, 152, 96, 4294967197, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_307(&Var1, 4294967197, 4294967197, 6, 129, 1, 4294967197, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_307(&Var1, 4294967197, 4294967197, 5, 0, 0, 4294967197, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_307(&Var1, 4294967197, 4294967197, 4, 159, 96, 4294967197, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_307(&Var1, 4294967197, 4294967197, 9, 232, 213, 4294967197, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_307(&Var1, 4294967197, 4294967197, 2, 8, 98, 4294967197, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_307(&Var1, 4294967197, 4294967197, 5, 150, 235, 4294967197, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_307(&Var1, 4294967197, 4294967197, 6, 96, 97, 4294967197, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_307(&Var1, 4294967197, 4294967197, 4, 48, 64, 4294967197, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_307(&Var1, 4294967197, 4294967197, 4, 62, 64, 4294967197, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_307(&Var1, 4294967197, 4294967197, 4, 49, 65, 4294967197, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_307(&Var1, 4294967197, 4294967197, 3, 20, 16, 4294967197, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_307(&Var1, 4294967197, 4294967197, 0, 73, 178, 4294967197, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_307(&Var1, 4294967197, 4294967197, 5, 135, 53, 4294967197, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_307(&Var1, 4294967197, 4294967197, 7, 233, 176, 4294967197, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_307(&Var1, 4294967197, 4294967197, 4, 34, 179, 4294967197, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_307(&Var1, 4294967197, 4294967197, 15, 131, 93, 4294967197, 32, 0, 0, 0, 0, 250, 23);
					break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_294(iParam0, iParam2, 14, 3), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_294(iParam0, iParam2, 1, 3), 2452280943, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_294(iParam0, iParam2, 14, 4), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_294(iParam0, iParam2, 1, 4), 2452280943, 0));
					}
					break;
			}
			break;
...
void func_314(int iParam0)
{
	...
	{
		func_320(iParam0, Global_12A92[1 /*14*/].f_5, Global_12A92[1 /*14*/].f_2, 2, Global_12A92[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 1) && unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_315(Global_280004, 2, 1, 1, 4294967295);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_324(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 155, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_325(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_329(Global_280004, 1, 1, 1, 4294967295))
			{
				unk_0x0674E58A79778E99(&(uParam0->f_6), 2);
			}
			if (!func_329(Global_280004, 2, 1, 1, 4294967295))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_318(func_328(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 1);
			}
			iVar0 = func_318(func_327(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_318(iVar1, Global_12A8F, 0);
				if (!unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
				{
					unk_0x5D96D8530B3D0904(&(uParam0->f_6), 4);
				}
...
void func_331(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_325(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_325(&(Global_12A92[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_325(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_12B3B)
		{
			...
			Global_280005 = Var11;
			func_325(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, 4294967295, 0, 4294967295, func_282(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_332(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 9, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_333(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 48, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_334(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 1, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_336(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 6, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_337(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 33, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_338(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 17, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_339(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 18, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_340(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 7, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_341(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 84, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_342(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 104, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_343(int iParam0)
{
	...
	{
		func_331(3, iParam0, 242, 4294967295);
	}
}
...
void func_349(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 175, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_351(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 47, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_352(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 63, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_354(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 5, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_355(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 53, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_356(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 12, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_357(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 77, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_359(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 134, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_360(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 117, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_361(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_331(3, iParam0, 318, 4294967295);
	}
}
...
void func_365(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 21, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_366(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 10, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_368(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 113, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_371(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 45, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_375(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 20, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_376(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 24, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_377(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 14, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_378(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_331(iVar7, iParam0, 99, 4294967295);
			return;
			break;
	}
	func_325(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_380(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_331(3, iParam0, 181, 4294967295);
	}
}
...
int func_386(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = unk_0x134B62B726CEC8E6(iParam0);
	Global_12A92[1 /*14*/] = { func_322(iVar0, iParam1, iParam2, 4294967295) };
	if (!unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != 4294967197 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_386(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_386(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_12A92[2 /*14*/] = { func_322(iVar0, 14, iVar4, 4294967295) };
									if (Global_12A92[2 /*14*/].f_C == iVar3)
									{
										if (func_386(iParam0, 14, iVar4))
										{
											if (!func_278(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_12A92[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_12A92[2 /*14*/] = { func_322(iVar0, iVar2, iVar1, 4294967295) };
						if (!func_278(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_12A92[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_12A92[1 /*14*/].f_3 == unk_0x36C584991B4C183F(iParam0, func_282(iParam1)) && Global_12A92[1 /*14*/].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_282(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_390()
{
	...
	if (unk_0xC844350D5D58C99A(iVar0))
	{
		if (unk_0xDF1306B443CD3D15(iVar0, 0))
		{
			func_391(iVar0, unk_0x68F4C0EC296D3901(iVar0, true), unk_0xD9522BA9E27E1349(iVar0), 24, 0);
		}
	}
}
...
{
	if ((((((((((!unk_0xC844350D5D58C99A(iParam0) || !unk_0xDF1306B443CD3D15(iParam0, 0)) || func_409(iParam0, 0, 0)) || func_409(iParam0, 1, 0)) || func_409(iParam0, 2, 0)) || func_432(iParam0) != 145) || func_408(iParam0)) || func_407(iParam0)) || func_406(iParam0)) || func_405(iParam0)) || !func_395(unk_0x134B62B726CEC8E6(iParam0)))
	{
		if (func_407(iParam0))
		{
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_418(unk_0xEAE0D21A50E6C7F4(iParam0, 31), 4294967295, 1)) + 2011;
}
...
int func_423(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_180(Global_1B416.f_7FE8.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_1B416.f_936.f_21B.f_E04[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_1B416.f_936.f_21B.f_E04[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_426(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_423(&(Global_126B1.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_431(iParam0);
			func_430(uParam1, &(Global_1B416.f_7FE8.f_45[Global_126B1.f_22B[0 /*21*/].f_E /*78*/]));
...
void func_433(int iParam0, var uParam1)
{
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4EB64970EC291A00(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_436(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
...
void func_443()
{
	...
	if (!func_6(iLocal_198))
	{
		...
		if (func_6(Local_202))
		{
			if (!func_209(unk_0x16F2683693E537C9(), Local_202, 500f, 1))
			{
				iVar0++;
			}
		}
		...
		{
			if (!func_209(unk_0x16F2683693E537C9(), iLocal_199, 500f, 1))
			{
				iVar0++;
			}
		}
	...
	{
		if (!func_209(unk_0x16F2683693E537C9(), iLocal_198, 500f, 1))
		{
			iVar0++;
		}
		if (func_6(iLocal_199))
...
void func_450(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_452() == 0)
		{
			iVar0 = func_318(func_451(iParam0), 4294967295, 0);
			unk_0x0674E58A79778E99(&iVar0, iParam1);
			func_316(func_451(iParam0), iVar0, 4294967295, 1, 0);
		}
	}
	else
	{
...
int func_457(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_452() == 0)
		{
			return unk_0xEAE0D21A50E6C7F4(func_318(func_451(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
void func_473()
{
	...
	func_475();
	func_474();
	unk_0x2952D66A502EA873(iLocal_206, 0);
	func_262(0);

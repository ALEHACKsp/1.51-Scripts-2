...
void __EntryFunction__()
{
	...
	bLocal_273 = true;
	cLocal_293 = "BSPRAAU";
	iLocal_465 = 4294967295;
	iLocal_467 = 1;
	iLocal_470 = 4294967295;
	...
	func_395();
	func_381();
	iLocal_264 = unk_0x7D6CA5F52B3748BF(402.9022f, -1633.604f, 25.0472f, 315.6288f, -1558.814f, 38.7931f, 0, 1, 1, 1);
	func_380(27, 0);
	if (func_379())
	{
	...
	while (true)
	{
		unk_0x1A6DFFFEEC27BF4F("M_STS", 0);
	...
	switch (iLocal_41)
	{
		...
		case 1:
			if (func_14())
			{
				...
				else if (func_12(&uLocal_150, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)))
				{
					func_10(408.3364f, -1567.429f, 28.2723f, 128.2512f);
					func_8(471.5946f, -1412.737f, 28.1562f, 68.5531f);
				}
				unk_0x536F1BE96C726C4B(372.9868f, -1623.531f, 28.2928f, 100f, 1, 0, 0, false);
				func_2();
				func_396();
			}
			break;
...
void func_15(int iParam0)
{
	...
	if (Global_1B416.f_2378 || func_30(0))
	{
		iVar0 = func_29();
		if (!func_16(iVar0))
		{
...
void func_23()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_27(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_25(iVar0) && (!func_24(14) || Global_1AFFD))
			{
...
void func_35()
{
	...
	switch (iLocal_41)
	{
		...
		case 1:
			...
			if (iLocal_45 == 2)
			{
				if (func_12(&uLocal_150, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)))
				{
			...
			{
				unk_0x8B4C4CA774181102(5f, 6f, 4);
				func_55();
				func_50();
			}
			break;
		...
		case 3:
			if (func_7(Local_290))
			{
				if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_290, 0))
				{
					unk_0xF821F915BC24D246(unk_0x16F2683693E537C9(), Local_290, 4294967295);
				}
				else
				{
...
void func_39(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_44(unk_0xD803B885F5E47A62())) && !func_41(unk_0xD803B885F5E47A62(), 0)) && !func_40()) && !bParam4) && !bParam5)
			{
...
void func_51(bool bParam0, int iParam1)
{
	...
	if (bParam0)
	{
		if ((func_30(0) && Global_12C44.f_1 == 1) && func_52(Global_12C44))
		{
		}
		else
		{
...
int func_58(int iParam0, vector3 vParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, float fParam10)
{
	...
	else
	{
		...
		if (!*iParam6)
		{
			...
			{
				unk_0x2F23E8033F1ADDD9(func_61(func_69(), 0));
			}
	...
	switch (iParam0)
	{
		case 0:
			...
			else if (func_82(1, vLocal_265, 0))
			{
				...
				{
					iLocal_271 = unk_0x544B74C043CE9948(400.8628f, -1609.739f, 28.29278f, 7.5f, 2f, 9.5f, func_81(229.3746f), 0, 7);
					if (unk_0xC0E5DA578D275A41(Local_290) != 0)
					{
		...
		case 1:
			if (bParam1)
			{
				if (((func_82(2, Local_290.f_1, Local_290.f_4) && func_82(4, vLocal_265, 0)) && func_82(3, vLocal_265, 0)) && func_82(5, vLocal_265, 0))
				{
					...
					func_72();
					unk_0x745CE398A4B0A3C6(369.0115f, -1609.116f, 28.2928f, 5f, 0);
					unk_0x745CE398A4B0A3C6(Local_289[0 /*22*/].f_1, 5f, 0);
					func_77();
					func_75();
					bLocal_28 = false;
					func_36(1, 1, 1);
...
void func_72()
{
	...
	while (iVar0 <= 2)
	{
		Local_289[iVar0 /*22*/].f_12 = 0;
		Local_289[iVar0 /*22*/].f_13 = 0;
		Local_289[iVar0 /*22*/].f_14 = 0;
		iLocal_459[iVar0] = 0;
		iVar0++;
	}
	iLocal_461 = 0;
	...
	iLocal_467 = 1;
	func_380(27, 0);
	unk_0x1BA7FCEAFCE8D46E(Global_9E6A[13 /*31*/], 4, true, false);
	iLocal_468 = 0;
}
...
void func_73()
{
	...
	while (iVar1 <= 2)
	{
		...
		Local_289[iVar1 /*22*/].f_11 = 0;
		Local_289[iVar1 /*22*/].f_10 = 0;
		iVar1++;
	}
	iLocal_277 = 0;
	iLocal_278 = 0;
...
void func_75()
{
	...
	func_76(&uLocal_294, iVar0, unk_0x16F2683693E537C9(), sVar1, 0, 1);
...
void func_77()
{
	...
	while (iVar0 <= 2)
	{
		unk_0x11AD11297DC58CC7(Local_289[iVar0 /*22*/], false);
		if (!func_78(Local_289[iVar0 /*22*/], 3196503398))
		{
			switch (iVar0)
			{
				case 0:
				case 1:
					unk_0x0B7C52F2BC1DC8EB(Local_289[iVar0 /*22*/], "WORLD_HUMAN_HANG_OUT_STREET", Local_289[iVar0 /*22*/].f_1, Local_289[iVar0 /*22*/].f_4, 0, 0, 1);
					break;
				
				case 2:
					unk_0x8D4C354BB8991817(Local_289[iVar0 /*22*/], 1, 1);
					break;
				}
		}
		unk_0x262EF6C6306BEA6C(Local_289[iVar0 /*22*/], joaat("weapon_pistol"), 4294967295, false, false);
		unk_0x6DF7BF67E86AAE86(Local_289[iVar0 /*22*/], iLocal_292);
		Local_289[iVar0 /*22*/].f_12 = 1;
		Local_289[iVar0 /*22*/].f_15 = 0;
		iVar0++;
	}
}
...
int func_82(int iParam0, vector3 vParam1, float fParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			unk_0xD7992BEF7A9D109E(sLocal_258, 0);
			unk_0xD7992BEF7A9D109E(cLocal_293, 6);
		...
		case 2:
			if (func_7(Global_17409[0]))
			{
				unk_0x73270B3C9CC833FD(Global_17409[0], true, 1);
				Local_290 = Global_17409[0];
				if (func_7(Local_290))
				{
					...
					unk_0x2E81FA494A883541(Local_290, 2, false);
					unk_0x2E81FA494A883541(Local_290, 3, false);
					func_89(Local_290, 0);
					unk_0x44A200C9B6E1CEA6(Local_290, true);
					unk_0x71EDC33E5A423750(Local_290, 1);
					return 1;
				}
			}
		...
		case 3:
			...
			while (iVar0 <= 2)
			{
				...
				{
					if (!unk_0x28072FDD60CE3A6E(Global_17409.f_9[iVar0], 1))
					{
						unk_0x73270B3C9CC833FD(Global_17409.f_9[iVar0], true, 1);
						Local_289[iVar0 /*22*/] = Global_17409.f_9[iVar0];
						if (func_377(Local_289[iVar0 /*22*/]))
						{
							unk_0x26A6B1686E33113F(Local_289[iVar0 /*22*/], 2);
							unk_0x33CE5A9E32EA10B2(Local_289[iVar0 /*22*/], true);
							func_87(iVar0);
							iVar1++;
						}
					}
		...
		case 4:
			...
			while (iVar3 <= 3)
			{
				...
				{
					unk_0x73270B3C9CC833FD(Global_17409[iVar3], true, 1);
		...
		case 5:
			if (func_83(&iLocal_262, joaat("prop_box_guncase_03a"), 354.6938f, -1634.783f, 22.7849f, 299.1508f, 1))
			{
				if (func_7(Local_290))
				{
					unk_0x9F528B1B53FBC5D9(iLocal_262, Local_290, 0, 0f, -1.85f, 0.05f, unk_0x835730A2D89F6093(Local_290, 2), 0, 0, 0, 0, 2, 1);
...
void func_87(int iParam0)
{
	if (func_377(Local_289[iParam0 /*22*/]))
	{
		if (iParam0 == 0)
		{
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 0, 0, 1, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 3, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 8, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 9, 1, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 10, 0, 0, 0);
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 0, 1, 1, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 3, 0, 1, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 4, 0, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 8, 1, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 9, 2, 0, 0);
			unk_0x64F9F278AB9DCA2C(Local_289[iParam0 /*22*/], 10, 0, 1, 0);
		}
	}
}
...
void func_91(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, vector3 vParam5, int iParam6, bool bParam7, float fParam8)
{
	if (func_7(*iParam0))
	{
		switch (*iParam2)
		{
			...
			case 2:
			case 1:
				if ((!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), *iParam0, 0) && !func_97(*iParam0)) && !func_96(*iParam0))
				{
					func_34(iParam4);
...
int func_96(int iParam0)
{
	...
	if ((func_377(unk_0x16F2683693E537C9()) && unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0)) && func_7(iParam0))
	{
	...
	while (iVar0 < 3)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(iVar1))
		{
			switch (iLocal_44[iVar0])
			{
				...
				case 1:
					if (func_109(iVar0, iVar1) && unk_0x9C77D2D0559097F0(iVar1, 1))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
				...
				case 2:
					if (func_107(iVar0, iVar1) && unk_0x9C77D2D0559097F0(iVar1, 1))
					{
						iLocal_44[iVar0] = 0;
						func_108(iVar1);
					}
...
int func_107(int iParam0, int iParam1)
{
	...
	{
		case 0:
			unk_0x132B85BCE016BCA0(iParam1, unk_0x6937EA2286828455(iParam1, 0), vLocal_266, 4, 20f, 786469, 3.5f, 5f, 1);
			iLocal_43[iParam0] = 3;
			break;
...
int func_109(int iParam0, int iParam1)
{
	...
	{
		case 0:
			if (!unk_0xF65264B66E133BD8(Local_254[iLocal_470 /*4*/], 1.5f, 0, 0, 1, 0, 0, iParam1, 0))
			{
				...
				unk_0x96167B03C5A77156(iParam1, Local_254[iLocal_470 /*4*/], fVar0, 20000, 0.25f, 0, Local_254[iLocal_470 /*4*/].f_3);
				iLocal_43[iParam0] = 1;
			}
			break;
		...
		case 1:
			...
			{
				unk_0x6EDD55375054780D(iParam1, 0);
				iLocal_43[iParam0] = 2;
			}
			break;
		
		case 2:
			if (!func_78(iParam1, 3087203786))
			{
				iLocal_43[iParam0] = 4;
			}
			break;
...
int func_111(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if ((unk_0xC844350D5D58C99A(Local_290) && unk_0xDF1306B443CD3D15(Local_290, 0)) && !unk_0x5A91F08DF773C39D(Local_290, vLocal_266, 2f, 2f, 2f, false, true, 0))
		{
			if ((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_290, 0)) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0)
			{
				if (unk_0xC42A92762C58E1B9(iParam1, Local_290, 0) && unk_0xA30B8362589C124A(Local_290, 4294967295, 0) == iParam1)
				{
					iLocal_44[iParam0] = 2;
					return 1;
				}
...
int func_113(int iParam0, int iParam1)
{
	if (!func_112())
	{
		if (unk_0x3D1053F9EB43B7AD(iParam1, 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.63f, 0, true, 0) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.38f, 0, true, 0))
		{
			iLocal_470 = 0;
			iLocal_44[iParam0] = 1;
			return 1;
		}
		else if (unk_0x3D1053F9EB43B7AD(iParam1, 345.1542f, -1604.173f, 28.29278f, 360.8858f, -1617.23f, 31.29278f, 3.63f, 0, true, 0) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 344.9844f, -1604.011f, 28.29278f, 339.7212f, -1599.484f, 31.29056f, 3.38f, 0, true, 0))
		{
			iLocal_470 = 1;
			iLocal_44[iParam0] = 1;
			return 1;
...
void func_118()
{
	...
	if (!bLocal_28)
	{
		...
		{
			unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 38);
			unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 30);
			bLocal_274 = false;
		}
		if (iLocal_40 == 2)
		{
...
void func_119()
{
	...
	iVar0 = 2;
	if (Local_289[iVar0 /*22*/].f_12 != 3 && Local_289[iVar0 /*22*/].f_14 != 7)
	{
		func_196(Local_289[iVar0 /*22*/], &(Local_289[iVar0 /*22*/].f_6), 4294967295, 0, 0, 0, 3212836864, 0, 4294967295, 4294967295, 1);
	}
	else
	{
	...
	else
	{
		...
		{
			if (unk_0xB87D13D0C064E9D1(Local_289[iVar0 /*22*/], unk_0x16F2683693E537C9(), 1))
			{
				...
				if (((unk_0x52AE17073D025311(unk_0x16F2683693E537C9()) || unk_0x9E834FAC6CCB49FB(Local_289[iVar0 /*22*/])) || unk_0xC021B60D52071374(Local_289[iVar0 /*22*/])) || unk_0xFEAA79CCC9861C2B(Local_289[iVar0 /*22*/]))
				{
					if (!bLocal_274)
					{
						unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 41);
						unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 33);
...
void func_120(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_14)
	{
		case 1:
			...
			{
				if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(1000, 1500)
				{
					if (!func_78(Local_289[iParam0 /*22*/], 3419293077))
					{
						unk_0x2ECF845953E95D1B(Local_289[iParam0 /*22*/]);
						unk_0xF96A174EE26D7588(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 0);
					}
		...
		case 2:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(5000, 6000)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 2))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					Local_289[iParam0 /*22*/].f_11 = 1;
				}
			}
			break;
		
		case 3:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(2500, 3000)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 8))
				{
					Local_289[iParam0 /*22*/].f_11 = 1;
				}
				else
		...
		case 4:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(2500, 3000)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 8))
				{
					...
					else if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 9) && !bLocal_272)
					{
						func_127(iParam0);
						func_125();
						return;
		...
		case 6:
			...
			{
				if (!unk_0x15D0A3E61766C539(Local_289[iParam0 /*22*/], 0) && !unk_0x46BC6F5F089F3AFF(Local_289[iParam0 /*22*/]))
				{
					Local_289[iParam0 /*22*/].f_E = unk_0x1C0640BA9A7327B3();
					func_127(iParam0);
				}
		...
		case 5:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(1000, 3000)
			{
				func_125();
				return;
			}
		...
		case 7:
			if ((unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > 350)
			{
				...
				{
					if (iLocal_465 != 4294967295)
					{
						if ((unk_0x1C0640BA9A7327B3() - iLocal_465) > 12000)
						{
							func_123(4294967295);
						}
					...
					if ((func_78(Local_289[iParam0 /*22*/], 2166240316) || func_78(Local_289[iParam0 /*22*/], 3312640106)) && unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) < 2)
					{
			...
			if (!iLocal_463)
			{
				if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 1) && unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 14))
				{
					if (iParam0 == 0)
					{
						sVar3 = "PRA_COPSHT1";
...
void func_123(int iParam0)
{
	...
	{
		unk_0x11AD11297DC58CC7(Local_289[0 /*22*/], false);
	}
	if (func_377(Local_289[1 /*22*/]))
	{
		unk_0x11AD11297DC58CC7(Local_289[1 /*22*/], false);
	}
	if (func_377(Local_289[2 /*22*/]))
	{
		unk_0x11AD11297DC58CC7(Local_289[2 /*22*/], false);
	}
	if (iParam0 != 4294967295)
	{
		unk_0x67F91979413C5D76(unk_0xD803B885F5E47A62(), iParam0, 0);
		unk_0x56EA5D248F36A081(unk_0xD803B885F5E47A62(), 0);
	}
}
...
void func_125()
{
	...
	while (iVar0 <= 2)
	{
		if (Local_289[iVar0 /*22*/].f_14 != 6 && Local_289[iVar0 /*22*/].f_14 != 7)
		{
			func_195(&(Local_289[iVar0 /*22*/].f_6));
			Local_289[iVar0 /*22*/].f_E = unk_0x1C0640BA9A7327B3();
			Local_289[iVar0 /*22*/].f_12 = 3;
			Local_289[iVar0 /*22*/].f_14 = 6;
		}
		iVar0++;
	}
}
...
{
	if (Local_289[iParam0 /*22*/].f_14 != 7)
	{
		if (func_377(Local_289[iParam0 /*22*/]))
		{
			if (func_78(Local_289[iParam0 /*22*/], 242628503) || unk_0xFBF1556B75C783FC(Local_289[iParam0 /*22*/]))
			{
				unk_0xA3BF0AA5A2608191(Local_289[iParam0 /*22*/]);
			}
			else if (func_78(Local_289[iParam0 /*22*/], 3196503398) || func_78(Local_289[iParam0 /*22*/], 993674639))
			{
				unk_0x2ECF845953E95D1B(Local_289[iParam0 /*22*/]);
			}
			unk_0xE733200EEF894A35(Local_289[iParam0 /*22*/], 1);
			unk_0xF27A0DCBF07DE99D(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9());
			unk_0x262EF6C6306BEA6C(Local_289[iParam0 /*22*/], joaat("weapon_pistol"), 4294967295, false, true);
			unk_0xE910A68AA670B4AA(Local_289[iParam0 /*22*/]);
			unk_0xB61FC7262CB2E7A1(unk_0xD803B885F5E47A62());
			func_128(iParam0);
			Local_289[iParam0 /*22*/].f_12 = 3;
			Local_289[iParam0 /*22*/].f_14 = 7;
		}
	}
}
...
void func_128(int iParam0)
{
	...
	if ((iLocal_40 != 2 && !iLocal_464) && !unk_0x437347B10A200C4B(Local_289[iParam0 /*22*/], 0))
	{
		if (func_133(iParam0) && func_131(Local_289[iParam0 /*22*/], 30f))
		{
			...
			if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 3))
			{
				iLocal_464 = 1;
			}
			else if (!func_124(iParam0, 15) || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, true, 0))
			{
				func_129();
				iLocal_461 = 0;
				if (iParam0 == 2)
				...
				{
					unk_0xEB0A515D699A7E90(Local_289[iParam0 /*22*/], "ARREST_PLAYER", sVar0, "SPEECH_PARAMS_FORCE", 0);
				}
				iLocal_464 = 1;
			}
		}
...
int func_131(int iParam0, float fParam1)
{
	...
	{
		if (func_132(unk_0x16F2683693E537C9(), iParam0, 0) <= fParam1)
		{
			return 1;
		}
	}
...
{
	return Local_289[iParam0 /*22*/].f_12 > 1;
}
...
void func_134(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_12 != 1 && !func_78(Local_289[iParam0 /*22*/], 242628503))
	{
		unk_0xA3BF0AA5A2608191(Local_289[iParam0 /*22*/]);
		...
		if (iParam0 == 2)
		{
			...
			{
				unk_0x96167B03C5A77156(0, Local_289[iParam0 /*22*/].f_1, 1f, 120000, 0.25f, 0, Local_289[iParam0 /*22*/].f_4);
			}
			else
			{
				unk_0xE655C47E46F9A7E4(0, Local_289[iParam0 /*22*/].f_4, 0);
			}
			if (iLocal_459[2] && unk_0xEA6BC48857E0AC4C("sResumeRoot"))
			{
				unk_0x509B8296EBA9B408(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
			}
			else
			{
				unk_0x8D4C354BB8991817(0, 1, 1);
			}
			unk_0x75ABDC5F81978924(iVar0);
			unk_0x78ADC381772E3D54(Local_289[iParam0 /*22*/], iVar0);
		...
		func_135();
		unk_0x11AD11297DC58CC7(Local_289[iParam0 /*22*/], false);
		Local_289[iParam0 /*22*/].f_12 = 1;
		Local_289[iParam0 /*22*/].f_15 = 0;
		Local_289[iParam0 /*22*/].f_13 = 0;
		Local_289[iParam0 /*22*/].f_14 = 0;
	}
}

void func_135()
{
	if (func_12(&uLocal_46, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)))
	{
		if (!func_103())
		{
			if ((!unk_0x7F8A39872A07D2CE(&cLocal_471, "NONE") && !unk_0x7F8A39872A07D2CE(&cLocal_475, "NONE")) && !func_66("PR_TAKBACK", 0, 0))
			{
...
{
	if (Local_289[func_150(iParam0) /*22*/].f_12 > 1 && Local_289[func_150(iParam0) /*22*/].f_14 != 1)
	{
		return 1;
	}
	return 0;
...
void func_151(int iParam0)
{
	switch (Local_289[iParam0 /*22*/].f_15)
	{
		case 0:
			...
			{
				if (iLocal_459[2] && !unk_0x82FE7F11C00330B0(Local_289[iParam0 /*22*/]))
				{
					unk_0xA3BF0AA5A2608191(Local_289[iParam0 /*22*/]);
					unk_0x509B8296EBA9B408(Local_289[iParam0 /*22*/], "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				}
			}
			break;
...
void func_152(int iParam0)
{
	...
	if (!func_173(iParam0))
	{
		if (func_154(Local_289[iParam0 /*22*/], 1, 50f, 140f, 0, 1, 1, 1) || unk_0x681F21BF9F7B449B(4294967295, unk_0x68F4C0EC296D3901(Local_289[iParam0 /*22*/], true), 100f))
		{
			...
			else if (!bLocal_274)
			{
				unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 41);
				unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 33);
				unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 12);
				unk_0x67F91979413C5D76(unk_0xD803B885F5E47A62(), 0, 0);
				unk_0x56EA5D248F36A081(unk_0xD803B885F5E47A62(), 0);
			}
		}
	}
	else if (func_153(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 5f, 1))
	{
		if (!bLocal_274)
		{
			unk_0x0B54B0F65E7FEED7(unk_0xD803B885F5E47A62(), 41);
...
{
	return func_157(iParam0, unk_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}
...
int func_161(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_163(unk_0x68F4C0EC296D3901(iParam1, true) - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	{
		vVar1 = { func_163(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_171(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_163(vParam1 - unk_0x68F4C0EC296D3901(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(Local_289[iParam0 /*22*/], 0f, -2f, 0f), 2f, 3f, 2f, false, true, 0) && !unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
	{
		return 1;
	}
	return 0;
...
void func_174(int iParam0)
{
	...
	func_187(iParam0);
	func_184(iParam0);
	if (Local_289[iParam0 /*22*/].f_14 != 7 || Local_289[iParam0 /*22*/].f_14 != 6)
	{
...
void func_175(int iParam0)
{
	...
	if ((((!func_149(iParam0) && Local_289[iParam0 /*22*/].f_14 != 7) && Local_289[iParam0 /*22*/].f_14 != 6) && !bLocal_274) && Local_289[iParam0 /*22*/].f_11)
	{
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
void func_177(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 2)
		{
			if (Local_289[func_150(iParam0) /*22*/].f_14 != 2)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPGUNW1";
		...
		{
			if (Local_289[func_150(iParam0) /*22*/].f_14 != 3 || (unk_0x1C0640BA9A7327B3() - iLocal_276) > 7500)
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 9))
				{
					if (iParam0 == 0)
					{
						sVar0 = "PRA_CWCAR1";
		...
		{
			if (Local_289[func_150(iParam0) /*22*/].f_14 != 4 || (unk_0x1C0640BA9A7327B3() - iLocal_276) > 7500)
			{
				if (!bLocal_273)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_289[func_150(iParam0) /*22*/].f_14 != 5)
			{
				if (iParam0 == 0)
				{
					sVar1 = "S_M_Y_COP_01_WHITE_MINI_03";
					unk_0xEB0A515D699A7E90(Local_289[iParam0 /*22*/], "CHALLENGE_THREATEN", sVar1, "SPEECH_PARAMS_FORCE", 0);
				}
				else if (iParam0 == 1)
				{
		...
		Local_289[func_150(iParam0) /*22*/].f_12 = 3;
		Local_289[func_150(iParam0) /*22*/].f_14 = 1;
		Local_289[iParam0 /*22*/].f_12 = 3;
...
void func_178(int iParam0, char* sParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 12))
		{
			return;
		}
	}
	...
	if ((!unk_0x7F8A39872A07D2CE(&Var0, sParam1) && !func_66("PR_TAKBACK", 0, 0)) && !func_66("PR_GOVEH", 0, 0))
	{
		func_179();
		func_121(&uLocal_294, cLocal_293, sParam1, 7, 0, 0);
		if (bParam2)
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_149(iParam0) || iParam2)
	{
		if (iParam1 == 1)
		{
			if (Local_289[iParam0 /*22*/].f_13 != 1 || (unk_0x1C0640BA9A7327B3() - iLocal_276) > 7500)
			{
				if (!bLocal_272)
				{
					if (iParam0 == 0)
		...
		{
			if (Local_289[iParam0 /*22*/].f_13 != 2 || (unk_0x1C0640BA9A7327B3() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPPLY1";
		...
		{
			if (Local_289[iParam0 /*22*/].f_13 != 4 || (unk_0x1C0640BA9A7327B3() - iLocal_276) > 7500)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPST1";
		...
		{
			if (Local_289[iParam0 /*22*/].f_13 != 6)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_COPGUNR1";
		...
		{
			if (Local_289[iParam0 /*22*/].f_13 != 5)
			{
				if (iParam0 == 0)
				{
					sVar1 = "S_M_Y_COP_01_WHITE_MINI_03";
				...
				unk_0xEB0A515D699A7E90(Local_289[iParam0 /*22*/], "BUMP", sVar1, "SPEECH_PARAMS_FORCE", 0);
				func_183(iParam0, iParam1, 0);
			}
		}
		else if (iParam1 == 7)
		{
			if (Local_289[iParam0 /*22*/].f_13 != 7)
			{
				if (iParam0 == 0)
				{
					sVar0 = "PRA_CHP1";
		...
		if (bLocal_272)
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 12))
			{
				unk_0x5D96D8530B3D0904(&(Local_289[iParam0 /*22*/].f_F), 12);
			}
		}
	}
}
...
void func_184(int iParam0)
{
	...
	if ((!func_149(iParam0) && Local_289[iParam0 /*22*/].f_14 != 6) && Local_289[iParam0 /*22*/].f_14 != 7)
	{
		...
		if (iParam0 == 0 || iParam0 == 1)
		{
			if (!iLocal_282)
			{
				if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 340.0758f, -1598.255f, 28.29322f, 346.4939f, -1603.684f, 38.29278f, 6.22f, 0, true, 0))
				{
					...
					else if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 11))
					{
						if ((((fVar0 > 16f && !Local_289[iParam0 /*22*/].f_10) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10)) && !unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, true, 0)) && unk_0x3D1053F9EB43B7AD(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0))
						{
							func_186(iParam0, 11);
							return;
						}
				...
				if (((unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0) && unk_0x3D1053F9EB43B7AD(Local_289[iParam0 /*22*/], Local_255[1 /*7*/], Local_255[1 /*7*/].f_3, Local_255[1 /*7*/].f_6, 0, true, 0)) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10)) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 11))
				{
					if ((fVar0 > 12f && !Local_289[iParam0 /*22*/].f_10) && !unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 344.4482f, -1603.473f, 28.29278f, 345.6222f, -1604.478f, 32.29278f, 3.46f, 0, true, 0))
					{
						func_186(iParam0, 11);
					}
				}
			}
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_281) > 4000)
			{
				iLocal_282 = 0;
			}
		}
		else if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, true, 0) && unk_0x3D1053F9EB43B7AD(Local_289[iParam0 /*22*/], Local_255[5 /*7*/], Local_255[5 /*7*/].f_3, Local_255[5 /*7*/].f_6, 0, true, 0))
		{
...
void func_187(int iParam0)
{
	...
	if ((Local_289[iParam0 /*22*/].f_13 != 5 && Local_289[iParam0 /*22*/].f_14 != 6) && Local_289[iParam0 /*22*/].f_14 != 7)
	{
		bVar0 = false;
		if (((func_153(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 5f, 1) && !unk_0x9E834FAC6CCB49FB(Local_289[iParam0 /*22*/])) && !unk_0xC021B60D52071374(Local_289[iParam0 /*22*/])) && !unk_0xFEAA79CCC9861C2B(Local_289[iParam0 /*22*/]))
		{
	...
	else if (!func_153(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 5.5f, 1))
	{
		func_185(iParam0, 5);
		func_185(iParam0, 3);
	}
...
int func_188(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_14 != 7)
	{
		if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), unk_0x68E4ADDDDCD7BDDE(Local_289[iParam0 /*22*/], 1f, -1f, 0f), 1f, 1f, 2f, false, true, 0))
		{
			return 1;
		}
	}
...
void func_190(int iParam0)
{
	...
	if (Local_289[iParam0 /*22*/].f_14 != 6 && Local_289[iParam0 /*22*/].f_14 != 7)
	{
		iVar0 = 0;
		while (iVar0 <= 5)
		{
			if (Local_289[iParam0 /*22*/].f_10)
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 12))
				{
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, true, 0))
					{
						iLocal_282 = 1;
						iLocal_281 = unk_0x1C0640BA9A7327B3();
						if (iVar0 == 4)
			...
			else if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_255[iVar0 /*7*/], Local_255[iVar0 /*7*/].f_3, Local_255[iVar0 /*7*/].f_6, 0, true, 0) || unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 12))
			{
				func_191(iParam0, iVar0);
			}
			iVar0++;
	...
	else if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_255[3 /*7*/], Local_255[3 /*7*/].f_3, Local_255[3 /*7*/].f_6, 0, true, 0))
	{
		func_193(iParam0, 3);
	}
	else
		...
		case 4:
			if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				...
				if (func_7(iVar0))
				{
					...
					if (!unk_0x3D1053F9EB43B7AD(iVar0, Local_255[4 /*7*/], Local_255[4 /*7*/].f_3, Local_255[4 /*7*/].f_6, 0, true, 0))
					{
						func_185(iParam0, 8);
						func_185(iParam0, 7);
					}
					else if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 7))
					{
						func_186(iParam0, 7);
					}
				}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		case 1:
			if ((!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 6) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 1)) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 9))
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10))
				{
					func_186(iParam0, 10);
				}
			}
		...
		case 2:
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 1))
			{
				if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 6))
				{
					func_186(iParam0, 6);
				}
			}
		...
		case 3:
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 14))
			{
				func_186(iParam0, 14);
			}
			break;
		...
		case 4:
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 8))
			{
				...
				{
					unk_0x5D96D8530B3D0904(&(Local_289[iParam0 /*22*/].f_F), 9);
					func_186(iParam0, 8);
				}
				else
				{
					unk_0x0674E58A79778E99(&(Local_289[iParam0 /*22*/].f_F), 9);
					func_186(iParam0, 8);
				}
			}
			break;
		...
		case 5:
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 4))
			{
				if ((!unk_0x9E834FAC6CCB49FB(Local_289[iParam0 /*22*/]) && !unk_0xC021B60D52071374(Local_289[iParam0 /*22*/])) && !unk_0xFEAA79CCC9861C2B(Local_289[iParam0 /*22*/]))
				{
					func_186(iParam0, 4);
...
{
	if (func_153(unk_0x16F2683693E537C9(), Local_289[iParam0 /*22*/], 30f, 1))
	{
		if (func_157(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 140f, 1, 250, 7))
		{
			Local_289[iParam0 /*22*/].f_10 = 1;
		}
		else
		{
			Local_289[iParam0 /*22*/].f_10 = 0;
		}
	}
}
	...
	while (iVar0 <= 1)
	{
		...
		else
		{
			if (unk_0xC844350D5D58C99A(Local_289[iVar0 /*22*/]))
			{
				...
				{
					if (unk_0xB87D13D0C064E9D1(Local_289[iVar0 /*22*/], unk_0x728870EB733D12A1(), 1))
					{
						unk_0xE910A68AA670B4AA(Local_289[iVar0 /*22*/]);
						func_125();
					}
...
void func_198(int iParam0)
{
	...
	switch (Local_289[iParam0 /*22*/].f_13)
	{
		case 1:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(2500, 3000)
			{
				if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 362.6359f, -1581.256f, 31.54774f, 358.1074f, -1586.615f, 34.29774f, 2f, 0, true, 0))
				{
					func_127(iParam0);
					func_125();
					return;
				...
				{
					if ((unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 13) && (unk_0x1C0640BA9A7327B3() - iLocal_276) > 2500) && !iLocal_466)
					{
						if (iParam0 == 0)
						{
							sVar0 = "PRA_COPST1";
						...
						func_121(&uLocal_294, cLocal_293, sVar0, 7, 0, 0);
						unk_0x0674E58A79778E99(&(Local_289[iParam0 /*22*/].f_F), 13);
						unk_0x0674E58A79778E99(&(Local_289[func_150(iParam0) /*22*/].f_F), 13);
						iLocal_466 = 1;
					}
					Local_289[iParam0 /*22*/].f_11 = 1;
				}
		...
		case 2:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(1500, 2000)
			{
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 5:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(2500, 3000)
			{
				if (!func_153(Local_289[iParam0 /*22*/], unk_0x16F2683693E537C9(), 1.5f, 1))
				{
					unk_0x0674E58A79778E99(&(Local_289[iParam0 /*22*/].f_F), 5);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
		...
		case 7:
			if (unk_0x1C0640BA9A7327B3() - Local_289[iParam0 /*22*/].f_E) > unk_0x09AC81E49EA267F7(2500, 3000)
			{
				...
				if (((fVar1 < 12f && !Local_289[iParam0 /*22*/].f_10) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10)) && !func_78(Local_289[iParam0 /*22*/], 3419293077))
				{
					unk_0x0674E58A79778E99(&(Local_289[iParam0 /*22*/].f_F), 11);
				}
				if (func_124(iParam0, 12))
				{
					func_134(iParam0);
...
void func_200(int iParam0)
{
	...
	if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 1))
	{
		if ((Local_289[iParam0 /*22*/].f_14 != 6 && Local_289[iParam0 /*22*/].f_14 != 7) && !bLocal_274)
		{
...
void func_201(int iParam0)
{
	...
	if (!iLocal_466)
	{
		...
		if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 13))
		{
			if (unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10))
			{
				if (Local_289[iParam0 /*22*/].f_10)
		...
		else if (func_133(iParam0))
		{
			if (bVar0)
			{
				if (!func_153(unk_0x16F2683693E537C9(), Local_289[iParam0 /*22*/], 10f, 1))
				{
					if (!unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 10) && !unk_0xEAE0D21A50E6C7F4(Local_289[iParam0 /*22*/].f_F, 6))
					{
						unk_0x0674E58A79778E99(&(Local_289[iParam0 /*22*/].f_F), 13);
					}
				}
...
void func_202(int iParam0)
{
	...
	bVar0 = unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 4);
	if (Local_289[iParam0 /*22*/].f_14 != 6 && Local_289[iParam0 /*22*/].f_14 != 7)
	{
		if (func_153(unk_0x16F2683693E537C9(), Local_289[iParam0 /*22*/], 12f, 1))
		{
			if (bVar0)
			{
				if (Local_289[iParam0 /*22*/].f_10)
...
void func_203(int iParam0)
{
	if (!func_173(iParam0))
	{
		...
		else if (func_154(Local_289[iParam0 /*22*/], 1, 70f, 150f, 0, 1, 0, 1) || unk_0x681F21BF9F7B449B(4294967295, unk_0x68F4C0EC296D3901(Local_289[iParam0 /*22*/], true), 100f))
		{
			func_125();
		}
...
int func_204(int iParam0)
{
	...
	if (func_377(Local_289[iParam0 /*22*/]))
	{
		...
		if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), Local_289[iParam0 /*22*/], fVar0, fVar0, fVar0, 0, 1, 0))
		{
...
void func_205()
{
	if ((Local_289[0 /*22*/].f_12 == 1 && Local_289[1 /*22*/].f_12 == 1) && Local_289[2 /*22*/].f_12 == 1)
	{
		if ((((func_377(Local_289[0 /*22*/]) && func_377(Local_289[1 /*22*/])) && func_12(&uLocal_46, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true))) && func_63(Local_289[0 /*22*/], Local_289[0 /*22*/].f_1, 3f)) && func_63(Local_289[1 /*22*/], Local_289[1 /*22*/].f_1, 3f))
		{
		...
		else if ((func_377(Local_289[2 /*22*/]) && func_12(&uLocal_98, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true))) && func_63(Local_289[2 /*22*/], Local_289[2 /*22*/].f_1, 3f))
		{
			if (!unk_0xEAE0D21A50E6C7F4(Local_289[2 /*22*/].f_F, 2) && !unk_0xEAE0D21A50E6C7F4(Local_289[2 /*22*/].f_F, 4))
			{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, bLocal_28))
			{
				...
				if (unk_0x76395FF5E8D5E643(Global_9E6A[13 /*31*/]))
				{
					unk_0xC9F68C22171478B8(Global_9E6A[13 /*31*/], 1);
				}
				iLocal_479 = 0;
				unk_0x8B4C4CA774181102(2f, 10f, 4);
				iLocal_41 = 1;
			}
			break;
		...
		case 1:
			if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) < 3)
			{
				if (func_377(Local_289[2 /*22*/]))
				{
					...
					{
						if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 371.9393f, -1604.252f, 45.603f, 399.8371f, -1627.065f, 31.75287f, 32.73f, 0, true, 2) || unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
						{
			...
			if ((unk_0x39E5E51C6E21A69B(unk_0x16F2683693E537C9()) && iLocal_479 == 0) && func_132(Local_290, unk_0x16F2683693E537C9(), 1) < 100f)
			{
			...
			if (func_7(Local_290))
			{
				...
				{
					unk_0x8B4C4CA774181102(10f, 6f, 4);
					iLocal_41 = 2;
				}
				if (bLocal_274)
				{
	...
	switch (iLocal_41)
	{
		case 0:
			if (func_71(iLocal_40, 0))
			{
				...
				unk_0x745CE398A4B0A3C6(369.0115f, -1609.116f, 28.2928f, 5f, 0);
				unk_0x745CE398A4B0A3C6(Local_289[0 /*22*/].f_1, 5f, 0);
				if (func_273(unk_0x16F2683693E537C9(), 12, 4) || func_273(unk_0x16F2683693E537C9(), 12, 3))
				{
					bLocal_272 = true;
				}
				func_224();
...
void func_224()
{
	...
	if (unk_0xC844350D5D58C99A(iVar0))
	{
		if (unk_0xDF1306B443CD3D15(iVar0, 0))
		{
			func_225(iVar0, unk_0x68F4C0EC296D3901(iVar0, true), unk_0xD9522BA9E27E1349(iVar0), 24, 0);
		}
	}
}
...
void func_226(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_257(&(Global_126B1.f_22B[0 /*21*/]), iParam0))
	{
		return;
	}
...
{
	if ((((((((((!unk_0xC844350D5D58C99A(iParam0) || !unk_0xDF1306B443CD3D15(iParam0, 0)) || func_243(iParam0, 0, 0)) || func_243(iParam0, 1, 0)) || func_243(iParam0, 2, 0)) || func_266(iParam0) != 145) || func_242(iParam0)) || func_241(iParam0)) || func_240(iParam0)) || func_239(iParam0)) || !func_229(unk_0x134B62B726CEC8E6(iParam0)))
	{
		if (func_241(iParam0))
		{
		}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_252(unk_0xEAE0D21A50E6C7F4(iParam0, 31), 4294967295, 1)) + 2011;
}
...
int func_257(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_11(Global_1B416.f_7FE8.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_1B416.f_936.f_21B.f_E04[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_11(Global_1B416.f_936.f_21B.f_E04[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_260(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_257(&(Global_126B1.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_265(iParam0);
			func_264(uParam1, &(Global_1B416.f_7FE8.f_45[Global_126B1.f_22B[0 /*21*/].f_E /*78*/]));
...
int func_273(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = unk_0x134B62B726CEC8E6(iParam0);
	Global_12A92[1 /*14*/] = { func_293(iVar0, iParam1, iParam2, 4294967295) };
			...
			if ((uVar5[iVar2] != 4294967197 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_273(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_273(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_12A92[2 /*14*/] = { func_293(iVar0, 14, iVar4, 4294967295) };
									if (Global_12A92[2 /*14*/].f_C == iVar3)
									{
										if (func_273(iParam0, 14, iVar4))
										{
											if (!func_277(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_12A92[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_12A92[2 /*14*/] = { func_293(iVar0, iVar2, iVar1, 4294967295) };
						if (!func_277(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_12A92[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_12A92[1 /*14*/].f_3 == unk_0x36C584991B4C183F(iParam0, func_274(iParam1)) && Global_12A92[1 /*14*/].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_274(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_277(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	...
	{
		if (func_283(iParam0, iParam2, iParam3, 4294967295))
		{
		...
		else if (func_282(iParam0, iParam2, iParam3, 4294967295))
		{
		...
		else if (func_278(iParam0, iParam2, iParam3, 4294967295))
		{
			if (((((((((iParam1 == 1 || iParam1 == 2) || iParam1 == 4) || iParam1 == 5) || iParam1 == 10) || iParam1 == 11) || iParam1 == 12) || iParam1 == 14) || iParam1 == 18) || iParam1 == 50)
			{
				return 0;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_279(iParam0, iParam2, 14, 3), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_279(iParam0, iParam2, 1, 3), 2452280943, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_279(iParam0, iParam2, 14, 4), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_279(iParam0, iParam2, 1, 4), 2452280943, 0));
					}
					break;
			}
			break;
...
int func_279(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_274(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_287(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_274(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
struct<17> func_289(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_292(&Var1, 4294967197, 4294967197, 1, 1, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					else
					{
						func_292(&Var1, 4294967197, 4294967197, 0, 0, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					break;
				
				case 1:
					func_292(&Var1, 4294967197, 4294967197, 16, 16, 6, 1, 1, 0, 1, 4294967197, 0, 0, 0);
					break;
				
				case 2:
					func_292(&Var1, 4294967197, 4294967197, 36, 21, 6, 1, 5, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 3:
					func_292(&Var1, 4294967197, 4294967197, 65, 36, 6, 0, 2, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 4:
					func_292(&Var1, 4294967197, 4294967197, 61, 32, 6, 0, 0, 7, 3, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_292(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[0], Global_1B416.f_936.f_21B.f_C8[0], 6, 3, 0, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 6:
					func_292(&Var1, 4294967197, 4294967197, 92, 72, 7, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_292(&Var1, 4294967197, 4294967197, 85, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 8:
					func_292(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_292(&Var1, 4294967197, 4294967197, 171, 89, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_292(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 4);
					break;
				
				case 11:
					func_292(&Var1, 4294967197, 4294967197, 33, 18, 17, 10, 4, 8, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_292(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 23, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_292(&Var1, 4294967197, 4294967197, 69, 40, 13, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_292(&Var1, 4294967197, 4294967197, 62, 33, 38, 0, 8, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 15:
					func_292(&Var1, 4294967197, 4294967197, 63, 34, 6, 10, 0, 0, 4, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_292(&Var1, 4294967197, 4294967197, 174, 93, 18, 0, 18, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_292(&Var1, 4294967197, 4294967197, 76, 46, 6, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_292(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 4, 0, 4294967197, 0, 0, 7);
					break;
				
				case 19:
					func_292(&Var1, 4294967197, 4294967197, 64, 35, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_292(&Var1, 4294967197, 4294967197, 66, 37, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_292(&Var1, 4294967197, 4294967197, 67, 38, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_292(&Var1, 4294967197, 4294967197, 68, 39, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_292(&Var1, 4294967197, 4294967197, 177, 94, 19, 9, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_292(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 4, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_292(&Var1, 4294967197, 4294967197, 97, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_292(&Var1, 4294967197, 4294967197, 3, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_292(&Var1, 4294967197, 4294967197, 129, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_292(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_292(&Var1, 4294967197, 4294967197, 2, 2, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_292(&Var1, 4294967197, 4294967197, 161, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_292(&Var1, 4294967197, 4294967197, 3, 3, 0, 12, 0, 0, 0, 4294967197, 0, 1, 31);
					break;
				
				case 32:
					func_292(&Var1, 4294967197, 4294967197, 85, 55, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_292(&Var1, 4294967197, 4294967197, 86, 4, 20, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_292(&Var1, 4294967197, 4294967197, 44, 97, 6, 0, 0, 0, 0, 4294967197, 0, 2, 31);
					break;
				
				case 35:
					func_292(&Var1, 4294967197, 4294967197, 85, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_292(&Var1, 4294967197, 4294967197, 4, 4, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_292(&Var1, 4294967197, 4294967197, 5, 5, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_292(&Var1, 4294967197, 4294967197, 6, 6, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_292(&Var1, 4294967197, 4294967197, 7, 7, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_292(&Var1, 4294967197, 4294967197, 8, 8, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_292(&Var1, 4294967197, 4294967197, 9, 9, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_292(&Var1, 4294967197, 4294967197, 10, 10, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_292(&Var1, 4294967197, 4294967197, 11, 11, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_292(&Var1, 4294967197, 4294967197, 12, 12, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_292(&Var1, 4294967197, 4294967197, 13, 13, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 46:
					func_292(&Var1, 4294967197, 4294967197, 14, 14, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_292(&Var1, 4294967197, 4294967197, 15, 15, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 48:
					func_292(&Var1, 4294967197, 4294967197, 91, 71, 14, 13, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 49:
					func_292(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 50:
					func_292(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 9);
					break;
				
				case 51:
					func_292(&Var1, 4294967197, 4294967197, 169, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 52:
					func_292(&Var1, 4294967197, 4294967197, 169, 72, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_one"):
			...
			{
				case 0:
					func_292(&Var1, 4294967197, 4294967197, 73, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_292(&Var1, 4294967197, 4294967197, 22, 10, 64, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 2:
					func_292(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[1], Global_1B416.f_936.f_21B.f_C8[1], 17, 2, 26, 0, 0, 4294967197, 0, 45, 31);
					break;
				
				case 3:
					func_292(&Var1, 4294967197, 4294967197, 23, 11, 13, 5, 2, 4, 0, 4294967197, 0, 0, 1);
					break;
				
				case 4:
					func_292(&Var1, 4294967197, 4294967197, 23, 11, 34, 5, 26, 0, 0, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_292(&Var1, 4294967197, 20, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 6:
					func_292(&Var1, 4294967197, 4294967197, 40, 13, 14, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_292(&Var1, 4294967197, 4294967197, 90, 32, 17, 1, 8, 0, 1, 4294967197, 0, 0, 3);
					break;
				
				case 8:
					func_292(&Var1, 4294967197, 4294967197, 17, 5, 12, 0, 26, 0, 2, 4294967197, 0, 0, 5);
					break;
				
				case 9:
					func_292(&Var1, 4294967197, 4294967197, 16, 4, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_292(&Var1, 4294967197, 4294967197, 208, 71, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_292(&Var1, 4294967197, 4294967197, 259, 10, 35, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 12:
					func_292(&Var1, 4294967197, 4294967197, 18, 6, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_292(&Var1, 4294967197, 4294967197, 19, 7, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_292(&Var1, 4294967197, 4294967197, 20, 8, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_292(&Var1, 4294967197, 4294967197, 21, 9, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_292(&Var1, 4294967197, 4294967197, 135, 40, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_292(&Var1, 4294967197, 4294967197, 74, 24, 52, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_292(&Var1, 4294967197, 4294967197, 176, 53, 26, 5, 26, 0, 0, 4294967197, 0, 41, 31);
					break;
				
				case 19:
					func_292(&Var1, 4294967197, 4294967197, 125, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_292(&Var1, 4294967197, 4294967197, 162, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_292(&Var1, 4294967197, 4294967197, 75, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 22:
					func_292(&Var1, 4294967197, 4294967197, 227, 53, 25, 0, 27, 0, 0, 4294967197, 0, 25, 31);
					break;
				
				case 23:
					func_292(&Var1, 4294967197, 4294967197, 228, 54, 25, 0, 28, 0, 0, 4294967197, 0, 26, 31);
					break;
				
				case 24:
					func_292(&Var1, 4294967197, 4294967197, 229, 55, 25, 0, 29, 0, 0, 4294967197, 0, 27, 31);
					break;
				
				case 25:
					func_292(&Var1, 4294967197, 4294967197, 230, 56, 25, 0, 30, 0, 0, 4294967197, 0, 28, 31);
					break;
				
				case 26:
					func_292(&Var1, 4294967197, 4294967197, 231, 57, 25, 0, 31, 0, 0, 4294967197, 0, 29, 31);
					break;
				
				case 27:
					func_292(&Var1, 4294967197, 4294967197, 232, 58, 25, 0, 32, 0, 0, 4294967197, 0, 30, 31);
					break;
				
				case 28:
					func_292(&Var1, 4294967197, 4294967197, 233, 59, 25, 0, 33, 0, 0, 4294967197, 0, 31, 31);
					break;
				
				case 29:
					func_292(&Var1, 4294967197, 4294967197, 234, 60, 25, 0, 34, 0, 0, 4294967197, 0, 32, 31);
					break;
				
				case 30:
					func_292(&Var1, 4294967197, 4294967197, 235, 61, 25, 0, 35, 0, 0, 4294967197, 0, 33, 31);
					break;
				
				case 31:
					func_292(&Var1, 4294967197, 4294967197, 236, 62, 25, 0, 36, 0, 0, 4294967197, 0, 34, 31);
					break;
				
				case 32:
					func_292(&Var1, 4294967197, 4294967197, 237, 63, 25, 0, 37, 0, 0, 4294967197, 0, 35, 31);
					break;
				
				case 33:
					func_292(&Var1, 4294967197, 4294967197, 238, 64, 25, 0, 38, 0, 0, 4294967197, 0, 36, 31);
					break;
				
				case 34:
					func_292(&Var1, 4294967197, 4294967197, 239, 65, 25, 0, 39, 0, 0, 4294967197, 0, 37, 31);
					break;
				
				case 35:
					func_292(&Var1, 4294967197, 4294967197, 240, 66, 25, 0, 40, 0, 0, 4294967197, 0, 38, 31);
					break;
				
				case 36:
					func_292(&Var1, 4294967197, 4294967197, 241, 67, 25, 0, 41, 0, 0, 4294967197, 0, 39, 31);
					break;
				
				case 37:
					func_292(&Var1, 4294967197, 4294967197, 242, 68, 25, 0, 42, 0, 0, 4294967197, 0, 40, 31);
					break;
				
				case 38:
					func_292(&Var1, 4294967197, 4294967197, 260, 72, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_292(&Var1, 4294967197, 4294967197, 125, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_292(&Var1, 4294967197, 4294967197, 123, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_292(&Var1, 4294967197, 4294967197, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_292(&Var1, 4294967197, 4294967197, 89, 22, 15, 6, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_292(&Var1, 4294967197, 4294967197, 317, 69, 17, 0, 0, 0, 51, 4294967197, 0, 0, 6);
					break;
				
				case 44:
					func_292(&Var1, 4294967197, 4294967197, 30, 23, 16, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 45:
					func_292(&Var1, 4294967197, 4294967197, 106, 70, 17, 5, 26, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 46:
					func_292(&Var1, 4294967197, 4294967197, 117, 24, 20, 5, 26, 0, 52, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_two"):
			...
			{
				case 0:
					func_292(&Var1, 4294967197, 4294967197, 0, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_292(&Var1, 4294967197, 4294967197, 17, 5, 8, 2, 3, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 2:
					func_292(&Var1, 4294967197, 4294967197, 43, 8, 12, 3, 5, 0, 0, 4294967197, 0, 0, 1);
					break;
				
				case 3:
					func_292(&Var1, 4294967197, 4294967197, 50, 14, 8, 0, 15, 6, 3, 4294967197, 0, 0, 2);
					break;
				
				case 4:
					func_292(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[2], Global_1B416.f_936.f_21B.f_C8[2], 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 5:
					func_292(&Var1, 4294967197, 4294967197, 95, 33, 8, 0, 15, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 6:
					func_292(&Var1, 4294967197, 4294967197, 49, 13, 10, 4, 6, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 7:
					func_292(&Var1, 4294967197, 4294967197, 49, 13, 14, 4, 15, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 8:
					func_292(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 7, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_292(&Var1, 4294967197, 4294967197, 53, 17, 11, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_292(&Var1, 4294967197, 4294967197, 96, 81, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_292(&Var1, 4294967197, 4294967197, 51, 15, 33, 0, 8, 0, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_292(&Var1, 4294967197, 4294967197, 0, 93, 29, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_292(&Var1, 4294967197, 4294967197, 52, 16, 30, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_292(&Var1, 4294967197, 4294967197, 241, 92, 16, 0, 12, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_292(&Var1, 4294967197, 4294967197, 97, 34, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_292(&Var1, 4294967197, 4294967197, 44, 9, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_292(&Var1, 4294967197, 4294967197, 45, 10, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_292(&Var1, 4294967197, 4294967197, 46, 11, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 19:
					func_292(&Var1, 4294967197, 4294967197, 47, 12, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_292(&Var1, 4294967197, 4294967197, 161, 53, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_292(&Var1, 4294967197, 4294967197, 0, 44, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_292(&Var1, 4294967197, 4294967197, 98, 0, 28, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_292(&Var1, 4294967197, 4294967197, 27, 0, 31, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_292(&Var1, 4294967197, 4294967197, 190, 71, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_292(&Var1, 4294967197, 4294967197, 191, 72, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_292(&Var1, 4294967197, 4294967197, 192, 73, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_292(&Var1, 4294967197, 4294967197, 193, 74, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_292(&Var1, 4294967197, 4294967197, 194, 75, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_292(&Var1, 4294967197, 4294967197, 195, 76, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_292(&Var1, 4294967197, 4294967197, 196, 77, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_292(&Var1, 4294967197, 4294967197, 197, 78, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 32:
					func_292(&Var1, 4294967197, 4294967197, 198, 79, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_292(&Var1, 4294967197, 4294967197, 199, 80, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_292(&Var1, 4294967197, 4294967197, 200, 62, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 35:
					func_292(&Var1, 4294967197, 4294967197, 201, 63, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_292(&Var1, 4294967197, 4294967197, 202, 64, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_292(&Var1, 4294967197, 4294967197, 203, 65, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_292(&Var1, 4294967197, 4294967197, 204, 66, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_292(&Var1, 4294967197, 4294967197, 205, 67, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_292(&Var1, 4294967197, 4294967197, 206, 68, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_292(&Var1, 4294967197, 4294967197, 2, 43, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_292(&Var1, 4294967197, 4294967197, 55, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_292(&Var1, 4294967197, 4294967197, 0, 52, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_292(&Var1, 4294967197, 4294967197, 70, 30, 32, 6, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_292(&Var1, 4294967197, 4294967197, 19, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 46:
					func_292(&Var1, 4294967197, 4294967197, 0, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_292(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("mp_m_freemode_01"):
			...
			{
				case 0:
					func_292(&Var1, 4294967197, 4294967197, 0, 0, 10, 4294967197, 0, 4294967197, 4294967197, 0, 0, 0, 31);
					break;
				
				case 1:
					func_292(&Var1, 4294967197, 4294967197, 1, 127, 38, 4294967197, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_292(&Var1, 4294967197, 4294967197, 0, 248, 45, 4294967197, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_292(&Var1, 4294967197, 4294967197, 4, 31, 25, 4294967197, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_292(&Var1, 4294967197, 4294967197, 1, 66, 10, 4294967197, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_292(&Var1, 4294967197, 4294967197, 1, 93, 141, 4294967197, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_292(&Var1, 4294967197, 4294967197, 1, 116, 113, 4294967197, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_292(&Var1, 4294967197, 4294967197, 1, 61, 136, 4294967197, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_292(&Var1, 4294967197, 4294967197, 0, 112, 10, 4294967197, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_292(&Var1, 4294967197, 4294967197, 4, 131, 24, 4294967197, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_292(&Var1, 4294967197, 4294967197, 1, 209, 188, 4294967197, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_292(&Var1, 4294967197, 4294967197, 1, 209, 160, 4294967197, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_292(&Var1, 4294967197, 4294967197, 1, 162, 174, 4294967197, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_292(&Var1, 4294967197, 4294967197, 1, 4, 240, 4294967197, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_292(&Var1, 4294967197, 4294967197, 1, 128, 232, 4294967197, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_292(&Var1, 4294967197, 4294967197, 1, 66, 65, 4294967197, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_292(&Var1, 4294967197, 4294967197, 1, 65, 172, 4294967197, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_292(&Var1, 4294967197, 4294967197, 1, 64, 10, 4294967197, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_292(&Var1, 4294967197, 4294967197, 5, 98, 80, 4294967197, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_292(&Var1, 4294967197, 4294967197, 5, 192, 96, 4294967197, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_292(&Var1, 4294967197, 4294967197, 1, 124, 96, 4294967197, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_292(&Var1, 4294967197, 4294967197, 0, 80, 114, 4294967197, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_292(&Var1, 4294967197, 4294967197, 6, 43, 112, 4294967197, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_292(&Var1, 4294967197, 4294967197, 1, 116, 144, 4294967197, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_292(&Var1, 4294967197, 4294967197, 1, 63, 38, 4294967197, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_292(&Var1, 4294967197, 4294967197, 2, 64, 10, 4294967197, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 0:
					func_292(&Var1, 4294967197, 4294967197, 0, 0, 0, 4294967197, 0, 4294967197, 4294967197, 0, 4294967197, 0, 31);
					break;
				
				case 1:
					func_292(&Var1, 4294967197, 4294967197, 5, 136, 241, 4294967197, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_292(&Var1, 4294967197, 4294967197, 4, 1, 96, 4294967197, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_292(&Var1, 4294967197, 4294967197, 1, 73, 241, 4294967197, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_292(&Var1, 4294967197, 4294967197, 2, 88, 217, 4294967197, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_292(&Var1, 4294967197, 4294967197, 9, 7, 98, 4294967197, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_292(&Var1, 4294967197, 4294967197, 1, 140, 241, 4294967197, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_292(&Var1, 4294967197, 4294967197, 4, 139, 112, 4294967197, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_292(&Var1, 4294967197, 4294967197, 1, 193, 48, 4294967197, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_292(&Var1, 4294967197, 4294967197, 5, 114, 97, 4294967197, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_292(&Var1, 4294967197, 4294967197, 9, 134, 239, 4294967197, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_292(&Var1, 4294967197, 4294967197, 5, 152, 96, 4294967197, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_292(&Var1, 4294967197, 4294967197, 6, 129, 1, 4294967197, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_292(&Var1, 4294967197, 4294967197, 5, 0, 0, 4294967197, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_292(&Var1, 4294967197, 4294967197, 4, 159, 96, 4294967197, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_292(&Var1, 4294967197, 4294967197, 9, 232, 213, 4294967197, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_292(&Var1, 4294967197, 4294967197, 2, 8, 98, 4294967197, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_292(&Var1, 4294967197, 4294967197, 5, 150, 235, 4294967197, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_292(&Var1, 4294967197, 4294967197, 6, 96, 97, 4294967197, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_292(&Var1, 4294967197, 4294967197, 4, 48, 64, 4294967197, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_292(&Var1, 4294967197, 4294967197, 4, 62, 64, 4294967197, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_292(&Var1, 4294967197, 4294967197, 4, 49, 65, 4294967197, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_292(&Var1, 4294967197, 4294967197, 3, 20, 16, 4294967197, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_292(&Var1, 4294967197, 4294967197, 0, 73, 178, 4294967197, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_292(&Var1, 4294967197, 4294967197, 5, 135, 53, 4294967197, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_292(&Var1, 4294967197, 4294967197, 7, 233, 176, 4294967197, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_292(&Var1, 4294967197, 4294967197, 4, 34, 179, 4294967197, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_292(&Var1, 4294967197, 4294967197, 15, 131, 93, 4294967197, 32, 0, 0, 0, 0, 250, 23);
					break;
...
void func_295(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 155, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_296(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_303(Global_280004, 1, 1, 1, 4294967295))
			{
				unk_0x0674E58A79778E99(&(uParam0->f_6), 2);
			}
			if (!func_303(Global_280004, 2, 1, 1, 4294967295))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_299(func_301(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 1);
			}
			iVar0 = func_299(func_298(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_299(iVar1, Global_12A8F, 0);
				if (!unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
				{
					unk_0x5D96D8530B3D0904(&(uParam0->f_6), 4);
				}
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_296(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_296(&(Global_12A92[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_296(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_12B3B)
		{
			...
			Global_280005 = Var11;
			func_296(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, 4294967295, 0, 4294967295, func_274(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_307(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 9, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_308(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 48, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_309(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 1, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_311(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 6, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_312(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 33, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_313(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 17, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_314(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 18, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_315(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 7, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_316(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 84, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_317(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 104, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_318(int iParam0)
{
	...
	{
		func_306(3, iParam0, 242, 4294967295);
	}
}
...
void func_324(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 175, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_326(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 47, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_327(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 63, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_329(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 5, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_330(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 53, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_331(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 12, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_332(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 77, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_334(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 134, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_335(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 117, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_336(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_306(3, iParam0, 318, 4294967295);
	}
}
...
void func_340(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 21, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_341(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 10, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_343(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 113, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_346(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 45, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_350(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 20, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_351(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 24, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_352(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 14, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_353(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_306(iVar7, iParam0, 99, 4294967295);
			return;
			break;
	}
	func_296(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_355(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_306(3, iParam0, 181, 4294967295);
	}
}
...
void func_363()
{
	...
	{
		unk_0x1BA7FCEAFCE8D46E(iLocal_269, 0, true, true);
	}
	else
	{
		unk_0x1BA7FCEAFCE8D46E(iLocal_269, 1, true, true);
	}
}
...
void func_364()
{
	if (bLocal_274)
	{
		if (unk_0x029064EA9141FCC2(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f) || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0))
		{
			if (func_12(&uLocal_150, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)))
			{
				func_366(Global_9E6A[13 /*31*/], &fLocal_270);
				return;
			}
		}
		else
		{
			func_365(Global_9E6A[13 /*31*/], &fLocal_270);
		}
	}
	else if (unk_0x838876B8BA050A8A(unk_0x16F2683693E537C9()) || iLocal_42 == 1)
	{
		if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 390.4927f, -1621.07f, 28.29278f, 406.0266f, -1604.358f, 35.2086f, 15f, 0, true, 0) || unk_0x029064EA9141FCC2(387.0058f, -1641.537f, 20.4895f, 404.1412f, -1580.302f, 40.34303f))
		{
			func_366(Global_9E6A[13 /*31*/], &fLocal_270);
		}
		else
...
void func_365(int iParam0, float fParam1)
{
	if (unk_0x76395FF5E8D5E643(iParam0))
	{
		if (*fParam1 != 0f)
		{
			...
			unk_0x838CC054A9235BEC(iParam0, *fParam1, true, true);
			*fParam1 = (*fParam1 - (0.2f * SYSTEM::TIMESTEP()));
			if (*fParam1 <= 0f)
			{
				unk_0x1BA7FCEAFCE8D46E(iParam0, 1, true, false);
...
void func_374()
{
	...
	else
	{
		...
		if (iLocal_40 == 2 || iLocal_40 == 3)
		{
			if (!func_153(unk_0x16F2683693E537C9(), Local_290, 50f, 1) && !bLocal_288)
			{
				func_373("PR_VANWARN", &bLocal_288);
			}
			else if (!func_153(unk_0x16F2683693E537C9(), Local_290, 100f, 1) && bLocal_288)
			{
				func_372(4);
			}
		}
...
void func_375()
{
	if (unk_0x5B17F10380E80E5B(Local_290))
	{
		if (iLocal_268)
		{
			if ((unk_0x1C0640BA9A7327B3() - iLocal_267) > 5000)
			{
				func_372(2);
				return;
			}
...
void func_385()
{
	iLocal_269 = 2825439690;
	if (!unk_0x76395FF5E8D5E643(iLocal_269))
	{
		unk_0x8010B3127F058F0F(iLocal_269, joaat("prop_fnclink_03gate5"), 391.8602f, -1636.07f, 29.9744f, 1, true, 0);
	}
	unk_0x1BA7FCEAFCE8D46E(Global_9E6A[13 /*31*/], 1, true, false);
	unk_0x1BA7FCEAFCE8D46E(iLocal_269, 1, true, false);
}
...
void func_391()
{
	...
	while (iVar1 <= 2)
	{
		Local_289[iVar1 /*22*/].f_12 = 0;
		Local_289[iVar1 /*22*/].f_13 = 0;
		Local_289[iVar1 /*22*/].f_14 = 0;
		Local_289[iVar1 /*22*/].f_11 = 0;
		Local_289[iVar1 /*22*/].f_10 = 0;
		iVar2 = 0;
		while (iVar2 <= (15 - 1))
...
void func_396()
{
	...
	if (unk_0x76395FF5E8D5E643(Global_9E6A[13 /*31*/]))
	{
		unk_0xC9F68C22171478B8(Global_9E6A[13 /*31*/], 0);
	}
	unk_0x838CC054A9235BEC(Global_9E6A[13 /*31*/], 0f, true, true);
	unk_0x1BA7FCEAFCE8D46E(Global_9E6A[13 /*31*/], 4, true, true);
	unk_0x1BA7FCEAFCE8D46E(iLocal_269, 0, true, false);
	unk_0xA4A8625CC710BC1F(iLocal_269);
	unk_0x2952D66A502EA873(iLocal_264, 0);
	func_55();
	unk_0x34D79252800B23FF(5);
	unk_0x51B096AAC60548C1(1f);
	func_406();
...
void func_397(bool bParam0)
{
	...
	if (unk_0x9F4FE516EAACCFC5(iLocal_263))
	{
		...
		unk_0x9A8DDC7C522F5BF5(iLocal_263, 0);
	}
}

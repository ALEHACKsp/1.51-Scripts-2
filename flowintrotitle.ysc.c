...
void __EntryFunction__()
{
	...
	unk_0x0674E58A79778E99(&(Global_1B416.f_271B.f_19), 1);
	func_7();
	...
	{
		func_7();
		if (!unk_0xEAE0D21A50E6C7F4(Global_1B416.f_271B.f_19, 1))
		{
			...
			{
				unk_0x5D96D8530B3D0904(&(Global_1B416.f_271B.f_19), 1);

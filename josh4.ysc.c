...
void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(19))
	{
		...
		unk_0xC92DB9682A650680("JOSH4_MISSION_FAIL");
		func_466(1);
		func_455();
	}
	if (func_454())
	{
		...
		func_453(vLocal_53, fLocal_54, 1, 0);
		func_488("*** Replay setup started");
		Global_12C43 = 1;
		iLocal_37 = 0;
		while (!func_442(&Local_386))
		{
			SYSTEM::WAIT(0);
		}
		func_488("*** Josh 4 scene set up");
		func_441(&Local_386, 0, 1);
		Global_12C43 = 0;
	}
	if (func_440(Local_386.f_1C[1]))
	{
		unk_0x33CE5A9E32EA10B2(Local_386.f_1C[1], true);
	}
	if (func_440(Local_386.f_1C[2]))
	{
		unk_0x33CE5A9E32EA10B2(Local_386.f_1C[2], true);
	}
	iLocal_390 = Local_386.f_23[0];
	iLocal_391 = Local_386.f_23[1];
	...
	if (func_454())
	{
		...
		unk_0xC92DB9682A650680("JOSH4_RESTART1");
		func_325();
	}
	while (true)
	{
		unk_0x1A6DFFFEEC27BF4F("SF_BOC", 0);
		SYSTEM::WAIT(0);
...
void func_1()
{
	...
	switch (iLocal_46)
	{
		case 0:
			func_441(&Local_386, 0, 1);
			if (func_440(iLocal_390))
			{
				unk_0xAA6B3A4292417750(iLocal_390, false, false, false, false, false, false, 0, false);
			}
			if (func_440(iLocal_391))
			{
				unk_0xAA6B3A4292417750(iLocal_391, false, false, false, false, false, false, 0, false);
			}
			func_260("JOSH4_LOSECOPS", 7500, 1);
			unk_0x67F91979413C5D76(unk_0xA30EC016B12C03E4(), 2, 0);
			unk_0x56EA5D248F36A081(unk_0xA30EC016B12C03E4(), 0);
			unk_0x10F3BFFADF2CE3DA(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f);
			unk_0x17E8C6920A1E386F(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, false, 0);
			unk_0x745CE398A4B0A3C6(-1114.788f, 319.3401f, 66.1226f, 20.5f, 0);
			if (func_440(Local_386.f_1C[0]))
			{
				unk_0x0C8C0C840C2D1AD2(Local_386.f_1C[0], unk_0x16F2683693E537C9(), 4294967295, 0, 2);
			}
			unk_0xB975E4541DDAB1F5(2);
			iLocal_394 = unk_0x1C0640BA9A7327B3();
			iLocal_46 = 1;
			break;
		...
		case 1:
			...
			func_209();
			func_207();
			if (unk_0x179932739160BA96(unk_0xA30EC016B12C03E4()) <= 0 && !func_206())
			{
				iVar0 = 1;
				while (iVar0 <= (Local_386.f_1C - 1))
				{
					if (func_440(Local_386.f_1C[iVar0]))
					{
						func_205(&(Local_386.f_1C[iVar0]), 0, 1, 1);
					}
					iVar0++;
				}
				if (func_204(iLocal_390))
				{
					if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_390, 0))
					{
						func_203(777);
					}
				}
...
void func_2()
{
	if (func_440(unk_0x16F2683693E537C9()))
	{
		...
		{
			unk_0xC92DB9682A650680("JOSH4_COPS_LOST_RADIO");
			func_488("Starting 'JOSH4_COPS_LOST_RADIO'");
		}
		else
		{
			unk_0xC92DB9682A650680("JOSH4_COPS_LOST");
...
void func_3(int iParam0, bool bParam1)
{
	...
	{
		func_171(&(Global_1B085[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_6(int iParam0, int iParam1, int iParam2)
{
	...
	{
		func_10((891 + iParam0), 1, 4294967295, 1);
	}
	bVar0 = true;
...
void func_7()
{
	...
	{
		func_9(13, SYSTEM::FLOOR(Global_1B416.f_27CD.f_F0D));
	}
	if (!unk_0xBA972B2C9F1D30C1())
	{
		if (!Global_12B4E)
		{
			if (func_8() == 2 == 0 && !unk_0x8CD06866876216F2())
			{
...
void func_22(var uParam0)
{
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_27(&(uParam0->f_19[0 /*295*/][iVar1 /*98*/]));
		func_27(&(uParam0->f_19[1 /*295*/][iVar1 /*98*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_26(&(uParam0->f_B44));
	func_24(&(uParam0->f_B4A));
	func_23(&(uParam0->f_BA4));
}
...
int func_32(int iParam0, int iParam1, int iParam2)
{
	...
	Global_12A92[1 /*14*/] = { func_83(iVar0, iParam1, iParam2, 4294967295) };
	...
	else
	{
		...
		Global_12A92[1 /*14*/] = { func_83(iVar0, iParam1, uVar6[iParam1], 4294967295) };
		if (unk_0xD2C792E5A65B6BF1(iParam0, func_75(iParam1)) > 0 && unk_0x0F84621831DD8D8A(iParam0, func_75(iParam1), Global_12A92[1 /*14*/].f_3) > 0)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_75(iParam1), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, 0);
		}
	}
	if (func_74(iParam0, iVar0, &iVar7, 0))
	{
		func_35(iParam0, 2, iVar7, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
	}
	if (func_33(iParam0, iVar0, &iVar7))
	{
		func_35(iParam0, 1, iVar7, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
	}
	return 1;
}
...
int func_33(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_148(iParam0, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_40, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_12A92[1 /*14*/] = { func_83(iVar10, iParam1, iParam2, 4294967295) };
		if (!func_73(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			if (!func_62(iVar10, 14, iVar7, 4294967295))
			{
				iVar7 = 4294967197;
			}
			iVar8 = func_63(iParam0, 0);
			if (!func_61(iVar10, 14, iVar8, 4294967295) && !func_60(iVar10, 14, iVar8, 4294967295))
			{
				iVar8 = 4294967197;
			}
			if (iVar10 == joaat("player_one"))
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_12A92[1 /*14*/] = { func_83(iVar10, iVar0, uVar11[iVar0], 4294967295) };
				if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_12A92[1 /*14*/] = { func_83(iVar10, 14, uVar12[iVar1], 4294967295) };
							func_51(iParam0, Global_12A92[1 /*14*/].f_C, Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4);
							func_66(14);
							if (Global_12A90 == 1)
							{
								iVar2 = 0;
								while (iVar2 < 15)
								{
									...
									if (iVar3 != 4294967197)
									{
										func_35(iParam0, iVar2, iVar3, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
									}
									iVar2++;
								}
							}
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_75(iVar0), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_75(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_75(iVar0), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, iParam4);
						}
						func_66(iVar0);
						if (Global_12A90 == 1)
						{
			...
			{
				Global_12A92[1 /*14*/] = { func_83(iVar10, iVar0, func_41(iParam0, iVar0, 4294967295), 4294967295) };
				if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 3))
				{
					if (iVar0 == 2)
					{
						if (iVar10 == joaat("player_one"))
						{
							...
							{
								func_35(iParam0, 2, iVar4, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
							}
						}
					}
					else
					{
						...
						func_35(iParam0, iVar0, uVar13[iVar0], 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
				}
			}
			iVar0++;
		...
		if (iParam7 == 1)
		{
			Var14 = { func_83(iVar10, 8, iVar5, 4294967295) };
			if (iVar5 != 4294967197)
			{
				if (func_39(iVar10, iParam2, 8, iVar5, &uVar11, &Var14))
				{
					func_35(iParam0, 8, iVar5, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_83(iVar10, 9, iVar6, 4294967295) };
			if (iVar6 != 4294967197)
			{
				if (func_39(iVar10, iParam2, 9, iVar6, &uVar11, &Var14))
				{
					func_35(iParam0, 9, iVar6, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_83(iVar10, 14, iVar7, 4294967295) };
			if (iVar7 != 4294967197)
			{
				if (func_39(iVar10, iParam2, 14, iVar7, &uVar11, &Var14))
				{
					func_35(iParam0, 14, iVar7, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_83(iVar10, 14, iVar8, 4294967295) };
			if (iVar8 != 4294967197)
			{
				if (func_39(iVar10, iParam2, 14, iVar8, &uVar11, &Var14))
				{
					func_35(iParam0, 14, iVar8, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
			Var14 = { func_83(iVar10, 14, iVar9, 4294967295) };
			if (iVar9 != 4294967197)
			{
				if (func_39(iVar10, iParam2, 14, iVar9, &uVar11, &Var14))
				{
					func_35(iParam0, 14, iVar9, iParam3, iParam4, iParam5, iParam6, iParam7, 4294967295, 4294967295, 4294967295, 0, 0, 0);
				}
			}
		}
	}
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_12A92[1 /*14*/] = { func_83(iVar10, 14, uVar15[iVar1], 4294967295) };
			func_51(iParam0, Global_12A92[1 /*14*/].f_C, Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4);
			func_66(14);
			if (Global_12A90 == 1)
			{
	...
	else
	{
		if (iParam4 == 4294967295)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_75(iParam1), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_75(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_75(iParam1), Global_12A92[1 /*14*/].f_3, Global_12A92[1 /*14*/].f_4, iParam4);
		}
		if (Global_12A90 == 1)
		{
			iVar2 = 0;
	...
	if (Global_12A90 == 1)
	{
		...
		{
			func_35(iParam0, 1, iVar4, 0, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
		}
	}
	Global_12A90 = (Global_12A90 - 1);
	return 1;
...
{
	Global_12A92[1 /*14*/] = { func_83(iParam0, iParam1, iParam2, 4294967295) };
...
int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)
{
	...
	if (iParam0 == joaat("player_zero"))
	{
		if (func_62(iParam0, iParam2, iParam3, 4294967295))
		{
		...
		else if (func_60(iParam0, iParam2, iParam3, 4294967295))
		{
			if (((((((((iParam1 == 1 || iParam1 == 2) || iParam1 == 4) || iParam1 == 5) || iParam1 == 10) || iParam1 == 11) || iParam1 == 12) || iParam1 == 14) || iParam1 == 18) || iParam1 == 50)
			{
				return 0;
					...
					case 11:
						...
						else if (iParam2 == 8)
						{
							if (((iParam3 >= 27 && iParam3 <= 42) || (iParam3 >= 43 && iParam3 <= 58)) || (iParam3 >= 59 && iParam3 <= 74))
							{
								...
								iVar0 = func_45(iParam1, 4294967197, iVar9, 0);
							}
						}
						break;
				}
...
void func_51(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		if (iParam1 == 0)
		{
			...
			if (func_52(unk_0x134B62B726CEC8E6(iParam0), 14, iVar0, unk_0xD1BC07002824FE76(iParam0, 0, iParam2, iParam3)))
			{
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_75(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iVar1 != 4294967295 && iVar1 != 0)
	{
		...
		{
			return func_58(unk_0x134B62B726CEC8E6(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_58(unk_0x134B62B726CEC8E6(iParam0), iVar1, 14, 4);
		}
	}
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, 4294967295, 0, 4294967295, func_75(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_53(iParam0, iParam2, 14, 3), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_53(iParam0, iParam2, 1, 3), 2452280943, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 1) || unk_0x1A5A491D253EA7BA(func_53(iParam0, iParam2, 14, 4), 2452280943, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, 2537416713, 0) || unk_0x1A5A491D253EA7BA(func_53(iParam0, iParam2, 1, 4), 2452280943, 0));
					}
					break;
			}
			break;
...
void func_66(int iParam0)
{
	...
	{
		func_72(iParam0, Global_12A92[1 /*14*/].f_5, Global_12A92[1 /*14*/].f_2, 2, Global_12A92[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 1) && unk_0xEAE0D21A50E6C7F4(Global_12A92[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_67(Global_280004, 2, 1, 1, 4294967295);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	iVar0 = Global_26E2D2[iParam0 /*3*/][func_69(iParam2)];
	if (iVar0 != 0)
	{
...
int func_70(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 11511)
	{
		...
		iVar0 = Global_26E2D2[iParam0 /*3*/][func_69(iParam1)];
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_148(iParam0, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_3D, Global_1B416.f_936.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
struct<17> func_79(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				case 0:
					...
					{
						func_82(&Var1, 4294967197, 4294967197, 1, 1, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					else
					{
						func_82(&Var1, 4294967197, 4294967197, 0, 0, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					}
					break;
				
				case 1:
					func_82(&Var1, 4294967197, 4294967197, 16, 16, 6, 1, 1, 0, 1, 4294967197, 0, 0, 0);
					break;
				
				case 2:
					func_82(&Var1, 4294967197, 4294967197, 36, 21, 6, 1, 5, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 3:
					func_82(&Var1, 4294967197, 4294967197, 65, 36, 6, 0, 2, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 4:
					func_82(&Var1, 4294967197, 4294967197, 61, 32, 6, 0, 0, 7, 3, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_82(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[0], Global_1B416.f_936.f_21B.f_C8[0], 6, 3, 0, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 6:
					func_82(&Var1, 4294967197, 4294967197, 92, 72, 7, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_82(&Var1, 4294967197, 4294967197, 85, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 8:
					func_82(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_82(&Var1, 4294967197, 4294967197, 171, 89, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_82(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 4);
					break;
				
				case 11:
					func_82(&Var1, 4294967197, 4294967197, 33, 18, 17, 10, 4, 8, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_82(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 23, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_82(&Var1, 4294967197, 4294967197, 69, 40, 13, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_82(&Var1, 4294967197, 4294967197, 62, 33, 38, 0, 8, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 15:
					func_82(&Var1, 4294967197, 4294967197, 63, 34, 6, 10, 0, 0, 4, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_82(&Var1, 4294967197, 4294967197, 174, 93, 18, 0, 18, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_82(&Var1, 4294967197, 4294967197, 76, 46, 6, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_82(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 4, 0, 4294967197, 0, 0, 7);
					break;
				
				case 19:
					func_82(&Var1, 4294967197, 4294967197, 64, 35, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_82(&Var1, 4294967197, 4294967197, 66, 37, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_82(&Var1, 4294967197, 4294967197, 67, 38, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_82(&Var1, 4294967197, 4294967197, 68, 39, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_82(&Var1, 4294967197, 4294967197, 177, 94, 19, 9, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_82(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 4, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_82(&Var1, 4294967197, 4294967197, 97, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_82(&Var1, 4294967197, 4294967197, 3, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_82(&Var1, 4294967197, 4294967197, 129, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_82(&Var1, 4294967197, 4294967197, 170, 80, 6, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_82(&Var1, 4294967197, 4294967197, 2, 2, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_82(&Var1, 4294967197, 4294967197, 161, 3, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_82(&Var1, 4294967197, 4294967197, 3, 3, 0, 12, 0, 0, 0, 4294967197, 0, 1, 31);
					break;
				
				case 32:
					func_82(&Var1, 4294967197, 4294967197, 85, 55, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_82(&Var1, 4294967197, 4294967197, 86, 4, 20, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_82(&Var1, 4294967197, 4294967197, 44, 97, 6, 0, 0, 0, 0, 4294967197, 0, 2, 31);
					break;
				
				case 35:
					func_82(&Var1, 4294967197, 4294967197, 85, 81, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_82(&Var1, 4294967197, 4294967197, 4, 4, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_82(&Var1, 4294967197, 4294967197, 5, 5, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_82(&Var1, 4294967197, 4294967197, 6, 6, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_82(&Var1, 4294967197, 4294967197, 7, 7, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_82(&Var1, 4294967197, 4294967197, 8, 8, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_82(&Var1, 4294967197, 4294967197, 9, 9, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_82(&Var1, 4294967197, 4294967197, 10, 10, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_82(&Var1, 4294967197, 4294967197, 11, 11, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_82(&Var1, 4294967197, 4294967197, 12, 12, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_82(&Var1, 4294967197, 4294967197, 13, 13, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 46:
					func_82(&Var1, 4294967197, 4294967197, 14, 14, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_82(&Var1, 4294967197, 4294967197, 15, 15, 0, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 48:
					func_82(&Var1, 4294967197, 4294967197, 91, 71, 14, 13, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 49:
					func_82(&Var1, 4294967197, 4294967197, 35, 20, 9, 10, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 50:
					func_82(&Var1, 4294967197, 4294967197, 33, 18, 8, 10, 3, 8, 0, 4294967197, 0, 0, 9);
					break;
				
				case 51:
					func_82(&Var1, 4294967197, 4294967197, 169, 95, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 52:
					func_82(&Var1, 4294967197, 4294967197, 169, 72, 6, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_one"):
			...
			{
				case 0:
					func_82(&Var1, 4294967197, 4294967197, 73, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_82(&Var1, 4294967197, 4294967197, 22, 10, 64, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 2:
					func_82(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[1], Global_1B416.f_936.f_21B.f_C8[1], 17, 2, 26, 0, 0, 4294967197, 0, 45, 31);
					break;
				
				case 3:
					func_82(&Var1, 4294967197, 4294967197, 23, 11, 13, 5, 2, 4, 0, 4294967197, 0, 0, 1);
					break;
				
				case 4:
					func_82(&Var1, 4294967197, 4294967197, 23, 11, 34, 5, 26, 0, 0, 4294967197, 0, 0, 2);
					break;
				
				case 5:
					func_82(&Var1, 4294967197, 20, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 6:
					func_82(&Var1, 4294967197, 4294967197, 40, 13, 14, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 7:
					func_82(&Var1, 4294967197, 4294967197, 90, 32, 17, 1, 8, 0, 1, 4294967197, 0, 0, 3);
					break;
				
				case 8:
					func_82(&Var1, 4294967197, 4294967197, 17, 5, 12, 0, 26, 0, 2, 4294967197, 0, 0, 5);
					break;
				
				case 9:
					func_82(&Var1, 4294967197, 4294967197, 16, 4, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_82(&Var1, 4294967197, 4294967197, 208, 71, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_82(&Var1, 4294967197, 4294967197, 259, 10, 35, 0, 24, 0, 0, 4294967197, 0, 43, 31);
					break;
				
				case 12:
					func_82(&Var1, 4294967197, 4294967197, 18, 6, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_82(&Var1, 4294967197, 4294967197, 19, 7, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_82(&Var1, 4294967197, 4294967197, 20, 8, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_82(&Var1, 4294967197, 4294967197, 21, 9, 12, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_82(&Var1, 4294967197, 4294967197, 135, 40, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_82(&Var1, 4294967197, 4294967197, 74, 24, 52, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_82(&Var1, 4294967197, 4294967197, 176, 53, 26, 5, 26, 0, 0, 4294967197, 0, 41, 31);
					break;
				
				case 19:
					func_82(&Var1, 4294967197, 4294967197, 125, 24, 18, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_82(&Var1, 4294967197, 4294967197, 162, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_82(&Var1, 4294967197, 4294967197, 75, 24, 36, 0, 26, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 22:
					func_82(&Var1, 4294967197, 4294967197, 227, 53, 25, 0, 27, 0, 0, 4294967197, 0, 25, 31);
					break;
				
				case 23:
					func_82(&Var1, 4294967197, 4294967197, 228, 54, 25, 0, 28, 0, 0, 4294967197, 0, 26, 31);
					break;
				
				case 24:
					func_82(&Var1, 4294967197, 4294967197, 229, 55, 25, 0, 29, 0, 0, 4294967197, 0, 27, 31);
					break;
				
				case 25:
					func_82(&Var1, 4294967197, 4294967197, 230, 56, 25, 0, 30, 0, 0, 4294967197, 0, 28, 31);
					break;
				
				case 26:
					func_82(&Var1, 4294967197, 4294967197, 231, 57, 25, 0, 31, 0, 0, 4294967197, 0, 29, 31);
					break;
				
				case 27:
					func_82(&Var1, 4294967197, 4294967197, 232, 58, 25, 0, 32, 0, 0, 4294967197, 0, 30, 31);
					break;
				
				case 28:
					func_82(&Var1, 4294967197, 4294967197, 233, 59, 25, 0, 33, 0, 0, 4294967197, 0, 31, 31);
					break;
				
				case 29:
					func_82(&Var1, 4294967197, 4294967197, 234, 60, 25, 0, 34, 0, 0, 4294967197, 0, 32, 31);
					break;
				
				case 30:
					func_82(&Var1, 4294967197, 4294967197, 235, 61, 25, 0, 35, 0, 0, 4294967197, 0, 33, 31);
					break;
				
				case 31:
					func_82(&Var1, 4294967197, 4294967197, 236, 62, 25, 0, 36, 0, 0, 4294967197, 0, 34, 31);
					break;
				
				case 32:
					func_82(&Var1, 4294967197, 4294967197, 237, 63, 25, 0, 37, 0, 0, 4294967197, 0, 35, 31);
					break;
				
				case 33:
					func_82(&Var1, 4294967197, 4294967197, 238, 64, 25, 0, 38, 0, 0, 4294967197, 0, 36, 31);
					break;
				
				case 34:
					func_82(&Var1, 4294967197, 4294967197, 239, 65, 25, 0, 39, 0, 0, 4294967197, 0, 37, 31);
					break;
				
				case 35:
					func_82(&Var1, 4294967197, 4294967197, 240, 66, 25, 0, 40, 0, 0, 4294967197, 0, 38, 31);
					break;
				
				case 36:
					func_82(&Var1, 4294967197, 4294967197, 241, 67, 25, 0, 41, 0, 0, 4294967197, 0, 39, 31);
					break;
				
				case 37:
					func_82(&Var1, 4294967197, 4294967197, 242, 68, 25, 0, 42, 0, 0, 4294967197, 0, 40, 31);
					break;
				
				case 38:
					func_82(&Var1, 4294967197, 4294967197, 260, 72, 17, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_82(&Var1, 4294967197, 4294967197, 125, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_82(&Var1, 4294967197, 4294967197, 123, 24, 0, 0, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_82(&Var1, 4294967197, 4294967197, 159, 69, 17, 5, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_82(&Var1, 4294967197, 4294967197, 89, 22, 15, 6, 26, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_82(&Var1, 4294967197, 4294967197, 317, 69, 17, 0, 0, 0, 51, 4294967197, 0, 0, 6);
					break;
				
				case 44:
					func_82(&Var1, 4294967197, 4294967197, 30, 23, 16, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 45:
					func_82(&Var1, 4294967197, 4294967197, 106, 70, 17, 5, 26, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 46:
					func_82(&Var1, 4294967197, 4294967197, 117, 24, 20, 5, 26, 0, 52, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("player_two"):
			...
			{
				case 0:
					func_82(&Var1, 4294967197, 4294967197, 0, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 1:
					func_82(&Var1, 4294967197, 4294967197, 17, 5, 8, 2, 3, 0, 0, 4294967197, 0, 0, 8);
					break;
				
				case 2:
					func_82(&Var1, 4294967197, 4294967197, 43, 8, 12, 3, 5, 0, 0, 4294967197, 0, 0, 1);
					break;
				
				case 3:
					func_82(&Var1, 4294967197, 4294967197, 50, 14, 8, 0, 15, 6, 3, 4294967197, 0, 0, 2);
					break;
				
				case 4:
					func_82(&Var1, 4294967197, 4294967197, Global_1B416.f_936.f_21B.f_C4[2], Global_1B416.f_936.f_21B.f_C8[2], 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 5:
					func_82(&Var1, 4294967197, 4294967197, 95, 33, 8, 0, 15, 0, 0, 4294967197, 0, 0, 6);
					break;
				
				case 6:
					func_82(&Var1, 4294967197, 4294967197, 49, 13, 10, 4, 6, 0, 0, 4294967197, 0, 0, 3);
					break;
				
				case 7:
					func_82(&Var1, 4294967197, 4294967197, 49, 13, 14, 4, 15, 0, 0, 4294967197, 0, 0, 4);
					break;
				
				case 8:
					func_82(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 7, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 9:
					func_82(&Var1, 4294967197, 4294967197, 53, 17, 11, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 10:
					func_82(&Var1, 4294967197, 4294967197, 96, 81, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 11:
					func_82(&Var1, 4294967197, 4294967197, 51, 15, 33, 0, 8, 0, 0, 4294967197, 0, 0, 5);
					break;
				
				case 12:
					func_82(&Var1, 4294967197, 4294967197, 0, 93, 29, 0, 13, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 13:
					func_82(&Var1, 4294967197, 4294967197, 52, 16, 30, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 14:
					func_82(&Var1, 4294967197, 4294967197, 241, 92, 16, 0, 12, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 15:
					func_82(&Var1, 4294967197, 4294967197, 97, 34, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 16:
					func_82(&Var1, 4294967197, 4294967197, 44, 9, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 17:
					func_82(&Var1, 4294967197, 4294967197, 45, 10, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 18:
					func_82(&Var1, 4294967197, 4294967197, 46, 11, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 19:
					func_82(&Var1, 4294967197, 4294967197, 47, 12, 12, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 20:
					func_82(&Var1, 4294967197, 4294967197, 161, 53, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 21:
					func_82(&Var1, 4294967197, 4294967197, 0, 44, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 22:
					func_82(&Var1, 4294967197, 4294967197, 98, 0, 28, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 23:
					func_82(&Var1, 4294967197, 4294967197, 27, 0, 31, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 24:
					func_82(&Var1, 4294967197, 4294967197, 190, 71, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 25:
					func_82(&Var1, 4294967197, 4294967197, 191, 72, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 26:
					func_82(&Var1, 4294967197, 4294967197, 192, 73, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 27:
					func_82(&Var1, 4294967197, 4294967197, 193, 74, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 28:
					func_82(&Var1, 4294967197, 4294967197, 194, 75, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 29:
					func_82(&Var1, 4294967197, 4294967197, 195, 76, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 30:
					func_82(&Var1, 4294967197, 4294967197, 196, 77, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 31:
					func_82(&Var1, 4294967197, 4294967197, 197, 78, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 32:
					func_82(&Var1, 4294967197, 4294967197, 198, 79, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 33:
					func_82(&Var1, 4294967197, 4294967197, 199, 80, 8, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 34:
					func_82(&Var1, 4294967197, 4294967197, 200, 62, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 35:
					func_82(&Var1, 4294967197, 4294967197, 201, 63, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 36:
					func_82(&Var1, 4294967197, 4294967197, 202, 64, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 37:
					func_82(&Var1, 4294967197, 4294967197, 203, 65, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 38:
					func_82(&Var1, 4294967197, 4294967197, 204, 66, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 39:
					func_82(&Var1, 4294967197, 4294967197, 205, 67, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 40:
					func_82(&Var1, 4294967197, 4294967197, 206, 68, 16, 0, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 41:
					func_82(&Var1, 4294967197, 4294967197, 2, 43, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 42:
					func_82(&Var1, 4294967197, 4294967197, 55, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 43:
					func_82(&Var1, 4294967197, 4294967197, 0, 52, 8, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 44:
					func_82(&Var1, 4294967197, 4294967197, 70, 30, 32, 6, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 45:
					func_82(&Var1, 4294967197, 4294967197, 19, 91, 28, 0, 0, 0, 0, 4294967197, 0, 0, 7);
					break;
				
				case 46:
					func_82(&Var1, 4294967197, 4294967197, 0, 0, 28, 0, 0, 0, 0, 4294967197, 0, 0, 31);
					break;
				
				case 47:
					func_82(&Var1, 4294967197, 4294967197, 79, 32, 8, 5, 15, 0, 0, 4294967197, 0, 0, 31);
					break;
		...
		case joaat("mp_m_freemode_01"):
			...
			{
				case 0:
					func_82(&Var1, 4294967197, 4294967197, 0, 0, 10, 4294967197, 0, 4294967197, 4294967197, 0, 0, 0, 31);
					break;
				
				case 1:
					func_82(&Var1, 4294967197, 4294967197, 1, 127, 38, 4294967197, 2, 0, 0, 0, 0, 62, 0);
					break;
				
				case 2:
					func_82(&Var1, 4294967197, 4294967197, 0, 248, 45, 4294967197, 240, 0, 0, 0, 0, 144, 1);
					break;
				
				case 3:
					func_82(&Var1, 4294967197, 4294967197, 4, 31, 25, 4294967197, 240, 0, 0, 0, 0, 231, 2);
					break;
				
				case 4:
					func_82(&Var1, 4294967197, 4294967197, 1, 66, 10, 4294967197, 21, 0, 0, 0, 0, 123, 3);
					break;
				
				case 5:
					func_82(&Var1, 4294967197, 4294967197, 1, 93, 141, 4294967197, 3, 0, 0, 0, 0, 114, 4);
					break;
				
				case 6:
					func_82(&Var1, 4294967197, 4294967197, 1, 116, 113, 4294967197, 7, 0, 0, 0, 0, 113, 5);
					break;
				
				case 7:
					func_82(&Var1, 4294967197, 4294967197, 1, 61, 136, 4294967197, 27, 0, 0, 0, 0, 61, 6);
					break;
				
				case 8:
					func_82(&Var1, 4294967197, 4294967197, 0, 112, 10, 4294967197, 240, 0, 0, 0, 0, 8, 7);
					break;
				
				case 9:
					func_82(&Var1, 4294967197, 4294967197, 4, 131, 24, 4294967197, 240, 0, 0, 0, 0, 223, 8);
					break;
				
				case 10:
					func_82(&Var1, 4294967197, 4294967197, 1, 209, 188, 4294967197, 208, 0, 0, 0, 0, 64, 9);
					break;
				
				case 11:
					func_82(&Var1, 4294967197, 4294967197, 1, 209, 160, 4294967197, 211, 0, 0, 0, 43, 157, 10);
					break;
				
				case 12:
					func_82(&Var1, 4294967197, 4294967197, 1, 162, 174, 4294967197, 201, 0, 0, 0, 0, 158, 11);
					break;
				
				case 13:
					func_82(&Var1, 4294967197, 4294967197, 1, 4, 240, 4294967197, 34, 0, 0, 0, 0, 97, 12);
					break;
				
				case 14:
					func_82(&Var1, 4294967197, 4294967197, 1, 128, 232, 4294967197, 43, 0, 0, 0, 0, 102, 13);
					break;
				
				case 15:
					func_82(&Var1, 4294967197, 4294967197, 1, 66, 65, 4294967197, 224, 0, 0, 0, 0, 100, 14);
					break;
				
				case 16:
					func_82(&Var1, 4294967197, 4294967197, 1, 65, 172, 4294967197, 202, 0, 0, 0, 0, 64, 15);
					break;
				
				case 17:
					func_82(&Var1, 4294967197, 4294967197, 1, 64, 10, 4294967197, 1, 0, 0, 0, 0, 66, 16);
					break;
				
				case 18:
					func_82(&Var1, 4294967197, 4294967197, 5, 98, 80, 4294967197, 240, 0, 0, 0, 0, 87, 17);
					break;
				
				case 19:
					func_82(&Var1, 4294967197, 4294967197, 5, 192, 96, 4294967197, 240, 0, 0, 0, 0, 80, 18);
					break;
				
				case 20:
					func_82(&Var1, 4294967197, 4294967197, 1, 124, 96, 4294967197, 11, 0, 0, 0, 0, 110, 19);
					break;
				
				case 21:
					func_82(&Var1, 4294967197, 4294967197, 0, 80, 114, 4294967197, 240, 0, 0, 0, 0, 2, 20);
					break;
				
				case 22:
					func_82(&Var1, 4294967197, 4294967197, 6, 43, 112, 4294967197, 82, 0, 0, 0, 0, 48, 21);
					break;
				
				case 23:
					func_82(&Var1, 4294967197, 4294967197, 1, 116, 144, 4294967197, 2, 0, 0, 0, 0, 108, 22);
					break;
				
				case 24:
					func_82(&Var1, 4294967197, 4294967197, 1, 63, 38, 4294967197, 3, 0, 0, 0, 0, 63, 23);
					break;
				
				case 25:
					func_82(&Var1, 4294967197, 4294967197, 2, 64, 10, 4294967197, 240, 0, 0, 0, 0, 41, 24);
					break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 0:
					func_82(&Var1, 4294967197, 4294967197, 0, 0, 0, 4294967197, 0, 4294967197, 4294967197, 0, 4294967197, 0, 31);
					break;
				
				case 1:
					func_82(&Var1, 4294967197, 4294967197, 5, 136, 241, 4294967197, 47, 0, 0, 0, 0, 21, 31);
					break;
				
				case 2:
					func_82(&Var1, 4294967197, 4294967197, 4, 1, 96, 4294967197, 32, 0, 0, 0, 7, 215, 0);
					break;
				
				case 3:
					func_82(&Var1, 4294967197, 4294967197, 1, 73, 241, 4294967197, 3, 0, 0, 0, 0, 25, 1);
					break;
				
				case 4:
					func_82(&Var1, 4294967197, 4294967197, 2, 88, 217, 4294967197, 32, 0, 0, 0, 0, 33, 2);
					break;
				
				case 5:
					func_82(&Var1, 4294967197, 4294967197, 9, 7, 98, 4294967197, 32, 0, 0, 0, 7, 153, 3);
					break;
				
				case 6:
					func_82(&Var1, 4294967197, 4294967197, 1, 140, 241, 4294967197, 7, 0, 0, 0, 31, 16, 4);
					break;
				
				case 7:
					func_82(&Var1, 4294967197, 4294967197, 4, 139, 112, 4294967197, 32, 0, 0, 0, 49, 78, 5);
					break;
				
				case 8:
					func_82(&Var1, 4294967197, 4294967197, 1, 193, 48, 4294967197, 108, 0, 0, 0, 0, 17, 6);
					break;
				
				case 9:
					func_82(&Var1, 4294967197, 4294967197, 5, 114, 97, 4294967197, 103, 0, 0, 0, 0, 98, 7);
					break;
				
				case 10:
					func_82(&Var1, 4294967197, 4294967197, 9, 134, 239, 4294967197, 32, 0, 0, 0, 2, 144, 8);
					break;
				
				case 11:
					func_82(&Var1, 4294967197, 4294967197, 5, 152, 96, 4294967197, 10, 0, 0, 0, 31, 96, 9);
					break;
				
				case 12:
					func_82(&Var1, 4294967197, 4294967197, 6, 129, 1, 4294967197, 96, 0, 0, 0, 5, 120, 10);
					break;
				
				case 13:
					func_82(&Var1, 4294967197, 4294967197, 5, 0, 0, 4294967197, 10, 0, 0, 0, 0, 130, 31);
					break;
				
				case 14:
					func_82(&Var1, 4294967197, 4294967197, 4, 159, 96, 4294967197, 32, 0, 0, 0, 22, 214, 11);
					break;
				
				case 15:
					func_82(&Var1, 4294967197, 4294967197, 9, 232, 213, 4294967197, 32, 0, 0, 0, 22, 147, 12);
					break;
				
				case 16:
					func_82(&Var1, 4294967197, 4294967197, 2, 8, 98, 4294967197, 32, 0, 0, 0, 33, 39, 13);
					break;
				
				case 17:
					func_82(&Var1, 4294967197, 4294967197, 5, 150, 235, 4294967197, 106, 0, 0, 0, 0, 128, 14);
					break;
				
				case 18:
					func_82(&Var1, 4294967197, 4294967197, 6, 96, 97, 4294967197, 7, 0, 0, 0, 32, 114, 15);
					break;
				
				case 19:
					func_82(&Var1, 4294967197, 4294967197, 4, 48, 64, 4294967197, 32, 0, 0, 0, 0, 89, 16);
					break;
				
				case 20:
					func_82(&Var1, 4294967197, 4294967197, 4, 62, 64, 4294967197, 32, 0, 0, 0, 0, 78, 17);
					break;
				
				case 21:
					func_82(&Var1, 4294967197, 4294967197, 4, 49, 65, 4294967197, 32, 0, 0, 0, 8, 80, 31);
					break;
				
				case 22:
					func_82(&Var1, 4294967197, 4294967197, 3, 20, 16, 4294967197, 32, 0, 0, 0, 0, 49, 18);
					break;
				
				case 23:
					func_82(&Var1, 4294967197, 4294967197, 0, 73, 178, 4294967197, 32, 0, 0, 0, 38, 11, 19);
					break;
				
				case 24:
					func_82(&Var1, 4294967197, 4294967197, 5, 135, 53, 4294967197, 9, 0, 0, 0, 29, 27, 20);
					break;
				
				case 25:
					func_82(&Var1, 4294967197, 4294967197, 7, 233, 176, 4294967197, 120, 0, 0, 0, 11, 160, 21);
					break;
				
				case 26:
					func_82(&Var1, 4294967197, 4294967197, 4, 34, 179, 4294967197, 32, 0, 0, 0, 0, 77, 22);
					break;
				
				case 27:
					func_82(&Var1, 4294967197, 4294967197, 15, 131, 93, 4294967197, 32, 0, 0, 0, 0, 250, 23);
					break;
...
void func_85(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 155, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_86(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_90(Global_280004, 1, 1, 1, 4294967295))
			{
				unk_0x0674E58A79778E99(&(uParam0->f_6), 2);
			}
			if (!func_90(Global_280004, 2, 1, 1, 4294967295))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_70(func_89(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 1);
			}
			iVar0 = func_70(func_88(iParam1, uParam0->f_2), Global_12A8F, 0);
			if (unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
			{
				unk_0x5D96D8530B3D0904(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_70(iVar1, Global_12A8F, 0);
				if (!unk_0xEAE0D21A50E6C7F4(iVar0, uParam0->f_1))
				{
					unk_0x5D96D8530B3D0904(&(uParam0->f_6), 4);
				}
...
void func_93(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_86(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, 4294967295, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_86(&(Global_12A92[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, 4294967295, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_86(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, 2244334710, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != 4294967295 && Global_12B3B)
		{
			...
			Global_280005 = Var11;
			func_86(&(Global_12A92[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, 2244334710, 0), 4294967295, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, 4294967295, 0, 4294967295, func_75(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_94(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 9, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_95(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 48, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_96(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 1, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_98(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 6, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_99(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 33, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_100(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 17, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_101(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 18, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_102(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 7, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_103(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 84, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_104(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 104, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_105(int iParam0)
{
	...
	{
		func_93(3, iParam0, 242, 4294967295);
	}
}
...
void func_111(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 175, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_113(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 47, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_114(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 63, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_116(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 5, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_117(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 53, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_118(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 12, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_119(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 77, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_121(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 134, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_122(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 117, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_123(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_93(3, iParam0, 318, 4294967295);
	}
}
...
void func_127(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 21, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_128(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 10, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_130(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 113, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_133(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 45, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_137(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 20, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_138(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 24, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_139(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 14, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_140(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		default:
			func_93(iVar7, iParam0, 99, 4294967295);
			return;
			break;
	}
	func_86(&(Global_12A92[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
...
void func_142(int iParam0)
{
	...
	if (Global_12A92[0 /*14*/].f_2 == 4294967295)
	{
		func_93(3, iParam0, 181, 4294967295);
	}
}
...
int func_148(int iParam0, int iParam1, int iParam2)
{
			...
			if ((uVar5[iVar2] != 4294967197 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_148(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_148(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_12A92[2 /*14*/] = { func_83(iVar0, 14, iVar4, 4294967295) };
									if (Global_12A92[2 /*14*/].f_C == iVar3)
									{
										if (func_148(iParam0, 14, iVar4))
										{
											if (!func_39(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_12A92[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_12A92[2 /*14*/] = { func_83(iVar0, iVar2, iVar1, 4294967295) };
						if (!func_39(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_12A92[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_12A92[1 /*14*/].f_3 == unk_0x36C584991B4C183F(iParam0, func_75(iParam1)) && Global_12A92[1 /*14*/].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_75(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()
{
	...
	{
		if (func_150(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			iVar0 = func_149(unk_0x16F2683693E537C9());
			if (func_152(iVar0) && (!func_91(14) || Global_1AFFD))
			{
				if (Global_1B416.f_936.f_21B.f_10E1 != iVar0 && func_152(Global_1B416.f_936.f_21B.f_10E1))
				{
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != 4294967295)
	{
		...
		func_161(&sVar1, Var0.f_3, Global_181DD, iParam1, iParam2);
	}
}
...
void func_162(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 1:
			func_163(uParam1, "Abigail2", func_156(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 2:
			func_163(uParam1, "Barry1", func_156(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 3:
			func_163(uParam1, "Barry2", func_156(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 1, 1);
			break;
		
		case 4:
			func_163(uParam1, "Barry3", func_156(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		...
		case 7:
			func_163(uParam1, "Barry4", func_156(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_164(iParam0), 0, 0);
			break;
		
		case 8:
			func_163(uParam1, "Dreyfuss1", func_156(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		...
		case 15:
			func_163(uParam1, "Epsilon7", func_156(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 16:
			func_163(uParam1, "Epsilon8", func_156(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 17:
			func_163(uParam1, "Extreme1", func_156(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		...
		case 20:
			func_163(uParam1, "Extreme4", func_156(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 21:
			func_163(uParam1, "Fanatic1", func_156(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_164(iParam0), 1, 0);
			break;
		
		case 22:
			func_163(uParam1, "Fanatic2", func_156(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_164(iParam0), 1, 0);
			break;
		
		case 23:
			func_163(uParam1, "Fanatic3", func_156(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_164(iParam0), 0, 1);
			break;
		
		case 24:
			func_163(uParam1, "Hao1", func_156(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_164(iParam0), 0, 1);
			break;
		
		case 25:
			func_163(uParam1, "Hunting1", func_156(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 26:
			func_163(uParam1, "Hunting2", func_156(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 27:
			func_163(uParam1, "Josh1", func_156(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		...
		case 29:
			func_163(uParam1, "Josh3", func_156(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_164(iParam0), 1, 1);
			break;
		
		case 30:
			func_163(uParam1, "Josh4", func_156(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 31:
			func_163(uParam1, "Maude1", func_156(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 32:
			func_163(uParam1, "Minute1", func_156(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 33:
			func_163(uParam1, "Minute2", func_156(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 34:
			func_163(uParam1, "Minute3", func_156(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 35:
			func_163(uParam1, "MrsPhilips1", func_156(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 36:
			func_163(uParam1, "MrsPhilips2", func_156(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 37:
			func_163(uParam1, "Nigel1", func_156(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		...
		case 42:
			func_163(uParam1, "Nigel2", func_156(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_164(iParam0), 1, 1);
			break;
		
		case 43:
			func_163(uParam1, "Nigel3", func_156(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 1, 1);
			break;
		
		case 44:
			func_163(uParam1, "Omega1", func_156(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 45:
			func_163(uParam1, "Omega2", func_156(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 46:
			func_163(uParam1, "Paparazzo1", func_156(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 47:
			func_163(uParam1, "Paparazzo2", func_156(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 48:
			func_163(uParam1, "Paparazzo3", func_156(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		...
		case 51:
			func_163(uParam1, "Paparazzo4", func_156(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 52:
			func_163(uParam1, "Rampage1", func_156(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 54:
			func_163(uParam1, "Rampage3", func_156(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 55:
			func_163(uParam1, "Rampage4", func_156(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 56:
			func_163(uParam1, "Rampage5", func_156(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_164(iParam0), 0, 0);
			break;
		
		case 53:
			func_163(uParam1, "Rampage2", func_156(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_164(iParam0), 1, 0);
			break;
		
		case 57:
			func_163(uParam1, "TheLastOne", func_156(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 58:
			func_163(uParam1, "Tonya1", func_156(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 59:
			func_163(uParam1, "Tonya2", func_156(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 60:
			func_163(uParam1, "Tonya3", func_156(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 61:
			func_163(uParam1, "Tonya4", func_156(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
		
		case 62:
			func_163(uParam1, "Tonya5", func_156(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_164(iParam0), 0, 1);
			break;
...
void func_166()
{
	...
	{
		func_155();
		unk_0x9BF51DDC898CF6FE(func_167(Global_1B416.f_936.f_21B.f_10E1));
	}
	else
	{
...
void func_172(int iParam0, bool bParam1)
{
	...
	if (Var0.f_16 != 0)
	{
		func_199(Var0.f_16, 0);
	}
	func_190(iParam0, Global_12C5B);
	if (!bParam1)
	{
...
{
	func_176(iParam0, 1);
	Global_1B416.f_4889[iParam0 /*6*/].f_3 = func_175();
...
int func_186()
{
	if ((func_8() == 4294967295 || func_8() == 999) && !func_187() == 0)
	{
		return 1;
	}
	return 0;
...
int func_201()
{
	return func_202(unk_0xBB0808A181D4745C(), 0);
}
...
void func_207()
{
	if (iLocal_414 == 0)
	{
		if (func_208(unk_0x16F2683693E537C9(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
			unk_0x91F2686FF85AFDF5("SCRIPTED_SCANNER_REPORT_JOSH_4_01", 0f);
...
void func_209()
{
	if (iLocal_409 == 0)
	{
		if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, true, 0))
		{
			while (func_206())
			{
				func_229();
			...
			func_228(&uLocal_221, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
			func_228(&uLocal_221, 4, Local_386.f_1C[0], "JOSH", 0, 1);
	...
	else if (iLocal_409 == 1)
	{
		if (iLocal_49 != 0)
		{
			if ((unk_0x1C0640BA9A7327B3() - iLocal_412) > 6000)
			{
				if (iLocal_49 == 3)
				{
				...
				else if (iLocal_49 == 1)
				{
					if (func_440(Local_386.f_1C[0]))
					{
						if (func_210(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 1) < 75f)
						{
...
int func_214()
{
	...
	if (unk_0xD803B885F5E47A62() == func_217())
	{
		return 0;
	}
	...
	switch (iLocal_49)
	{
		case 0:
			if (iLocal_48 == 3)
			{
				if (func_440(Local_386.f_1C[0]))
				{
					unk_0xA3BF0AA5A2608191(Local_386.f_1C[0]);
					if (func_204(iLocal_391))
					{
						if (unk_0xF65264B66E133BD8(-1138.421f, 298.0307f, 65.90032f, 4f, 0, 1, 0, 0, 0, iLocal_391, 0))
						{
							func_488("Back gate blocked");
							vLocal_55 = { -1130.35f, 307.92f, 65.19f };
							unk_0xDD353D0E9C789D0E(&iLocal_389);
							unk_0x96167B03C5A77156(0, vLocal_55, 2f, 20000, 1f, 1, 1193033728);
							unk_0x96167B03C5A77156(0, -1126.56f, 319.85f, 65.98f, 2f, 20000, 1f, 1, 1193033728);
							unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 500f, 4294967295, 0, 0);
							unk_0x75ABDC5F81978924(iLocal_389);
							unk_0xFADC0A217229F6B5(Local_386.f_1C[0], true);
							unk_0x78ADC381772E3D54(Local_386.f_1C[0], iLocal_389);
						}
						else
						{
							...
							if (func_204(iLocal_391))
							{
								unk_0x89258193691A7600(0, iLocal_391, unk_0x16F2683693E537C9(), 8, 30f, 786469, 500f, 0.1f, 1);
							}
							else
							{
								unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 500f, 4294967295, 0, 0);
					...
					else
					{
						...
						if (func_204(iLocal_391))
						{
							unk_0x5B1D360B9C6F0A09(0, iLocal_391, 20000, 4294967295, 2f, 1, 0);
							unk_0x89258193691A7600(0, iLocal_391, unk_0x16F2683693E537C9(), 8, 30f, 786469, 500f, 0.1f, 1);
						}
						else
						{
					...
					unk_0xBAFED2F6486F771A(Local_386.f_1C[0], 2, true);
					unk_0xF82EA857DA10E0CD(&iLocal_389);
				}
				iLocal_413 = unk_0x1C0640BA9A7327B3();
				unk_0x5507FCD92D15E617(Local_386.f_1C[0], 1);
				unk_0x4E885A246A9D983A(Local_386.f_1C[0], 177, true);
				iLocal_49 = 1;
			}
			break;
		...
		case 1:
			if (func_440(Local_386.f_1C[0]))
			{
				if (!iLocal_406)
				{
					...
					{
						if (func_210(Local_386.f_1C[0], unk_0x16F2683693E537C9(), 0) < 20f)
						{
							func_228(&uLocal_221, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
							func_228(&uLocal_221, 4, Local_386.f_1C[0], "JOSH", 0, 1);
							if (func_206())
				...
				if (func_204(iLocal_391))
				{
					if (unk_0xC42A92762C58E1B9(Local_386.f_1C[0], iLocal_391, 1))
					{
						if (unk_0x6EE94F60DA2A2273(iLocal_391) < 20f)
						{
							unk_0xA3BF0AA5A2608191(Local_386.f_1C[0]);
							unk_0x75CDA8644CD3B5F5(Local_386.f_1C[0], 0, 4416);
							unk_0xF3268524E9BE6D6E(Local_386.f_1C[0], unk_0x16F2683693E537C9(), 510f, 4294967295, 0, 0);
							func_234(&iLocal_391);
						}
					}
					if (func_440(unk_0x16F2683693E537C9()))
					{
						if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), iLocal_391, 1))
						{
							unk_0xA3BF0AA5A2608191(Local_386.f_1C[0]);
							unk_0xF3268524E9BE6D6E(Local_386.f_1C[0], unk_0x16F2683693E537C9(), 510f, 4294967295, 0, 0);
							func_234(&iLocal_391);
					...
					if (unk_0x36646919F20EAFFC(Local_386.f_1C[0]))
					{
						if (iLocal_407 == 0)
						{
				...
				if (func_210(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 1) > 350f)
				{
					func_488("Deleting Josh, setting as lost");
					func_233(&(Local_386.f_1C[0]));
					func_232(&iLocal_391);
					iLocal_49 = 2;
				}
				if (func_440(unk_0x16F2683693E537C9()) && func_440(Local_386.f_1C[0]))
				{
					if (iLocal_410 < 3)
					{
						if (func_210(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 1) < 10f)
						{
							if (!func_206() && (unk_0x1C0640BA9A7327B3() - iLocal_413) > 8000)
							{
			...
			{
				if (unk_0xB87D13D0C064E9D1(Local_386.f_1C[0], unk_0x16F2683693E537C9(), 1))
				{
...
void func_237()
{
	switch (Local_47.f_B)
	{
		case 0:
			...
			while (iLocal_393 <= 4)
			{
				if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_415[iLocal_393 /*7*/], Local_415[iLocal_393 /*7*/].f_3, Local_415[iLocal_393 /*7*/].f_6, 0, true, 2))
				{
					func_238("Player detected inside flee direction trigger: ", iLocal_393);
					unk_0x523BCC9DC80CD82F(iLocal_43);
					unk_0x523BCC9DC80CD82F(iLocal_42);
					...
					func_238(Local_47.f_A, Local_47.f_9);
					unk_0x36187931D29E5BBE(Local_47.f_9, Local_47.f_A);
					while ((!unk_0x3DDA6C6A285628E4(Local_47.f_9, Local_47.f_A) || !unk_0xB87F6CF6E5628C67(iLocal_43)) || !unk_0xB87F6CF6E5628C67(iLocal_42))
					{
						SYSTEM::WAIT(0);
					}
		...
		case 1:
			if (!unk_0xC844350D5D58C99A(Local_47.f_7))
			{
				Local_47.f_7 = unk_0x122AAB0B1D6F55AD(iLocal_43, Local_47, 0f, true, true, false);
				unk_0xB9FD7450C0DAB575(Local_47.f_7, 1084227584);
				unk_0xC4C7FD0EF3FEAB0B(Local_47.f_7, Local_47.f_3, Local_47.f_4, Local_47.f_5, Local_47.f_6);
				Local_47.f_8 = unk_0x852A19533F896693(Local_47.f_7, 6, iLocal_42, 4294967295, 1, true);
				unk_0x262EF6C6306BEA6C(Local_47.f_8, joaat("weapon_pistol"), 4294967295, false, true);
				unk_0x11AD11297DC58CC7(Local_47.f_8, true);
				unk_0xA3BF0AA5A2608191(Local_47.f_8);
		...
		case 2:
			...
			{
				if (func_440(Local_47.f_8))
				{
					if (unk_0x405E212DDE472467(Local_47.f_8, 0))
					{
						unk_0x4D3C3C0B0DE2663E(Local_47.f_7, Local_47.f_9, Local_47.f_A, 1);
						unk_0x9C8F7A2F15781E10(Local_47.f_7, 1);
						func_238("*** m_AI_FleeCar.iRecNum: ", Local_47.f_9);
						switch (Local_47.f_9)
						{
							case 0:
								unk_0xA9FBE21EB8701B34(Local_47.f_7, 1.5f);
								break;
							
							case 1:
								unk_0xA9FBE21EB8701B34(Local_47.f_7, 1f);
								break;
							
							case 2:
								unk_0xA9FBE21EB8701B34(Local_47.f_7, 1.4f);
								break;
		...
		case 3:
			if (func_204(Local_47.f_7))
			{
				if (!unk_0x20D6474D5F4B9FC6(Local_47.f_7))
				{
					if (unk_0x3DDA6C6A285628E4(Local_47.f_9, Local_47.f_A))
					{
						unk_0xDB8844D4B7C60440(Local_47.f_9, Local_47.f_A);
		...
		case 4:
			if (func_204(Local_47.f_7))
			{
				if (func_440(Local_47.f_8))
				{
					unk_0x11AD11297DC58CC7(Local_47.f_8, false);
...
void func_239()
{
	...
	switch (iLocal_48)
	{
		case 0:
			...
			if ((unk_0x1C0640BA9A7327B3() - iLocal_394) > 4000)
			{
			...
			while (iVar0 <= (Local_386.f_1C - 1))
			{
				if (func_440(Local_386.f_1C[iVar0]))
				{
					if (func_210(Local_386.f_1C[iVar0], unk_0x16F2683693E537C9(), 0) > 10f)
					{
		...
		case 2:
			if ((unk_0x1C0640BA9A7327B3() - iLocal_394) > 20000)
			{
				func_488("************************************** TIMEOUT - ARREST next frame");
				if (func_440(Local_386.f_1C[1]))
				{
					unk_0xA3BF0AA5A2608191(Local_386.f_1C[1]);
					unk_0x11AD11297DC58CC7(Local_386.f_1C[1], false);
					unk_0xF27A0DCBF07DE99D(Local_386.f_1C[1], unk_0x16F2683693E537C9());
				}
				iLocal_48 = 4;
				iLocal_394 = unk_0x1C0640BA9A7327B3();
			}
			...
			while (iVar0 <= (Local_386.f_1C - 1))
			{
				if (func_440(Local_386.f_1C[iVar0]))
				{
					if (func_210(Local_386.f_1C[iVar0], unk_0x16F2683693E537C9(), 0) > 12f)
					{
		...
		case 4:
			...
			while (iVar0 <= (Local_386.f_1C - 1))
			{
				if (func_440(Local_386.f_1C[iVar0]))
				{
					...
					else if (func_240(Local_386.f_1C[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
		...
		case 3:
			...
			if (!iLocal_399)
			{
				...
				while (iVar0 <= (Local_386.f_1C - 1))
				{
					if (func_440(Local_386.f_1C[iVar0]))
					{
						unk_0xA3BF0AA5A2608191(Local_386.f_1C[iVar0]);
						unk_0x11AD11297DC58CC7(Local_386.f_1C[iVar0], false);
						unk_0xDD353D0E9C789D0E(&iLocal_389);
						unk_0x2C4A1A0F54A166E8(0, unk_0x16F2683693E537C9(), 4294967295, 3607063905);
						unk_0x75ABDC5F81978924(iLocal_389);
						unk_0x78ADC381772E3D54(Local_386.f_1C[iVar0], iLocal_389);
						unk_0xF82EA857DA10E0CD(&iLocal_389);
					}
					iVar0++;
				}
				func_228(&uLocal_56, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
				func_228(&uLocal_56, 3, Local_386.f_1C[1], "JOSHCOP", 0, 1);
				if (func_206())
				{
					func_236();
				...
				iLocal_399 = 1;
				iLocal_411 = unk_0x1C0640BA9A7327B3();
			}
			else
			{
				iVar1 = 1;
				while (iVar1 <= (Local_386.f_1C - 1))
				{
					if (func_440(Local_386.f_1C[iVar1]))
					{
						if (func_210(Local_386.f_1C[iVar1], unk_0x16F2683693E537C9(), 1) > 20f)
						{
							unk_0x298903DD96203C2C(Local_386.f_1C[iVar1], 75);
						}
						else
						{
							unk_0x298903DD96203C2C(Local_386.f_1C[iVar1], 1);
						}
					}
					iVar1++;
				}
				if ((unk_0x1C0640BA9A7327B3() - iLocal_411) > 15000)
				{
					iVar1 = 1;
					while (iVar1 <= (Local_386.f_1C - 1))
					{
						if (func_440(Local_386.f_1C[iVar1]))
						{
							if (func_210(Local_386.f_1C[iVar1], unk_0x16F2683693E537C9(), 1) >= 50f)
							{
								func_205(&(Local_386.f_1C[iVar1]), 0, 1, 1);
							}
						}
						iVar1++;
					}
	...
	if (iLocal_48 != 3)
	{
		...
		while (iVar0 <= (Local_386.f_1C - 1))
		{
			if (func_440(Local_386.f_1C[iVar0]))
			{
				if (unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), Local_386.f_1C[iVar0]))
				{
				...
				if (func_240(Local_386.f_1C[iVar0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
				...
				if (iLocal_48 != 4)
				{
					if (func_210(Local_386.f_1C[iVar0], unk_0x16F2683693E537C9(), 0) < 2.3f)
					{
	...
	if (func_440(unk_0x16F2683693E537C9()) && func_440(iParam0))
	{
		...
		if (!unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
		{
			if (unk_0x65851B2C8786EE74(unk_0x16F2683693E537C9()))
			{
				...
				{
					return func_253(unk_0x16F2683693E537C9(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_241(int iParam0, float fParam1)
{
	...
	if (func_440(unk_0x16F2683693E537C9()) && func_440(iParam0))
	{
		if (func_252(iParam0) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iParam0))
		{
			if (unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
			{
				fVar0 = 40f;
...
{
	return func_243(iParam0, unk_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}
...
int func_247(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_249(unk_0x68F4C0EC296D3901(iParam1, true) - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	{
		vVar1 = { func_249(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_254(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_440(unk_0x16F2683693E537C9()) && func_440(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_258(iParam0, bParam1, iVar0, fVar1))
			{
				return 1;
			}
...
int func_257(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_249(vParam1 - unk_0x68F4C0EC296D3901(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_258(int iParam0, bool bParam1, int iParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
...
void func_259()
{
	...
	else
	{
		...
		{
			case 0:
				if ((unk_0x1C0640BA9A7327B3() - iLocal_52) > 1000)
				{
					iLocal_50 = 1;
				}
				break;
			...
			case 1:
				if (!func_206() && !unk_0xD17F06053799A7CA())
				{
					if (iLocal_51)
					{
						func_228(&uLocal_56, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
			...
			case 2:
				if (!func_206())
				{
					iLocal_52 = unk_0x1C0640BA9A7327B3();
					iLocal_50 = 0;
				}
				break;
...
void func_261()
{
	if (iLocal_45 == 1)
	{
		...
		{
			if (unk_0x8F677B1F58B4741C() > 14000 && !iLocal_403)
			{
				unk_0xC92DB9682A650680("JOSH4_START");
	...
	{
		unk_0xC92DB9682A650680("JOSH4_ACTION");
	...
	else if (!iLocal_405)
	{
		if (func_440(unk_0x16F2683693E537C9()))
		{
			if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				unk_0xC92DB9682A650680("JOSH4_VEHICLE");
...
void func_262()
{
	...
	if (unk_0x75EECC9B0572F772())
	{
		if (func_440(Local_386.f_1C[1]))
		{
			...
			unk_0xA0A8D79ACBBD1CB8("Cop_standing_idle", Local_386.f_1C[1], 0);
		}
		if (func_440(Local_386.f_1C[2]))
		{
			func_488("Trying to set Cop 2 component variation (intro loop)");
			unk_0xA0A8D79ACBBD1CB8("Cop_with_notepad", Local_386.f_1C[2], 0);
		}
	}
	switch (iLocal_46)
	{
		case 0:
			if (!unk_0x7F8A39872A07D2CE(sLocal_41, ""))
			{
				if (iLocal_400 == 0)
				{
		...
		case 1:
			switch (iLocal_408)
			{
				case 0:
					if (func_290(1, 1093140480, 0))
					{
						...
						if (func_204(iVar0))
						{
							...
							else if (unk_0x3D1053F9EB43B7AD(iVar0, -1115.984f, 285.5924f, 61.94241f, -1097.599f, 285.1346f, 66.34669f, 33f, 0, true, 0))
							{
						...
						if (func_204(iLocal_390))
						{
							unk_0xA47B46945FF6DE74(iLocal_390, -1107.5f, 280.33f, 64.01f, 1, false, 0, 1);
							unk_0xD8F6A53F4799FAFE(iLocal_390, 97.97f);
							unk_0xB9FD7450C0DAB575(iLocal_390, 1084227584);
						}
						iLocal_408++;
					}
					break;
				...
				case 1:
					unk_0x3F423BF5B8125A50("rcmjosh4");
					unk_0x3F423BF5B8125A50("combat@gestures@pistol@halt");
					unk_0x3F423BF5B8125A50("combat@gestures@pistol@glances");
					unk_0x523BCC9DC80CD82F(iLocal_392);
					iLocal_408++;
					break;
				
				case 2:
					if (((unk_0xB4AE0788C1587752("rcmjosh4") && unk_0xB4AE0788C1587752("combat@gestures@pistol@halt")) && unk_0xB4AE0788C1587752("combat@gestures@pistol@glances")) && unk_0xB87F6CF6E5628C67(iLocal_392))
					{
						iLocal_408++;
					}
					break;
				...
				case 3:
					...
					if (func_274())
					{
						...
						unk_0x8B4C4CA774181102(0f, 5f, 0);
						iLocal_408 = 4;
					}
					func_273();
...
void func_263(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_264(unk_0x16F2683693E537C9()))
	{
...
void func_265(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_269(unk_0xD803B885F5E47A62())) && !func_267(unk_0xD803B885F5E47A62(), 0)) && !func_266()) && !bParam4) && !bParam5)
			{
				unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
			}
		}
		else if (((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_269(unk_0xD803B885F5E47A62())) && !bParam4) && !bParam5)
		{
			unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
		}
		Global_12B4C = 0;
...
void func_273()
{
	if (unk_0x3148AE92ED70DC30("Josh", 0))
	{
		if (func_440(Local_386.f_1C[0]))
		{
			func_488("Playing Josh's leadout");
			unk_0xDD353D0E9C789D0E(&iLocal_389);
			unk_0x0C8C0C840C2D1AD2(0, unk_0x16F2683693E537C9(), 4294967295, 2, 2);
			unk_0xC6EB89C59F2AF6B8(0, "rcmjosh4", "josh_leadout_loop", 4f, -4f, 4294967295, 262153, 0, 0, 0, 0);
			unk_0x75ABDC5F81978924(iLocal_389);
			unk_0x78ADC381772E3D54(Local_386.f_1C[0], iLocal_389);
			unk_0xF82EA857DA10E0CD(&iLocal_389);
			unk_0xBD453909DC26A85D(Local_386.f_1C[0], 247561816, false, 1, 0);
		}
	}
	if (unk_0x3148AE92ED70DC30("Security_guard_pistol", 0))
	{
		if (func_440(iLocal_387) && func_440(Local_386.f_1C[1]))
		{
			unk_0x96C150704BF4D0C6(iLocal_387, Local_386.f_1C[1]);
			func_488("*** Gave idle cop gun");
		}
	}
	if (unk_0x3148AE92ED70DC30("FBI_Agent_1_Gun", 0))
	{
		if (func_440(iLocal_388) && func_440(Local_386.f_1C[2]))
		{
			unk_0x96C150704BF4D0C6(iLocal_388, Local_386.f_1C[2]);
			func_488("*** Gave notepad cop gun");
		}
	}
	if (unk_0x3148AE92ED70DC30("Cop_standing_idle", 0))
	{
		if (func_440(Local_386.f_1C[1]))
		{
			unk_0xBD453909DC26A85D(Local_386.f_1C[1], 1063765679, false, 1, 0);
			unk_0xDD353D0E9C789D0E(&iLocal_389);
			unk_0x0C8C0C840C2D1AD2(0, unk_0x16F2683693E537C9(), 4294967295, 1026, 2);
			unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 4294967295, 1);
			unk_0xC6EB89C59F2AF6B8(0, "combat@gestures@pistol@glances", "90", 8f, -1000f, 4294967295, 262184, 0, 0, 0, 0);
			unk_0x75ABDC5F81978924(iLocal_389);
			unk_0x78ADC381772E3D54(Local_386.f_1C[1], iLocal_389);
			unk_0xF82EA857DA10E0CD(&iLocal_389);
			func_488("*** Idle cop anim");
		}
	}
	if (unk_0x3148AE92ED70DC30("Cop_with_notepad", 0))
	{
		if (func_440(Local_386.f_1C[2]))
		{
			unk_0xBD453909DC26A85D(Local_386.f_1C[2], 1063765679, false, 1, 0);
			unk_0xDD353D0E9C789D0E(&iLocal_389);
			unk_0x0C8C0C840C2D1AD2(0, unk_0x16F2683693E537C9(), 4294967295, 1026, 2);
			unk_0xE20F700AC2AFCA92(0, -1103.72f, 289.46f, 63.23f, unk_0x16F2683693E537C9(), 1f, false, 0.1f, 4f, true, 0, 1, 3337513804, 20000);
			unk_0xE20F700AC2AFCA92(0, -1106.08f, 288.55f, 63.31f, unk_0x16F2683693E537C9(), 1f, false, 0.1f, 4f, true, 0, 1, 3337513804, 20000);
			unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 4294967295, 1);
			unk_0x75ABDC5F81978924(iLocal_389);
			unk_0x78ADC381772E3D54(Local_386.f_1C[2], iLocal_389);
			unk_0xF82EA857DA10E0CD(&iLocal_389);
...
void func_275(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (unk_0xE1DBBD6CE209517C(iVar0))
	{
		...
		if (bParam6)
		{
			...
			{
				case 0:
					if (func_148(unk_0x16F2683693E537C9(), 8, 15))
					{
						func_35(unk_0x16F2683693E537C9(), 8, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					if (func_148(unk_0x16F2683693E537C9(), 9, 6))
					{
						func_35(unk_0x16F2683693E537C9(), 9, 0, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 1:
					if (func_148(unk_0x16F2683693E537C9(), 8, 1) || func_148(unk_0x16F2683693E537C9(), 8, 10))
					{
						func_35(unk_0x16F2683693E537C9(), 8, 26, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				
				case 2:
					if (func_148(unk_0x16F2683693E537C9(), 8, 4))
					{
						func_35(unk_0x16F2683693E537C9(), 8, 15, 1, 4294967295, 0, 0, 0, 4294967295, 4294967295, 4294967295, 0, 0, 0);
					}
					break;
				}
		}
		if (iParam4 == 1)
		{
			unk_0x745CE398A4B0A3C6(func_277(unk_0xA30EC016B12C03E4()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_289()
{
	...
	if (func_440(Local_386.f_1C[0]))
	{
		unk_0x29E8331978B73E7F(Local_386.f_1C[0], "Josh", 0, 0, 0);
		func_488("*** Registered Josh");
	}
	if (func_440(Local_386.f_1C[1]))
	{
		iLocal_387 = unk_0x5ACD4E66C7BF0F49(joaat("weapon_pistol"), 4294967295, unk_0x68F4C0EC296D3901(Local_386.f_1C[1], true), 1, 1065353216, 0, 0, 1);
		unk_0x29E8331978B73E7F(Local_386.f_1C[1], "Cop_standing_idle", 0, 0, 0);
		func_488("*** Registered Cop standing");
	}
	if (func_440(Local_386.f_1C[2]))
	{
		iLocal_388 = unk_0x5ACD4E66C7BF0F49(joaat("weapon_pistol"), 4294967295, unk_0x68F4C0EC296D3901(Local_386.f_1C[2], true), 1, 1065353216, 0, 0, 1);
		unk_0x29E8331978B73E7F(Local_386.f_1C[2], "Cop_with_notepad", 0, 0, 0);
		func_488("*** Registered Cop with notepad");
	}
	if (func_440(iLocal_387))
	{
		unk_0x29E8331978B73E7F(iLocal_387, "Security_guard_pistol", 0, 0, 0);
		func_488("*** Registered idle cop gun");
	}
	if (func_440(iLocal_388))
	{
		unk_0x29E8331978B73E7F(iLocal_388, "FBI_Agent_1_Gun", 0, 0, 0);
...
int func_290(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_294(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_293(unk_0x16F2683693E537C9(), 3466132403))
				{
...
void func_297(int iParam0)
{
	...
	unk_0x3F423BF5B8125A50("combat@gestures@pistol@glances");
	unk_0x523BCC9DC80CD82F(iLocal_392);
	while ((!unk_0xB4AE0788C1587752("combat@gestures@pistol@halt") || !unk_0xB4AE0788C1587752("combat@gestures@pistol@glances")) || !unk_0xB87F6CF6E5628C67(iLocal_392))
	{
		SYSTEM::WAIT(0);
	}
	if (unk_0xBF75E4DF4C367CD9(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
	{
		unk_0x6DA3AC47D5DB9EED(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, false, 0f, 0);
	}
	if (unk_0xBF75E4DF4C367CD9(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
	{
		unk_0x6DA3AC47D5DB9EED(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, false, 0f, 0);
	}
	if (func_440(Local_386.f_1C[0]))
	{
		if (iParam0 == 1)
		{
			unk_0xA47B46945FF6DE74(Local_386.f_1C[0], -1103.962f, 291.3401f, 63.367f, 1, false, 0, 1);
			unk_0xD8F6A53F4799FAFE(Local_386.f_1C[0], 193.1737f);
			unk_0xC6EB89C59F2AF6B8(Local_386.f_1C[0], "rcmjosh4", "josh_leadout_loop", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
		}
		unk_0x7980D72D61BEF4D5(Local_386.f_1C[0], true);
		unk_0x25C5402CC10F76CD(Local_386.f_1C[0], true);
	}
	if (iParam0 == 1)
	{
		if (func_440(Local_386.f_1C[2]))
		{
			unk_0x262EF6C6306BEA6C(Local_386.f_1C[2], joaat("weapon_pistol"), 4294967295, true, true);
			unk_0xA47B46945FF6DE74(Local_386.f_1C[2], -1106.08f, 288.55f, 63.31f, 1, false, 0, 1);
			unk_0xDD353D0E9C789D0E(&iLocal_389);
			unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 4294967295, 1);
			unk_0x75ABDC5F81978924(iLocal_389);
			unk_0x78ADC381772E3D54(Local_386.f_1C[2], iLocal_389);
			unk_0xF82EA857DA10E0CD(&iLocal_389);
			unk_0x11AD11297DC58CC7(Local_386.f_1C[2], true);
		}
	}
	if (iParam0 == 1)
	{
		if (func_440(Local_386.f_1C[1]))
		{
			unk_0x262EF6C6306BEA6C(Local_386.f_1C[1], joaat("weapon_pistol"), 4294967295, true, true);
			unk_0xA47B46945FF6DE74(Local_386.f_1C[1], -1102.41f, 289.73f, 63.18f, 1, false, 0, 1);
			unk_0xDD353D0E9C789D0E(&iLocal_389);
			unk_0x9BE7E7B6B488CC55(0, unk_0x16F2683693E537C9(), 4294967295, 1);
			unk_0x75ABDC5F81978924(iLocal_389);
			unk_0x78ADC381772E3D54(Local_386.f_1C[1], iLocal_389);
			unk_0xF82EA857DA10E0CD(&iLocal_389);
			unk_0x11AD11297DC58CC7(Local_386.f_1C[1], true);
		}
	}
	if (func_440(Local_386.f_1C[1]))
	{
		unk_0xAFF39FB306F8E232(Local_386.f_1C[1], 23, true);
	}
	if (func_440(Local_386.f_1C[2]))
	{
		unk_0xAFF39FB306F8E232(Local_386.f_1C[2], 23, true);
	}
	if (func_204(Local_386.f_23[1]))
	{
		unk_0x71EDC33E5A423750(Local_386.f_23[1], 1);
	}
	func_228(&uLocal_221, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
	iLocal_395 = 0;
	iLocal_396 = 0;
...
void func_299()
{
	...
	{
		case 0:
			if (!func_5(0) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				func_488("Doing setup for leadin");
				func_228(&uLocal_221, 4, Local_386.f_1C[0], "JOSH", 0, 1);
				func_228(&uLocal_221, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
				unk_0x3F423BF5B8125A50("rcmjosh4");
				if (unk_0xB4AE0788C1587752("rcmjosh4"))
				{
					iLocal_46 = 1;
				}
			}
		...
		case 1:
			if (!func_5(0) && unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, true, 0))
			{
				if (func_440(unk_0x16F2683693E537C9()) && func_264(Local_386.f_1C[0]))
				{
					if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, true, 0))
					{
						if (!func_300())
						{
							if (!func_293(unk_0x16F2683693E537C9(), 3419293077))
							{
								unk_0xF96A174EE26D7588(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 0);
							}
						}
						else
						{
				...
				if (!iLocal_400)
				{
					if (func_264(Local_386.f_1C[0]))
					{
						if (unk_0xB4ECF989E2C1DAC8(Local_386.f_1C[0], "rcmjosh4", "beckon_a_josh", 3) && !func_206())
						{
							unk_0xC6EB89C59F2AF6B8(Local_386.f_1C[0], "rcmjosh4", "josh_4_leadin_josh", 2f, -8f, 4294967295, 2, 0, 0, 0, 0);
							func_488("Done Josh leadin anim");
							if (func_264(Local_386.f_1C[2]))
							{
								unk_0xC6EB89C59F2AF6B8(Local_386.f_1C[2], "rcmjosh4", "josh_4_leadin_cop_a", 8f, -8f, 4294967295, 2, 0, 0, 0, 0);
								func_488("Done Notepad cop leadin anim");
							}
							if (func_264(Local_386.f_1C[1]))
							{
								unk_0xC6EB89C59F2AF6B8(Local_386.f_1C[1], "rcmjosh4", "josh_4_leadin_cop_b", 8f, -8f, 4294967295, 2, 0, 0, 0, 0);
								func_488("Done Speaker cop leadin anim");
							}
							unk_0x5C8D148FC238F38A();
							unk_0x8E590B419F1E5182("JOSH_4_INT_CONCAT", 2, 8);
							iLocal_400 = 1;
						}
					}
				}
				...
				{
					if ((func_440(unk_0x16F2683693E537C9()) && func_264(Local_386.f_1C[0])) && !func_300())
					{
						if (!func_293(unk_0x16F2683693E537C9(), 3419293077))
						{
							unk_0xF96A174EE26D7588(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 0);
					...
					if (func_264(Local_386.f_1C[0]))
					{
						if (unk_0xB4ECF989E2C1DAC8(Local_386.f_1C[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							if (unk_0x8CA9406E01C7EE58(Local_386.f_1C[0], "rcmjosh4", "josh_4_leadin_josh") > 0.276f)
							{
								if (iLocal_401 == 0)
								{
									if (func_211(&uLocal_221, "JOSH4AU", "JOSH_4_INTLI", 9, 0, 0, 0))
									{
										unk_0x8B4C4CA774181102(2f, 3f, 1);
										iLocal_401 = 1;
									}
								}
							}
							if (unk_0x8CA9406E01C7EE58(Local_386.f_1C[0], "rcmjosh4", "josh_4_leadin_josh") > 0.98f)
							{
								func_296(1);
							}
							if (func_210(unk_0x16F2683693E537C9(), Local_386.f_1C[0], 1) <= 2f)
							{
								if (func_206())
								{
									func_229();
...
void func_302()
{
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
		{
			if (func_294(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
	...
	if (Global_12C4C != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x757EF87A33649210())
			{
				...
				Var4 = { func_311(Global_12C4D, Global_12C4F, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_322(0) || Global_12C5B) || Global_12C50 == 1) || !unk_0x0F1CCD77290EE12F())
	{
		return 0;
	}
	switch (Global_12C4C)
	{
		...
		case 5:
			if ((unk_0x22A8E52414415B76() || func_307(0)) || func_321(1))
			{
			}
			else
			{
...
{
	return func_324(iParam0, Global_A1D7);
}
...
void func_325()
{
	if (func_440(Local_386.f_1C[1]))
	{
		unk_0x08841CDB215AE18F(Local_386.f_1C[1], -1102.48f, 290.2f, 64.22f, 0, 0, 1);
		unk_0xD8F6A53F4799FAFE(Local_386.f_1C[1], 177.74f);
	}
	else
	{
		Local_386.f_1C[1] = unk_0x36F2404464202779(6, iLocal_42, -1102.92f, 290.12f, -200f, 40.46f, 0, false);
	}
	if (func_440(Local_386.f_1C[2]))
	{
		unk_0x08841CDB215AE18F(Local_386.f_1C[2], -1103.94f, 290.21f, 64.28f, 0, 0, 1);
		unk_0xD8F6A53F4799FAFE(Local_386.f_1C[2], -167.67f);
	}
	else
	{
		Local_386.f_1C[2] = unk_0x36F2404464202779(6, iLocal_42, -1102.73f, 290.91f, -200f, 92.06f, 0, false);
	}
	if (!func_331())
	{
		func_330(unk_0x16F2683693E537C9(), vLocal_53, fLocal_54, 1, 1);
		unk_0xEF6276132B396452(0f, 1065353216);
		unk_0x2FB9A57162E54BAB(0f);
	}
	func_297(1);
	unk_0x523BCC9DC80CD82F(iLocal_392);
	while (!unk_0xB87F6CF6E5628C67(iLocal_392))
	{
		SYSTEM::WAIT(0);
	}
	func_296(2);
...
int func_328(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0x838CC054A9235BEC(2792509962, 0f, false, false);
		unk_0x1BA7FCEAFCE8D46E(2792509962, 3, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0x838CC054A9235BEC(2300778356, 0f, false, false);
		unk_0x1BA7FCEAFCE8D46E(2300778356, 3, false, true);
		iVar0++;
	}
	else
	{
...
int func_329(bool bParam0, bool bParam1)
{
	...
	if (bParam0)
	{
		unk_0x1346A2F19187AF79(-1107.01f, 289.38f, 64.76f, 5f, joaat("prop_lrggate_01c_l"), 0);
		unk_0x838CC054A9235BEC(904342475, 1f, false, false);
		unk_0x1BA7FCEAFCE8D46E(904342475, 4, false, true);
		iVar0++;
	}
	else
	{
	...
	if (bParam1)
	{
		unk_0x1346A2F19187AF79(-1101.62f, 290.36f, 64.76f, 5f, joaat("prop_lrggate_01c_r"), 0);
		unk_0x838CC054A9235BEC(3499548916, -0.9f, false, false);
		unk_0x1BA7FCEAFCE8D46E(3499548916, 4, false, true);
		iVar0++;
	}
	else
	{
...
void func_332(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	...
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_406(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		if (Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (unk_0xB87F6CF6E5628C67(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0x122AAB0B1D6F55AD(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_391(iParam0, &(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (unk_0xB87F6CF6E5628C67(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0x122AAB0B1D6F55AD(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_391(iParam0, &(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/].f_51));
				unk_0x0947AEED9914905B(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (unk_0x134B62B726CEC8E6(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (unk_0xB87F6CF6E5628C67(Var2))
			{
				...
				*iParam0 = unk_0x122AAB0B1D6F55AD(Var2, vParam2, fParam3, true, true, false);
				...
				func_391(iParam0, &(Var2.f_1F), &(Var2.f_51));
				unk_0x0947AEED9914905B(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_334(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && unk_0xC844350D5D58C99A(*iParam1)) && unk_0xDF1306B443CD3D15(*iParam1, 0))
	{
		...
		if (unk_0x67303E186EA6C9A0(*iParam1) >= 0 && func_339(*iParam1, 0, &uVar0))
		{
			func_338(iParam1, &(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_1B416.f_4E91[iParam0 /*43*/].f_1F = func_337(*iParam1);
				...
				func_335(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_1B416.f_4E91[iParam0 /*43*/].f_1));
				...
				func_335(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_1B416.f_4E91[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_339(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = unk_0x134B62B726CEC8E6(iParam0);
	if ((!func_367(iVar0, bParam1, uParam2) && !func_366(unk_0xD803B885F5E47A62())) && !func_349(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_347(unk_0xD803B885F5E47A62()) && (unk_0xAFB8495D36825275(iVar0) || unk_0xC41A9202669A24C4(iVar0)))
	{
		bVar1 = true;
	}
	if (((unk_0x56E1CD81AE700E98(iParam0) && !func_345(iParam0)) && !bVar1) && !(func_344(unk_0x134B62B726CEC8E6(iParam0)) && func_341(unk_0xD803B885F5E47A62())))
	{
	...
	if (!unk_0x8CD06866876216F2())
	{
		if ((func_340(iParam0) && unk_0x134B62B726CEC8E6(iParam0) != joaat("sentinel2")) && unk_0x134B62B726CEC8E6(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_341(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			...
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_346(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_347(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_365(unk_0xD803B885F5E47A62()) || func_364(unk_0xD803B885F5E47A62()))
	{
		if (func_350(iParam0))
		{
			return 1;
...
int func_351(int iParam0)
{
	...
	if (func_352(unk_0x134B62B726CEC8E6(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_353(int iParam0, bool bParam1)
{
	switch (unk_0x134B62B726CEC8E6(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_355(unk_0x134B62B726CEC8E6(iParam0), 0))
			{
				if (Global_26B66F.f_12D == iParam0)
				{
					return 1;
				}
				else if (func_354(iParam0) != 4294967295 && !bParam1)
				{
					return 1;
				}
			}
...
int func_364(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295 && Global_25033E[iParam0 /*421*/].f_136.f_8 != func_217())
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_365(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295 && Global_25033E[iParam0 /*421*/].f_136.f_8 != func_217())
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_366(int iParam0)
{
	if (iParam0 != func_217())
	{
		if (func_343(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_342(Global_25033E[iParam0 /*421*/].f_136.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_367(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_347(unk_0xD803B885F5E47A62()) && (unk_0xAFB8495D36825275(iParam0) || unk_0xC41A9202669A24C4(iParam0)))
	{
		bVar0 = true;
	}
...
void func_369(int iParam0, int iParam1)
{
	...
	func_370(iParam0, &(Global_1B416.f_7FE8.f_1586));
}
...
void func_370(int iParam0, var uParam1)
{
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4EB64970EC291A00(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_372(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		func_338(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (unk_0xDD62D560CFE11A27(iParam0, iVar0 + 1))
			{
				unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_371(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0xC844350D5D58C99A(iParam0) || !unk_0xDF1306B443CD3D15(iParam0, 0)) || func_283(iParam0, 0, 0)) || func_283(iParam0, 1, 0)) || func_283(iParam0, 2, 0)) || func_387(iParam0) != 145) || func_386(iParam0)) || func_385(iParam0)) || func_340(iParam0)) || func_384(iParam0)) || !func_374(unk_0x134B62B726CEC8E6(iParam0)))
	{
		if (func_385(iParam0))
		{
		}
...
int func_391(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_363(unk_0x134B62B726CEC8E6(*iParam0), 1) && unk_0x0ECB5CA5140957AD(*iParam0, 24) != func_394(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xEE6A1776A67F70C1(*iParam0, 24, func_394(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_393(iParam0);
	if (func_392(*iParam0))
	{
...
void func_397(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xC844350D5D58C99A(Global_1774B[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x134B62B726CEC8E6(Global_1774B[iVar0]) == func_398(iParam0, iParam1))
				{
...
void func_399(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_404(&(Global_126B1.f_22B[0 /*21*/]), iVar0))
		{
...
void func_400(int iParam0)
{
	...
	if (func_404(&(Global_126B1.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_12A3E.f_42 == 0) && Global_1B416.f_7FE8.f_7A6[Global_126B1.f_22B[0 /*21*/].f_E] != 0) && Global_1B416.f_7FE8.f_7A6[Global_126B1.f_22B[0 /*21*/].f_E] > 3) && (!func_402(0, Global_126B1.f_22B[0 /*21*/].f_C) || !func_402(1, Global_126B1.f_22B[0 /*21*/].f_C)))
			{
				func_401(&(Global_1B416.f_7FE8.f_45[Global_126B1.f_22B[0 /*21*/].f_E /*78*/]), &Global_12A3E);
...
int func_402(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_403(&(Global_1B416.f_7FE8.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_375(Global_1B416.f_7FE8.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}
...
int func_404(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_405(Global_1B416.f_7FE8.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_1B416.f_936.f_21B.f_E04[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_405(Global_1B416.f_936.f_21B.f_E04[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_405(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_406(vector3 vParam0, float fParam1)
{
	return func_407(&(Global_19AE3.f_B4A), vParam0, fParam1, 0);
}

int func_407(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_424(uParam0))
	{
		...
		if (func_423(uParam0))
		{
			...
			if (unk_0xC844350D5D58C99A(iVar0))
			{
				...
				func_412(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_397(uParam0->f_B, 1);
						}
						else if (unk_0x7D8B2A8F9EA82DB7(unk_0x134B62B726CEC8E6(iVar0)))
						{
							func_397(uParam0->f_B, 2);
						}
					}
					unk_0x316958DDB94DF3FC(iVar0, 0);
					unk_0x626D5ADA3EFAE431(iVar0, false);
					unk_0x44A200C9B6E1CEA6(iVar0, true);
					func_388(iVar0, uParam0->f_B);
				}
				else if ((!func_409(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && unk_0x7F8A39872A07D2CE(unk_0xBB0808A181D4745C(), "startup_positioning"))
				{
					iVar4 = func_408(iVar0);
					if (iVar4 == 4294967295)
					{
						uParam0->f_A = 0;
					}
...
int func_409(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_411(iParam0, Global_126B1.f_8B[38], 0))
			{
				func_400(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_411(iParam0, Global_126B1.f_8B[43], 1))
			{
				func_400(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_411(iParam0, uVar1[iVar3], 1) && func_410(unk_0x68F4C0EC296D3901(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_405(vParam1, 0f, 0f, 0f, 0)) || unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(uVar1[iVar3], true), true) < 10f)
					{
						unk_0xA954465BA6FDEFE2(&iParam0);
						return 1;
					}
...
int func_410(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_412(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar1 + 1)))
			{
			}
			else
			{
				unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_371(iVar1 + 1));
			}
		}
		else if (uParam1->f_42 == 340154634 || uParam1->f_42 == 2334210311)
		{
			...
			while (iVar2 <= 9)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar2)))
				{
				}
				else
				{
					unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_371(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_42 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar3)))
				{
				}
				else
				{
					unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_371(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_42 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar4)))
					{
					}
					else
					{
						unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_371(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, 15) || func_415(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_414())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_391(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		}
		if (!unk_0xAFB8495D36825275(uParam1->f_42) && !unk_0xA7082C42B8809BF2(uParam1->f_42))
		{
			...
			while (iVar5 <= 11)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_371(iVar5 + 1)))
				{
...
int func_416(int iParam0)
{
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		if (!func_422(unk_0xD803B885F5E47A62(), 4294967295))
		{
	...
	if (func_418(unk_0xD803B885F5E47A62()) == 3)
	{
		if (unk_0xC844350D5D58C99A(iParam0) && unk_0xDF1306B443CD3D15(iParam0, 0))
		{
...
int func_424(var uParam0)
{
	...
	if (!func_375(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("stunt") && func_410(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_425()
{
	return func_423(&(Global_19AE3.f_B4A));
}

void func_426()
{
	func_427(&(Global_19AE3.f_B4A));
}
...
int func_428(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_430(Global_19AE3.f_B4A.f_C.f_42))
	{
		return 0;
	}
...
bool func_431()
{
	return func_424(&(Global_19AE3.f_B4A));
}
		...
		if (bParam2)
		{
			if (!Global_12B4E)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_1F4F[iParam1 /*4*/] = { func_434(iParam0) };
					...
					{
						Global_1F1E[1 /*6*/] = { func_434(iParam0) };
...
void func_439()
{
	...
	unk_0xD7992BEF7A9D109E("JOSH4", 0);
...
int func_442(var uParam0)
{
	...
	switch (iLocal_37)
	{
		case 0:
			...
			func_452(&(uParam0->f_30), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_37 = 1;
			break;
		
		case 1:
			if (!func_451(&iVar0) || !func_449(&(uParam0->f_30)))
			{
				return 0;
			}
			if (!func_329(0, 1))
		...
		case 2:
			...
			{
				if (func_446(&(uParam0->f_1C[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_445(&(uParam0->f_1C[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_440(uParam0->f_1C[1]))
				{
					unk_0x78ED16BE998AECC7(uParam0->f_1C[1]);
					unk_0x11AD11297DC58CC7(uParam0->f_1C[1], true);
					unk_0x262EF6C6306BEA6C(uParam0->f_1C[1], joaat("weapon_pistol"), 4294967295, false, true);
					if (unk_0xB4AE0788C1587752("rcmjosh4"))
					{
						unk_0xA3BF0AA5A2608191(uParam0->f_1C[1]);
						unk_0xC6EB89C59F2AF6B8(uParam0->f_1C[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			{
				func_445(&(uParam0->f_1C[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_440(uParam0->f_1C[2]))
				{
					unk_0x64F9F278AB9DCA2C(uParam0->f_1C[2], 0, 1, 1, 0);
					unk_0x64F9F278AB9DCA2C(uParam0->f_1C[2], 3, 0, 1, 0);
					unk_0x64F9F278AB9DCA2C(uParam0->f_1C[2], 10, 0, 1, 0);
					unk_0x11AD11297DC58CC7(uParam0->f_1C[2], true);
					unk_0x262EF6C6306BEA6C(uParam0->f_1C[2], joaat("weapon_pistol"), 4294967295, false, true);
					if (unk_0xB4AE0788C1587752("rcmjosh4"))
					{
						unk_0xA3BF0AA5A2608191(uParam0->f_1C[2]);
						unk_0xC6EB89C59F2AF6B8(uParam0->f_1C[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			{
				func_444(&(uParam0->f_23[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_23[1]))
			{
				func_443(&(uParam0->f_23[1]), 0);
				if (func_204(uParam0->f_23[1]))
				{
					unk_0xDC544F7DF5E5164D(uParam0->f_23[1], 900f);
					fVar2 = unk_0x6EE94F60DA2A2273(uParam0->f_23[1]);
					fVar2 = (fVar2 / 2f);
					unk_0x5DAB50E08C3C504A(uParam0->f_23[1], fVar2);
					unk_0xB9FD7450C0DAB575(uParam0->f_23[1], 1084227584);
				}
				else
				{
					bVar3 = false;
		...
		case 3:
			if (unk_0xBF75E4DF4C367CD9(-1138.32f, 299.69f, 65.94f, 5f, joaat("prop_lrggate_01c_l"), 0))
			{
				unk_0x6DA3AC47D5DB9EED(joaat("prop_lrggate_01c_l"), -1138.32f, 299.69f, 65.94f, true, 0f, 0);
			}
			if (unk_0xBF75E4DF4C367CD9(-1137.52f, 297.02f, 65.81f, 5f, joaat("prop_lrggate_01c_r"), 0))
			{
				unk_0x6DA3AC47D5DB9EED(joaat("prop_lrggate_01c_r"), -1137.054f, 295.5856f, 67.18046f, true, 0f, 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_443(int iParam0, bool bParam1)
{
	...
	func_444(iParam0, iLocal_39, vVar0, fVar1);
	unk_0xC6A6B4DDD6DC073A(*iParam0, 4);
	unk_0x71EDC33E5A423750(*iParam0, 3);
	unk_0x9A8BCD43DBDDCDCA(*iParam0, false, 0);
	unk_0xF3F7BF451A720FDF(*iParam0, true);
}
...
void func_445(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)
{
	func_233(iParam0);
...
void func_455()
{
	...
	while (iVar0 <= (Local_386.f_1C - 1))
	{
		if (func_440(Local_386.f_1C[iVar0]))
		{
			func_205(&(Local_386.f_1C[iVar0]), 1, 0, 1);
		}
		iVar0++;
	}
	func_205(&(Local_386.f_1C[0]), 1, 0, 1);
	iVar0 = 0;
	while (iVar0 <= (Local_386.f_23 - 1))
	{
		func_234(&(Local_386.f_23[iVar0]));
		iVar0++;
	}
	unk_0xB975E4541DDAB1F5(0);
	unk_0xEFED0CD6E25037B9();
	unk_0x9FE27D475353EFE9(-1140.223f, 271.745f, 50f, -1082.403f, 344.8568f, 80f, 0);
	func_456(&Local_386, 1, 0, 0);
	unk_0x71199B01895C6202(iLocal_43);
	unk_0x71199B01895C6202(iLocal_42);

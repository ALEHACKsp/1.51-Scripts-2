	...
	if (unk_0x2EBF608FFE6CA406(83))
	{
		...
		if (Var0 != 4294967295)
		{
			if (Global_1B085[Var0 /*10*/].f_9 != 4294967295)
			{
				...
				func_269(&(Global_1B085[Var0 /*10*/].f_9));
			}
		}
		func_253(&Var0, 1);
	}
...
int func_193(var uParam0, bool bParam1)
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_12C43 == 1)
	{
		return 1;
	}
	if (!unk_0x338D6FF72D84D90F())
	...
	{
		func_194(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}
...
void func_194(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_127(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_196(uParam1) || !unk_0xB4ECF989E2C1DAC8(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_196(uParam1) && uParam1->f_4 == 0) && unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
void func_198(var uParam0)
{
	...
	if (*uParam0 == 52)
	{
		func_199(&(uParam0->f_29[1]));
		func_199(&(uParam0->f_29[2]));
	}
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_1C[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(uParam0->f_1C[iVar0]))
				{
					...
					if (func_222(*uParam0))
					{
						if (!func_158(*uParam0))
						{
							if (func_217(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_198(uParam0);
						...
						if (func_205(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_198(uParam0);
...
{
	return func_207(iParam0, unk_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_213(unk_0x68F4C0EC296D3901(iParam1, true) - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	{
		vVar1 = { func_213(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_220(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_213(vParam1 - unk_0x68F4C0EC296D3901(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
{
	if ((func_229() && Global_181B8.f_B == 6) && iParam0 == func_167(&(Global_181B8.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_232(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_237(&iVar0) || !unk_0xB4AE0788C1587752("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				func_236(&(uParam0->f_29[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_29[1]))
			{
				func_236(&(uParam0->f_29[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_1C[0]))
			{
				if (!func_233(&(uParam0->f_1C[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_126(uParam0->f_1C[0]) && func_127(uParam0->f_29[0]))
			{
...
void func_238(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = unk_0x7D6CA5F52B3748BF(vVar0, vVar1, 0, 1, 1, 1);
...
void func_267(var uParam0)
{
	if (unk_0x69DF961355195C3C(uParam0->f_3B))
	{
		...
		{
			if (func_268(uParam0->f_1C[0], 1785177548))
			{
		...
		if (func_127(uParam0->f_29[0]))
		{
			unk_0x1BF8B16C32704027(uParam0->f_29[0], -1000f, 1);
		}
	}
}

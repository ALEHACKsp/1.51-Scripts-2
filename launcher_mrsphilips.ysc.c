...
void __EntryFunction__()
{
	...
	func_231(&Var0);
	iLocal_52 = unk_0x7D6CA5F52B3748BF(vVar1 - Vector(20f, 20f, 20f), vVar1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
{
	iParam0->f_10 = 5;
	iParam0->f_11[0 /*3*/] = { 1973.324f, 3815.594f, 31.42936f };
	iParam0->f_11[1 /*3*/] = { 1974.936f, 3812.747f, 34.438f };
	iParam0->f_18 = 6.5f;
	iParam0->f_1B = 0;

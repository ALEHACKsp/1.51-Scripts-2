...
void __EntryFunction__()
{
	...
	if (unk_0x8A22C4C08282BF26(joaat("letterscraps")) > 1)
	{
	...
	switch (iLocal_43)
	{
		...
		case 1:
			...
			if (iLocal_56 < 4)
			{
				...
				unk_0x6567AE843FADBA94(iLocal_55, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_43 = 2;
...
int func_23(var uParam0, int iParam1)
{
	...
	while (iVar0 < 1)
	{
		...
		if (!(iParam1[uParam0->f_A /*11*/])->f_A)
		{
			if (!bVar1)
			{
				...
				{
					func_57(iParam1[uParam0->f_A /*11*/], uParam0->f_7, joaat("pickup_custom_script"), 0, 1, 2);
				}
				...
				{
					func_57(iParam1[uParam0->f_A /*11*/], uParam0->f_7, joaat("pickup_custom_script"), 0, 0, 2);
				}
			}
		}
		else if (!bVar1)
		{
			if (func_40(uParam0, iParam1, vVar2))
			{
				if (bVar3)
				{
					if (!func_39(33))
					{
						func_36("LETTERS_FIRST", 1, 0, 4294967295, 10000, 7, 0, 0, 0);
						func_35(33);
					}
				}
			}
	...
	if (uParam0->f_B)
	{
		if (!Global_12C52)
		{
			func_24(&(uParam0->f_B), &(uParam0->f_C), &(uParam0->f_9), 1, &iLocal_53, &iLocal_54, "LETTERS_TITLE", "LETTERS_COLLECT");
		}
	}
...
int func_26(int iParam0)
{
	...
	else
	{
		...
		while (iVar1 < func_33(iParam0))
		{
			...
			if (func_27(iVar2, 4294967295, 4294967295))
			{
				iVar0++;
			}
			iVar1++;
...
int func_40(var uParam0, var uParam1, vector3 vParam2)
{
	...
	{
		if ((SYSTEM::VDIST2(vParam2, unk_0xE925E52ACABA4CE7((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_60(13)) || func_60(14))
		{
...
void func_46()
{
	...
	iVar3 = 0;
	unk_0x6FB46C25CCB7E6D5(func_48(0), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(18, iVar0);
	}
	unk_0x6FB46C25CCB7E6D5(func_48(1), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(19, iVar0);
	}
	unk_0x6FB46C25CCB7E6D5(func_48(3), &iVar0, 4294967295);
	iVar1 = (iVar1 + iVar0);
	if (iVar0 > 0)
	{
		func_47(20, iVar0);
...
void func_49(var uParam0)
{
	...
	while (iVar0 < uParam0->f_3)
	{
		...
		{
			iVar1++;
			func_50((uParam0->f_2 + iVar0), 1, 4294967295, 1);
			if (bLocal_40)
			{
			}
		}
...
void func_51(var uParam0, int iParam1)
{
	...
	{
		uParam0->f_4++;
		func_50((uParam0->f_2 + iParam1), 1, 4294967295, 1);
		if (bLocal_40)
		{
		}
	}
...
void func_62(int iParam0, var uParam1, var uParam2)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_27((iParam0->f_2 + iVar0), 4294967295, 4294967295))
		{
			iVar1++;
...
void func_64()
{
	...
	Global_1B416.f_273C.f_7A.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
void func_75()
{
	...
	Global_1B416.f_273C.f_7A.f_2 = 0;
	iVar0 = 0;

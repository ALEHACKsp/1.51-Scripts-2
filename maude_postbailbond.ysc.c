...
void func_1()
{
	...
	{
		func_2(&iLocal_42);
		unk_0xF3268524E9BE6D6E(iLocal_42, unk_0x16F2683693E537C9(), 10000f, 4294967295, 0, 0);
...
char* func_21()
{
	if (unk_0xEAE0D21A50E6C7F4(Global_1B416.f_6195, 3))
	{
		return "BB4_loiter";
	}
	else if (unk_0xEAE0D21A50E6C7F4(Global_1B416.f_6195, 2))
	{
		return "BB3_loiter";
	}
	else if (unk_0xEAE0D21A50E6C7F4(Global_1B416.f_6195, 1))
	{
		return "BB2_loiter";
	}
	else if (unk_0xEAE0D21A50E6C7F4(Global_1B416.f_6195, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
...
void func_50()
{
	...
	if (func_51(iLocal_42))
	{
		...
		if (unk_0xBF75E4DF4C367CD9(vVar0, 10f, 3914268813, 0))
		{
			iLocal_40 = unk_0x4B72871A3BE7B474(vVar0, 10f, 3914268813, 1, 0, 1);
			if (func_8(iLocal_40))
			{
		...
		if (unk_0xBF75E4DF4C367CD9(vVar0, 10f, 3553022755, 0))
		{
			iLocal_39 = unk_0x4B72871A3BE7B474(vVar0, 10f, 3553022755, 0, 0, 1);
			if (func_8(iLocal_39))
			{

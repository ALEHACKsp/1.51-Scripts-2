	...
	while (true)
	{
		switch (iLocal_45)
		{
			...
			case 2:
				...
				unk_0x1FF2BF40EEFA5ABC(iLocal_46, "SET_MISSION_TITLE_COLOUR", ScriptParam_50.f_2, ScriptParam_50.f_2, ScriptParam_50.f_2, 3212836864, 3212836864);
				if (ScriptParam_50.f_5.f_1 != -1f && !unk_0x2EBF5002C6B6A06C(ScriptParam_50.f_5.f_2))
				{
					unk_0x4728AD8A6BE3AED3(iLocal_46, "SET_TOTAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), ScriptParam_50.f_5.f_1, -1f, -1f, -1f, ScriptParam_50.f_5.f_2, 0, 0, 0, 0);
				}
				unk_0x1FF2BF40EEFA5ABC(iLocal_46, "SET_MEDAL", SYSTEM::TO_FLOAT(ScriptParam_50.f_5), 3212836864, 3212836864, 3212836864, 3212836864);
				unk_0x1FF2BF40EEFA5ABC(iLocal_46, "SET_SOCIAL_CLUB_INFO", 0f, 3212836864, 3212836864, 3212836864, 3212836864);
				iVar0 = 0;
				while (iVar0 < ScriptParam_50.f_42 + 1)
				{
					...
					if (ScriptParam_50.f_9[iVar0 /*7*/].f_2 == 4)
					{
						...
						unk_0x164431059FF80580(SYSTEM::FLOOR((ScriptParam_50.f_9[iVar0 /*7*/].f_3 * 1000f)), 6);
				...
				func_12(1);
				func_9(&iLocal_47);
				if (!func_8(Global_1B416.f_4A94, 4096))
				{
					func_6(&(Global_1B416.f_4A94), 4096);
				}
				iLocal_45 = 3;
				break;
			
			case 3:
				if (((func_2(&iLocal_47) > ScriptParam_50.f_43 && ScriptParam_50.f_43 != -1f) || unk_0x757EF87A33649210()) || Global_78C0)
				{
					func_19();
				}
				else

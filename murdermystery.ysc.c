...
void func_1()
{
	switch (iLocal_71)
	{
		...
		case 3:
			if (!func_76(iLocal_71))
			{
				if (((func_73() && !func_72()) && func_71()) && !func_70(0))
				{
					if (iLocal_73 != 0)
					{
						if (unk_0x3C112ECA9AEEC229(iLocal_73))
						{
		...
		case 4:
			...
			{
				unk_0x7EB60BF335619074(iLocal_66, 0.75f);
			}
			if (!func_76(4))
			{
		...
		case 6:
			...
			if (!func_34(2))
			{
				...
				{
					unk_0x3124890FDA752DE4(vLocal_58, 200f, 3053754761, 0);
					func_33(2, 1);
				}
			}
			if (func_73() && !func_72())
...
void func_3()
{
	switch (Global_1B416.f_273C.f_86)
	{
		case 0:
			Global_1B416.f_273C.f_86 = 1;
			break;
		
		case 1:
			Global_1B416.f_273C.f_86 = 2;
			unk_0xB686910E0D0C530B(func_4());
			unk_0x4D7F4CC43D4D0DE3(4294967295, "ON", "NOIR_FILTER_SOUNDS", true);
			break;
		
		case 2:
			Global_1B416.f_273C.f_86 = 0;
			break;
	}
}
...
bool func_6()
{
	return Global_1B416.f_273C.f_85 == 127;
}
		...
		if (bParam2)
		{
			if (!Global_12B4E)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_1F4F[iParam1 /*4*/] = { func_9(iParam0) };
					...
					{
						Global_1F1E[1 /*6*/] = { func_9(iParam0) };
...
bool func_22(int iParam0)
{
	...
	iVar1 = unk_0xDC4DD3980107166C(Global_1B416.f_273C.f_85, 0, (iVar0 - 1));
...
void func_33(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		unk_0x5D96D8530B3D0904(&iLocal_78, iParam0);
	}
	else
	{
		unk_0x0674E58A79778E99(&iLocal_78, iParam0);
	}
}

bool func_34(int iParam0)
{
	return unk_0xEAE0D21A50E6C7F4(iLocal_78, iParam0);
}
...
void func_35()
{
	...
	switch (iLocal_60)
	{
		case 0:
			...
			{
				if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_51, vLocal_57, true, true, 0))
				{
					if (func_62())
					{
						iLocal_60 = 2;
		...
		case 1:
			...
			{
				if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_52, vLocal_57, true, true, 0))
				{
					func_54(0);
					iLocal_60 = 3;
					func_61(0, 800);
		...
		case 2:
			...
			{
				func_45(24, 0);
				func_44(unk_0x16F2683693E537C9(), vLocal_55, fLocal_56);
				...
				unk_0x9E632F16E887F781(vLocal_55, 20f, 0);
				func_39(24, &iLocal_59);
				unk_0x0007C2367F4F23F3(iLocal_59);
				iLocal_72 = (unk_0x1C0640BA9A7327B3() + 40000);
				while ((!unk_0x68367101660E33F0() || !unk_0xBD307E66C0669BFC(iLocal_59)) && iLocal_72 > unk_0x1C0640BA9A7327B3())
				{
					SYSTEM::WAIT(0);
				}
				unk_0x486B4ADE317F0689();
				if (iLocal_72 <= unk_0x1C0640BA9A7327B3())
				{
					unk_0x25BB71BA267FE042(iLocal_59);
					func_44(unk_0x16F2683693E537C9(), vLocal_53, fLocal_54);
					func_61(1, 800);
					iLocal_60 = 0;
				}
				else
...
void func_36(vector3 vParam0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_49()
{
	...
	{
		case 0:
			if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				func_53(sLocal_76);
				iLocal_61++;
			}
		...
		case 1:
			if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), vVar0, vVar1, fVar2, 0, true, 0) && !func_5(0))
			{
				if (!func_52(unk_0x16F2683693E537C9(), 3414437612))
				{
					unk_0xDBE4EC9C88839074(unk_0x16F2683693E537C9(), -1007.995f, -476.8016f, 49.9117f, 4294967295, 0, 2);
				}
				if (unk_0xBFC0798A6E3417F9(2, 51))
				{
					func_51(0);
					unk_0x96167B03C5A77156(unk_0x16F2683693E537C9(), -1007.351f, -477.5197f, 49.0282f, 1f, 4294967295, 0.5f, 0, 30.4025f);
					func_53(sLocal_77);
		...
		case 2:
			...
			if (unk_0xBFC0798A6E3417F9(2, 51))
			{
				...
				{
					iLocal_72 = unk_0x1C0640BA9A7327B3() + 300;
					unk_0x82A772610883F395("CamPushInNeutral", 0, 0);
					unk_0x4D7F4CC43D4D0DE3(4294967295, "1st_Person_Transition", "PLAYER_SWITCH_CUSTOM_SOUNDSET", false);
				}
				else
				{
					iLocal_72 = 0;
...
int func_63()
{
	...
	if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) > 0 && iLocal_60 == 0)
	{
		return 0;
	}
	if (func_70(0))
...
void func_68(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
		unk_0x5D96D8530B3D0904(&(Global_1B416.f_273C.f_85), iParam0);
		if (!bParam2)
		{
			unk_0x4D7F4CC43D4D0DE3(iLocal_69, sLocal_67, sLocal_68, false);
		}
		func_69();
	}
	else
	{
		unk_0x0674E58A79778E99(&(Global_1B416.f_273C.f_85), iParam0);
	}
}
...
{
	return unk_0xEAE0D21A50E6C7F4(Global_1B416.f_273C.f_85, iParam0);
}
...
void func_82()
{
	if (func_67(unk_0x16F2683693E537C9()))
	{
		vLocal_70 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false) };
	}
}
...
void func_84()
{
	switch (iLocal_71)
	{
		...
		case 4:
			func_86(3623056905);
			func_85(sLocal_74);
			iLocal_66 = unk_0x36F2404464202779(26, 3623056905, func_75(4), 184.5548f, 1, true);
			unk_0x71199B01895C6202(3623056905);
			unk_0xC6EB89C59F2AF6B8(iLocal_66, sLocal_74, sLocal_75, 1000f, -1000f, 4294967295, 9, 0, 0, 0, 0);
			unk_0x11AD11297DC58CC7(iLocal_66, true);
			unk_0xFADC0A217229F6B5(iLocal_66, true);
			unk_0x1E9649458B15960F(iLocal_66, true);
			unk_0x33CE5A9E32EA10B2(iLocal_66, true);
			unk_0xCAC78D14D05349E7(iLocal_66, true);
			unk_0x4E885A246A9D983A(iLocal_66, 118, false);
			unk_0x4E885A246A9D983A(iLocal_66, 208, true);
			unk_0xE121AE1BBF90E186(iLocal_66, true);
			unk_0x6DF7BF67E86AAE86(iLocal_66, 1862763509);
			break;
		
		case 5:
			iLocal_63 = 731806707;
			unk_0x8010B3127F058F0F(iLocal_63, joaat("v_ilev_sol_off_door01"), -1002.147f, -478.064f, 50.117f, 1, true, 0);
			unk_0x1BA7FCEAFCE8D46E(iLocal_63, 1, true, false);
			iLocal_62 = unk_0xAE06CCC36C49929C(26379945, -1008.056f, -476.7573f, 50.2493f, -89.5003f, 0f, 38.7952f, 50f, 0, 2);
			break;
		
		case 6:
			func_86(732742363);
			iLocal_64 = unk_0x36F2404464202779(26, 732742363, func_75(6), 22.9631f, 1, true);
			unk_0x9A28E8CB86CD4694(iLocal_64, 0, 0, 0, false);
			unk_0x71199B01895C6202(732742363);
			unk_0x33CE5A9E32EA10B2(iLocal_64, true);
			unk_0xCAC78D14D05349E7(iLocal_64, true);
			unk_0xBC3E304ACAF897E2(iLocal_64, joaat("weapon_sniperrifle"));
			unk_0x6DF7BF67E86AAE86(iLocal_64, 1862763509);
			iLocal_65 = unk_0xB0BE3DFBBB59A620(130556722, -543.71f, 1986.2f, 126.05f, true, true, false);
			break;
	}
}
...
void func_91()
{
	switch (iLocal_71)
	{
		...
		case 2:
		case 3:
			unk_0x9066F534496C8D68(iLocal_73);
			iLocal_73 = 0;
			break;
		...
		case 4:
			...
			{
				unk_0x6DAD7906B73F064D(&iLocal_66);
			}
			unk_0x8D17794CE3273D70(sLocal_74);
			break;
		
		case 5:
			if (unk_0x76395FF5E8D5E643(iLocal_63))
			{
				unk_0xA4A8625CC710BC1F(iLocal_63);
			}
			if (unk_0x9F4FE516EAACCFC5(iLocal_62))
			{
		...
		case 6:
			...
			{
				unk_0x6DAD7906B73F064D(&iLocal_64);
			}
			if (unk_0xC844350D5D58C99A(iLocal_65))
			{
				unk_0xEEEE2E5FA6F78DF0(&iLocal_65);
			}
			if (func_34(2))
			{
				unk_0x77ADAEFF81EAE1E4(vLocal_58, 200f, 3053754761, false);
			}
			break;
	}
}

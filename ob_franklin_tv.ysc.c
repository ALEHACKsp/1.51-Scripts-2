...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (unk_0x0EB28750412C3A5A(vLocal_305, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false), true) < 3f)
			{
				switch (iLocal_303)
				{
					case 0:
...
void func_1()
{
	...
	switch (iLocal_304)
	{
		case 0:
			...
			{
				if (unk_0xBFDF2644D7CBD7C5(unk_0x16F2683693E537C9(), vLocal_306, 90f) || iLocal_309)
				{
					func_32("TV_HLP0");
		...
		case 1:
			if (func_31(1, 0, 1))
			{
				if (func_35(vLocal_305, vVar0) && unk_0xBF75E4DF4C367CD9(vLocal_305, 3f, joaat("prop_cs_remote_01"), 0))
				{
					if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
					{
						if ((!unk_0x85651FDAB8414096(unk_0xD803B885F5E47A62()) && !unk_0xBBFFD1937ED16008(unk_0xD803B885F5E47A62())) && unk_0x06F8112AA79C53D9(0, 51))
						{
							...
							unk_0x679C321F8CAA2CFA(vLocal_306, 3f, 0);
		...
		case 2:
			...
			iLocal_311 = unk_0xE9744DB7B8CA6965(vLocal_315, vLocal_316, 2);
			if (Global_786C[1 /*11*/].f_2)
			{
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_311, sLocal_314, "enter_no_remote", 8f, -4f, 0, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), iLocal_311, "enter_no_remote_remote", sLocal_314, 8f, -4f, 0, 1148846080);
			}
			else
			{
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_311, sLocal_314, "enter", 8f, -4f, 0, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), iLocal_311, "enter_remote", sLocal_314, 8f, -4f, 0, 1148846080);
			}
			if (unk_0xB818A4F8553577BC(iLocal_311))
			{
				unk_0xEFC3DF9D33E248D8(iLocal_311, false);
			}
			if (unk_0x6C3F127AAF415E69() != 4)
			{
				iLocal_313 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", true);
				if (Global_786C[1 /*11*/].f_2)
				{
					unk_0x93E9ED66DAB9FBE3(iLocal_313, iLocal_311, "enter_no_remote_cam", sLocal_314);
				}
				else
				{
					unk_0x93E9ED66DAB9FBE3(iLocal_313, iLocal_311, "enter_cam", sLocal_314);
				}
				unk_0x91F5B0244AAE6222(iLocal_313, "HAND_SHAKE", 0.2f);
		...
		case 3:
			...
			if (!Global_786C[1 /*11*/].f_2)
			{
				if (unk_0xA45992A6CE82FB43(iLocal_311) > 0.691f)
				{
					func_16();
					func_12(1, 0, 1, 0, 0);
				}
			}
			if (unk_0xA45992A6CE82FB43(iLocal_311) > 0.9f)
			{
				iLocal_311 = unk_0xE9744DB7B8CA6965(vLocal_315, vLocal_316, 2);
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_311, sLocal_314, "base", 8f, -8f, 64, 0, 1148846080, 0);
				unk_0xE14EC663EED44AD5(func_18(), iLocal_311, "base_remote", sLocal_314, 8f, -8f, 64, 1148846080);
				unk_0xC90224D9E95E5E3A(iLocal_311, true);
				func_32("TV_HLP7");
		...
		case 5:
			...
			if (!func_8())
			{
				...
				{
					iLocal_311 = unk_0xE9744DB7B8CA6965(vLocal_315, vLocal_316, 2);
					unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_311, sLocal_314, "exit", 8f, -8f, 0, 0, 1148846080, 0);
					unk_0xE14EC663EED44AD5(func_18(), iLocal_311, "exit_remote", sLocal_314, 8f, -8f, 0, 1148846080);
					if (func_6(iLocal_313))
					{
						unk_0x93E9ED66DAB9FBE3(iLocal_313, iLocal_311, "exit_cam", sLocal_314);
					}
					if (unk_0xB818A4F8553577BC(iLocal_311))
					{
						unk_0xEFC3DF9D33E248D8(iLocal_311, false);
				...
				{
					iLocal_311 = unk_0xE9744DB7B8CA6965(vLocal_315, vLocal_316, 2);
					unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_311, sLocal_314, "idle_a", 8f, -8f, 0, 0, 1148846080, 0);
					unk_0xE14EC663EED44AD5(func_18(), iLocal_311, "idle_a_remote", sLocal_314, 8f, -8f, 0, 1148846080);
					if (unk_0xB818A4F8553577BC(iLocal_311))
					{
						unk_0xEFC3DF9D33E248D8(iLocal_311, false);
					}
		...
		case 6:
			...
			unk_0x3FC8DBCC154CA56B();
			unk_0x38C3A68D7861DCFD(0, 0, 1);
			if (unk_0x69DF961355195C3C(iLocal_311))
			{
				if (iLocal_308)
				{
					fVar1 = unk_0xA45992A6CE82FB43(iLocal_311);
					if (fVar1 > 0.3f)
					{
		...
		case 7:
			...
			else
			{
				...
				{
					fVar1 = unk_0xA45992A6CE82FB43(iLocal_311);
					if (unk_0xDC2A248C2CB7B3DB(sLocal_314, "exit", "WalkInterruptible", &fVar2, &fVar3))
					{
		...
		case 8:
			if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_tv_watched"), &iLocal_312, 4294967295))
			{
				unk_0xCDC520E5E48E63D9(joaat("num_sh_tv_watched"), iLocal_312 + 1, 1);
			}
...
int func_18()
{
	...
	iVar0 = unk_0x4B72871A3BE7B474(vLocal_305, 3f, joaat("prop_cs_remote_01"), 0, 0, 1);
	return iVar0;
}
	...
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if ((!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0) && !unk_0x4E861BC5B1EDA7BD(unk_0x16F2683693E537C9())) && unk_0x93B62D155C014521(unk_0xD803B885F5E47A62()))
		{
			if (!unk_0x681F21BF9F7B449B(4294967295, vParam0, 2f))
			{
				...
				{
					if ((Global_175B8 && Global_175B9) || func_37())
					{
						return 0;
					}
					if (func_36(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_41()
{
	...
	iVar0 = unk_0x4B72871A3BE7B474(vLocal_305, 10f, joaat("prop_cs_remote_01"), 0, 0, 1);
...
int func_42()
{
	unk_0x3F423BF5B8125A50(sLocal_314);
	if (unk_0xB4AE0788C1587752(sLocal_314))
	{
		iLocal_310 = 1;
		return 1;
	}
...
{
	return func_48(iParam0, Global_A1D7);
}
...
void func_50()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_54(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_52(iVar0) && (!func_51(14) || Global_1AFFD))
			{
...
void func_56()
{
	...
	if (iLocal_310)
	{
		unk_0x8D17794CE3273D70(sLocal_314);
	}
	if (unk_0x9F4FE516EAACCFC5(iLocal_313))
	{
		unk_0xE3BB8E05FCEB3FBE(iLocal_313, false);
		unk_0x9A8DDC7C522F5BF5(iLocal_313, 0);
	}
	func_10();
	if (iLocal_51)
	{

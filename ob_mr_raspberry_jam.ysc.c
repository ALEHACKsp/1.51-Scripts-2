...
void __EntryFunction__()
{
	...
	vLocal_274 = { 0f, 0f, 0f };
	vLocal_275 = { 0f, 0f, 0f };
	iLocal_280 = unk_0x09AC81E49EA267F7(0, 4);
	func_76();
	...
	if (unk_0xC844350D5D58C99A(iScriptParam_286))
	{
...
void func_1()
{
	...
	{
		case 0:
			if (func_52(vVar0, vVar1) && unk_0xBFDF2644D7CBD7C5(unk_0x16F2683693E537C9(), unk_0x68F4C0EC296D3901(iLocal_41, true), 90f))
			{
				func_76();
		...
		case 2:
			...
			iLocal_278 = unk_0xE9744DB7B8CA6965(func_37(), func_36(), 2);
			unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_278, func_35(), func_34(iLocal_280), 8f, -2f, 0, 0, 1148846080, 0);
			unk_0xE14EC663EED44AD5(iLocal_41, iLocal_278, func_33(iLocal_280), func_35(), 8f, -2f, 0, 1148846080);
			if (unk_0xB818A4F8553577BC(iLocal_278))
			{
				unk_0xEFC3DF9D33E248D8(iLocal_278, false);
			}
			if (unk_0x6C3F127AAF415E69() != 4)
			{
				iLocal_279 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", true);
				unk_0x93E9ED66DAB9FBE3(iLocal_279, iLocal_278, func_30(iLocal_280), func_35());
			...
			iLocal_283 = 0;
			iLocal_284 = (unk_0x1C0640BA9A7327B3() + func_29());
			iLocal_277 = 3;
			break;
		...
		case 3:
			...
			unk_0x3FC8DBCC154CA56B();
			unk_0x38C3A68D7861DCFD(1, 0, 1);
			if (unk_0x69DF961355195C3C(iLocal_278))
			{
				func_27();
				if (iLocal_281)
				{
					fVar2 = unk_0xA45992A6CE82FB43(iLocal_278);
					if (unk_0xDC2A248C2CB7B3DB(func_35(), func_34(iLocal_280), "WalkInterruptible", &fVar3, &fVar4))
					{
				...
				if (!iLocal_283 && unk_0x1C0640BA9A7327B3() > iLocal_284)
				{
		...
		case 5:
			...
			if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_mr_jam_used"), &iLocal_285, 4294967295))
			{
				unk_0xCDC520E5E48E63D9(joaat("num_sh_mr_jam_used"), iLocal_285 + 1, 1);
			}
	...
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if ((!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0) && !unk_0x4E861BC5B1EDA7BD(unk_0x16F2683693E537C9())) && unk_0x93B62D155C014521(unk_0xD803B885F5E47A62()))
		{
			if (!unk_0x681F21BF9F7B449B(4294967295, vParam0, 2f))
			{
				...
				{
					if ((Global_175B8 && Global_175B9) || func_54())
					{
						return 0;
					}
					if (func_53(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vParam0, fParam1, 0))
					{
						return 1;
					}
				}
...
int func_58()
{
	if (unk_0x64F604CF561734A9(func_59(), 0, 4294967295))
	{
		return 1;
	}
	return 0;
	...
	switch (iLocal_40)
	{
		...
		case joaat("prop_mr_raspberry_01"):
			if (Global_1B416.f_1C58.f_E3[145] == 1)
			{
				if (func_15() == 2)
				{
					if (((((Global_16E36[13] != 127 && Global_16E36[13] != 135) && Global_16E46 != 127) && Global_16E46 != 135) && !func_65()) && !func_67())
					{
						return 1;
					}
				}
...
{
	return func_73(iParam0, Global_A1D7);
}

			...
			if (unk_0x63D2C15453688621(iScriptParam_8))
			{
				switch (iLocal_0)
				{
					...
					case 3:
						...
						{
							unk_0x8BE3D040D15AEA1D(iLocal_1, 4294967295);
...
void func_3()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_1))
	{
		if (unk_0xD1960163A3042274(iLocal_1, 2277090178) == 7)
		{
			unk_0xC6EB89C59F2AF6B8(iLocal_1, sLocal_6, sLocal_4, 8f, -8f, 4294967295, 0, 0, 0, 0, 0);
		}

...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (unk_0xC844350D5D58C99A(iScriptParam_69))
		{
			if ((iLocal_41 != 4294967295 && (func_66() && !func_65())) && !func_64(iLocal_41))
			{
				func_68();
			}
				...
				if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
				{
					...
					switch (iLocal_29)
					{
						case 0:
							...
							{
								func_57();
								unk_0xE98E714BAA9A8D42("SAFEHOUSE_MICHAEL_SIT_SOFA", 0, 4294967295);
								unk_0x9CBC55A05A07FC47(0);
								Global_786C[iLocal_41 /*11*/].f_2 = 0;
								Global_786C[iLocal_41 /*11*/].f_6 = 1;
								Global_786C[iLocal_41 /*11*/] = unk_0x09AC81E49EA267F7(0, 2);
								Global_786C[iLocal_41 /*11*/].f_1 = 0;
								Global_786C[iLocal_41 /*11*/].f_4 = 0;
								Global_786C[iLocal_41 /*11*/].f_7 = 0;
								Global_786C[iLocal_41 /*11*/].f_8 = 0;
								Global_786C[iLocal_41 /*11*/].f_A = 0;
								fLocal_30 = -4f;
								func_55(&iLocal_26);
								func_53();
								func_52();
						...
						case 1:
							...
							else if (unk_0xC57D0A75AFA332A3(iLocal_35) && unk_0x10BA239D3B8FDC7F(iLocal_35, 1119092736))
							{
						...
						case 2:
							...
							if (!func_64(iLocal_41))
							{
								if ((Global_786C[iLocal_41 /*11*/] == 3 || Global_786C[iLocal_41 /*11*/] == 2) || Global_786C[iLocal_41 /*11*/] == 4294967295)
								{
									Global_786C[iLocal_41 /*11*/] = unk_0x09AC81E49EA267F7(0, 2);
								}
							...
							else
							{
								...
								{
									Global_786C[iLocal_41 /*11*/].f_5 = 0;
									Global_786C[iLocal_41 /*11*/].f_7 = 0;
								}
							}
							Global_786C[iLocal_41 /*11*/].f_2 = 1;
							func_40(133, 1);
							func_40(131, 1);
							func_40(132, 1);
							iLocal_29 = 3;
						...
						case 3:
							...
							{
								func_35();
								if (unk_0x04639A879AC88653() == 4294967295)
								{
									unk_0x188BA9B758DB0D5E(Global_786C[iLocal_41 /*11*/]);
								}
								if (func_15())
	...
	if (!func_64(iLocal_41))
	{
		if (((((((func_31(&iLocal_26) >= 1f && unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_68, 1f, 1f, 1.5f, false, true, 0)) && unk_0x4D570FEF9D230CE7(iLocal_35) == unk_0x4D570FEF9D230CE7(unk_0x16F2683693E537C9())) && !func_30(8, 4294967295)) && !unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0)) && unk_0xBFDF2644D7CBD7C5(unk_0x16F2683693E537C9(), vLocal_31, 90f)) && !unk_0x869EFD0BC0868856(unk_0x16F2683693E537C9())) && !unk_0x991B1F0980C62628())
		{
			...
			else if (func_26(iLocal_40, 1))
			{
				...
				{
					unk_0x4D7F4CC43D4D0DE3(4294967295, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
				}
				return 1;
			}
			func_16();
...
void func_25()
{
	...
	if (iLocal_65 == 0)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
		{
			...
			unk_0xDBE4EC9C88839074(unk_0x16F2683693E537C9(), vLocal_31, 4294967295, 0, 2);
			unk_0x4A4806F9D471E491(unk_0x16F2683693E537C9(), false, 0);
		}
		if (!unk_0x7F8A39872A07D2CE(&cLocal_53, "NULL"))
		{
...
int func_44()
{
	...
	if (func_26(iLocal_40, 1))
	{
		func_43(&iLocal_40);
		func_55(&iLocal_26);
		Global_786C[iLocal_41 /*11*/].f_7 = 1;
		if (unk_0x64F604CF561734A9("SAFEHOUSE_MICHAEL_SIT_SOFA", 0, 4294967295))
		{
			unk_0x4D7F4CC43D4D0DE3(4294967295, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
		}
...
void func_59()
{
	...
	func_61();
	if (unk_0x134B62B726CEC8E6(iLocal_35) == 3397365739)
	{
...
void func_62()
{
	...
	if (Global_786C[iLocal_41 /*11*/].f_A == 0)
	{
		if (iLocal_66 == 1)
		{
			if (unk_0xC844350D5D58C99A(iLocal_38))
...
void func_68()
{
	...
	{
		func_1();
		Global_786C[iLocal_41 /*11*/].f_6 = 0;
		Global_786C[iLocal_41 /*11*/].f_7 = 0;
		Global_786C[iLocal_41 /*11*/].f_8 = 0;
		Global_786C[iLocal_41 /*11*/].f_4 = 0;
		Global_786C[iLocal_41 /*11*/].f_5 = 0;
		Global_786C[iLocal_41 /*11*/].f_2 = 0;
		Global_786C[iLocal_41 /*11*/] = 4294967295;
		Global_786C[iLocal_41 /*11*/].f_1 = 0;
		Global_786C[iLocal_41 /*11*/].f_A = 0;
	}

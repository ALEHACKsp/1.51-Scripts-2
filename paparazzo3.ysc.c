...
void __EntryFunction__()
{
	...
	fLocal_30 = 180f;
	iLocal_33 = 3;
	uLocal_38 = func_481(50);
	iLocal_39 = joaat("pcj");
	iLocal_41 = 4294967294;
	...
	{
		SYSTEM::WAIT(0);
		unk_0x1A6DFFFEEC27BF4F("SF_PTP", 0);
...
{
	func_250();
	if (!func_231(Local_43.f_1C[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
	{
		switch (iLocal_42)
		{
			case 0:
				if (func_229(Local_43.f_1C[0]))
				{
					unk_0x11AD11297DC58CC7(Local_43.f_1C[0], true);
				}
				iLocal_42 = 1;
				break;
			...
			case 1:
				...
				{
					if (unk_0x69DF961355195C3C(iLocal_228))
					{
						if (unk_0xA45992A6CE82FB43(iLocal_228) >= 1f)
						{
							iLocal_42 = 2;
						}
					}
		...
		if (bParam2)
		{
			if (!Global_12B4E)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_1F4F[iParam1 /*4*/] = { func_206(iParam0) };
					...
					{
						Global_1F1E[1 /*6*/] = { func_206(iParam0) };
...
int func_217()
{
	...
	if (unk_0xD803B885F5E47A62() == func_220())
	{
		return 0;
	}
	if (func_218(unk_0xD803B885F5E47A62()))
	{
		return 0;
	}
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (func_230(unk_0x16F2683693E537C9()) && func_230(iParam0))
	{
		...
		if (!unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
		{
			if (unk_0x65851B2C8786EE74(unk_0x16F2683693E537C9()))
			{
				...
				{
					return func_244(unk_0x16F2683693E537C9(), iParam0, fParam2);
				}
			}
		}
		if (bParam4)
...
int func_232(int iParam0, float fParam1)
{
	...
	if (func_230(unk_0x16F2683693E537C9()) && func_230(iParam0))
	{
		if (func_243(iParam0) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iParam0))
		{
			if (unk_0x03A10A5707B2BB1F(unk_0x16F2683693E537C9(), 6))
			{
				fVar0 = 40f;
...
{
	return func_234(iParam0, unk_0x16F2683693E537C9(), fParam1, 1, 250, 7);
}
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_240(unk_0x68F4C0EC296D3901(iParam1, true) - unk_0x68F4C0EC296D3901(iParam0, true)) };
	...
	{
		vVar1 = { func_240(unk_0x64430C979F516F7A(iParam0, 31086, 0f, 5f, 0f) - unk_0x64430C979F516F7A(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_245(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_230(unk_0x16F2683693E537C9()) && func_230(iParam0))
	{
		...
		if (!bParam2)
		{
			if (func_249(iParam0, bParam1, iVar0, fVar1))
			{
				return 1;
			}
...
int func_248(int iParam0, vector3 vParam1, float fParam2, int iParam3)
{
	...
	vVar0 = { func_240(vParam1 - unk_0x68F4C0EC296D3901(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_249(int iParam0, bool bParam1, int iParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
...
void func_250()
{
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()) && func_230(Local_43.f_1C[0]))
	{
		unk_0x50155CDC2C5335FC(Local_43.f_1C[0], 1, unk_0x16F2683693E537C9(), 31086, 0f, 0f, 0f, 0, 4294967295, 4294967295);
		unk_0x50155CDC2C5335FC(unk_0x16F2683693E537C9(), 1, Local_43.f_1C[0], 31086, 0f, 0f, 0f, 0, 4294967295, 4294967295);
	}
}
	...
	switch (iLocal_42)
	{
		case 0:
			...
			if (func_230(unk_0x16F2683693E537C9()))
			{
				...
				{
					func_286(sLocal_56, unk_0x16F2683693E537C9(), 0, 2);
				}
			}
			if (func_279(1, 1093140480, 0))
			{
				if (func_230(Local_43.f_1C[0]))
				{
					unk_0x29E8331978B73E7F(Local_43.f_1C[0], sLocal_58, 0, 0, 0);
				}
				if (func_230(unk_0x16F2683693E537C9()))
				{
					unk_0x29E8331978B73E7F(unk_0x16F2683693E537C9(), sLocal_56, 0, 0, 0);
				}
				if (unk_0xC844350D5D58C99A(iLocal_47[0]))
				{
					unk_0x29E8331978B73E7F(iLocal_47[0], sLocal_52, 0, iLocal_48, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(iLocal_47[0], sLocal_52, 2, iLocal_48, 0);
				}
				if (unk_0xC844350D5D58C99A(iLocal_47[1]))
				{
					unk_0x29E8331978B73E7F(iLocal_47[1], sLocal_53, 0, iLocal_49, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(iLocal_47[1], sLocal_53, 2, iLocal_49, 0);
				}
				if (unk_0xC844350D5D58C99A(iLocal_45))
				{
					unk_0x29E8331978B73E7F(iLocal_45, sLocal_55, 0, iLocal_51, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(iLocal_45, sLocal_55, 2, iLocal_51, 0);
				}
				if (unk_0xC844350D5D58C99A(iLocal_46))
				{
					unk_0x29E8331978B73E7F(iLocal_46, sLocal_54, 0, iLocal_50, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(iLocal_46, sLocal_54, 2, iLocal_50, 0);
				}
		...
		case 1:
			...
			if (unk_0x3148AE92ED70DC30(sLocal_58, 0))
			{
				iLocal_228 = unk_0xE9744DB7B8CA6965(vLocal_229, vLocal_230, 2);
				unk_0x915804B434753CBD(Local_43.f_1C[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
				unk_0xF895E10BF4C72645(Local_43.f_1C[0], 0, 0);
			}
			if (unk_0x3148AE92ED70DC30(sLocal_56, 0))
			{
				unk_0xA47B46945FF6DE74(unk_0x16F2683693E537C9(), -258.8661f, 292.7882f, 90.5764f, 1, false, 0, 1);
				unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 153.0417f);
				unk_0xF895E10BF4C72645(unk_0x16F2683693E537C9(), 0, 0);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_46))
			{
				if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_54, iLocal_50)))
				{
					iLocal_46 = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_54, iLocal_50));
				}
			}
			else if (unk_0x69DF961355195C3C(iLocal_228) && unk_0x3148AE92ED70DC30(sLocal_54, 0))
			{
				unk_0xA47B46945FF6DE74(iLocal_46, vLocal_229, 0, false, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_46, vLocal_230, 2, 0);
				unk_0xE14EC663EED44AD5(iLocal_46, iLocal_228, "leadout_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
				unk_0x295ACC5727E47CB7(iLocal_46);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_47[0]))
			{
				if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_52, 0)))
				{
					iLocal_47[0] = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_52, iLocal_48));
				}
			}
			else if (unk_0x69DF961355195C3C(iLocal_228) && unk_0x3148AE92ED70DC30(sLocal_52, 0))
			{
				unk_0xE14EC663EED44AD5(iLocal_47[0], iLocal_228, "leadout_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 1, 1148846080);
				unk_0x295ACC5727E47CB7(iLocal_47[0]);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_47[1]))
			{
				if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_53, 0)))
				{
					iLocal_47[1] = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_53, iLocal_49));
				}
			}
			else if (unk_0x69DF961355195C3C(iLocal_228) && unk_0x3148AE92ED70DC30(sLocal_53, 0))
			{
				unk_0xE14EC663EED44AD5(iLocal_47[1], iLocal_228, "leadout_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 1, 1148846080);
				unk_0x295ACC5727E47CB7(iLocal_47[1]);
			}
			if (!unk_0xC844350D5D58C99A(iLocal_45))
			{
				if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_55, 0)))
				{
					iLocal_45 = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_55, iLocal_51));
				}
			}
			else if (unk_0x69DF961355195C3C(iLocal_228) && unk_0x3148AE92ED70DC30(sLocal_55, 0))
			{
				unk_0xA47B46945FF6DE74(iLocal_45, -261.1132f, 294.1956f, 90.68612f, 0, false, 0, 1);
				unk_0xC023D1C4BF532815(iLocal_45, -0.604164f, -2.332095f, 89.8831f, 2, 0);
				unk_0x295ACC5727E47CB7(iLocal_45);
			}
...
void func_253(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_229(unk_0x16F2683693E537C9()))
	{
...
void func_254(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	...
	else
	{
		...
		{
			if (((((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_258(unk_0xD803B885F5E47A62())) && !func_256(unk_0xD803B885F5E47A62(), 0)) && !func_255()) && !bParam4) && !bParam5)
			{
				unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
			}
		}
		else if (((!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && !func_258(unk_0xD803B885F5E47A62())) && !bParam4) && !bParam5)
		{
			unk_0xE121AE1BBF90E186(unk_0x16F2683693E537C9(), false);
		}
		Global_12B4C = 0;
...
void func_264(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (unk_0xE1DBBD6CE209517C(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			unk_0x745CE398A4B0A3C6(func_266(unk_0xA30EC016B12C03E4()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
int func_276()
{
	...
	{
		unk_0xA6B02C1DB14DDA13(unk_0x134B62B726CEC8E6(iVar2), &(vVar0[0 /*3*/]), &(vVar0[1 /*3*/]));
		vVar1 = { func_277() };
...
int func_279(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_284(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_283(unk_0x16F2683693E537C9(), 3466132403))
				{
...
void func_287(int iParam0, var uParam1, int iParam2)
{
	...
	func_288(iParam0, &Var2, 0, 4294967295);
	func_288(iParam0, uParam1, iParam2, 4294967295);
	iVar5 = 0;
	iVar6 = 0;
	iVar0 = 0;
	while (iVar0 < 12)
	{
		...
		{
			if (func_42(iVar4, func_81(iVar0), func_65(iParam0, Var2.f_D[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(iVar4, 2, uParam1->f_3B, 4294967295) };
				uParam1->f_D[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
				iVar5 = 1;
			}
			if (func_49(iVar4, func_81(iVar0), func_65(iParam0, Var2.f_D[iVar0], Var2[iVar0], func_81(iVar0)), &iVar1))
			{
				Var3 = { func_83(iVar4, 1, uParam1->f_3E, 4294967295) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_42(iVar4, 14, func_56(iParam0, Var2.f_27[iVar0], Var2.f_31[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(iVar4, 2, uParam1->f_3B, 4294967295) };
				uParam1->f_D[2] = Var3.f_3;
				(*uParam1)[2] = Var3.f_4;
			...
			if (func_49(iVar4, 14, func_56(iParam0, Var2.f_27[iVar0], Var2.f_31[iVar0], iVar0), &iVar1))
			{
				Var3 = { func_83(iVar4, 1, uParam1->f_3E, 4294967295) };
				uParam1->f_D[1] = Var3.f_3;
				(*uParam1)[1] = Var3.f_4;
	...
	if (iVar6 || iVar5)
	{
		iVar7 = func_65(iParam0, uParam1->f_D[1], (*uParam1)[1], 1);
		iVar8 = func_65(iParam0, uParam1->f_D[2], (*uParam1)[2], 2);
		iVar9 = func_50(iVar4, iVar8, iVar7);
		if (iVar9 != 4294967197)
		{
			Var3 = { func_83(iVar4, 0, iVar9, 4294967295) };
...
void func_288(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	if (!unk_0xEB6A8945D1AC98A1(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_291(iParam0, iVar1, &(uParam1->f_D[iVar1]), uParam1[iVar1], &(uParam1->f_1A[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_290(iParam0, iVar1, &(uParam1->f_27[iVar1]), &(uParam1->f_31[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_152(iVar0))
		{
...
int func_289(int iParam0, int iParam1)
{
	...
	iVar0 = Global_276C68[iParam0 /*3*/][func_69(iParam1)];
...
void func_292()
{
	if (func_262())
	{
		unk_0xC0B0B9E466C0ED17(Local_43.f_1C[0], 0f, 0f, 0f, 1, 4294967295, 1500, 2000, 0);
	}
}
...
void func_293()
{
	...
	{
		case 0:
			if (!unk_0x562F77A7F33D2E46("PAPARAZZO_03_SCENE"))
			{
				unk_0x8BC9595FD2792B5D("PAPARAZZO_03_SCENE");
			}
			iLocal_235 = 0;
			func_295("PAP_3_RCM", 0);
			if (func_229(Local_43.f_1C[0]) && unk_0xC844350D5D58C99A(iLocal_46))
			{
				iLocal_226 = unk_0xE9744DB7B8CA6965(unk_0x68F4C0EC296D3901(iLocal_46, true), unk_0x835730A2D89F6093(iLocal_46, 2), 2);
				unk_0x915804B434753CBD(Local_43.f_1C[0], iLocal_226, sLocal_57, "leadin_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				if (unk_0xC844350D5D58C99A(iLocal_46))
				{
					unk_0xE14EC663EED44AD5(iLocal_46, iLocal_226, "leadin_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xC844350D5D58C99A(iLocal_47[0]))
				{
					unk_0xE14EC663EED44AD5(iLocal_47[0], iLocal_226, "leadin_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				if (unk_0xC844350D5D58C99A(iLocal_47[1]))
				{
					unk_0xE14EC663EED44AD5(iLocal_47[1], iLocal_226, "leadin_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
				}
				func_253(1, 1, 1, 1);
				iLocal_42 = 1;
			}
		...
		case 1:
			if (func_229(Local_43.f_1C[0]) && unk_0xC844350D5D58C99A(iLocal_46))
			{
				if (unk_0x69DF961355195C3C(iLocal_226))
				{
					if (unk_0xA45992A6CE82FB43(iLocal_226) > 0.99f)
					{
						if (!unk_0x69DF961355195C3C(iLocal_227))
						{
							iLocal_227 = unk_0xE9744DB7B8CA6965(unk_0x68F4C0EC296D3901(iLocal_46, true), unk_0x835730A2D89F6093(iLocal_46, 2), 2);
							unk_0x915804B434753CBD(Local_43.f_1C[0], iLocal_227, sLocal_57, "idle_01_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
							unk_0xF895E10BF4C72645(Local_43.f_1C[0], 0, 0);
							if (unk_0xC844350D5D58C99A(iLocal_46))
							{
								unk_0xE14EC663EED44AD5(iLocal_46, iLocal_227, "idle_01_pap_3_rcm_dumpster", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0x295ACC5727E47CB7(iLocal_46);
							}
							if (unk_0xC844350D5D58C99A(iLocal_47[0]))
							{
								unk_0xE14EC663EED44AD5(iLocal_47[0], iLocal_227, "idle_01_pap_3_rcm_lid_l", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0x295ACC5727E47CB7(iLocal_47[0]);
							}
							if (unk_0xC844350D5D58C99A(iLocal_47[1]))
							{
								unk_0xE14EC663EED44AD5(iLocal_47[1], iLocal_227, "idle_01_pap_3_rcm_lid_r", sLocal_57, 1000f, -8f, 0, 1148846080);
								unk_0x295ACC5727E47CB7(iLocal_47[1]);
							}
						}
					}
					if (unk_0xA45992A6CE82FB43(iLocal_226) > 0.3f)
					{
						if (!bLocal_224)
						{
					...
					if (unk_0xA45992A6CE82FB43(iLocal_226) > 0.05f)
					{
						func_292();
					}
				}
...
void func_294()
{
	if (unk_0xC844350D5D58C99A(Local_43.f_29[3]) && !iLocal_235)
	{
		unk_0xBA3209FB359D3EA4("scr_rcpap1_camera", unk_0x64430C979F516F7A(Local_43.f_1C[0], 28422, vLocal_232), unk_0x835730A2D89F6093(Local_43.f_29[3], 2), 1f, 0, 0, 0);
		if (!unk_0x8AA6DC470ABA63A2(iLocal_231))
		{
			unk_0x55D0A2DB35045A35(iLocal_231);
		}
		if (unk_0xAE317D00A5A55DF6(sLocal_233, false, 4294967295))
		{
			unk_0xEB819BD1E585E9CB(iLocal_231, "CAMERA", unk_0x64430C979F516F7A(Local_43.f_1C[0], 28422, vLocal_232), sLocal_234, false, 0, 0);
			iLocal_235 = 1;
		}
	}
}
...
void func_297()
{
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
		{
			if (func_284(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_304()
{
	...
	if (func_229(unk_0x16F2683693E537C9()))
	{
		iLocal_44 = unk_0xD09DF7101876AFB8(unk_0x16F2683693E537C9());
	}
	if (func_229(Local_43.f_1C[0]))
	{
		unk_0x6DF7BF67E86AAE86(Local_43.f_1C[0], iLocal_44);
		unk_0x4E885A246A9D983A(Local_43.f_1C[0], 132, true);
		unk_0xFADC0A217229F6B5(Local_43.f_1C[0], true);
		unk_0x11AD11297DC58CC7(Local_43.f_1C[0], true);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_45))
	{
		iLocal_45 = unk_0x4B72871A3BE7B474(-261.19f, 292.22f, 90.79f, 10f, iLocal_51, 1, 0, 1);
		unk_0xE3430088DE1D3440(iLocal_45, 0);
	}
	if (!unk_0xC844350D5D58C99A(iLocal_46))
	{
		func_313(&iLocal_46, &(Local_43.f_29[0]));
	}
	if (!unk_0xC844350D5D58C99A(iLocal_47[0]))
	{
		func_313(&(iLocal_47[0]), &(Local_43.f_29[1]));
	}
	if (!unk_0xC844350D5D58C99A(iLocal_47[1]))
	{
		func_313(&(iLocal_47[1]), &(Local_43.f_29[2]));
	}
	func_312(&uLocal_59, 1, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
	func_312(&uLocal_59, 3, Local_43.f_1C[0], "BEVERLY", 0, 1);
	unk_0xD7992BEF7A9D109E("PAP3", 0);
	unk_0x3F423BF5B8125A50(sLocal_57);
	unk_0x9E5E60D8C63FD9D1();
	while (!unk_0xB4AE0788C1587752(sLocal_57) || !unk_0x25F7A4D42AF2AB93())
	{
		func_296();
		SYSTEM::WAIT(0);
	}
	iLocal_231 = unk_0xD68EA767274B7444();
	if (func_443())
	{
		switch (func_311())
		{
...
void func_305()
{
	...
	func_308();
	func_252(1);
	func_307(unk_0x16F2683693E537C9(), -258.8661f, 292.7882f, 90.5764f, 153.0393f, 0, 1);
	func_306(1, 1, 1);
}
...
void func_308()
{
	if (func_230(Local_43.f_1C[0]) && unk_0xC844350D5D58C99A(iLocal_46))
	{
		iLocal_228 = unk_0xE9744DB7B8CA6965(vLocal_229, vLocal_230, 2);
		unk_0x915804B434753CBD(Local_43.f_1C[0], iLocal_228, sLocal_57, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (unk_0xC844350D5D58C99A(iLocal_46))
		...
		unk_0x57E0CF9BF653D99A(iLocal_228, 0.02f);
	}
	bLocal_225 = false;
}
...
int func_314()
{
	...
	else if (unk_0xC844350D5D58C99A(Local_43.f_1C[0]))
	{
		if (unk_0x437347B10A200C4B(Local_43.f_1C[0], 0))
		{
			func_315("P3BEVDEAD");
			return 1;
		}
		else if (unk_0x65BC0B7172CA52DD(Local_43.f_1C[0]) > unk_0x7F6DC62EA9922664(Local_43.f_1C[0]))
		{
			func_315("P3BEVHURT");
			return 1;
		}
...
void func_316()
{
	...
	{
		case 0:
			if (unk_0x7F8A39872A07D2CE(sLocal_236, "DEFAULT"))
			{
				func_459(1);
			}
			else
	...
	if (Global_12C4C != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x757EF87A33649210())
			{
				...
				Var4 = { func_322(Global_12C4D, Global_12C4F, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_333(0) || Global_12C5B) || Global_12C50 == 1) || !unk_0x0F1CCD77290EE12F())
	{
		return 0;
	}
	switch (Global_12C4C)
	{
		...
		case 5:
			if ((unk_0x22A8E52414415B76() || func_302(0)) || func_332(1))
			{
			}
			else
			{
...
{
	return func_335(iParam0, Global_A1D7);
}
...
void func_337(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)
{
	...
	if (iVar0 == 1)
	{
		if (!func_433(iParam4, iParam5, iParam6, iParam11))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_411(vParam1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		if (Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (unk_0xB87F6CF6E5628C67(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0x122AAB0B1D6F55AD(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_396(iParam0, &(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			if (unk_0xB87F6CF6E5628C67(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = unk_0x122AAB0B1D6F55AD(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, false, false, false);
				...
				func_396(iParam0, &(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[1 /*295*/][iParam1 /*98*/].f_51));
				unk_0x0947AEED9914905B(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (unk_0x134B62B726CEC8E6(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (unk_0xB87F6CF6E5628C67(Var2))
			{
				...
				*iParam0 = unk_0x122AAB0B1D6F55AD(Var2, vParam2, fParam3, true, true, false);
				...
				func_396(iParam0, &(Var2.f_1F), &(Var2.f_51));
				unk_0x0947AEED9914905B(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_152(iParam0) && unk_0xC844350D5D58C99A(*iParam1)) && unk_0xDF1306B443CD3D15(*iParam1, 0))
	{
		...
		if (unk_0x67303E186EA6C9A0(*iParam1) >= 0 && func_344(*iParam1, 0, &uVar0))
		{
			func_343(iParam1, &(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_1B416.f_4E91[iParam0 /*43*/].f_1F = func_342(*iParam1);
				...
				func_340(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_1B416.f_4E91[iParam0 /*43*/].f_1));
				...
				func_340(Global_1B416.f_936.f_21B.f_967[iParam2 /*295*/][iParam0 /*98*/].f_6, 4294967295, iVar3, 0, &(Global_1B416.f_4E91[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_344(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	iVar0 = unk_0x134B62B726CEC8E6(iParam0);
	if ((!func_372(iVar0, bParam1, uParam2) && !func_371(unk_0xD803B885F5E47A62())) && !func_354(iParam0))
	{
		return 0;
	}
	...
	bVar1 = false;
	if (func_352(unk_0xD803B885F5E47A62()) && (unk_0xAFB8495D36825275(iVar0) || unk_0xC41A9202669A24C4(iVar0)))
	{
		bVar1 = true;
	}
	if (((unk_0x56E1CD81AE700E98(iParam0) && !func_350(iParam0)) && !bVar1) && !(func_349(unk_0x134B62B726CEC8E6(iParam0)) && func_346(unk_0xD803B885F5E47A62())))
	{
	...
	if (!unk_0x8CD06866876216F2())
	{
		if ((func_345(iParam0) && unk_0x134B62B726CEC8E6(iParam0) != joaat("sentinel2")) && unk_0x134B62B726CEC8E6(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_346(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			...
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 11;
			}
		}
	}
	return 0;
...
int func_351(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 13;
			}
		}
	}
	return 0;
...
int func_352(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 7;
			}
		}
	}
	return 0;
...
{
	if (func_370(unk_0xD803B885F5E47A62()) || func_369(unk_0xD803B885F5E47A62()))
	{
		if (func_355(iParam0))
		{
			return 1;
...
int func_356(int iParam0)
{
	...
	if (func_357(unk_0x134B62B726CEC8E6(iParam0)))
	{
		return 1;
	}
	return 0;
...
int func_358(int iParam0, bool bParam1)
{
	switch (unk_0x134B62B726CEC8E6(iParam0))
	{
		...
		case joaat("insurgent"):
			if (func_360(unk_0x134B62B726CEC8E6(iParam0), 0))
			{
				if (Global_26B66F.f_12D == iParam0)
				{
					return 1;
				}
				else if (func_359(iParam0) != 4294967295 && !bParam1)
				{
					return 1;
				}
			}
...
int func_369(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295 && Global_25033E[iParam0 /*421*/].f_136.f_8 != func_220())
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 5;
			}
		}
	}
	return 0;
...
int func_370(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295 && Global_25033E[iParam0 /*421*/].f_136.f_8 != func_220())
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 8;
			}
		}
	}
	return 0;
...
int func_371(int iParam0)
{
	if (iParam0 != func_220())
	{
		if (func_348(iParam0, 1, 1))
		{
			if (Global_25033E[iParam0 /*421*/].f_136.f_5 != 4294967295)
			{
				return func_347(Global_25033E[iParam0 /*421*/].f_136.f_5) == 9;
			}
		}
	}
	return 0;
...
int func_372(int iParam0, bool bParam1, var uParam2)
{
	...
	bVar0 = false;
	if (func_352(unk_0xD803B885F5E47A62()) && (unk_0xAFB8495D36825275(iParam0) || unk_0xC41A9202669A24C4(iParam0)))
	{
		bVar0 = true;
	}
...
void func_374(int iParam0, int iParam1)
{
	...
	func_375(iParam0, &(Global_1B416.f_7FE8.f_1586));
}
...
void func_375(int iParam0, var uParam1)
{
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4EB64970EC291A00(iParam0);
		...
		if (uParam1->f_41 == 4294967295 && !func_377(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		func_343(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (unk_0xDD62D560CFE11A27(iParam0, iVar0 + 1))
			{
				unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_376(iVar0 + 1));
			}
			iVar0++;
		}
...
{
	if ((((((((((!unk_0xC844350D5D58C99A(iParam0) || !unk_0xDF1306B443CD3D15(iParam0, 0)) || func_271(iParam0, 0, 0)) || func_271(iParam0, 1, 0)) || func_271(iParam0, 2, 0)) || func_392(iParam0) != 145) || func_391(iParam0)) || func_390(iParam0)) || func_345(iParam0)) || func_389(iParam0)) || !func_379(unk_0x134B62B726CEC8E6(iParam0)))
	{
		if (func_390(iParam0))
		{
		}
...
int func_396(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_368(unk_0x134B62B726CEC8E6(*iParam0), 1) && unk_0x0ECB5CA5140957AD(*iParam0, 24) != func_399(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0xEE6A1776A67F70C1(*iParam0, 24, func_399(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_398(iParam0);
	if (func_397(*iParam0))
	{
...
void func_402(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xC844350D5D58C99A(Global_1774B[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x134B62B726CEC8E6(Global_1774B[iVar0]) == func_403(iParam0, iParam1))
				{
...
void func_404(vector3 vParam0, float fParam1, bool bParam2)
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_409(&(Global_126B1.f_22B[0 /*21*/]), iVar0))
		{
...
void func_405(int iParam0)
{
	...
	if (func_409(&(Global_126B1.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_181(iParam0, 0)) && Global_12A3E.f_42 == 0) && Global_1B416.f_7FE8.f_7A6[Global_126B1.f_22B[0 /*21*/].f_E] != 0) && Global_1B416.f_7FE8.f_7A6[Global_126B1.f_22B[0 /*21*/].f_E] > 3) && (!func_407(0, Global_126B1.f_22B[0 /*21*/].f_C) || !func_407(1, Global_126B1.f_22B[0 /*21*/].f_C)))
			{
				func_406(&(Global_1B416.f_7FE8.f_45[Global_126B1.f_22B[0 /*21*/].f_E /*78*/]), &Global_12A3E);
...
int func_407(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_408(&(Global_1B416.f_7FE8.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_380(Global_1B416.f_7FE8.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}
...
int func_409(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xEAE0D21A50E6C7F4(uParam0->f_9, 10))
	{
		...
		if (!func_410(Global_1B416.f_7FE8.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_410(Global_1B416.f_936.f_21B.f_E04[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_410(Global_1B416.f_936.f_21B.f_E04[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
bool func_410(vector3 vParam0, vector3 vParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_411(vector3 vParam0, float fParam1)
{
	return func_412(&(Global_19AE3.f_B4A), vParam0, fParam1, 0);
}

int func_412(var uParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_429(uParam0))
	{
		...
		if (func_428(uParam0))
		{
			...
			if (unk_0xC844350D5D58C99A(iVar0))
			{
				...
				func_417(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_402(uParam0->f_B, 1);
						}
						else if (unk_0x7D8B2A8F9EA82DB7(unk_0x134B62B726CEC8E6(iVar0)))
						{
							func_402(uParam0->f_B, 2);
						}
					}
					unk_0x316958DDB94DF3FC(iVar0, 0);
					unk_0x626D5ADA3EFAE431(iVar0, false);
					unk_0x44A200C9B6E1CEA6(iVar0, true);
					func_393(iVar0, uParam0->f_B);
				}
				else if ((!func_414(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && unk_0x7F8A39872A07D2CE(unk_0xBB0808A181D4745C(), "startup_positioning"))
				{
					iVar4 = func_413(iVar0);
					if (iVar4 == 4294967295)
					{
						uParam0->f_A = 0;
					}
...
int func_414(int iParam0, vector3 vParam1, bool bParam2)
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_416(iParam0, Global_126B1.f_8B[38], 0))
			{
				func_405(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_416(iParam0, Global_126B1.f_8B[43], 1))
			{
				func_405(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_416(iParam0, uVar1[iVar3], 1) && func_415(unk_0x68F4C0EC296D3901(uVar1[iVar3], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_410(vParam1, 0f, 0f, 0f, 0)) || unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(uVar1[iVar3], true), true) < 10f)
					{
...
int func_415(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_417(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar1 + 1)))
			{
			}
			else
			{
				unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_376(iVar1 + 1));
			}
		}
		else if (uParam1->f_42 == 340154634 || uParam1->f_42 == 2334210311)
		{
			...
			while (iVar2 <= 9)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar2)))
				{
				}
				else
				{
					unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_376(iVar2));
				}
				iVar2++;
			}
		}
		else if (uParam1->f_42 == 1492612435)
		{
			...
			while (iVar3 <= 6)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar3)))
				{
				}
				else
				{
					unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_376(iVar3));
				}
				iVar3++;
			}
		}
		else if (uParam1->f_42 == 1181339704)
		{
			...
			while (iVar4 <= 11)
			{
				if (iVar4 != 9 && iVar4 != 10)
				{
					if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar4)))
					{
					}
					else
					{
						unk_0x5D96D8530B3D0904(&(uParam1->f_4D), func_376(iVar4));
					}
				}
				iVar4++;
			}
		...
		if (((unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, 15) || func_420(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_419())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_396(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		}
		if (!unk_0xAFB8495D36825275(uParam1->f_42) && !unk_0xA7082C42B8809BF2(uParam1->f_42))
		{
			...
			while (iVar5 <= 11)
			{
				if (unk_0xEAE0D21A50E6C7F4(uParam1->f_4D, func_376(iVar5 + 1)))
				{
...
int func_421(int iParam0)
{
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		if (!func_427(unk_0xD803B885F5E47A62(), 4294967295))
		{
	...
	if (func_423(unk_0xD803B885F5E47A62()) == 3)
	{
		if (unk_0xC844350D5D58C99A(iParam0) && unk_0xDF1306B443CD3D15(iParam0, 0))
		{
...
int func_429(var uParam0)
{
	...
	if (!func_380(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("stunt") && func_415(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_430()
{
	return func_428(&(Global_19AE3.f_B4A));
}

void func_431()
{
	func_432(&(Global_19AE3.f_B4A));
}
...
int func_433(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_435(Global_19AE3.f_B4A.f_C.f_42))
	{
		return 0;
	}
...
bool func_436()
{
	return func_429(&(Global_19AE3.f_B4A));
}
...
int func_437(var uParam0)
{
	...
	switch (iLocal_37)
	{
		case 0:
			uParam0->f_10 = 5;
			uParam0->f_11[0 /*3*/] = { -258.5052f, 287.5976f, 90.17828f };
			uParam0->f_11[1 /*3*/] = { -258.5263f, 298.0905f, 93.69456f };
			uParam0->f_18 = 7f;
			uParam0->f_1B = 1;
			uParam0->f_19 = 1;
			...
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x523BCC9DC80CD82F(iVar0[iVar5]);
				iVar5++;
			}
		...
		case 1:
			if (!func_442(&iVar0) || !unk_0xB4AE0788C1587752(sVar4))
			{
				return 0;
			}
			iLocal_37 = 2;
		...
		case 2:
			...
			{
				if (func_439(&(uParam0->f_1C[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
			...
			if (func_229(uParam0->f_1C[0]))
			{
				if (!unk_0xC844350D5D58C99A(uParam0->f_29[3]))
				{
					func_438(&(uParam0->f_29[3]), iVar0[1], unk_0x68E4ADDDDCD7BDDE(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_230(uParam0->f_29[3]))
					{
						unk_0x9F528B1B53FBC5D9(uParam0->f_29[3], uParam0->f_1C[0], unk_0x4A089F2B762B8D33(uParam0->f_1C[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
						unk_0x71199B01895C6202(iVar0[1]);
					}
					else
					{
						bVar6 = false;
			...
			if (bVar6)
			{
				iVar1[0] = unk_0x4B72871A3BE7B474(-260.62f, 292.1391f, 90.604f, 10f, joaat("prop_cs_dumpster_01a"), 1, 0, 1);
				vVar2[0 /*3*/] = { -260.614f, 292.106f, 91.127f };
				vVar3[0 /*3*/] = { 7.2E-05f, -2.500116f, 89.63998f };
				iVar1[1] = unk_0x4B72871A3BE7B474(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidl"), 1, 0, 1);
				vVar2[1 /*3*/] = { -261.108f, 292.5062f, 92.03645f };
				vVar3[1 /*3*/] = { -0.656039f, -2.50018f, 89.6114f };
				iVar1[2] = unk_0x4B72871A3BE7B474(-261.5835f, 291.6671f, 92.066f, 10f, joaat("prop_cs_dumpster_lidr"), 1, 0, 1);
				vVar2[2 /*3*/] = { -261.1135f, 291.6249f, 91.99765f };
				vVar3[2 /*3*/] = { -0.281056f, -2.500049f, 89.62769f };
				iVar5 = 0;
				while (iVar5 <= 2)
				{
					unk_0xEEEE2E5FA6F78DF0(&(iVar1[iVar5]));
					iVar5++;
				}
				unk_0x3124890FDA752DE4(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), 1);
				unk_0x3124890FDA752DE4(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), 1);
				unk_0x3124890FDA752DE4(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), 1);
				uParam0->f_29[0] = unk_0xB0BE3DFBBB59A620(joaat("prop_cs_dumpster_01a"), vVar2[0 /*3*/], true, true, false);
				unk_0xC023D1C4BF532815(uParam0->f_29[0], vVar3[0 /*3*/], 2, 1);
				unk_0xE3430088DE1D3440(uParam0->f_29[0], 0);
				uParam0->f_29[1] = unk_0xB0BE3DFBBB59A620(joaat("prop_cs_dumpster_lidl"), vVar2[1 /*3*/], true, true, false);
				unk_0xC023D1C4BF532815(uParam0->f_29[1], vVar3[1 /*3*/], 2, 1);
				unk_0xE3430088DE1D3440(uParam0->f_29[1], 0);
				uParam0->f_29[2] = unk_0xB0BE3DFBBB59A620(joaat("prop_cs_dumpster_lidr"), vVar2[2 /*3*/], true, true, false);
				unk_0xC023D1C4BF532815(uParam0->f_29[2], vVar3[2 /*3*/], 2, 1);
				unk_0xE3430088DE1D3440(uParam0->f_29[2], 0);
				iLocal_37 = 3;
			}
			break;
		
		case 3:
			if (func_230(uParam0->f_29[0]))
			{
				iLocal_40 = unk_0xE9744DB7B8CA6965(unk_0x68F4C0EC296D3901(uParam0->f_29[0], true), unk_0x835730A2D89F6093(uParam0->f_29[0], 2), 2);
				unk_0xE14EC663EED44AD5(uParam0->f_29[0], iLocal_40, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0xC90224D9E95E5E3A(iLocal_40, true);
				if (func_230(uParam0->f_1C[0]))
				{
					unk_0x915804B434753CBD(uParam0->f_1C[0], iLocal_40, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_230(uParam0->f_29[1]))
				{
					unk_0xE14EC663EED44AD5(uParam0->f_29[1], iLocal_40, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_230(uParam0->f_29[2]))
				{
					unk_0xE14EC663EED44AD5(uParam0->f_29[2], iLocal_40, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
			{
				unk_0x71199B01895C6202(iVar0[iVar5]);
				iVar5++;
			}
...
int func_439(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_440(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0xC844350D5D58C99A(*iParam0))
		{
			if (!unk_0x437347B10A200C4B(*iParam0, 0))
...
int func_440(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
void func_444()
{
	...
	if (unk_0x562F77A7F33D2E46("PAPARAZZO_03_SCENE"))
	{
		unk_0x8910D3D58E0132B8("PAPARAZZO_03_SCENE");
	}
	unk_0x43A06902454A1172(iLocal_231);
	if (unk_0xC844350D5D58C99A(iLocal_47[0]))
	{
		unk_0x1E9649458B15960F(iLocal_47[0], true);
	}
	if (unk_0xC844350D5D58C99A(iLocal_47[1]))
	{
		unk_0x1E9649458B15960F(iLocal_47[1], true);
	}
	func_457(&(iLocal_47[0]), 0);
	func_457(&(iLocal_47[1]), 0);
	func_457(&iLocal_45, 0);
	func_457(&iLocal_46, 0);
	unk_0x8D17794CE3273D70(sLocal_57);
	unk_0x29D7581AEF4440C2();
	func_456(&uLocal_59, 1);
	func_456(&uLocal_59, 3);
	unk_0x11CCD0ACA866C6C5(0, true);
	unk_0x790015DC92C918E2();
	func_455(&(Local_43.f_1C[0]), 1, 0, 1);
	func_445(&Local_43, 1, 0, 0);
...
void func_459(bool bParam0)
{
	...
	if (!func_476())
	{
		...
		{
			func_160(iVar0, 1, 0);
			func_460(unk_0xBB0808A181D4745C(), iVar0);
		}
		else
		{
			if (Global_1B085[iVar0 /*10*/].f_9 == 4294967295)
...
int func_461(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_467())
	{
		...
		{
			iVar2 = func_462(unk_0xBB0808A181D4745C());
			if (iVar2 > 4294967295)
			{
...
int func_463()
{
	...
	iVar0 = func_464(&(Global_181B8.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_467()
{
	...
	{
		if (func_462(&(Global_181B8.f_3)) > 4294967295)
		{
			return 1;
		}
	}
...
{
	func_480(&(uParam0->f_1C));
	func_480(&(uParam0->f_23));
	func_480(&(uParam0->f_29));
}

...
void func_1()
{
	if (SYSTEM::TIMERB() > 7000)
	{
		...
		{
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_48, 10f, 10f, 10f, 0, 1, 0) && iLocal_50 == 0)
			{
				SYSTEM::SETTIMERB(0);
				...
				unk_0xC6EB89C59F2AF6B8(0, "amb@PREACHER", "PREACH", 8f, -8f, 4294967295, 1, 0, 0, 0, 0);
			...
			if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_48, 3f, 3f, 3f, 0, 1, 0) && iLocal_49 == 0)
			{
				vLocal_46 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true) };
				SYSTEM::SETTIMERB(0);
				unk_0xDD353D0E9C789D0E(&iLocal_51);
...
void func_2()
{
	...
	iLocal_48 = unk_0x36F2404464202779(19, joaat("s_m_m_strpreach_01"), vLocal_45.x, vLocal_45.y, vLocal_46.z, 0f, 1, true);
	if (!unk_0x437347B10A200C4B(iLocal_48, 0))
	{
		unk_0xDD353D0E9C789D0E(&iLocal_51);
		unk_0x796BDF31572BB055(0, vLocal_46, 0);

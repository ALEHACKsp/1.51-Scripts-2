...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_29[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_4(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_29[iParam0], 600000);
}
...
void func_6()
{
	if (func_9())
	{
		func_7(0, 3832418740, 156.24f, 0f, 166.2f, 1, 1);
	}
}
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_27[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_8(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_24[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_12(iParam0), vParam2, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_24[iParam0], 600000);
}
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	iLocal_23[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_28(iParam0, 0), vParam2, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_23[iParam0], 600000);
	if (bParam4)
	{
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)
{
	...
	iLocal_22[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_22[iParam0], 600000);
	if (bParam3)
	{
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	iLocal_21[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_21[iParam0], 600000);
}
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_20[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, 4294967295, 2, 1, 0);
	unk_0x920814FE8940D940(iLocal_20[iParam0], 600000);
	if (bParam3)
	{

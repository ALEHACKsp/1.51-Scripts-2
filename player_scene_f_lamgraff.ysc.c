...
int func_2()
{
	...
	if (!unk_0xEB6A8945D1AC98A1(Global_180A1))
	{
		...
		{
			if (unk_0xB4ECF989E2C1DAC8(Global_180A1, &sLocal_239, &cLocal_271, 3))
			{
				if (unk_0x4E861BC5B1EDA7BD(Global_180A1))
				{
					unk_0x5B8BE59CB25E8968(Global_180A1, 0, 0);
				...
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_281 == 0)
					{
						iLocal_281 = unk_0xC1879030EB463216("scr_lamgraff_paint_spray", iLocal_235, 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
...
int func_26()
{
	...
	if (!unk_0xEB6A8945D1AC98A1(Global_180A1))
	{
		if (unk_0xC844350D5D58C99A(iLocal_235))
		{
			if (unk_0xB4ECF989E2C1DAC8(Global_180A1, &sLocal_239, &cLocal_255, 3))
			{
				if (unk_0x4E861BC5B1EDA7BD(Global_180A1))
				{
					unk_0x5B8BE59CB25E8968(Global_180A1, 0, 0);
				...
				else
				{
					...
					unk_0x915804B434753CBD(Global_180A1, iLocal_280, &sLocal_239, &cLocal_271, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					unk_0xA3BF0AA5A2608191(Global_180A1);
					unk_0xE972B33144E77B35(Global_180A1, 16);
					if (!unk_0x69DF961355195C3C(iLocal_280))
					{
						iLocal_280 = unk_0xE9744DB7B8CA6965(vLocal_237, 0f, 0f, fLocal_238, 2);
						unk_0xC90224D9E95E5E3A(iLocal_280, true);
...
int func_29(int iParam0, int iParam1)
{
	...
	if (!unk_0x991B1F0980C62628())
	{
		...
		else if (iParam1 == func_30(Global_180A1) && iParam1 != 0)
		{
			Global_180A1 = 0;
		}
	}
...
void func_37()
{
	...
	if (unk_0xC844350D5D58C99A(Global_180A1))
	{
		if (!unk_0xEB6A8945D1AC98A1(Global_180A1))
		{
			unk_0x93D47DFD0AE94949(Global_180A1, 4294967295);
		}
		unk_0x6DF7BF67E86AAE86(Global_180A1, 1862763509);
	}
	unk_0x73270B3C9CC833FD(Global_180A1, true, 1);
	unk_0x4E885A246A9D983A(Global_180A1, 132, true);
	unk_0x5E678B691C852774(Global_180A1, 16);
	func_39(&Global_180A1, Global_16E34);
	func_38(&uLocal_68, 1, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
	iLocal_235 = unk_0x7707E48765093646(iLocal_236, unk_0x68F4C0EC296D3901(Global_180A1, true), true, true, false);
	unk_0x9F528B1B53FBC5D9(iLocal_235, Global_180A1, unk_0x4A089F2B762B8D33(Global_180A1, 28422), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
}
	...
	switch (Param0.f_2)
	{
		...
		case 12:
			*uParam1 = { Param0 };
			...
			func_44(uParam1, 144, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 75:
			*uParam1 = { Param0 };
			...
			func_44(uParam1, 30, 3312640106, 3312640106, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 80:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_44(uParam1, 17, 2277090178, 2277090178, Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_45(uParam1);
			}
		...
		case 99:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_44(uParam1, 15, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 101:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 3312640106;
			func_44(uParam1, 14, 3312640106, 451360105, 0f, 0f, 0f, 0f);
			uParam1->f_76 = 2;
			return 1;
			break;
		...
		case 167:
			*uParam1 = { Param0 };
			uParam1->f_6D = 3312640106;
			uParam1->f_6E = 1785177548;
			func_44(uParam1, 14, 3312640106, 1785177548, -0.8472f, 0.155f, 0f, 152.556f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 193:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_44(uParam1, 144, 3312640106, 1785177548, 4.2943f, -6.7858f, 0f, -133.5332f);
			uParam1->f_76 = 1;
			if (Global_3)
			{
				uParam1->f_76 = 1;
		...
		case 270:
			*uParam1 = { Param0 };
			...
			if (Param0.f_2 == 267)
			{
				func_44(uParam1, 144, 3312640106, 2106541073, -2.4166f, -0.15f, 0f, -148.7555f);
			}
			if (Param0.f_2 == 266)
			{
		...
		case 289:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_44(uParam1, 144, 2277090178, 2277090178, -3.264f, -14.7895f, 14.1815f, -0.6311f);
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 312:
			*uParam1 = { Param0 };
			...
			func_44(uParam1, 144, 474215631, 2775823996, -9.5443f, -3.191f, -0.3f, 180f);
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_1B416.f_936.f_21B.f_906[0];
			StringCopy(sParam2, func_53(Global_1B416.f_936.f_21B.f_90A[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_1B416.f_936.f_21B.f_906[1];
			StringCopy(sParam2, func_53(Global_1B416.f_936.f_21B.f_90A[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_1B416.f_936.f_21B.f_906[2];
			StringCopy(sParam2, func_53(Global_1B416.f_936.f_21B.f_90A[2]), 32);
			return 1;
			break;

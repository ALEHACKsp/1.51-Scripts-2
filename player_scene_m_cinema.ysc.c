...
int func_2()
{
	...
	if (SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_72) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0xC844350D5D58C99A(iParam0))
	{
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0xD1960163A3042274(iParam0, 3148068810) != 1)
				{
					unk_0x01E4BB5190DF7317(iParam0, 1193033728, 0);
					unk_0xFADC0A217229F6B5(iLocal_68[iParam1], true);
				}
				break;
			...
			case 1:
				...
				{
					unk_0x509B8296EBA9B408(iParam0, sVar0, 0, 1);
					unk_0xFADC0A217229F6B5(iLocal_68[iParam1], true);
				}
				break;
			...
			case 3:
				...
				if (SYSTEM::VDIST2(unk_0x68F4C0EC296D3901(iParam0, true), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)
{
	...
	if (!unk_0x991B1F0980C62628())
	{
		...
		else if (iParam1 == func_8(Global_180A1) && iParam1 != 0)
		{
			Global_180A1 = 0;
		}
	}
...
void func_11()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_14(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_12(iVar0) && (!func_16(14) || Global_1AFFD))
			{
...
void func_21()
{
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x36F2404464202779(4, iLocal_69[iVar0], vLocal_72 + vLocal_74[iVar0 /*3*/], 0f, 1, true);
			...
			unk_0x46CB381A452EF99D(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45.5004f, unk_0x79833B02DBD2A244(-205.8167f, -210.4254f), unk_0x79833B02DBD2A244(-1416.54f, -1428.501f)) - vLocal_72 };

...
void func_11()
{
	if (unk_0x681F21BF9F7B449B(4294967295, vLocal_50, 5f))
	{
...
void func_12()
{
	if (func_10(iLocal_43))
	{
		...
		unk_0x1E9649458B15960F(iLocal_43, true);
		unk_0xC6EB89C59F2AF6B8(iLocal_43, sLocal_44, sLocal_45, 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
		unk_0x0C8C0C840C2D1AD2(iLocal_43, unk_0x16F2683693E537C9(), 4294967295, 0, 2);
	}
}

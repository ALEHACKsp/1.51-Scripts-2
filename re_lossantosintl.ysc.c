	...
	switch (iLocal_66)
	{
		...
		case 3:
			...
			while (iVar0 < 4)
			{
				if (unk_0xC844350D5D58C99A(iLocal_49[iVar0]))
				{
					iLocal_51[iVar0] = unk_0x852A19533F896693(iLocal_49[iVar0], 4, iLocal_62, 4294967295, 1, true);
	...
	switch (iLocal_61)
	{
		case 0:
			if (!unk_0xC844350D5D58C99A(iLocal_50))
			{
				...
				iLocal_52 = unk_0x852A19533F896693(iLocal_50, 4, iLocal_62, 4294967295, 1, true);
		...
		case 2:
			...
			if (unk_0xC844350D5D58C99A(iLocal_50) && !unk_0x437347B10A200C4B(iLocal_50, 0))
			{
				if (!unk_0x20D6474D5F4B9FC6(iLocal_50))
				{
					if ((unk_0x03068588A1FCED1A(iLocal_50) && !unk_0x8E28E832BEAC3DCE(-1602.086f, -2674.039f, 12.9444f, 50f)) && SYSTEM::VDIST2(vVar0, unk_0x68F4C0EC296D3901(iLocal_50, true)) > 62500f)
					{
						iLocal_61 = 1;
					}
				}
...
void func_13()
{
	...
	if (unk_0xC844350D5D58C99A(iLocal_67))
	{
		...
		else if (!unk_0x437347B10A200C4B(iLocal_67, 0) && !unk_0xEB6A8945D1AC98A1(iLocal_68))
		{
			...
			unk_0x9AFA0796FDCABCD5(iLocal_68, iLocal_67, 0, 0, vVar2, 4, 50f, -1f, 0f, 100, 50, 3212836864, 0);
		}
	}
	if (bLocal_73)
	{

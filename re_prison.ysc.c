...
void func_5()
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			...
			iLocal_68 = unk_0x852A19533F896693(iLocal_66, 6, joaat("s_m_y_cop_01"), 4294967295, 1, true);
			func_26(&iLocal_68);
			iLocal_50++;
			break;
		...
		case 2:
			...
			{
				unk_0x23406846FAACA3CA(joaat("prop_gate_prison_01"), 1845f, 2605f, 45f, false, 0f, 50f, 0);
				unk_0x23406846FAACA3CA(joaat("prop_gate_prison_01"), 1819.274f, 2608.537f, 44.6195f, false, 0f, 50f, 0);
		...
		case 3:
			if (func_14(&iLocal_72))
			{
				if (func_8(&iLocal_72) > 15f)
				{
					...
					iLocal_69 = unk_0x852A19533F896693(iLocal_67, 6, joaat("s_m_y_cop_01"), 4294967295, 1, true);
					func_26(&iLocal_69);
...
{
	unk_0x262EF6C6306BEA6C(*iParam0, joaat("weapon_assaultshotgun"), 4294967295, false, true);
...
void func_29()
{
	...
	while (iVar0 < 3)
	{
		if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1B[iVar0]))
		{
			if (!Local_307.f_12[iVar0])
			{
				...
				{
					unk_0x6C3AE6E278DB3D0E(Local_307.f_1B[iVar0], unk_0x16F2683693E537C9(), 0, 16);
			...
			if (!Local_307.f_12[iVar0])
			{
				...
				{
					unk_0xF44B0E19CAC31C33(Local_307.f_1B[iVar0], Local_307.f_E[iVar0], 0, 0, 4294967295);
				}
			}
		}
	...
	if (!Local_307.f_16[0])
	{
		if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[0]))
		{
			if ((func_16(Local_307.f_1F[0], 0, &Local_70, &uLocal_71, 1, 1, 0, 1, 1) || Local_307.f_12[1] == 1) || iLocal_306)
			{
				unk_0xA3BF0AA5A2608191(Local_307.f_1F[0]);
				unk_0x6C3AE6E278DB3D0E(Local_307.f_1F[0], unk_0x16F2683693E537C9(), 0, 16);
				Local_307.f_16[0] = 1;
			}
		}
	}
	if (!Local_307.f_16[1])
	{
		if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[1]))
		{
			if ((func_16(Local_307.f_1F[1], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[1] == 1) || iLocal_306)
			{
				unk_0xA3BF0AA5A2608191(Local_307.f_1F[1]);
				unk_0x6C3AE6E278DB3D0E(Local_307.f_1F[1], unk_0x16F2683693E537C9(), 0, 16);
				Local_307.f_16[1] = 1;
			}
		}
	}
	if (!Local_307.f_16[2])
	{
		if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[2]))
		{
			if ((func_16(Local_307.f_1F[2], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[2] == 1) || iLocal_306)
			{
				unk_0xA3BF0AA5A2608191(Local_307.f_1F[2]);
				unk_0x6C3AE6E278DB3D0E(Local_307.f_1F[2], unk_0x16F2683693E537C9(), 0, 16);
				Local_307.f_16[2] = 1;
			}
		}
	}
	if (!Local_307.f_16[3])
	{
		if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[3]))
		{
			if ((func_16(Local_307.f_1F[3], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || Local_307.f_12[2] == 1) || iLocal_306)
			{
				unk_0xA3BF0AA5A2608191(Local_307.f_1F[3]);
				unk_0x6C3AE6E278DB3D0E(Local_307.f_1F[3], unk_0x16F2683693E537C9(), 0, 16);
				Local_307.f_16[3] = 1;
			}
		}
	}
	if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1B[1]))
	{
		if (unk_0xB72E131222E66495(Local_307.f_1B[1]))
		{
			if (!Local_307.f_16[0])
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[0]))
				{
					unk_0xA8CC11FF8D2962D4(Local_307.f_1F[0], Local_307.f_1B[1], -2f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
			if (!Local_307.f_16[1])
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[1]))
				{
					unk_0xA8CC11FF8D2962D4(Local_307.f_1F[1], Local_307.f_1B[1], -1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
		}
	}
	if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1B[2]))
	{
		if (unk_0xB72E131222E66495(Local_307.f_1B[2]))
		{
			if (!Local_307.f_16[2])
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[2]))
				{
					unk_0xA8CC11FF8D2962D4(Local_307.f_1F[2], Local_307.f_1B[2], 1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
			if (!Local_307.f_16[3])
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1F[3]))
				{
					unk_0xA8CC11FF8D2962D4(Local_307.f_1F[3], Local_307.f_1B[2], -1f, 0f, 0f, 1f, 4294967295, 1036831949, 1);
				}
			}
		}
	}
...
void func_30()
{
				...
				while (iVar0 < 10)
				{
					if (unk_0xC844350D5D58C99A(Local_252.f_40[iVar0]) && !unk_0xEB6A8945D1AC98A1(Local_252.f_40[iVar0]))
					{
						if (unk_0x75B806D0A76CB67D(unk_0x16F2683693E537C9()) != 4294967295)
						{
							...
							{
								unk_0x298903DD96203C2C(Local_252.f_40[iVar0], 10);
								iLocal_268 = 1;
							}
						}
						...
						{
							unk_0x298903DD96203C2C(Local_252.f_40[iVar0], 100);
							iLocal_268 = 1;
						}
					}
					iVar0++;
	...
	while (iVar0 < 10)
	{
		if (unk_0xC844350D5D58C99A(Local_252.f_40[iVar0]) && !unk_0xEB6A8945D1AC98A1(Local_252.f_40[iVar0]))
		{
			...
			if ((((func_16(Local_252.f_40[iVar0], 0, &Local_70, &uLocal_71, 0, 1, 0, 1, 1) || unk_0xD3DCEC81D13AAFB1(Local_252[iVar0 /*3*/], 20f, 1)) || unk_0xE6F41F94FEE25AFF(Local_252[iVar0 /*3*/] - Vector(20f, 20f, 20f), Local_252[iVar0 /*3*/] + Vector(20f, 20f, 20f))) || iLocal_268) || func_32(&(Local_252.f_40[iVar0])))
			{
				if (!func_2(5))
				{
			...
			else if (unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) == 0)
			{
				...
				{
					unk_0xF44B0E19CAC31C33(Local_252.f_40[iVar0], Local_252.f_2A[iVar0], 0, 0, 4294967295);
...
void func_31(int iParam0)
{
	...
	{
		unk_0x2C4A1A0F54A166E8(Local_252.f_40[iParam0], unk_0x16F2683693E537C9(), 4294967295, 0);
...
void func_50()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_53(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_51(iVar0) && (!func_2(14) || Global_1AFFD))
			{
...
void func_67()
{
	...
	while (iVar0 < 3)
	{
		if (unk_0xC844350D5D58C99A(Local_307.f_1B[iVar0]) && !unk_0x437347B10A200C4B(Local_307.f_1B[iVar0], 0))
		{
			unk_0x262EF6C6306BEA6C(Local_307.f_1B[iVar0], joaat("weapon_assaultrifle"), 4294967295, true, true);
			unk_0x25BD67336EA4AECE(Local_307.f_1B[iVar0], 1000);
			unk_0x6DF7BF67E86AAE86(Local_307.f_1B[iVar0], 4111159735);
			unk_0xF5B281233FC43E54(Local_307.f_1B[iVar0], false);
			unk_0x11AD11297DC58CC7(Local_307.f_1B[iVar0], true);
			if (!unk_0xEB6A8945D1AC98A1(Local_307.f_1B[iVar0]))
			{
				unk_0xF44B0E19CAC31C33(Local_307.f_1B[iVar0], Local_307.f_E[iVar0], 0, 0, 4294967295);
			}
...
void func_68()
{
	...
	while (iVar0 < 3)
	{
		...
		{
			Local_307.f_1B[iVar0] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), Local_307[iVar0 /*3*/], Local_307.f_A[iVar0], 1, true);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
	vVar1 = { unk_0x8A5E176FF719A014(Local_307[1 /*3*/], Local_307.f_A[1], -2f, 0f, 0f) };
	vVar2 = { unk_0x8A5E176FF719A014(Local_307[1 /*3*/], Local_307.f_A[1], -1f, 0f, 0f) };
	vVar3 = { unk_0x8A5E176FF719A014(Local_307[2 /*3*/], Local_307.f_A[2], 1f, 0f, 0f) };
	vVar4 = { unk_0x8A5E176FF719A014(Local_307[2 /*3*/], Local_307.f_A[2], -1f, 0f, 0f) };
	Local_307.f_1F[0] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), vVar1, Local_307.f_A[1], 1, true);
	Local_307.f_1F[1] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), vVar2, Local_307.f_A[1], 1, true);
	Local_307.f_1F[2] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), vVar3, Local_307.f_A[2], 1, true);
	Local_307.f_1F[3] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), vVar4, Local_307.f_A[2], 1, true);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (unk_0xC844350D5D58C99A(Local_307.f_1F[iVar0]))
		{
			unk_0x262EF6C6306BEA6C(Local_307.f_1F[iVar0], joaat("weapon_assaultrifle"), 4294967295, true, true);
			unk_0x25BD67336EA4AECE(Local_307.f_1F[iVar0], 500);
			unk_0x6DF7BF67E86AAE86(Local_307.f_1F[iVar0], 4111159735);
			unk_0x7B97190AACA7600D(Local_307.f_1F[iVar0], 0);
			unk_0x11AD11297DC58CC7(Local_307.f_1F[iVar0], true);
		}
		iVar0++;
	}
	unk_0x71199B01895C6202(joaat("s_m_m_prisguard_01"));
...
void func_69()
{
	if (bLocal_294)
	{
		...
		unk_0xF821F915BC24D246(iLocal_290, iLocal_289, 4294967295);
		if (!unk_0x437347B10A200C4B(iLocal_289, 0))
		{
			unk_0x4D3C3C0B0DE2663E(iLocal_289, 101, "PrisonHeli", 1);
		}
...
void func_72()
{
	...
	while (iVar0 < 10)
	{
		if (unk_0xC844350D5D58C99A(Local_252.f_40[iVar0]) && !unk_0x437347B10A200C4B(Local_252.f_40[iVar0], 0))
		{
			unk_0x6DF7BF67E86AAE86(Local_252.f_40[iVar0], 4111159735);
			unk_0x4E885A246A9D983A(Local_252.f_40[iVar0], 132, true);
			unk_0x23CBFFA16CA5CF45(Local_252.f_40[iVar0], 300f, 10);
			...
			unk_0x083F03A847B640E9(Local_252.f_40[iVar0], 2);
			unk_0xAFF39FB306F8E232(Local_252.f_40[iVar0], 13, true);
			unk_0xAFF39FB306F8E232(Local_252.f_40[iVar0], 0, false);
			unk_0x26A6B1686E33113F(Local_252.f_40[iVar0], 1);
			unk_0x3CC33E4E9CE523F4(Local_252.f_40[iVar0], 1);
			unk_0x16F8631A5D4FBCE5(Local_252.f_40[iVar0], 0f);
			unk_0xFADC0A217229F6B5(Local_252.f_40[iVar0], true);
			unk_0x298903DD96203C2C(Local_252.f_40[iVar0], 20);
			unk_0xB35CCEC0D4946813(Local_252.f_40[iVar0], 2);
			unk_0xAFF39FB306F8E232(Local_252.f_40[iVar0], 23, false);
			unk_0x262EF6C6306BEA6C(Local_252.f_40[iVar0], joaat("weapon_sniperrifle"), 4294967295, true, true);
			unk_0x25BD67336EA4AECE(Local_252.f_40[iVar0], 1000);
			unk_0x11AD11297DC58CC7(Local_252.f_40[iVar0], true);
			unk_0x9FA191B317572861(Local_252.f_40[iVar0], 1000f);
			if (!unk_0xEB6A8945D1AC98A1(Local_252.f_40[iVar0]))
			{
				if (iVar0 == 0)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_01", 1, 0, 1);
				}
				else if (iVar0 == 1)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_02", 1, 0, 1);
				}
				else if (iVar0 == 2)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_03", 1, 0, 1);
				}
				else if (iVar0 == 3)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_04", 1, 0, 1);
				}
				else if (iVar0 == 4)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_05", 1, 0, 1);
				}
				else if (iVar0 == 5)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_06", 1, 0, 1);
				}
				else if (iVar0 == 6)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_07", 1, 0, 1);
				}
				else if (iVar0 == 7)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_08", 1, 0, 1);
				}
				else if (iVar0 == 9)
				{
					unk_0x0D5B15BD519BC73C(Local_252.f_40[iVar0], "miss_Tower_10", 1, 0, 1);
				}
				else
				{
					unk_0xF44B0E19CAC31C33(Local_252.f_40[iVar0], Local_252.f_2A[iVar0], 0, 0, 4294967295);
...
void func_73()
{
	...
	if (!unk_0x8E28E832BEAC3DCE(1823.845f, 2621.267f, 57f, 0.5f))
	{
		...
		{
			iLocal_264[0] = unk_0x852A19533F896693(iLocal_263[0], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
	...
	if (!unk_0x8E28E832BEAC3DCE(1761.418f, 2410.378f, 61f, 0.5f))
	{
		...
		{
			iLocal_264[1] = unk_0x852A19533F896693(iLocal_263[1], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
	...
	if (!unk_0x8E28E832BEAC3DCE(1534.635f, 2585.162f, 61f, 0.5f))
	{
		...
		{
			iLocal_264[2] = unk_0x852A19533F896693(iLocal_263[2], 6, joaat("s_m_m_prisguard_01"), 4294967295, 1, true);
...
void func_74()
{
	...
	while (iVar0 < 10)
	{
		...
		{
			Local_252.f_40[iVar0] = unk_0x36F2404464202779(6, joaat("s_m_m_prisguard_01"), Local_252[iVar0 /*3*/], Local_252.f_1F[iVar0], 1, true);
			unk_0x71199B01895C6202(joaat("s_m_m_prisguard_01"));
			SYSTEM::WAIT(0);
		}
		iVar0++;
...
void func_86()
{
	...
	Local_70.f_4 = 75;
	Local_70.f_6 = 15;
	unk_0x23406846FAACA3CA(joaat("prop_gate_prison_01"), 1845f, 2605f, 45f, true, 0f, 0, 0);
	unk_0x23406846FAACA3CA(joaat("prop_gate_prison_01"), 1819.274f, 2608.537f, 44.6195f, true, 0f, 50f, 0);
	...
	unk_0x0E2400AB9174FA81(1, iLocal_250, 2761840924);
	unk_0x0E2400AB9174FA81(1, 2761840924, iLocal_250);
		...
		if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
		{
			if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1917.889f, 2618.476f, -45.677f, 1822.889f, 2618.476f, 45.677f, 195f, 0, false, 0))
			{
				if (unk_0x82D09C8DBB516A49(unk_0xD803B885F5E47A62()))
				{
					unk_0x67F91979413C5D76(unk_0xD803B885F5E47A62(), 4, 0);
					unk_0x56EA5D248F36A081(unk_0xD803B885F5E47A62(), 0);
					unk_0x0E2400AB9174FA81(5, 1862763509, 4111159735);
					unk_0x0E2400AB9174FA81(5, 4111159735, 1862763509);
					iLocal_56 = 1;
				}
...
void func_89(bool bParam0)
{
	...
	if (iLocal_56)
	{
		unk_0x0E2400AB9174FA81(2, 1862763509, 4111159735);
		unk_0x0E2400AB9174FA81(2, 4111159735, 1862763509);
	}
	iVar0 = 0;
	while (iVar0 < 12)
	{

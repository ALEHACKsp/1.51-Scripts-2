						...
						switch (iLocal_44)
						{
								...
								else
								{
									...
									if (func_172())
									{
										...
										while (iVar0 < iLocal_66)
										{
											...
											{
												unk_0x6C3AE6E278DB3D0E(iLocal_66[iVar0], unk_0x16F2683693E537C9(), 0, 16);
												unk_0xFADC0A217229F6B5(iLocal_66[iVar0], true);
										...
										if (iLocal_47 == 2)
										{
											...
											while (iVar0 < iLocal_67)
											{
												...
												{
													unk_0x8BE3D040D15AEA1D(iLocal_67[iVar0], 4294967295);
													unk_0xFADC0A217229F6B5(iLocal_67[iVar0], true);
												}
												iVar0++;
											}
											iVar0 = 0;
											while (iVar0 < iLocal_68)
											{
												...
												{
													unk_0x8BE3D040D15AEA1D(iLocal_68[iVar0], 4294967295);
													unk_0xFADC0A217229F6B5(iLocal_68[iVar0], true);
												}
												iVar0++;
											}
										}
									...
									if (func_170())
									{
										func_163(1);
										SYSTEM::SETTIMERA(0);
										unk_0x7D0D8317DC09FF68(90, vLocal_123, 15000f);
										iLocal_44 = 1;
									}
								}
								break;
							...
							case 1:
								...
								while (iVar1 < iLocal_67)
								{
									...
									{
										if (unk_0xB87D13D0C064E9D1(iLocal_67[iVar1], unk_0x16F2683693E537C9(), 1))
										{
											func_162();
										}
									}
								...
								while (iVar1 < iLocal_68)
								{
									...
									{
										if (unk_0xB87D13D0C064E9D1(iLocal_68[iVar1], unk_0x16F2683693E537C9(), 1))
										{
											func_162();
										}
									}
								...
								switch (iLocal_45)
								{
									...
									case 2:
										...
										if (SYSTEM::TIMERB() > 500)
										{
											if (unk_0xC844350D5D58C99A(iLocal_102))
											{
												...
												{
													func_151();
													unk_0x5745EA6329A91E29(iLocal_66[0], joaat("weapon_unarmed"), true);
													unk_0x9F528B1B53FBC5D9(iLocal_102, iLocal_66[0], unk_0x4A089F2B762B8D33(iLocal_66[0], 57005), 0.3f, 0f, 0f, 80f, -90f, 0f, 1, 1, 0, 0, 2, 1);
												}
											}
										}
										if (unk_0x723EE7F83DF1497D(vLocal_123 - Vector(20f, 20f, 20f), vLocal_123 + Vector(20f, 20f, 20f), 0))
										{
											if (!unk_0xEB6A8945D1AC98A1(iLocal_67[1]))
											{
												unk_0xEEB67C3D0A71A47B(iLocal_67[1], vLocal_59, 150f, 4294967295, 0, 0);
												unk_0x11AD11297DC58CC7(iLocal_67[1], false);
												unk_0x6DAD7906B73F064D(&(iLocal_67[1]));
											}
											if (!unk_0xEB6A8945D1AC98A1(iLocal_67[2]))
											{
												unk_0xEEB67C3D0A71A47B(iLocal_67[2], vLocal_59, 150f, 4294967295, 0, 0);
												unk_0x11AD11297DC58CC7(iLocal_67[2], false);
												unk_0x6DAD7906B73F064D(&(iLocal_67[2]));
											}
											iVar2 = 0;
											while (iVar2 <= (iLocal_65 - 1))
											{
												...
												{
													unk_0xE8832A9E16A57A1F(iLocal_68[iVar2], true, 1);
													unk_0xDD353D0E9C789D0E(&iLocal_87);
													if (iLocal_47 == 1)
													{
														unk_0xC6EB89C59F2AF6B8(0, "random@robbery", "exit_flee", 4f, -4f, 4294967295, 5632, 0f, 0, 1, 0);
													}
													else if (iLocal_47 == 2)
													{
														unk_0x96167B03C5A77156(0, -1201.476f, -790.2733f, 15.5475f, 2f, 4294967295, 0.25f, 0, 1193033728);
													}
													unk_0xEEB67C3D0A71A47B(0, vLocal_59, 150f, 4294967295, 0, 0);
													unk_0x75ABDC5F81978924(iLocal_87);
													unk_0x78ADC381772E3D54(iLocal_68[iVar2], iLocal_87);
													unk_0xF82EA857DA10E0CD(&iLocal_87);
													unk_0xFADC0A217229F6B5(iLocal_68[iVar2], true);
													unk_0x11AD11297DC58CC7(iLocal_68[iVar2], false);
													unk_0x25C5402CC10F76CD(iLocal_68[iVar2], true);
										...
										if (func_150() || SYSTEM::TIMERA() > 20000)
										{
											if (!iLocal_99)
											{
												if (!unk_0x437347B10A200C4B(iLocal_66[0], 0))
												{
													...
													if (iLocal_47 == 1)
													{
														if (unk_0xC844350D5D58C99A(iLocal_102))
														{
															unk_0x4A4806F9D471E491(iLocal_102, false, 0);
															unk_0x20641932E5104B25(iLocal_102, false, 0);
														}
													}
													else if (iLocal_47 == 2)
													{
													...
													while (iVar1 < iLocal_67)
													{
														...
														{
															unk_0x11AD11297DC58CC7(iLocal_67[iVar1], false);
														}
														iVar1++;
													}
													iVar1 = 0;
													while (iVar1 < iLocal_68)
													{
														...
														{
															unk_0x11AD11297DC58CC7(iLocal_68[iVar1], false);
														}
														iVar1++;
													}
													if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
													{
														unk_0x11AD11297DC58CC7(iLocal_67[0], true);
														unk_0xDD353D0E9C789D0E(&iLocal_87);
														unk_0xC6EB89C59F2AF6B8(0, "random@robbery", "f_distressed_loop", 2f, -2f, 4294967295, 9, 0, 0, 0, 0);
														unk_0x75ABDC5F81978924(iLocal_87);
														unk_0x78ADC381772E3D54(iLocal_67[0], iLocal_87);
														unk_0xF82EA857DA10E0CD(&iLocal_87);
														unk_0xFADC0A217229F6B5(iLocal_67[0], true);
													}
													if (!func_134())
													{
										...
										if (iLocal_47 == 1)
										{
											...
											if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && unk_0xDF1306B443CD3D15(iLocal_106, 0))
											{
												if (unk_0xC42A92762C58E1B9(iLocal_66[0], iLocal_106, 0))
												{
													if (unk_0xC844350D5D58C99A(iLocal_102))
													{
														unk_0xF690C84DADBB3551(&iLocal_102);
											...
											{
												if (unk_0xE4EDC4B0E92C078B(uLocal_116[0]))
												{
													unk_0x142CC44DB769B57E(&(uLocal_116[0]));
												}
												if (unk_0xE4EDC4B0E92C078B(uLocal_116[1]))
												{
													unk_0x142CC44DB769B57E(&(uLocal_116[1]));
												}
												...
												{
													unk_0xAFF39FB306F8E232(iLocal_115, 17, true);
													unk_0xAFF39FB306F8E232(iLocal_115, 6, true);
													unk_0xAFF39FB306F8E232(iLocal_115, 1, true);
													unk_0x89258193691A7600(iLocal_115, iLocal_106, unk_0x16F2683693E537C9(), 8, 16f, 786469, -1f, -1f, 1);
													unk_0xFADC0A217229F6B5(iLocal_115, true);
													iLocal_97 = 1;
												}
											}
											if (iLocal_97 && !iLocal_143)
											{
												if (unk_0xDF1306B443CD3D15(iLocal_106, 0) && !unk_0xEB6A8945D1AC98A1(iLocal_115))
												{
													if (!unk_0x5A91F08DF773C39D(iLocal_106, vLocal_51[0 /*3*/], 20f, 20f, 10f, false, true, 0))
													{
														unk_0x89258193691A7600(iLocal_115, iLocal_106, unk_0x16F2683693E537C9(), 8, 19f, 786469, -1f, -1f, 1);
														iLocal_143 = 1;
													}
												}
											}
											if (func_112())
											{
												if (!unk_0xEB6A8945D1AC98A1(iLocal_115))
												{
													if (unk_0xDF1306B443CD3D15(iLocal_106, 0))
													{
														if (!iLocal_98)
														{
															unk_0xAFF39FB306F8E232(iLocal_115, 17, true);
															unk_0xAFF39FB306F8E232(iLocal_115, 6, true);
															unk_0xAFF39FB306F8E232(iLocal_115, 1, true);
															unk_0x89258193691A7600(iLocal_115, iLocal_106, unk_0x16F2683693E537C9(), 8, 17f, 786469, -1f, -1f, 1);
															iLocal_98 = 1;
														}
														if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
														{
															if (unk_0xC42A92762C58E1B9(iLocal_66[0], iLocal_106, 0))
															{
																if (unk_0xE4EDC4B0E92C078B(uLocal_116[0]))
												...
												while (iVar3 <= (iLocal_63 - 1))
												{
													if (!iLocal_80[iVar3])
													{
														...
														{
															if (unk_0x405E212DDE472467(iLocal_66[iVar3], 0) && !unk_0xEB6A8945D1AC98A1(iLocal_115))
															{
																unk_0xFFDDE8CC59EB6D40(iLocal_66[iVar3], unk_0x16F2683693E537C9(), 0, 0.3f, 0.7f, 1.9f, -1f, 15, 0, 3541198322);
																iLocal_80[iVar3] = 1;
															}
															else if (!unk_0xE4EDC4B0E92C078B(iLocal_121))
															{
																unk_0x6C3AE6E278DB3D0E(iLocal_66[iVar3], unk_0x16F2683693E537C9(), 0, 16);
																unk_0xFADC0A217229F6B5(iLocal_66[iVar3], true);
																if (unk_0xE4EDC4B0E92C078B(iLocal_120))
																{
													...
													if (!iLocal_81[iVar3])
													{
														if (unk_0xDF1306B443CD3D15(iLocal_106, 0))
														{
															if (!unk_0xEB6A8945D1AC98A1(iLocal_66[iVar3]))
															{
																if ((unk_0xEB6A8945D1AC98A1(iLocal_115) || unk_0xBBA8A868118C90ED(iLocal_106, 4294967295, 0)) || unk_0x4E861BC5B1EDA7BD(iLocal_66[iVar3]))
																{
																	unk_0xE8832A9E16A57A1F(iLocal_66[iVar3], true, 1);
																	unk_0xDD353D0E9C789D0E(&iLocal_87);
																	...
																	if (!unk_0xEB6A8945D1AC98A1(iLocal_115))
																	{
																		unk_0xE8832A9E16A57A1F(iLocal_115, true, 1);
																		unk_0xDD353D0E9C789D0E(&iLocal_87);
																		unk_0x75CDA8644CD3B5F5(0, 0, 0);
																		unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 300f, 4294967295, 0, 0);
																		unk_0x75ABDC5F81978924(iLocal_87);
										...
										else if (iLocal_47 == 2)
										{
											...
											if (unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
											{
												if (unk_0xE4EDC4B0E92C078B(uLocal_116[1]))
												{
											...
											if (unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
											{
												if (unk_0xC844350D5D58C99A(iLocal_102))
												{
													if (unk_0xD59B17D2DFF98E26(iLocal_102))
													{
														unk_0x15AFB6CBDE990FB6(iLocal_102, 1, true);
													}
													unk_0xF690C84DADBB3551(&iLocal_102);
													func_110();
													func_107();
											...
											else if (unk_0xB87D13D0C064E9D1(iLocal_66[0], unk_0x16F2683693E537C9(), 1))
											{
												if (unk_0xC844350D5D58C99A(iLocal_102))
												{
													if (unk_0xD59B17D2DFF98E26(iLocal_102))
									...
									case 10:
										...
										if (iLocal_47 == 1)
										{
											if (!iLocal_95)
											{
												...
												else if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
												{
													unk_0xA47B46945FF6DE74(iLocal_67[0], -818.5553f, -185.4815f, 36.5689f, 1, false, 0, 1);
													unk_0xD8F6A53F4799FAFE(iLocal_67[0], 47.0582f);
													unk_0xC6EB89C59F2AF6B8(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
													if (!unk_0xEB6A8945D1AC98A1(iLocal_67[1]))
													{
														unk_0xEEB67C3D0A71A47B(iLocal_67[1], vLocal_59, 150f, 4294967295, 0, 0);
														unk_0x11AD11297DC58CC7(iLocal_67[1], false);
													...
													while (iVar4 <= (iLocal_65 - 1))
													{
														if (!unk_0xEB6A8945D1AC98A1(iLocal_68[iVar4]))
														{
															...
															unk_0xF82EA857DA10E0CD(&iLocal_87);
															unk_0xFADC0A217229F6B5(iLocal_68[iVar4], true);
															unk_0x11AD11297DC58CC7(iLocal_68[iVar4], false);
															unk_0x25C5402CC10F76CD(iLocal_68[iVar4], true);
										...
										else if (iLocal_47 == 2)
										{
											if (!iLocal_95)
											{
												...
												{
													unk_0xA47B46945FF6DE74(iLocal_67[0], -1197.455f, -776.0289f, 16.3254f, 1, false, 0, 1);
													unk_0xD8F6A53F4799FAFE(iLocal_67[0], 205.7753f);
													unk_0xC6EB89C59F2AF6B8(iLocal_67[0], "random@robbery", "stand_worried_female", 8f, -8f, 4294967295, 9, 0, 0, 0, 0);
													if (!unk_0xEB6A8945D1AC98A1(iLocal_67[1]))
													{
														unk_0xEEB67C3D0A71A47B(iLocal_67[1], vLocal_59, 150f, 4294967295, 0, 0);
													...
													while (iVar5 <= (iLocal_65 - 1))
													{
														...
														{
															unk_0xEEB67C3D0A71A47B(iLocal_68[iVar5], vLocal_59, 150f, 4294967295, 0, 0);
															unk_0x11AD11297DC58CC7(iLocal_68[iVar5], false);
															unk_0x25C5402CC10F76CD(iLocal_68[iVar5], true);
										...
										if (SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), func_250()) > (fLocal_124 + 150f))
										{
											iLocal_45 = 12;
										}
										...
										else if (unk_0xB87D13D0C064E9D1(iLocal_67[0], unk_0x16F2683693E537C9(), 1))
										{
											func_75(2);
											func_55();
										}
									...
									case 13:
										if (!iLocal_144)
										{
											if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
											{
												unk_0xA3BF0AA5A2608191(iLocal_67[0]);
												if (iLocal_47 == 1)
												{
												...
												unk_0x1DC614CBE22FFB4F(iLocal_67[0], 20000);
												unk_0xFADC0A217229F6B5(iLocal_67[0], true);
												unk_0x11AD11297DC58CC7(iLocal_67[0], false);
												iLocal_144 = 1;
											}
										}
										if (!func_134())
...
void func_1()
{
	if (func_170())
	{
		...
		if (!iLocal_113)
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
			{
				...
				unk_0x679C321F8CAA2CFA(unk_0x68F4C0EC296D3901(iLocal_67[0], true), 20f, 0);
	...
	if (bLocal_112)
	{
		if (!iLocal_114)
		{
			...
			vLocal_125 = { unk_0x68F4C0EC296D3901(iLocal_67[0], false) };
			if (iLocal_47 == 1)
			{
			...
			iLocal_135 = unk_0xE9744DB7B8CA6965(vLocal_125, vLocal_127, 2);
			iLocal_129 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", false);
			unk_0x93E9ED66DAB9FBE3(iLocal_129, iLocal_135, sLocal_134, sLocal_130);
			unk_0x327AAEE25F323797(unk_0x16F2683693E537C9());
			unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_135, sLocal_130, sLocal_131, 1000f, -2f, 5, 0, 1148846080, 0);
			unk_0xF895E10BF4C72645(unk_0x16F2683693E537C9(), 0, 0);
			unk_0x327AAEE25F323797(iLocal_67[0]);
			unk_0x915804B434753CBD(iLocal_67[0], iLocal_135, sLocal_130, sLocal_132, 1000f, -2f, 4, 0, 1148846080, 0);
			unk_0xF895E10BF4C72645(iLocal_67[0], 0, 0);
			iLocal_102 = unk_0x7707E48765093646(joaat("prop_cs_duffel_01"), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), true, true, false);
			unk_0xE14EC663EED44AD5(iLocal_102, iLocal_135, sLocal_133, sLocal_130, 1000f, 8f, 0, 1148846080);
			if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
			{
				func_54();
	...
	if (unk_0xA45992A6CE82FB43(iLocal_135) > fLocal_136 && iLocal_114)
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_67[0]))
		{
			unk_0x6D80F1AEBA734886(iLocal_67[0], iLocal_118);
			unk_0xA3BF0AA5A2608191(iLocal_67[0]);
			unk_0xDD353D0E9C789D0E(&iLocal_87);
			unk_0xC6EB89C59F2AF6B8(0, "random@robbery", "stand_worried_female", 2f, -2f, 4294967295, 1, 0, 0, 0, 0);
			unk_0x75ABDC5F81978924(iLocal_87);
			unk_0x78ADC381772E3D54(iLocal_67[0], iLocal_87);
			unk_0xF82EA857DA10E0CD(&iLocal_87);
			unk_0xFADC0A217229F6B5(iLocal_67[0], true);
		...
		unk_0x9A8DDC7C522F5BF5(iLocal_129, 0);
		func_51();
...
void func_3(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_9() == 0)
		{
			iVar0 = func_7(func_8(iParam0), 4294967295, 0);
			unk_0x0674E58A79778E99(&iVar0, iParam1);
			func_4(func_8(iParam0), iVar0, 4294967295, 1, 0);
		}
	}
	else
	{
...
int func_11(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_9() == 0)
		{
			return unk_0xEAE0D21A50E6C7F4(func_7(func_8(iParam0), 4294967295, 0), iParam1);
		}
	}
	else
	{
...
void func_16(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		func_19(129, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 9)
	{
		func_19(135, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 10)
	{
		func_19(136, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 11)
	{
		func_19(137, 0, 4294967295, 1);
		return;
	}
	if (iParam0 == 12)
	{
		func_4(8269, 0, 4294967295, 1, 0);
		return;
	}
	if (iParam0 == 13)
	{
		func_4(8270, 0, 4294967295, 1, 0);
		return;
	}
	if (iParam0 == 14)
	{
		func_4(8271, 0, 4294967295, 1, 0);
		return;
	}
	if (iParam0 == 15)
	{
		func_4(8272, 0, 4294967295, 1, 0);
		return;
	}
	if (iParam0 == 16)
	{
		func_4(8273, 0, 4294967295, 1, 0);
		return;
	}
	if (iParam0 == 17)
	{
		func_4(8274, 0, 4294967295, 1, 0);
		return;
	}
	bVar0 = false;
...
bool func_21(int iParam0)
{
	...
	if (iParam0 == 8)
	{
		return func_22(129, 4294967295, 4294967295);
	}
	if (iParam0 == 9)
	{
		return func_22(135, 4294967295, 4294967295);
	}
	if (iParam0 == 10)
	{
		return func_22(136, 4294967295, 4294967295);
	}
	if (iParam0 == 11)
	{
		return func_22(137, 4294967295, 4294967295);
	}
	if (iParam0 == 12)
	{
		iVar0 = unk_0xDD0E7998AE8AD485();
		iVar1 = func_7(8269, 4294967295, 0);
	...
	if (iParam0 == 13)
	{
		...
		iVar3 = func_7(8270, 4294967295, 0);
	...
	if (iParam0 == 14)
	{
		...
		iVar5 = func_7(8271, 4294967295, 0);
	...
	if (iParam0 == 15)
	{
		...
		iVar7 = func_7(8272, 4294967295, 0);
	...
	if (iParam0 == 16)
	{
		...
		iVar9 = func_7(8273, 4294967295, 0);
	...
	if (iParam0 == 17)
	{
		...
		iVar11 = func_7(8274, 4294967295, 0);
...
{
	return func_36(uParam0, iParam1) != 4294967295;
}
...
void func_45()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_48(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_46(iVar0) && (!func_39(14) || Global_1AFFD))
			{
...
void func_51()
{
	if (iLocal_47 == 1)
	{
		if (unk_0xC844350D5D58C99A(iLocal_67[0]))
		{
			...
			{
				unk_0x11AD11297DC58CC7(iLocal_67[0], false);
				unk_0x6DAD7906B73F064D(&(iLocal_67[0]));
			}
		}
		...
		if (unk_0xC844350D5D58C99A(iLocal_68[0]))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68[0]))
			{
				unk_0x11AD11297DC58CC7(iLocal_68[0], false);
				unk_0x6DAD7906B73F064D(&(iLocal_68[0]));
			}
		}
		if (unk_0xC844350D5D58C99A(iLocal_68[1]))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68[1]))
			{
				unk_0x11AD11297DC58CC7(iLocal_68[1], false);
				unk_0x6DAD7906B73F064D(&(iLocal_68[1]));
			}
		}
		if (unk_0xC844350D5D58C99A(iLocal_68[2]))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_68[2]))
			{
				unk_0xA47B46945FF6DE74(iLocal_68[2], -820.424f, -181.9059f, 36.5687f, 1, false, 0, 1);
				unk_0xD8F6A53F4799FAFE(iLocal_68[2], 167.7909f);
				unk_0x11AD11297DC58CC7(iLocal_68[2], false);
				unk_0x6DAD7906B73F064D(&(iLocal_68[2]));
			}
		}
	}
}
...
void func_60(int iParam0, var uParam1, var uParam2)
{
	...
	{
		func_19((891 + iParam0), 1, 4294967295, 1);
	}
	bVar0 = true;
...
void func_61()
{
	...
	{
		func_40(13, SYSTEM::FLOOR(Global_1B416.f_27CD.f_F0D));
	}
...
void func_83(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_84(iParam0) && unk_0x8A22C4C08282BF26(Global_15DBC[26 /*34*/].f_6) == 0)
			{
				Global_1B416.f_1C58[iParam0] = 1;
				unk_0x1BA7FCEAFCE8D46E(uParam1->f_5, Global_1B416.f_1C58[iParam0], true, true);
			}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_92(unk_0xEAE0D21A50E6C7F4(iParam0, 31), 4294967295, 1)) + 2011;
}
...
int func_98()
{
	if ((func_9() == 4294967295 || func_9() == 999) && !func_99() == 0)
	{
		return 1;
	}
	return 0;
	...
	switch (iParam0)
	{
		case 0:
			if (Global_1B416.f_619E.f_2 < 3)
			{
				...
				{
					func_102(func_103(iParam0), 4294967295);
...
void func_104()
{
	if (unk_0xEB751B41BC4080D4(iLocal_62))
	{
		...
		func_105(&uLocal_148);
		fLocal_124 = SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), func_250());
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 10;
	}
	if (unk_0x762119754C50557A(iLocal_62))
	{
		if (SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0xE925E52ACABA4CE7(iLocal_62)) > 200f)
		{
			func_162();
		}
	}
...
void func_107()
{
	...
	if (!unk_0x762119754C50557A(iLocal_62))
	{
		unk_0x5D96D8530B3D0904(&iLocal_60, 3);
		unk_0x5D96D8530B3D0904(&iLocal_60, 4);
		unk_0x5D96D8530B3D0904(&iLocal_60, 1);
		if (!bLocal_96)
		{
			if (unk_0x437347B10A200C4B(iLocal_66[0], 0))
			{
				if (unk_0xC844350D5D58C99A(iLocal_66[0]))
				{
					vLocal_61 = { unk_0xC6151A4F2BB0AC79(iLocal_66[0], 1067030938, 1069547520) };
				}
			}
			else
			{
				vLocal_61 = { unk_0x550B1459B4642A86(unk_0x68F4C0EC296D3901(iLocal_66[0], true), 1.2f, 1.5f) };
			}
		}
		else if (unk_0xC844350D5D58C99A(iLocal_106))
		{
			vLocal_61 = { unk_0x550B1459B4642A86(unk_0x68F4C0EC296D3901(iLocal_106, false), 1.2f, 1.5f) };
		}
		vLocal_61 = { vLocal_61.x, vLocal_61.y, (vLocal_61.z + 0.25f) };
		iLocal_62 = unk_0xA6FF0828D17CF374(joaat("pickup_money_med_bag"), vLocal_61, iLocal_60, iLocal_118, 1, joaat("prop_cs_duffel_01"));
		...
		if (iLocal_47 == 1)
		{
			...
			while (iVar0 <= (iLocal_63 - 1))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_66[iVar0]))
				{
					unk_0xE8832A9E16A57A1F(iLocal_66[iVar0], true, 1);
		...
		else if (iLocal_47 == 2)
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
			{
				unk_0x8FB4E06C94958F84(iLocal_66[0]);
				if (!unk_0x46BC6F5F089F3AFF(iLocal_66[0]))
				{
					func_52();
					SYSTEM::WAIT(0);
...
int func_111()
{
	...
	else if (unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
	{
		iLocal_84 = 1;
	}
	if (!bLocal_96)
	{
		if (!unk_0xC844350D5D58C99A(iLocal_66[1]))
		{
			iLocal_85 = 1;
		}
		else if (unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
		{
			iLocal_85 = 1;
		}
	}
	...
	else if (unk_0xEB6A8945D1AC98A1(iLocal_115) || !unk_0x405E212DDE472467(iLocal_115, 0))
	{
		iLocal_86 = 1;
	}
...
int func_112()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		...
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_66[iVar0]) || unk_0x437347B10A200C4B(iLocal_66[iVar0], 0))
			{
				if (unk_0xB87D13D0C064E9D1(iLocal_66[iVar0], unk_0x16F2683693E537C9(), 1))
				{
					return 1;
				}
			}
		...
		if (unk_0xC844350D5D58C99A(iLocal_66[iVar0]))
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_66[iVar0]))
			{
				if (unk_0x36646919F20EAFFC(iLocal_66[iVar0]))
				{
					...
					{
						unk_0xE8832A9E16A57A1F(iLocal_66[iVar0], true, 1);
						unk_0xF3268524E9BE6D6E(iLocal_66[iVar0], unk_0x16F2683693E537C9(), 250f, 4294967295, 0, 0);
						unk_0xFADC0A217229F6B5(iLocal_66[iVar0], true);
						SYSTEM::WAIT(0);
	...
	if (unk_0xC844350D5D58C99A(iLocal_115))
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_115) || unk_0x437347B10A200C4B(iLocal_115, 0))
		{
			if (unk_0xB87D13D0C064E9D1(iLocal_115, unk_0x16F2683693E537C9(), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0xC844350D5D58C99A(iLocal_115))
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_115))
		{
			if (unk_0x36646919F20EAFFC(iLocal_115))
			{
				...
				{
					unk_0xE8832A9E16A57A1F(iLocal_115, true, 1);
					unk_0xF3268524E9BE6D6E(iLocal_115, unk_0x16F2683693E537C9(), 250f, 4294967295, 0, 0);
					unk_0xFADC0A217229F6B5(iLocal_115, true);
					SYSTEM::WAIT(0);
	...
	{
		if (!unk_0x437347B10A200C4B(iLocal_106, 0) || unk_0x437347B10A200C4B(iLocal_106, 0))
		{
			if (unk_0xB87D13D0C064E9D1(iLocal_106, unk_0x16F2683693E537C9(), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0xDF1306B443CD3D15(iLocal_106, 0))
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
		{
			if (unk_0xC42A92762C58E1B9(iLocal_66[0], iLocal_106, 0))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
				{
					if (unk_0xC42A92762C58E1B9(iLocal_66[1], iLocal_106, 0))
					{
						return 1;
					}
				}
...
int func_150()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && !unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
	{
		if (iLocal_47 == 1)
		{
			if (!iLocal_100)
			{
				if (!unk_0x3D1053F9EB43B7AD(iLocal_66[0], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, true, 0))
				{
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if (!unk_0x3D1053F9EB43B7AD(iLocal_66[1], -823.5066f, -187.3465f, 40.36355f, -803.6377f, -175.9496f, 36.4337f, 11.9375f, 0, true, 0))
				{
					iLocal_101 = 1;
				}
			}
		...
		else if (iLocal_47 == 2)
		{
			if (!iLocal_100)
			{
				if ((!unk_0x3D1053F9EB43B7AD(iLocal_66[0], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, true, 0) || unk_0x3D1053F9EB43B7AD(iLocal_66[0], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, true, 0)) || unk_0x3D1053F9EB43B7AD(iLocal_66[0], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, true, 0))
				{
					unk_0xF3268524E9BE6D6E(iLocal_66[0], unk_0x16F2683693E537C9(), 1000f, 4294967295, 0, 0);
					iLocal_100 = 1;
				}
			}
			if (!iLocal_101)
			{
				if ((!unk_0x3D1053F9EB43B7AD(iLocal_66[1], -1204.031f, -779.629f, 16.33565f, -1174.799f, -757.0704f, 21.01281f, 12.125f, 0, true, 0) || unk_0x3D1053F9EB43B7AD(iLocal_66[1], -1206.545f, -777.8941f, 21.20355f, -1204.313f, -778.2245f, 16.08434f, 2.25f, 0, true, 0)) || unk_0x3D1053F9EB43B7AD(iLocal_66[1], -1202.928f, -782.6883f, 21.20369f, -1202.583f, -780.5067f, 16.08243f, 2.25f, 0, true, 0))
				{
					unk_0xF3268524E9BE6D6E(iLocal_66[1], unk_0x16F2683693E537C9(), 1000f, 4294967295, 0, 0);
					iLocal_101 = 1;
				}
			}
		}
...
void func_151()
{
	...
	vVar0 = { unk_0x68F4C0EC296D3901(iLocal_102, true) };
	vVar1 = { unk_0x835730A2D89F6093(iLocal_102, 2) };
	unk_0xF690C84DADBB3551(&iLocal_102);
	iLocal_102 = unk_0x7707E48765093646(joaat("prop_cs_duffel_01"), vVar0, true, true, false);
	unk_0xC023D1C4BF532815(iLocal_102, vVar1, 2, 1);
}
...
void func_152()
{
	if (unk_0xC844350D5D58C99A(iLocal_66[0]))
	{
		if (SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iLocal_66[0], false)) > 200f && unk_0x03068588A1FCED1A(iLocal_66[0]))
		{
			if (unk_0xE4EDC4B0E92C078B(uLocal_116[0]))
			{
				unk_0x142CC44DB769B57E(&(uLocal_116[0]));
			}
			unk_0x6DAD7906B73F064D(&(iLocal_66[0]));
			bLocal_82 = true;
		}
	}
	else
	...
	if (unk_0xC844350D5D58C99A(iLocal_106))
	{
		if (SYSTEM::VDIST(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iLocal_106, false)) > 200f && unk_0x03068588A1FCED1A(iLocal_106))
		{
			if (unk_0xE4EDC4B0E92C078B(iLocal_120))
			{
				unk_0x142CC44DB769B57E(&iLocal_120);
...
void func_153()
{
	...
	{
		if (unk_0x7F6DC62EA9922664(iLocal_106) < 800)
		{
...
void func_155()
{
	...
	if (unk_0x168558745A6AC21E(unk_0x16F2683693E537C9()))
	{
		if (!bLocal_79)
		{
			...
			while (iVar1 <= (iLocal_63 - 1))
			{
				...
				{
					unk_0x6C3AE6E278DB3D0E(iLocal_66[iVar1], unk_0x16F2683693E537C9(), 0, 16);
				}
				iVar1++;
			}
			bLocal_79 = true;
	...
	if (!bLocal_79)
	{
		...
		else if (iLocal_47 == 2)
		{
			...
			if (unk_0xC844350D5D58C99A(iLocal_102) && !unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
			{
				if (!iLocal_109)
				{
					iLocal_109 = 1;
		...
		if (!iLocal_77)
		{
			if (iLocal_47 == 1)
			{
				...
				{
					unk_0xF690C84DADBB3551(&(iLocal_103[0]));
					unk_0xF690C84DADBB3551(&(iLocal_103[1]));
					if (unk_0xDF1306B443CD3D15(iLocal_106, 0))
					{
						if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
						{
							unk_0xA3BF0AA5A2608191(iLocal_66[0]);
							unk_0xDD353D0E9C789D0E(&iLocal_87);
							unk_0xBC43ED9FE28DB191(0);
							unk_0x5B1D360B9C6F0A09(0, iLocal_106, 4294967295, 0, 2f, 1, 0);
							unk_0x75ABDC5F81978924(iLocal_87);
							unk_0x78ADC381772E3D54(iLocal_66[0], iLocal_87);
							unk_0xF82EA857DA10E0CD(&iLocal_87);
						}
						if (!unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
						{
							unk_0xBD453909DC26A85D(iLocal_66[1], 4294436772, true, 0, 0);
							unk_0xDD353D0E9C789D0E(&iLocal_87);
							unk_0xBC43ED9FE28DB191(0);
							unk_0x5B1D360B9C6F0A09(0, iLocal_106, 4294967295, 1, 2f, 1, 0);
							unk_0x75ABDC5F81978924(iLocal_87);
							unk_0x78ADC381772E3D54(iLocal_66[1], iLocal_87);
							unk_0xF82EA857DA10E0CD(&iLocal_87);
						}
						iLocal_45 = 2;
						iLocal_77 = 1;
					...
					else
					{
						if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]))
						{
							unk_0xE8832A9E16A57A1F(iLocal_66[0], true, 1);
							unk_0x327AAEE25F323797(iLocal_66[0]);
							unk_0xDD353D0E9C789D0E(&iLocal_87);
							unk_0xBC43ED9FE28DB191(0);
						...
						if (!unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
						{
							unk_0xE8832A9E16A57A1F(iLocal_66[1], true, 1);
							unk_0x327AAEE25F323797(iLocal_66[1]);
							unk_0xDD353D0E9C789D0E(&iLocal_87);
							unk_0xBC43ED9FE28DB191(0);
							unk_0xF3268524E9BE6D6E(0, unk_0x16F2683693E537C9(), 1000f, 4294967295, 0, 0);
							unk_0x75ABDC5F81978924(iLocal_87);
			...
			else if (iLocal_47 == 2)
			{
				if (unk_0xA45992A6CE82FB43(iLocal_135) > 0.453f)
				{
					...
					{
						unk_0xA3BF0AA5A2608191(iLocal_66[0]);
						unk_0xBAFED2F6486F771A(iLocal_66[0], 128, true);
						unk_0xBAFED2F6486F771A(iLocal_66[0], 1, true);
						unk_0xAFF39FB306F8E232(iLocal_66[0], 17, true);
						unk_0xCAF7AE54F764D5AA(iLocal_66[0], 1.6f);
						unk_0xE8832A9E16A57A1F(iLocal_66[0], true, 1);
						unk_0xDD353D0E9C789D0E(&iLocal_87);
						unk_0xC6EB89C59F2AF6B8(0, "random@robbery", "run", 2f, -2f, 4294967295, 49, 0, 0, 0, 0);
						unk_0xF44B0E19CAC31C33(0, "re_shoprobbery", 0, 0, 16);
						unk_0xBC43ED9FE28DB191(0);
						unk_0x75ABDC5F81978924(iLocal_87);
						unk_0x78ADC381772E3D54(iLocal_66[0], iLocal_87);
						unk_0xF82EA857DA10E0CD(&iLocal_87);
						unk_0xFADC0A217229F6B5(iLocal_66[0], true);
						SYSTEM::SETTIMERB(0);
					}
					if (!unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
					{
						unk_0xBAFED2F6486F771A(iLocal_66[1], 128, true);
						unk_0xBAFED2F6486F771A(iLocal_66[1], 1, true);
						unk_0xAFF39FB306F8E232(iLocal_66[1], 17, true);
						unk_0xCAF7AE54F764D5AA(iLocal_66[1], 1.6f);
						unk_0xE8832A9E16A57A1F(iLocal_66[1], true, 1);
						unk_0xDD353D0E9C789D0E(&iLocal_87);
						unk_0xBC43ED9FE28DB191(0);
						...
						unk_0x78ADC381772E3D54(iLocal_66[1], iLocal_87);
						unk_0xF82EA857DA10E0CD(&iLocal_87);
						unk_0xFADC0A217229F6B5(iLocal_66[1], true);
					}
					iLocal_45 = 2;
					iLocal_77 = 1;
				}
...
void func_156()
{
	switch (iLocal_146)
	{
		case 0:
			...
			iLocal_145 = unk_0x0D032838710EE57D("DEFAULT_ANIMATED_CAMERA", false);
			unk_0xE3BB8E05FCEB3FBE(iLocal_145, true);
		...
		case 1:
			if (iLocal_147 < unk_0x1C0640BA9A7327B3())
			{
				...
				unk_0xE3BB8E05FCEB3FBE(iLocal_145, false);
...
void func_158()
{
	...
	if (!iLocal_75 && func_161(1, 0, 1))
	{
		...
		if (iLocal_47 == 1)
		{
			if (!iLocal_108)
			{
				iLocal_135 = unk_0xE9744DB7B8CA6965(vLocal_126, vLocal_128, 2);
				unk_0x327AAEE25F323797(unk_0x16F2683693E537C9());
				unk_0x915804B434753CBD(unk_0x16F2683693E537C9(), iLocal_135, "random@shop_robbery", "robbery_action_p", 8f, -8f, 1, 0, 1148846080, 0);
				unk_0xF895E10BF4C72645(unk_0x16F2683693E537C9(), 1, 0);
				if (((!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && !unk_0xEB6A8945D1AC98A1(iLocal_66[1])) && !unk_0xEB6A8945D1AC98A1(iLocal_67[0])) && unk_0xC844350D5D58C99A(iLocal_102))
				{
					unk_0x915804B434753CBD(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0x915804B434753CBD(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 8f, -8f, 1, 0, 1148846080, 0);
					unk_0x915804B434753CBD(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 8f, -4f, 0, 0, 1148846080, 0);
					unk_0xE14EC663EED44AD5(iLocal_102, iLocal_135, "robbery_action_bag", "random@shop_robbery", 8f, -8f, 0, 1148846080);
				}
		...
		else if (iLocal_47 == 2)
		{
			...
			{
				unk_0xA3BF0AA5A2608191(iLocal_67[0]);
				unk_0xC6EB89C59F2AF6B8(iLocal_67[0], "random@robbery", "robbery_main_female", 2f, -2f, 4294967295, 0, 0, 0, 0, 0);
			}
			unk_0x9E632F16E887F781(-1195.062f, -773.2098f, 16.324f, 20f, 4);
			iLocal_135 = unk_0xE9744DB7B8CA6965(vLocal_126, vLocal_128, 2);
			if (((!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && !unk_0xEB6A8945D1AC98A1(iLocal_66[1])) && !unk_0xEB6A8945D1AC98A1(iLocal_67[0])) && unk_0xC844350D5D58C99A(iLocal_102))
			{
				unk_0x915804B434753CBD(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_action_b", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0x915804B434753CBD(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_action_f", 2f, -2f, 0, 0, 1148846080, 0);
				if (unk_0xC844350D5D58C99A(iLocal_103[0]) && unk_0xC844350D5D58C99A(iLocal_103[1]))
				{
					unk_0x9F528B1B53FBC5D9(iLocal_103[0], iLocal_67[0], unk_0x4A089F2B762B8D33(iLocal_67[0], 28422), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
					unk_0x9F528B1B53FBC5D9(iLocal_103[1], iLocal_67[0], unk_0x4A089F2B762B8D33(iLocal_67[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
				}
			}
			...
			if (!unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
			{
				unk_0x915804B434753CBD(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_action_a", 2f, -2f, 1, 0, 1148846080, 0);
			}
			unk_0x57E0CF9BF653D99A(iLocal_135, 0.06f);
			...
			unk_0xA3BF0AA5A2608191(unk_0x16F2683693E537C9());
			unk_0xDD353D0E9C789D0E(&iLocal_87);
			unk_0xC6EB89C59F2AF6B8(0, "random@shop_robbery", "robbery_action_p", 1000f, -2f, 4294967295, 134217736, 0.06f, 0, 0, 0);
			unk_0xC6EB89C59F2AF6B8(0, "random@shop_robbery", "kneel_loop_p", 2f, -4f, 4294967295, 134217737, 0, 0, 0, 0);
			unk_0x75ABDC5F81978924(iLocal_87);
	...
	if ((iLocal_47 == 1 && unk_0xC844350D5D58C99A(iLocal_106)) || iLocal_47 == 2)
	{
		SYSTEM::SETTIMERA(0);
		iLocal_45 = 1;
	}
...
void func_159()
{
	...
	else if (unk_0xB87F6CF6E5628C67(iVar0))
	{
		if (func_160())
		{
			if (unk_0x3D1053F9EB43B7AD(iLocal_104, -828.3692f, -194.4669f, 36.41385f, -824.5801f, -201.1353f, 39.39436f, 4.3125f, 0, true, 0))
			{
		...
		iLocal_106 = unk_0x122AAB0B1D6F55AD(iVar0, vLocal_105, 31.9252f, true, true, false);
		unk_0xE8832A9E16A57A1F(iLocal_106, true, 1);
		unk_0xB9FD7450C0DAB575(iLocal_106, 1084227584);
		unk_0x56FDC9ADE35F7DB0(iLocal_106, true, true, 0);
		iLocal_115 = unk_0x852A19533F896693(iLocal_106, 26, joaat("g_m_y_korean_01"), 4294967295, 1, true);
		unk_0x4E885A246A9D983A(iLocal_115, 134, true);
		unk_0x11AD11297DC58CC7(iLocal_115, true);
		unk_0x6DF7BF67E86AAE86(iLocal_115, iLocal_119);
		unk_0xAFF39FB306F8E232(iLocal_115, 8, false);
		unk_0x083F03A847B640E9(iLocal_115, 0);
		unk_0x298903DD96203C2C(iLocal_115, 13);
		unk_0x262EF6C6306BEA6C(iLocal_115, joaat("weapon_pistol"), 4294967295, true, true);
		unk_0xE2F0767314863BD8(iLocal_115, 1, 0);
		unk_0x4E885A246A9D983A(iLocal_115, 42, true);
		iLocal_107 = 1;
	}
}
...
int func_160()
{
	...
	if (unk_0xDF1306B443CD3D15(iVar0, 0))
	{
		if (unk_0x5A91F08DF773C39D(iVar0, -829.3693f, -191.9869f, 36.4616f, 15f, 15f, 5f, false, true, 0))
		{
			...
			{
				unk_0x73270B3C9CC833FD(iLocal_104, true, 0);
			}
			return 1;
		}
	}
...
int func_164()
{
	switch (func_165(&Global_786B, 0, 5, 0, unk_0x0D0A574C76D769AC()))
	{
		case 1:
			return 1;
			break;
...
int func_172()
{
	...
	if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), -823.1281f, -187.9591f, 36.6189f, 12f, 12f, 12f, false, true, 0) || unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), -1201.017f, -777.5527f, 16.3398f, 12f, 12f, 12f, false, true, 0))
	{
		if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && !unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
		{
			if (unk_0xB87D13D0C064E9D1(iLocal_66[0], unk_0x16F2683693E537C9(), 1) || unk_0xB87D13D0C064E9D1(iLocal_66[1], unk_0x16F2683693E537C9(), 1))
			{
				return 1;
			}
			if (unk_0xE115347EA59F7B86(iLocal_66[0], unk_0x16F2683693E537C9()) || unk_0xE115347EA59F7B86(iLocal_66[1], unk_0x16F2683693E537C9()))
			{
				if (((unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), iLocal_66[0]) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iLocal_66[0])) || unk_0xD3AB958FFC730661(unk_0xD803B885F5E47A62(), iLocal_66[1])) || unk_0x292E02BF8ABF889C(unk_0xD803B885F5E47A62(), iLocal_66[1]))
				{
					if (iLocal_69 == 4294967295)
					{
				...
				{
					iLocal_69 = 4294967295;
				}
				if (iLocal_69 != 4294967295 && unk_0x1C0640BA9A7327B3() > iLocal_69 + 1500)
				{
					return 1;
				}
			}
	...
	if (unk_0x372F6F38C16E36DA(4294967295, vLocal_123 - Vector(20f, 20f, 20f), vLocal_123 + Vector(20f, 20f, 20f)))
	{
		return 1;
	}
	if (unk_0x437347B10A200C4B(iLocal_66[0], 0) || unk_0x437347B10A200C4B(iLocal_66[1], 0))
	{
		return 1;
	}
	...
	if (!unk_0xEB6A8945D1AC98A1(iLocal_66[0]) && !unk_0xEB6A8945D1AC98A1(iLocal_66[1]))
	{
		if (((unk_0x4A42C22237F5FF76(unk_0x16F2683693E537C9(), unk_0x68F4C0EC296D3901(iLocal_66[1], true) - Vector(12f, 12f, 12f), unk_0x68F4C0EC296D3901(iLocal_66[1], true) + Vector(12f, 12f, 12f), 0, 1) && !unk_0x52AE17073D025311(unk_0x16F2683693E537C9())) || unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(iLocal_66[0], true), 3f, 1)) || unk_0xD3DCEC81D13AAFB1(unk_0x68F4C0EC296D3901(iLocal_66[1], true), 3f, 1))
		{
			return 1;
		}
	}
	...
	while (iVar0 < iLocal_67)
	{
		...
		{
			if (unk_0xB87D13D0C064E9D1(iLocal_67[iVar0], unk_0x16F2683693E537C9(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_68)
	{
		...
		{
			if (unk_0xB87D13D0C064E9D1(iLocal_68[iVar0], unk_0x16F2683693E537C9(), 1))
			{
				return 1;
			}
		}
...
void func_175()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_67[1]))
	{
		if (unk_0xCED082ADD3739B9F(iLocal_67[1]))
		{
		...
		unk_0x08082071A5F7C155(iLocal_67[1], 26, 0, 0);
	}
	if (!unk_0xEB6A8945D1AC98A1(iLocal_68[1]))
	{
		func_176(iLocal_68[1], "SCREAM_PANIC", "WAVELOAD_PAIN_FEMALE", 3);
		unk_0x08082071A5F7C155(iLocal_68[1], 3, 0, 0);
	}
}
...
void func_178()
{
	...
	while (iVar0 <= (iLocal_63 - 1))
	{
		iLocal_66[iVar0] = unk_0x36F2404464202779(26, iLocal_141, vLocal_51[iVar0 /*3*/], fLocal_52[iVar0], 1, true);
		unk_0x11AD11297DC58CC7(iLocal_66[iVar0], true);
		unk_0x6DF7BF67E86AAE86(iLocal_66[iVar0], iLocal_119);
		unk_0xAFF39FB306F8E232(iLocal_66[iVar0], 8, false);
		unk_0x083F03A847B640E9(iLocal_66[iVar0], 0);
		unk_0x298903DD96203C2C(iLocal_66[iVar0], 13);
		unk_0x262EF6C6306BEA6C(iLocal_66[iVar0], joaat("weapon_pistol"), 4294967295, true, true);
		unk_0xE2F0767314863BD8(iLocal_66[iVar0], 1, 0);
		unk_0x4E885A246A9D983A(iLocal_66[iVar0], 42, true);
		unk_0x4E885A246A9D983A(iLocal_66[iVar0], 269, true);
		unk_0x4E885A246A9D983A(iLocal_66[iVar0], 188, true);
		unk_0xF4CB0B98F8F79D8D(iLocal_66[iVar0], 0);
		unk_0xBAFED2F6486F771A(iLocal_66[iVar0], 128, true);
		unk_0xBAFED2F6486F771A(iLocal_66[iVar0], 8, true);
		iVar0++;
	}
	unk_0x5F2AA9E2843E9403(iLocal_66[0], "pedRobber[0]");
	unk_0x5F2AA9E2843E9403(iLocal_66[1], "pedRobber[1]");
	unk_0x0E2400AB9174FA81(5, iLocal_119, 1862763509);
	unk_0x0E2400AB9174FA81(5, 1862763509, iLocal_119);
	unk_0x0E2400AB9174FA81(5, iLocal_119, 2761840924);
	unk_0x0E2400AB9174FA81(5, 2761840924, iLocal_119);
	if (func_44() == 0)
	{
		func_183(&uLocal_151, 0, unk_0x16F2683693E537C9(), "MICHAEL", 0, 1);
	}
	else if (func_44() == 1)
	{
		func_183(&uLocal_151, 0, unk_0x16F2683693E537C9(), "FRANKLIN", 0, 1);
	}
	else if (func_44() == 2)
	{
		func_183(&uLocal_151, 0, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
	}
	iLocal_102 = unk_0x7707E48765093646(iLocal_117, vLocal_57, true, true, false);
	if (iLocal_47 == 1)
	{
		unk_0x7D6CA5F52B3748BF(vLocal_71 - Vector(20f, 20f, 20f), vLocal_71 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0xAB8E2DDC7AF955E0(joaat("baller"), true);
		iLocal_103[0] = unk_0x7707E48765093646(joaat("prop_anim_cash_pile_01"), vLocal_57, true, true, false);
		iLocal_103[1] = unk_0x7707E48765093646(joaat("prop_anim_cash_pile_01"), vLocal_57 - Vector(0.1f, 0f, 0f), true, true, false);
		unk_0x4F39CC3882DD074E(iLocal_66[0], "G_M_Y_KorLieut_01_Korean_MINI_01");
		unk_0x4F39CC3882DD074E(iLocal_66[1], "G_M_Y_Korean_01_Korean_MINI_02");
		vLocal_126 = { -821.565f, -186.467f, 36.6f };
		vLocal_128 = { 0f, 0f, -59.96f };
		iLocal_135 = unk_0xE9744DB7B8CA6965(vLocal_126, vLocal_128, 2);
		unk_0xC90224D9E95E5E3A(iLocal_135, true);
		unk_0x915804B434753CBD(iLocal_66[1], iLocal_135, "random@shop_robbery", "robbery_intro_loop_a", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0xE14EC663EED44AD5(iLocal_102, iLocal_135, "robbery_intro_loop_bag", "random@shop_robbery", 1000f, 8f, 0, 1148846080);
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
			iLocal_67[iVar0] = unk_0x36F2404464202779(26, iLocal_138, vLocal_53[iVar0 /*3*/], fLocal_54[iVar0], 1, true);
			unk_0xAFF39FB306F8E232(iLocal_67[iVar0], 17, true);
			unk_0x11AD11297DC58CC7(iLocal_67[iVar0], true);
			unk_0x25C5402CC10F76CD(iLocal_67[iVar0], false);
			unk_0x4E885A246A9D983A(iLocal_67[iVar0], 269, true);
			iVar0++;
		}
		unk_0x5F2AA9E2843E9403(iLocal_67[0], "pedWorker[0]");
		unk_0x5F2AA9E2843E9403(iLocal_67[1], "pedWorker[1]");
		unk_0x5F2AA9E2843E9403(iLocal_67[2], "pedWorker[2]");
		iLocal_68[0] = unk_0x36F2404464202779(26, iLocal_139, vLocal_55[0 /*3*/], fLocal_56[0], 1, true);
		unk_0xAFF39FB306F8E232(iLocal_68[0], 17, true);
		unk_0x11AD11297DC58CC7(iLocal_68[0], true);
		unk_0x25C5402CC10F76CD(iLocal_68[0], false);
		unk_0x4E885A246A9D983A(iLocal_68[0], 269, true);
		iVar0 = 1;
		while (iVar0 <= 2)
		{
			iLocal_68[iVar0] = unk_0x36F2404464202779(26, iLocal_140, vLocal_55[iVar0 /*3*/], fLocal_56[iVar0], 1, true);
			unk_0xAFF39FB306F8E232(iLocal_68[iVar0], 17, true);
			unk_0x11AD11297DC58CC7(iLocal_68[iVar0], true);
			unk_0x25C5402CC10F76CD(iLocal_68[iVar0], false);
			unk_0x4E885A246A9D983A(iLocal_68[iVar0], 269, true);
			iVar0++;
		}
		unk_0x5F2AA9E2843E9403(iLocal_68[0], "pedShopper[0]");
		unk_0x5F2AA9E2843E9403(iLocal_68[1], "pedShopper[1]");
		unk_0x5F2AA9E2843E9403(iLocal_68[2], "pedShopper[2]");
		unk_0x64F9F278AB9DCA2C(iLocal_67[0], 0, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[0], 2, 1, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[0], 3, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[0], 4, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[0], 5, 0, 0, 0);
		unk_0x915804B434753CBD(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 8f, -8f, 0, 0, 1148846080, 0);
		unk_0x4F39CC3882DD074E(iLocal_67[0], "A_M_Y_BevHills_01_White_Mini_01");
		func_183(&uLocal_151, 5, iLocal_67[0], "REROBShopworker", 0, 1);
		unk_0x64F9F278AB9DCA2C(iLocal_67[1], 0, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[1], 2, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[1], 3, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[1], 4, 1, 2, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[1], 5, 0, 0, 0);
		unk_0x8BE3D040D15AEA1D(iLocal_67[1], 4294967295);
		unk_0xFADC0A217229F6B5(iLocal_67[1], true);
		unk_0x64F9F278AB9DCA2C(iLocal_67[2], 0, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[2], 2, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[2], 3, 0, 2, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[2], 4, 1, 2, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_67[2], 5, 0, 0, 0);
		unk_0x8BE3D040D15AEA1D(iLocal_67[2], 4294967295);
		unk_0xFADC0A217229F6B5(iLocal_67[2], true);
		iLocal_135 = unk_0xE9744DB7B8CA6965(-812.37f, -185.65f, 37.5804f, 0f, 0f, 30f, 2);
		unk_0xC90224D9E95E5E3A(iLocal_135, true);
		unk_0x64F9F278AB9DCA2C(iLocal_68[0], 0, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[0], 2, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[0], 3, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[0], 4, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[0], 8, 0, 0, 0);
		unk_0x915804B434753CBD(iLocal_68[0], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xFADC0A217229F6B5(iLocal_68[0], true);
		iLocal_135 = unk_0xE9744DB7B8CA6965(-817.5606f, -190.8273f, 37.6114f, 0f, 0f, 25.8399f, 2);
		unk_0xC90224D9E95E5E3A(iLocal_135, true);
		unk_0x64F9F278AB9DCA2C(iLocal_68[1], 0, 0, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[1], 2, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[1], 3, 1, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[1], 4, 1, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[1], 8, 0, 0, 0);
		unk_0x915804B434753CBD(iLocal_68[1], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xFADC0A217229F6B5(iLocal_68[1], true);
		iLocal_135 = unk_0xE9744DB7B8CA6965(-816.1862f, -182.897f, 37.68f, 0f, 0f, 30f, 2);
		unk_0xC90224D9E95E5E3A(iLocal_135, true);
		unk_0x64F9F278AB9DCA2C(iLocal_68[2], 0, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[2], 2, 0, 2, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[2], 3, 0, 1, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[2], 4, 1, 0, 0);
		unk_0x64F9F278AB9DCA2C(iLocal_68[2], 8, 0, 0, 0);
		unk_0x915804B434753CBD(iLocal_68[2], iLocal_135, "random@robbery", "cower", 8f, -8f, 5, 0, 1148846080, 0);
		unk_0xFADC0A217229F6B5(iLocal_68[2], true);
		unk_0x9BE7E7B6B488CC55(iLocal_66[0], iLocal_67[0], 4294967295, 0);
	...
	{
		unk_0x7D6CA5F52B3748BF(vLocal_72 - Vector(20f, 20f, 20f), vLocal_72 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
		unk_0xC023D1C4BF532815(iLocal_102, vLocal_58, 2, 1);
		iLocal_67[0] = unk_0x36F2404464202779(26, iLocal_138, vLocal_53[0 /*3*/], fLocal_54[0], 1, true);
		unk_0x5F2AA9E2843E9403(iLocal_67[0], "pedWorker[0]");
		unk_0x4F39CC3882DD074E(iLocal_67[0], "A_M_Y_BeachVesp_01_White_Mini_01");
		func_183(&uLocal_151, 6, iLocal_67[0], "REROBShopworker2", 0, 1);
		iLocal_67[1] = unk_0x36F2404464202779(26, iLocal_137, vLocal_53[1 /*3*/], fLocal_54[1], 1, true);
		unk_0x5F2AA9E2843E9403(iLocal_67[1], "pedWorker[1]");
		iVar0 = 0;
		while (iVar0 <= (iLocal_64 - 1))
		{
		...
		iLocal_68[0] = unk_0x36F2404464202779(26, iLocal_139, vLocal_55[0 /*3*/], fLocal_56[0], 1, true);
		unk_0x5F2AA9E2843E9403(iLocal_68[0], "pedShopper[0]");
		iLocal_68[1] = unk_0x36F2404464202779(26, iLocal_140, vLocal_55[1 /*3*/], fLocal_56[1], 1, true);
		unk_0x5F2AA9E2843E9403(iLocal_68[1], "pedShopper[1]");
		iVar0 = 0;
		...
		unk_0xC6EB89C59F2AF6B8(iLocal_67[0], "random@shop_robbery", "robbery_intro_loop_f", 4f, -4f, 4294967295, 9, 0, 0, 0, 0);
		unk_0xFADC0A217229F6B5(iLocal_67[0], true);
		unk_0xC6EB89C59F2AF6B8(iLocal_67[1], "random@robbery", "f_cower_02", 4f, -4f, 4294967295, 9, 0, 0, 0, 0);
		unk_0xFADC0A217229F6B5(iLocal_67[1], true);
		unk_0x8BE3D040D15AEA1D(iLocal_68[0], 4294967295);
		unk_0xFADC0A217229F6B5(iLocal_68[0], true);
		unk_0xC6EB89C59F2AF6B8(iLocal_68[1], "random@robbery", "f_cower_01", 4f, -4f, 4294967295, 9, 0, 0, 0, 0);
		unk_0xFADC0A217229F6B5(iLocal_68[1], true);
		vLocal_126 = { -1192.01f, -768.929f, 16.358f };
		vLocal_128 = { 0f, 0f, -59.5f };
		iLocal_135 = unk_0xE9744DB7B8CA6965(vLocal_126, vLocal_128, 2);
		unk_0xC90224D9E95E5E3A(iLocal_135, true);
		unk_0x915804B434753CBD(iLocal_66[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_b", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0x915804B434753CBD(iLocal_67[0], iLocal_135, "random@shop_robbery", "robbery_intro_loop_f", 2f, -2f, 0, 0, 1148846080, 0);
		unk_0xC6EB89C59F2AF6B8(iLocal_66[1], "random@shop_robbery", "robbery_intro_loop_a", 16f, -4f, 4294967295, 9, 0, 0, 0, 0);
		func_182(14, 1);
		func_181(14);
		SYSTEM::WAIT(500);
		func_179(14, 0, 0);
...
void func_184()
{
	if (!iLocal_74)
	{
		iLocal_88 = unk_0xFBD08BECC9B87937(vLocal_51[0 /*3*/]);
...
void func_189(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 1:
			func_190(uParam1, "Abigail2", func_192(iParam0), 0, 0, 4, -1592.84f, 5214.04f, 3.01f, 400, "", 110, 0, "", 0, 0, 4294967295, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 2:
			func_190(uParam1, "Barry1", func_192(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 3:
			func_190(uParam1, "Barry2", func_192(iParam0), 0, 1, 4, 190.26f, -956.35f, 29.63f, 381, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 4:
			func_190(uParam1, "Barry3", func_192(iParam0), 0, 1, 4, 414f, -761f, 29f, 381, "", 4294967295, 0, "", 164, 1, 4294967295, 0, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		...
		case 7:
			func_190(uParam1, "Barry4", func_192(iParam0), 0, 1, 4, 237.65f, -385.41f, 44.4f, 381, "", 85, 0, "postRC_Barry4", 0, 0, 4294967295, 4, 2, 800, 2000, func_191(iParam0), 0, 0);
			break;
		
		case 8:
			func_190(uParam1, "Dreyfuss1", func_192(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		...
		case 15:
			func_190(uParam1, "Epsilon7", func_192(iParam0), 0, 3, 4, 524.43f, 3079.82f, 39.48f, 206, "", 4294967295, 16, "epsDesert", 0, 0, 16, 4, 1, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 16:
			func_190(uParam1, "Epsilon8", func_192(iParam0), 0, 3, 4, -697.75f, 45.38f, 43.03f, 206, "", 94, 16, "epsilonTract", 0, 0, 4294967295, 4, 1, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 17:
			func_190(uParam1, "Extreme1", func_192(iParam0), 0, 4, 4, -188.22f, 1296.1f, 302.86f, 66, "", 4294967295, 0, "", 4, 1, 18, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		...
		case 20:
			func_190(uParam1, "Extreme4", func_192(iParam0), 0, 4, 4, 1731.41f, 96.96f, 170.39f, 382, "", 98, 16, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 21:
			func_190(uParam1, "Fanatic1", func_192(iParam0), 0, 5, 4, -1877.82f, -440.649f, 45.05f, 405, "", 74, 0, "", 0, 1, 4294967295, 4, 1, 700, 2000, func_191(iParam0), 1, 0);
			break;
		
		case 22:
			func_190(uParam1, "Fanatic2", func_192(iParam0), 0, 5, 4, 809.66f, 1279.76f, 360.49f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 700, 2000, func_191(iParam0), 1, 0);
			break;
		
		case 23:
			func_190(uParam1, "Fanatic3", func_192(iParam0), 0, 5, 4, -915.6f, 6139.2f, 5.5f, 405, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 2, 700, 2000, func_191(iParam0), 0, 1);
			break;
		
		case 24:
			func_190(uParam1, "Hao1", func_192(iParam0), 0, 6, 4, -72.29f, -1260.63f, 28.14f, 66, "", 4294967295, 0, "controller_Races", 13, 1, 4294967295, 4, 2, 2000, 500, func_191(iParam0), 0, 1);
			break;
		
		case 25:
			func_190(uParam1, "Hunting1", func_192(iParam0), 0, 7, 4, 1804.32f, 3931.33f, 32.82f, 66, "", 4294967295, 0, "", 174, 1, 26, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 26:
			func_190(uParam1, "Hunting2", func_192(iParam0), 0, 7, 4, -684.17f, 5839.16f, 16.09f, 384, "", 99, 0, "", 7, 0, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 27:
			func_190(uParam1, "Josh1", func_192(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 66, "", 4294967295, 0, "forSaleSigns", 0, 1, 28, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		...
		case 29:
			func_190(uParam1, "Josh3", func_192(iParam0), 0, 8, 4, 565.39f, -1772.88f, 29.77f, 385, "", 4294967295, 16, "", 0, 0, 30, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 30:
			func_190(uParam1, "Josh4", func_192(iParam0), 0, 8, 4, -1104.93f, 291.25f, 64.3f, 385, "", 4294967295, 36, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 31:
			func_190(uParam1, "Maude1", func_192(iParam0), 0, 9, 4, 2726.1f, 4145f, 44.3f, 66, "", 4294967295, 0, "BailBond_Launcher", 0, 1, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 32:
			func_190(uParam1, "Minute1", func_192(iParam0), 0, 10, 4, 327.85f, 3405.7f, 35.73f, 66, "", 4294967295, 0, "", 0, 1, 33, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 33:
			func_190(uParam1, "Minute2", func_192(iParam0), 0, 10, 4, 18f, 4527f, 105f, 386, "", 4294967295, 10, "", 0, 0, 34, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 34:
			func_190(uParam1, "Minute3", func_192(iParam0), 0, 10, 4, -303.82f, 6211.29f, 31.05f, 386, "", 4294967295, 10, "", 0, 0, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 35:
			func_190(uParam1, "MrsPhilips1", func_192(iParam0), 0, 11, 4, 1972.59f, 3816.43f, 32.42f, 66, "", 4294967295, 0, "ambient_MrsPhilips", 0, 1, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 36:
			func_190(uParam1, "MrsPhilips2", func_192(iParam0), 0, 11, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 1, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 37:
			func_190(uParam1, "Nigel1", func_192(iParam0), 0, 12, 4, -1097.16f, 790.01f, 164.52f, 66, "", 4294967295, 0, "", 177, 1, 4294967295, 1, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		...
		case 42:
			func_190(uParam1, "Nigel2", func_192(iParam0), 0, 12, 4, -1310.7f, -640.22f, 26.54f, 149, "", 4294967295, 8, "", 0, 0, 43, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 43:
			func_190(uParam1, "Nigel3", func_192(iParam0), 0, 12, 4, -44.75f, -1288.67f, 28.21f, 149, "", 4294967295, 16, "postRC_Nigel3", 0, 0, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 1, 1);
			break;
		
		case 44:
			func_190(uParam1, "Omega1", func_192(iParam0), 0, 13, 4, 2468.51f, 3437.39f, 49.9f, 66, "", 4294967295, 0, "spaceshipParts", 0, 1, 45, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 45:
			func_190(uParam1, "Omega2", func_192(iParam0), 0, 13, 4, 2319.44f, 2583.58f, 46.76f, 387, "", 107, 0, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 46:
			func_190(uParam1, "Paparazzo1", func_192(iParam0), 0, 14, 4, -149.75f, 285.81f, 93.67f, 66, "", 4294967295, 0, "", 0, 1, 47, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 47:
			func_190(uParam1, "Paparazzo2", func_192(iParam0), 0, 14, 4, -70.71f, 301.43f, 106.79f, 389, "", 4294967295, 8, "", 0, 0, 48, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 48:
			func_190(uParam1, "Paparazzo3", func_192(iParam0), 0, 14, 4, -257.22f, 292.85f, 90.63f, 389, "", 4294967295, 8, "", 183, 1, 4294967295, 2, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		...
		case 51:
			func_190(uParam1, "Paparazzo4", func_192(iParam0), 0, 14, 4, -484.2f, 229.68f, 82.21f, 389, "", 4294967295, 8, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 52:
			func_190(uParam1, "Rampage1", func_192(iParam0), 0, 15, 4, 908f, 3643.7f, 32.2f, 66, "", 4294967295, 0, "", 0, 1, 54, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 54:
			func_190(uParam1, "Rampage3", func_192(iParam0), 0, 15, 4, 465.1f, -1849.3f, 27.8f, 84, "", 4294967295, 0, "", 0, 1, 55, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 55:
			func_190(uParam1, "Rampage4", func_192(iParam0), 0, 15, 4, -161f, -1669.7f, 33f, 84, "", 4294967295, 0, "", 0, 0, 56, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 56:
			func_190(uParam1, "Rampage5", func_192(iParam0), 0, 15, 4, -1298.2f, 2504.14f, 21.09f, 84, "", 4294967295, 0, "", 0, 0, 53, 4, 4, 0, 2359, func_191(iParam0), 0, 0);
			break;
		
		case 53:
			func_190(uParam1, "Rampage2", func_192(iParam0), 0, 15, 4, 1181.5f, -400.1f, 67.5f, 84, "", 4294967295, 0, "rampage_controller", 0, 0, 4294967295, 4, 4, 0, 2359, func_191(iParam0), 1, 0);
			break;
		
		case 57:
			func_190(uParam1, "TheLastOne", func_192(iParam0), 0, 16, 4, -1298.98f, 4640.16f, 105.67f, 66, "", 133, 1, "", 0, 1, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 58:
			func_190(uParam1, "Tonya1", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", 4294967295, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 59:
			func_190(uParam1, "Tonya2", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "ambient_Tonya", 185, 0, 60, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 60:
			func_190(uParam1, "Tonya3", func_192(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 187, 0, 61, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 61:
			func_190(uParam1, "Tonya4", func_192(iParam0), 0, 17, 4, 0f, 0f, 0f, 4294967295, "", 4294967295, 0, "", 0, 0, 62, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		
		case 62:
			func_190(uParam1, "Tonya5", func_192(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 388, "", 4294967295, 48, "", 0, 0, 4294967295, 4, 2, 0, 2359, func_191(iParam0), 0, 1);
			break;
		...
		if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
		{
			if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x093B8869A122CF27(unk_0xD803B885F5E47A62()) || unk_0xE934758D273C899A(unk_0x16F2683693E537C9())) || unk_0x81A5359F25512A04(unk_0x16F2683693E537C9())) || unk_0x869EFD0BC0868856(unk_0x16F2683693E537C9())) || unk_0x92444005288A72ED(unk_0x16F2683693E537C9())) || unk_0xA3C1B19E1596F41E(unk_0xD803B885F5E47A62(), 1)) || unk_0x2EEF020781C7E77A(unk_0xD803B885F5E47A62())) || unk_0x4734A6196B611C3B(unk_0x16F2683693E537C9(), 0)) || func_226()) || Global_1B05D) || Global_7832) || func_225()) || func_131(8, 4294967295)) || func_224()) || func_223()) || func_222()) || func_221()) || Global_1B416.f_1E03.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xA3C1B19E1596F41E(unk_0xD803B885F5E47A62(), 1) || func_226()) || Global_7832) || func_225()) || func_131(8, 4294967295)) || func_222()) || func_224()) || func_223()) || func_221()) || Global_1B416.f_1E03.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x093B8869A122CF27(unk_0xD803B885F5E47A62()) || unk_0xE934758D273C899A(unk_0x16F2683693E537C9())) || unk_0x81A5359F25512A04(unk_0x16F2683693E537C9())) || unk_0x869EFD0BC0868856(unk_0x16F2683693E537C9())) || unk_0x92444005288A72ED(unk_0x16F2683693E537C9())) || unk_0xA3C1B19E1596F41E(unk_0xD803B885F5E47A62(), 1)) || unk_0x2EEF020781C7E77A(unk_0xD803B885F5E47A62())) || unk_0x4734A6196B611C3B(unk_0x16F2683693E537C9(), 0)) || func_226()) || Global_1B05D) || Global_7832) || func_225()) || func_131(8, 4294967295)) || func_222()) || func_224()) || func_223()) || func_221()) || Global_1B416.f_1E03.f_397[iVar0] == 5) || Global_A3FA != 4294967295)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x869EFD0BC0868856(unk_0x16F2683693E537C9()) || unk_0x92444005288A72ED(unk_0x16F2683693E537C9())) || unk_0xA3C1B19E1596F41E(unk_0xD803B885F5E47A62(), 1)) || unk_0x4734A6196B611C3B(unk_0x16F2683693E537C9(), 0)) || func_226()) || Global_1B05D) || Global_7832) || func_225()) || func_131(8, 4294967295)) || func_224()) || func_223()) || func_221()) || Global_1B416.f_1E03.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_226() || unk_0x179932739160BA96(unk_0xD803B885F5E47A62()) > 0) || func_131(8, 4294967295)) || func_221()) || func_220()) || Global_1B416.f_1E03.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_131(8, 4294967295) || func_224()) || func_223()) || func_220()) || func_219())
						{
							return 0;
						}
...
void func_236()
{
	...
	if (iLocal_142)
	{
		...
		while (iVar0 <= (iLocal_63 - 1))
		{
			if (unk_0xC844350D5D58C99A(iLocal_66[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_66[iVar0]) && !unk_0x405E212DDE472467(iLocal_66[iVar0], 0))
				{
					unk_0xEEB67C3D0A71A47B(iLocal_66[iVar0], vLocal_59, 150f, 4294967295, 0, 0);
					unk_0xFADC0A217229F6B5(iLocal_66[iVar0], true);
				}
				unk_0x6DAD7906B73F064D(&(iLocal_66[iVar0]));
			}
		...
		while (iVar0 <= (iLocal_65 - 1))
		{
			if (unk_0xC844350D5D58C99A(iLocal_68[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_68[iVar0]))
				{
					unk_0xE8832A9E16A57A1F(iLocal_68[iVar0], true, 1);
					unk_0xDD353D0E9C789D0E(&iLocal_87);
					if (iLocal_47 == 1)
					{
						unk_0xC6EB89C59F2AF6B8(0, "random@robbery", "exit_flee", 4f, -4f, 4294967295, 5632, 0f, 0, 1, 0);
		...
		while (iVar0 <= (iLocal_64 - 1))
		{
			if (unk_0xC844350D5D58C99A(iLocal_67[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_67[iVar0]))
				{
					unk_0x4E885A246A9D983A(iLocal_67[iVar0], 317, true);
					unk_0xE8832A9E16A57A1F(iLocal_67[iVar0], true, 1);
					if (iVar0 == 0)
					{
						if (!iLocal_114)
						{
							unk_0xA3BF0AA5A2608191(iLocal_67[iVar0]);
							unk_0xEEB67C3D0A71A47B(iLocal_67[iVar0], vLocal_59, 150f, 4294967295, 0, 0);
						}
						else
						{
							unk_0x11AD11297DC58CC7(iLocal_67[iVar0], false);
						}
					}
					else
					{
					...
					unk_0x11AD11297DC58CC7(iLocal_67[iVar0], false);
					unk_0x25C5402CC10F76CD(iLocal_67[iVar0], true);
				}
			}
			iVar0++;
		}
...
void func_237(int iParam0)
{
	...
	if (func_200())
	{
		...
		func_240(30000);
		StringCopy(&cVar0, func_239(Global_1B40B, 1), 64);
		if (func_71(Global_1B40B) > 0)
		{
...
Vector3 func_250()
{
	...
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		fVar0 = unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_71, true);
		iLocal_70 = 1;
		if (unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_72, true) < fVar0)
		{
			fVar0 = unk_0x0EB28750412C3A5A(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_72, true);
			iLocal_70 = 2;
		}
		if (iLocal_70 == 1)
		{

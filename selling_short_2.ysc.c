...
void func_17(int iParam0)
{
	switch (iParam0)
	{
		...
		case 9:
			func_18(iParam0, 4294967295, 4294967295);
			break;
...
void func_21(var uParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			func_22(&(uParam0->f_9B[0 /*11*/]), 659.867f, 571.539f, 128.531f, vVar0, 0, 0.5f, -1.5f);
			func_22(&(uParam0->f_9B[1 /*11*/]), 660.646f, 567.108f, 128.521f, vVar0, 0, 0.5f, -1.5f);
			break;
		...
		case 2:
			...
			func_22(&(uParam0->f_9B[0 /*11*/]), 669.564f, 563.469f, 128.521f, vVar0, 2, -1.5f, -1.5f);
			func_22(&(uParam0->f_9B[1 /*11*/]), 672.34f, 559.914f, 128.522f, vVar0, 2, -1.5f, -1.5f);
			break;
		...
		case 4:
			...
			func_22(&(uParam0->f_9B[0 /*11*/]), 685.931f, 556.306f, 128.522f, vVar0, 0, 0.5f, -1.5f);
			func_22(&(uParam0->f_9B[1 /*11*/]), 685.897f, 555.108f, 128.521f, vVar0, 1, -1.5f, -1.5f);
			break;
		...
		case 6:
			...
			func_22(&(uParam0->f_9B[0 /*11*/]), 698.861f, 554.048f, 128.521f, vVar0, 0, 0.5f, -1.5f);
			func_22(&(uParam0->f_9B[1 /*11*/]), 703.267f, 554.91f, 128.522f, vVar0, 0, 0.5f, -1.5f);
			break;
...
void func_23(var uParam0, int iParam1, vector3 vParam2, vector3 vParam3, int iParam4, int iParam5, int iParam6)
{
	...
	func_24(uParam0[uParam0->f_9A /*17*/], iParam1, vParam2, vParam3, iParam4, iParam5, iParam6);
	uParam0->f_9A++;
}
...
void func_46(var uParam0)
{
	...
	sVar1 = func_48(uParam0->f_10);
	sVar2 = func_47(uParam0->f_10);
	iVar0 = 0;
	while (iVar0 < uParam0->f_11)
	{
		if (unk_0xC844350D5D58C99A(uParam0->f_11[iVar0]) && !unk_0x437347B10A200C4B(uParam0->f_11[iVar0], 0))
		{
			unk_0x7720CBBC7DD82563(uParam0->f_11[iVar0], sVar2, sVar1, -1000f);
		}
		func_52(&(uParam0->f_11[iVar0]));
		iVar0++;
	}
}
...
void func_49(var uParam0)
{
	...
	{
		func_50(&(uParam0->f_9B[iVar0 /*11*/].f_A));
		iVar0++;
	}
}

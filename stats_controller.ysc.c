...
void func_2()
{
	...
	func_78();
	if (Global_1771A || (Global_1771B && !func_75(0)))
	{
	...
	if (((!unk_0x8CD06866876216F2() && (unk_0x1C0640BA9A7327B3() - iLocal_56) > 2000) || (unk_0x8CD06866876216F2() && unk_0xE7E95E58E001D801(unk_0x2B6E0A53779D29EA(), unk_0x04787588C7E736F8(iLocal_57, 2000)))) || bLocal_59)
	{
		...
		while (iVar12 < iVar11)
		{
			...
			if (unk_0x8CD06866876216F2())
			{
				iVar3 = func_70(iVar7, 4294967295, 0);
			}
			else if (iVar8 == 0)
			{
			...
			{
				unk_0x6FB46C25CCB7E6D5(iVar6, &iVar3, 4294967295);
			}
			iVar5 = iVar3;
			...
			if (func_56(iLocal_58, iVar8, iVar3, &iVar4))
			{
				if (unk_0x8CD06866876216F2())
				{
					func_55(iVar7, iVar4, 4294967295, 1, 0);
				}
				else if (iVar8 == 0)
				{
					if (Global_1B416.f_936.f_21B.f_953[iLocal_58] == 0)
					{
						bVar13 = false;
					}
				...
				if (iVar4 > func_53(iLocal_58, iVar8, 4294967295))
				{
					if (unk_0x8CD06866876216F2())
					{
					}
					else if ((!Global_1B416.f_2378 && !func_52(0)) || !unk_0xEAE0D21A50E6C7F4(Global_1B416.f_2378.f_2[27 /*3*/], 2))
					{
						bVar13 = false;
					}
					iVar14 = iVar4;
					...
					if (iVar4 >= 100)
					{
						if (func_3(iLocal_58, iVar8, &iVar9))
						{
							if (iLocal_58 == 0)
							{
								unk_0x6FB46C25CCB7E6D5(joaat("sp0_total_playing_time"), &iVar10, 4294967295);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 1)
							{
								unk_0x6FB46C25CCB7E6D5(joaat("sp1_total_playing_time"), &iVar10, 4294967295);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 2)
							{
								unk_0x6FB46C25CCB7E6D5(joaat("sp2_total_playing_time"), &iVar10, 4294967295);
								unk_0xCDC520E5E48E63D9(iVar9, iVar10, 1);
							}
							else if (iLocal_58 == 3)
							{
...
int func_9()
{
	...
	if (Global_184507[unk_0xD803B885F5E47A62() /*876*/].f_2EE == 1)
	{
		return 0;
	}
	if (func_42())
	...
	if (func_40())
	{
		if (!func_41())
		{
			...
			{
				if (func_37(&Global_259519, 300000, 0) == 1)
				{
					func_36(&Global_259517);
					func_34(3, 4294967295);
				}
				else if (func_37(&Global_259517, 7000, 0) == 0)
				{
					return 0;
				}
			}
	...
	if (Global_2537E2.f_F3B.f_27 == 1)
	{
		return 0;
	}
	if (Global_2567E2.f_B1E.f_19 == 1)
	{
		return 0;
	}
	if (func_17(1))
...
bool func_13()
{
	return Global_2537E2.f_766.f_2BD != 0;
}
...
{
	return unk_0xEAE0D21A50E6C7F4(Global_18D38C[iParam0 /*38*/].f_E, 0);
}
...
bool func_28()
{
	return unk_0xEAE0D21A50E6C7F4(Global_EA450.f_8, 13);
}
...
{
	*uParam3 = func_57(iParam0, iParam1, 0, 4294967295);
	if (*uParam3 > iParam2)
	{
		return 1;
	}
...
int func_57(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_special_ability_unlocked"), &iVar3, 4294967295);
				fVar0 = SYSTEM::TO_FLOAT(iVar3);
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_special_ability_unlocked"), &iVar3, 4294967295);
				fVar0 = SYSTEM::TO_FLOAT(iVar3);
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_special_ability_unlocked"), &iVar3, 4294967295);
				fVar0 = SYSTEM::TO_FLOAT(iVar3);
			}
			else if (iParam0 == 3)
			{
		...
		case 1:
			...
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 + ((4f * Global_40001.f_5D11) * IntToFloat(func_70(7234, 4294967295, 0))));
			}
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 * 0.25f);
		...
		case 2:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_unarmed_hits"), &iVar3, 4294967295);
				fVar0 = (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_937[iParam0])) / 20f);
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_unarmed_hits"), &iVar3, 4294967295);
				fVar0 = (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_937[iParam0])) / 20f);
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_unarmed_hits"), &iVar3, 4294967295);
				fVar0 = (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_937[iParam0])) / 20f);
			}
			else if (iParam0 == 3)
			{
		...
		case 4:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_number_near_miss"), &iVar3, 4294967295);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_93B[iParam0])) / 50f));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_number_near_miss"), &iVar3, 4294967295);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_93B[iParam0])) / 50f));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_number_near_miss"), &iVar3, 4294967295);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_93B[iParam0])) / 50f));
			}
			else if (iParam0 == 3)
			{
		...
		case 5:
			...
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_plane_landings"), &iVar3, 4294967295);
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(iVar3));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_plane_landings"), &iVar3, 4294967295);
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(iVar3));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_plane_landings"), &iVar3, 4294967295);
				fVar0 = (fVar0 + SYSTEM::TO_FLOAT(iVar3));
			}
			else if (iParam0 == 3)
			{
		...
		case 7:
			if (iParam0 == 0)
			{
				unk_0x893A626C476B583D(joaat("sp0_dist_walk_st"), &fVar1, 4294967295);
				fVar0 = ((fVar1 - Global_1B416.f_936.f_21B.f_93F[iParam0]) / 45f);
			}
			else if (iParam0 == 1)
			{
				unk_0x893A626C476B583D(joaat("sp1_dist_walk_st"), &fVar1, 4294967295);
				fVar0 = ((fVar1 - Global_1B416.f_936.f_21B.f_93F[iParam0]) / 45f);
			}
			else if (iParam0 == 2)
			{
				unk_0x893A626C476B583D(joaat("sp2_dist_walk_st"), &fVar1, 4294967295);
				fVar0 = ((fVar1 - Global_1B416.f_936.f_21B.f_93F[iParam0]) / 45f);
			}
			else if (iParam0 == 3)
			{
			...
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_kills_stealth"), &iVar3, 4294967295);
				fVar0 = (fVar0 + ((SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_943[iParam0])) / 2f) * 1.5f));
			}
			else if (iParam0 == 1)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_kills_stealth"), &iVar3, 4294967295);
				fVar0 = (fVar0 + ((SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_943[iParam0])) / 2f) * 1.5f));
			}
			else if (iParam0 == 2)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_kills_stealth"), &iVar3, 4294967295);
				fVar0 = (fVar0 + ((SYSTEM::TO_FLOAT((iVar3 - Global_1B416.f_936.f_21B.f_943[iParam0])) / 2f) * 1.5f));
			}
			else if (iParam0 == 3)
			{
		...
		case 6:
			if (iParam0 == 0)
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_hits_mission"), &iVar5, 4294967295);
				unk_0x6FB46C25CCB7E6D5(joaat("sp0_hits_peds_vehicles"), &iVar6, 4294967295);
				iVar6 = (iVar6 - iVar5);
			...
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_hits_mission"), &iVar5, 4294967295);
				unk_0x6FB46C25CCB7E6D5(joaat("sp1_hits_peds_vehicles"), &iVar6, 4294967295);
				iVar6 = (iVar6 - iVar5);
				fVar0 = (SYSTEM::TO_FLOAT((iVar5 - Global_1B416.f_936.f_21B.f_947[iParam0])) / 40f);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar6 - Global_1B416.f_936.f_21B.f_94B[iParam0])) / 80f));
			}
			...
			{
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_hits_mission"), &iVar5, 4294967295);
				unk_0x6FB46C25CCB7E6D5(joaat("sp2_hits_peds_vehicles"), &iVar6, 4294967295);
				iVar6 = (iVar6 - iVar5);
				fVar0 = (SYSTEM::TO_FLOAT((iVar5 - Global_1B416.f_936.f_21B.f_947[iParam0])) / 40f);
				fVar0 = (fVar0 + (SYSTEM::TO_FLOAT((iVar6 - Global_1B416.f_936.f_21B.f_94B[iParam0])) / 80f));
			}
...
void func_74(int iParam0, int iParam1)
{
	...
	if (unk_0x8CD06866876216F2())
	{
		iVar0 = func_70(iVar3, 4294967295, 0);
	}
	else
	{
...
void func_79()
{
	...
	if (!iLocal_80)
	{
		if (iLocal_58 == 3)
		{
			...
			{
				iLocal_77 = func_62(func_63(147, 4294967295));
				Global_200000[func_81() /*10930*/].f_181E.f_7 = 0;
			}
			else
			{
				iLocal_77 = Global_200000[func_81() /*10930*/].f_181E.f_6;
			}
			if (Global_200000[func_81() /*10930*/].f_181E.f_4 == 0)
			{
		...
		else
		{
			if (Global_1B416.f_936.f_21B.f_8F4[iLocal_58])
			{
				...
				Global_1B416.f_936.f_21B.f_8F4[iLocal_58] = 0;
			}
			else
			{
				iLocal_77 = Global_1B416.f_936.f_21B.f_8F0[iLocal_58];
			}
			if (Global_1B416.f_936.f_21B.f_8E8[iLocal_58] == 0)
			{
	...
	else if ((unk_0xDD0E7998AE8AD485() - iLocal_79) > 86400)
	{
		...
		if (iLocal_58 == 3)
		{
			Global_200000[func_81() /*10930*/].f_181E.f_7 = 1;
		}
		else
		{
			Global_1B416.f_936.f_21B.f_8F4[iLocal_58] = 1;
		}
	}
	if (iLocal_81)
	{
		switch (iLocal_58)
		{
			...
			case 3:
				iVar0 = func_62(func_63(147, 4294967295));
				break;
		}
...
void func_80(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			...
			if (iVar1 != 11511)
			{
				iVar0 = func_70(iVar1, 4294967295, 0);
				iVar0 = (iVar0 + iParam2);
				if (iVar0 > 100)
				{
					iVar0 = 100;
				}
				func_55(iVar1, iVar0, 4294967295, 1, 0);
			}
			break;
	}
}
...
void func_82()
{
	...
	if (iLocal_74)
	{
		...
		if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()) && unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
		{
			...
			if ((((unk_0xC844350D5D58C99A(iVar1) && unk_0xDF1306B443CD3D15(iVar1, 0)) && !unk_0xE934758D273C899A(iVar1)) && unk_0xA30B8362589C124A(iVar1, 4294967295, 0) == unk_0x16F2683693E537C9()) && (unk_0x7D8B2A8F9EA82DB7(unk_0x134B62B726CEC8E6(iVar1)) || unk_0x8E39AC3C76C8AA58(unk_0x134B62B726CEC8E6(iVar1))))
			{
				bVar0 = false;
...
void func_83()
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		if (((unk_0xC844350D5D58C99A(iVar1) && unk_0xDF1306B443CD3D15(iVar1, 0)) && unk_0xA30B8362589C124A(iVar1, 4294967295, 0) == unk_0x16F2683693E537C9()) && (((unk_0x8E39AC3C76C8AA58(unk_0x134B62B726CEC8E6(iVar1)) || unk_0x7D8B2A8F9EA82DB7(unk_0x134B62B726CEC8E6(iVar1))) || unk_0xAD09C9A4B56FA133(unk_0x134B62B726CEC8E6(iVar1))) || unk_0xD1CC995EE5EB1EC1(unk_0x134B62B726CEC8E6(iVar1))))
		{
			if (iLocal_66)
			{
...
void func_86()
{
	...
	if (unk_0xC844350D5D58C99A(unk_0x16F2683693E537C9()))
	{
		if (func_88(Global_1B416.f_936.f_21B.f_10E1) != unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()))
		{
			...
			if (func_73(iVar0) && (!func_54(14) || Global_1AFFD))
			{
...
void func_99()
{
	...
	if (unk_0x8CD06866876216F2())
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_200000[func_81() /*10930*/].f_181E.f_4F9, 2))
		{
			fVar0 = (SYSTEM::TO_FLOAT(func_70(192, 4294967295, 0)) / 20f);
			iVar1 = SYSTEM::FLOOR(fVar0);
			iVar1 = func_69(iVar1, 0, 100);
			func_80(3, 2, iVar1);
			unk_0x5D96D8530B3D0904(&(Global_200000[func_81() /*10930*/].f_181E.f_4F9), 2);
		}
	}
	bLocal_59 = true;
	iLocal_54 = 1;
	...
	if (unk_0x8CD06866876216F2())
	{
		...
		while (iVar0 < 8)
		{
			if (iVar0 != 0)
			{
				...
				func_55(iVar2, func_53(3, iVar0, 4294967295), 4294967295, 1, 0);
			}
			iVar0++;
		}
		...
		while (iVar3 < 3)
		{
			...
			while (iVar4 < 8)
			{
				if (iVar4 != 0)
				{
					...
					unk_0xCDC520E5E48E63D9(iVar5, func_53(iVar3, iVar4, 4294967295), 1);
				}
				iVar4++;
			}
			iVar3++;
		}
		Global_1B416.f_936.f_21B.f_953[0] = func_53(0, 0, 4294967295);
		Global_1B416.f_936.f_21B.f_953[1] = func_53(1, 0, 4294967295);
		Global_1B416.f_936.f_21B.f_953[2] = func_53(2, 0, 4294967295);
		Global_1B416.f_936.f_21B.f_932 = 1;
		Global_1771A = 1;
	}
}

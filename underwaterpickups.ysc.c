...
void __EntryFunction__()
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false) };
	func_1();
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar4, iVar5, 1, 0);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar4, 4294967295, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar3, iVar4, 4294967295, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
int func_4()
{
	if (Global_259192 == 4294967281)
	{
		Global_259192 = func_23();
		func_15(&Global_259192, 0, 0, 0, 1, 0, 0);
		return 1;
	}
	if (func_5(func_23(), Global_259192))
	{
		Global_259192 = func_23();
		func_15(&Global_259192, 0, 0, 0, 1, 0, 0);
		return 1;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_12(unk_0xEAE0D21A50E6C7F4(iParam0, 31), 4294967295, 1)) + 2011;
}

...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (!iLocal_38)
		{
			if (!iLocal_37 && unk_0x757EF87A33649210())
			{
				unk_0xA47B46945FF6DE74(unk_0x16F2683693E537C9(), vLocal_45, 1, false, 0, 1);
				unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), fLocal_43);
				unk_0x9E632F16E887F781(vLocal_45, 2500f, 0);
...
int func_1()
{
	if (!unk_0xC30A04502B3FE8A8(iLocal_44, "garage_decor_01"))
	{
		unk_0x8A12C90BAA1275CC(iLocal_44, "garage_decor_01");
	}
	else
	{
		unk_0xF1ABF0D4BF2D0A54(iLocal_44);
		return 1;
	}
	return 0;
}
...
int func_2()
{
	iLocal_44 = unk_0x4D570FEF9D230CE7(unk_0x16F2683693E537C9());
	if (unk_0x31609A585163CBAC(iLocal_44))
	{
		if (!iLocal_40)
		{
			unk_0x0007C2367F4F23F3(iLocal_44);
			iLocal_40 = 1;
		}
		else if (unk_0xBD307E66C0669BFC(iLocal_44))
		{
			unk_0x25BB71BA267FE042(iLocal_44);
			return 1;
		}
	}
	return 0;
